...
/**
 * Strings for component 'auth_fc', language 'es', version '3.9'.
 *
 * @package     auth_fc
 * @category    string
...
$string['auth_fccreators'] = 'Lista de grupos cuyos miembros pueden crear nuevos espacios. Separe los distintos grupos con \';\'. Los nombres deben escribirse exactamente igual que en el servidor FirstClass. El sistema diferencia entre mayúsculas y minúsculas.';
