...
/**
 * Strings for component 'local_mail', language 'es', version '3.9'.
 *
 * @package     local_mail
 * @category    string
...
$string['cannotcompose'] = 'Usted no puede redactar mensajes porque no está inscrito en ningún espacio.';
$string['cc'] = 'CC';
...
$string['erroremptycourse'] = 'Por favor especifique un espacio';
