...
/**
 * Strings for component 'tool_recyclebin', language 'es', version '3.9'.
 *
...
$string['categorybinexpiry'] = 'Tiempo de resguardo de Espacios';
$string['categorybinexpiry_desc'] = '¿Cuanto tiempo debe mantenerse en la papelera de reciclaje un espacio eliminado?';
$string['coursebinenable'] = 'Activar papelera de reciclaje del espacio';
...
$string['taskcleanupcoursebin'] = 'Limpiar la Papelera de reciclaje del espacio';
