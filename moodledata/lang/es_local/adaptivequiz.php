...
/**
 * Strings for component 'adaptivequiz', language 'es', version '3.9'.
 *
...
$string['attemptsallowed_help'] = 'Número de veces que un participante puede intentar esta actividad';
...
$string['browsersecurity_help'] = 'Si se selecciona "Ventana emergente de pantalla completa con algo de seguridad de JavaScript", la prueba solo comenzará si el participante tiene un navegador web habilitado para JavaScript, la prueba aparece en una ventana emergente de pantalla completa que cubre todas las demás ventanas y no tiene navegación, los controles y los participantes no pueden, en la medida de lo posible, utilizar funciones como copiar y pegar';
