...
/**
 * Strings for component 'local_o365', language 'es', version '3.9'.
 *
 * @package     local_o365
 * @category    string
...
$string['acp_maintenance_coursegroupusers'] = 'Volver a sincronizar los usuarios en grupos para los espacios.';
...
$string['acp_parentsite_desc'] = 'Sitio para compartir archivos del espacio de Moodle.';
...
$string['acp_sharepointcourseselect_filter'] = 'Flitrar espacios';
$string['acp_sharepointcourseselect_filtercategory'] = 'Filtrar por categoría de espacio';
...
$string['erroro365apicoursenotfound'] = 'Espacio no encontrado.';
...
$string['settings_systemapiuser_details'] = 'Cualquier usuario de AzureAD , pero debe ser la cuenta de un administrador o una cuenta dedicada. Esta cuenta se utiliza para realizar operaciones que no son específicas del usuario. Por ejemplo, la gestión de los sitios de espacios de SharePoint.';
...
$string['spsite_group_contributors_desc'] = 'Todos los usuarios que tienen acceso a administrar los archivos de espacio {$a}';
