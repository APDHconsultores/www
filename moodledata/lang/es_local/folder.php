...
/**
 * Strings for component 'folder', language 'es', version '3.9'.
 *
 * @package     folder
 * @category    string
...
$string['display_help'] = 'Si elige mostrar los contenidos de la carpeta en la página del espacio no aparecerá el enlace a una página separada.
La descripción solo se muestra si se elige "Descripción de la pantalla en la página del espacio". <br />
También tenga en cuenta que las acciones de los usuarios no se pueden registrar en este caso.';
$string['displayinline'] = 'Mostrar en la página del espacio';
...
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en un recurso Carpeta.';
$string['indicator:socialbreadth'] = 'Carpeta social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en un recurso Carpeta.';
...
$string['modulename_help'] = 'El recurso Carpeta permite al facilitador mostrar un grupo de archivos relacionados dentro de una única carpeta. Se puede subir un archivo comprimido (zip) que se descomprimirá (unzip) posteriormente para mostrar su contenido, o bien, se puede crear una carpeta vacía y subir los archivos dentro de ella.

Una carpeta se puede usar para:

* Agrupar una serie de documentos sobre un tema, por ejemplo, un conjunto de exámenes de otros años en formato pdf, o una colección de archivos para crear un proyecto concreto por parte de los participantes.
* Crear un espacio de subida de archivos compartido entre los facilitadores del espacio (se debería ocultar la carpeta a los alumnos para que lo vean solo los facilitadores)';
$string['modulenameplural'] = 'Carpetas';
$string['newfoldercontent'] = 'Nuevo directorio de contenido';
$string['noautocompletioninline'] = 'La cierre automática de la visualización de la actividad no se puede seleccionar junto con la opción "Mostrar en la página del espacio"';
