...
$string['mnet_enrol_description'] = 'Publique este servicio para permitir a los administradores de {$a} matricular a sus participantes en los espacios que usted ha creado en su servidor.<br/><ul><li><em>Dependencia</em>: Usted debe asimismo <strong>suscribirse</strong> al servicio SSO (Proveedor de Identidad) en {$a}.</li><li><em>Dependencia</em>: Debe también <strong>subscribirse</strong> al servicio SSO (Proveedor de Identidad) en {$a}.</li></ul><br/>Suscríbase a este servicio para poder matricular a sus participantes en los espacios de {$a}.<br/><ul><li><em>Dependencia</em>: Debe también <strong>publicar</strong> el servicio SSO (Proveedor de Identidad) en {$a}.</li><li><em>Dependencia</em>: Debe también <strong>suscribirse</strong> al servicio SSO (Proveedor de Identidad) en {$a}.</li></ul><br/>';
$string['mnet_enrol_name'] = 'Servicio remoto de matriculación';
$string['pluginname'] = 'Matriculaciones remotas MNet';
$string['pluginname_desc'] = 'Permite servidor remoto MNet para matricular sus usuarios en nuestros espacios';
$string['remotesubscriber'] = 'Host remoto';
$string['remotesubscriber_help'] = 'Seleccione "Todos los servidores"  para abrir este espacio para todos los puntos MNet a los que estamos ofreciendo el servicio de matriculación remota. O bien, escoja un único servidor para poner este espacio únicamente a disposición de los usuarios del mismo.';
