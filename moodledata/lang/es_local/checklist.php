...
$string['autopopulate'] = 'Mostrar módulos de espacio en lista de verificación';
$string['autopopulate_help'] = 'Esto añadirá automáticamente una lista de todos los recursos y actividades en el espacio actual hacia la lista de verificación..<br /> Esta lista será actualizada con cualquier cambio en el espacio siempre que visite la página de "Editar" de la lista.<br />Los Items podrán ocultarse de la lista, al elegir el icono \'ocultar\' a un lado de ellos.<br /> Para quitar los items automáticos de la lista, cambie esta opción a \'No\' y entonces elija \'Quitar items de módulos del espacio\' en la página de \'Editar\'.';
$string['autoupdate'] = 'Tacharla cuando se completen los módulos';
$string['autoupdate_help'] = 'Esto tachará automáticamente los items en su lista de verificación en cuanto complete la actividad relevante en el espacio.<br /> \'Completar\' una actividad varía de una actividad a otra.- \'ver\' un recurso, \'enviar\' un examen o tarea \'publicar\' en un foro o unirse a un chat, etc.<br /> Si estuviera activado el seguimiento de completo (completion tracking) de Moodle 2.0 para una actividad particular, esto se usaría para tachar el item en la lista.<br /> Para conocer los detalles de exactamente que causa que una actividad se marque como \'completa\', pida al administrador que vea el archivo  \'mod/checklist/autoupdate.php\'<br /> Nota: puede tardarse hasta 60 segundos para que una activad de un participante se vea reflejada en su lista de verificación';
$string['autoupdatenote'] = 'Es la marca del \'participante\' la que se actualiza automáticamente - no se mostrarán actualizaciones en las listas de verificación de \'Solamente Facilitador\'';
$string['autoupdatewarning_both'] = 'Hay items en esta lista que serán actualizados automáticamente (en cuanto los participantes completen la actividad relacionada). Sin embargo, como esta es una lista de verificación de \'participante y facilitador\', las barras de progreso no se actualizarán hasta que el facilitador esté de acuerdo con las puntuaciones otorgadas.';
$string['autoupdatewarning_student'] = 'Hay items en esta lista que serán actualizadas automáticamente (en cuanto los participantes completen la actividad relacionada).';
$string['autoupdatewarning_teacher'] = 'Se han activado las actualizaciones automáticas para esta lista de verificación, pero estas calificaciones no se mostrarán debido a que solamente se muestran las marcas del \'facilitador\'.';
...
$string['checklist:updateother'] = 'Actualizar calificaciones de lista de verificación del participante';
...
$string['checklist:viewreports'] = 'Ver progreso del participante';
...
$string['emailoncomplete_help'] = 'Cuando se completa una lista de verificación, se manda un correo electrónico de notificación a todos los facilitadores del espacio.<br /> Un administrador puede controlar quienes reciben este correo al usar la capacidad \'mod:checklist/emailoncomplete\' - por defecto, todos los facilitadores y facilitadores no-editores tienen esta capacidad.';
$string['emailoncompletebody'] = 'El usuario {$a->user} ha completado la lista de verificación \'{$a->checklist}\'  en el espacio \'{$a->coursename}\'
...
$string['importfromcourse'] = 'Espacio completo';
...
$string['lockteachermarks'] = 'Bloquear calificaciones del facilitador';
$string['lockteachermarks_help'] = 'Cuando se habilita esta configuración, una vez que un facilitador haya guardado una calificación de \'Si\', ya no podrán cambiarla después. Los usuarios con la capacidad \'mod/checklist:updatelocked\' si podrán seguir cambiando la calificación.';
...
$string['removeauto'] = 'Quitar items de módulo del espacio';
$string['report'] = 'Ver progreso';
$string['reporttablesummary'] = 'Tabla que muestra los items en la lista de verificación que cada participante ha completado';
...
$string['teacheralongsidecheck'] = 'Participante y facilitador';
$string['teachercomments'] = 'Los facilitadores pueden añadir comentarios';
$string['teacherdate'] = 'Fecha en la que un facilitador actualizó por última vez este item';
$string['teacheredit'] = 'Actualizaciones por';
$string['teacherid'] = 'El facilitador que actualizó por última vez esta calificación';
$string['teachermarkno'] = 'El facilitador indica que usted NO ha completado esto';
$string['teachermarkundecided'] = 'El facilitador aún no ha calificado esto';
$string['teachermarkyes'] = 'El facilitador indica que usted ha completado esto';
$string['teachernoteditcheck'] = 'Solamente participante';
$string['teacheroverwritecheck'] = 'Solamente facilitador';
...
$string['viewall'] = 'Ver a todos los participantes';
