...
/**
 * Strings for component 'local_ltiprovider', language 'es', version '3.9'.
 *
...
$string['activityroleinstructor'] = 'Rol de actividad para Facilitador';
...
$string['coursebeingrestored'] = 'Este espacio está siendo restaurado, puede llevar algunos minutos su cierre';
$string['courseroleinstructor'] = 'Rol de espacio para Facilitador';
...
$string['enablememberssync'] = 'Activar la sincronización de miembros del espacio';
...
$string['forcenavigation'] = 'Forzar navegación xencursox o actividad';
...
$string['invalidtplcourse'] = 'Identificador de plantilla de espacio no válido';
...
$string['shortnameformat'] = 'Formato de nombre corto para los nuevos espacios creados';
