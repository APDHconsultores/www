...
/**
 * Strings for component 'workshopallocation_scheduled', language 'es', version '3.9'.
 *
...
Internamente, el método de asignación aleatorio es ejecutado con los parámetros predefinidos en el formulario. Esto significa que la asignación programada funciona como si el facilitador ejecutara la asignación aleatoria al final de la fase de envío usando los parámetros a continuación
