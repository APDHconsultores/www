...
/**
 * Strings for component 'local_moodleorg', language 'es', version '3.9'.
 *
...
$string['aboutdemosite'] = 'Nuestro sitio de demostración es un sitio Moodle con todas sus características y algunos espacios de ejemplo donde puede acceder como facilitador, participante o incluso como administrador. No se preocupe por estropear algo, el sitio al completo se vacía y reinicia cada hora.';
$string['aboutdemositetitle'] = 'Sitio de demostración';
$string['aboutintro'] = 'Moodle es un Sistema de Gestión de Espacios de Código Abierto (<i>Open Source Course Management System, CMS</i>), conocido también como Sistema de Gestión del Aprendizaje (<i>Learning Management System, LMS</i>) o como Entorno de Aprendizaje Virtual (<i>Virtual Learning Environment, VLE</i>).  Es muy popular entre los educadores de todo el mundo como una herramienta para crear sitios web dinámicos en línea para sus participantes. Para utilizarlo, necesita ser instalado en un servidor web, puede ser instalado tanto en un ordenador personal como en un servidor proporcionado por una compañía de hospedaje de páginas web.';
...
<ul>
<li>Moodle dispone de características que le permiten escalar a grandes despliegues con cientos de miles de participantes, pero también puede ser utilizado en escuelas de educación infantil y primaria.</li>
...
$string['donationsservices'] = 'Si usted tiene necesidad de servicios de Moodle, tales como como hosting, soporte, instalación, programación personalizada, desarrollo de espacios o asesoría, por favor contacte con su distribuidor autorizado <a href="http://moodle.com/"> Moodle Partner de moodle.com </ a> (puede encontrar sus anuncios publicitarios en este sitio). Los socios aportan un porcentaje fijo de todos sus ingresos para el fondo fiduciario de desarrollo de Moodle, por lo que todo el mundo gana.';
...
$string['focusbox_teaching_courses'] = 'Espacios y contenido';
...
$string['heroslide_story_description'] = '"Al ser líder en el aprendizaje apoyado en la tecnología, nos permite fomentar en los participantes la curiosidad, la creatividad y la búsqueda de oportunidades."- Facilitador Darrell Evans, Vicerrector (Aprendizaje y Enseñanza), Universidad Monash';
...
$string['mycoursesintro'] = 'Actualmente está matriculado en los siguientes "espacios" en este sitio de la comunidad, cada uno de ellos podría disponer de uno o más foros.';
...
$string['namemycourses'] = 'Mis espacios';
...
$string['noenrolledcoursesyet'] = 'Aún no se ha matriculado en ningún espacio de este sitio';
...
$string['resources_courses'] = 'Espacios';
...
$string['social-twitter-moodlenet'] = 'Contenido y espacios compartidos de Moodle';
...
$string['statsteachers'] = 'Facilitadores';
...
$string['supportforums'] = 'Nuestra comunidad de usuarios se comunica principalmente mediante los foros dentro de los "espacios" de este sitio Moodle.  Debe "matricularte" en el espacio para poder enviar mensajes (la matriculación es totalmente gratuita).';
...
$string['supportforumslistname'] = 'Listado de todos los espacios';
$string['supportintro'] = '¡No está solo!  Hay muchas formas de conseguir ayuda con Moodle si lo necesita.';
$string['top10sitesbycourses'] = 'Los 10 sitios con más espacios';
