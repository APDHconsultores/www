...
$string['auth_joomla_auto_sell'] = 'Venta automática de espacios <br>';
$string['auth_joomla_auto_sell_description'] = 'Crear/actualizar/eliminar espacios en la tienda Joomla cuando se hace en Moodle <br>';
...
$string['auth_joomla_enrol_parents'] = 'Inscribir a los padres en espacios';
$string['auth_joomla_enrol_parents_description'] = 'Inscripción automática de padres en espacios para niños';
...
$string['auth_joomla_group_for_course'] = 'Grupo para espacio';
...
$string['auth_joomla_jomsocial_groups_delete_description'] = 'Eliminar el grupo Social al eliminar el espacio <br>';
$string['auth_joomla_jomsocial_groups_description'] = 'Crear un grupo social para cada espacio <br>';
...
$string['auth_joomla_joomla_user_groups_description'] = 'Crear grupos de usuarios de Joomla para participantes y facilitadores. Solo Joomla 1.6+';
...
$string['auth_joomla_use_kunena_forums_description'] = 'Sincronice los foros del espacio con los foros de Kunena en Joomla. Solo Joomla 1.6+';
