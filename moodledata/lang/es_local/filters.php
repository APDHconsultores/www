...
/**
 * Strings for component 'filters', language 'es', version '3.9'.
 *
 * @package     filters
 * @category    string
...
$string['anycourse'] = 'cualquier espacio';
...
$string['courserole'] = 'Rol de espacio';
$string['courserolelabel'] = '{$a->label} es {$a->rolename} en {$a->coursename} de {$a->categoryname}';
$string['courserolelabelerror'] = 'error {$a->label}: el espacio {$a->coursename} no existe';
$string['coursevalue'] = 'valor del espacio';
