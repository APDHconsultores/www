...
/**
 * Strings for component 'cohort', language 'es', version '3.9'.
 *
 * @package     cohort
 * @category    string
...
$string['removeuserwarning'] = 'Quitar usuarios de una cohorte puede dar como resultado la baja de matrícula de estos usuarios en múltiples espacios, lo que implica la eliminación de las configuraciones de usuario, las calificaciones, la pertenencia a grupos y otra información de usuario en los espacios afectados.';
...
Las cohortes visibles también pueden ser vistas por usuarios en los espacios subyacentes.';
