...
/**
 * Strings for component 'tool_lpmigrate', language 'es', version '3.9'.
 *
...
$string['allowedcourses'] = 'Espacios permitidos';
$string['allowedcourses_help'] = 'Elija los espacios a ser migrados al nuevo marco. Si no se especifica ningún espacio, todos los espacios serán migrados';
$string['continuetoframeworks'] = 'Continuar a los marcos';
$string['coursecompetencymigrations'] = 'Migraciones de competencias de espacios';
...
$string['coursesfound'] = 'Se encontraron espacios';
$string['coursestartdate'] = 'Fecha de inicio de los espacios';
$string['coursestartdate_help'] = 'Si está habilitado, los espacios con fecha de inicio previa a la fecha especificada no serán migrados.';
$string['disallowedcourses'] = 'Espacios no permitidos';
$string['disallowedcourses_help'] = 'Seleccione los espacios que NO deberían migrarse al nuevo marco.';
...
$string['errorwhilemigratingcoursecompetencywithexception'] = 'Error al migrar la competencia de espacio {$a}';
...
$string['explanation'] = 'Esta herramienta se puede utilizar para actualizar un marco de competencias a una nueva versión. Busca competencias de espacios y actividades que usan el marco mayor y actualiza los enlaces para que apunten al nuevo marco. No se recomienda editar el antiguo conjunto de competencias directamente ya que esto cambiaría todas las competencias que ya han sido adjudicadas en los planes de aprendizaje de los usuarios. Normalmente debería importarse la nueva versión de un marco, ocultar el marco antiguo y finalmente utilizar esta herramienta para migrar los nuevos espacios al nuevo marco.';
$string['findingcoursecompetencies'] = 'Encontrando las competencias de espacio';
...
$string['migratingcourses'] = 'Migrando espacios';
...
$string['warningcouldnotremovecoursecompetency'] = 'La competencia de espacio no pudo eliminarse.';
$string['warningcouldnotremovemodulecompetency'] = 'La competencia de actividad o recurso no pudo eliminarse.';
$string['warningdestinationcoursecompetencyalreadyexists'] = 'La competencia de espacio destino ya existe.';
