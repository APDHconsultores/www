...
/**
 * Strings for component 'questionnaire', language 'es', version '3.9'.
 *
...
$string['dependquestion_help'] = 'Usted puede seleccionar una pregunta padre y una opción elegible para esta pregunta. Una pregunta hija solamente se le mostrará al participante si su pregunta padre y opción padre han sido previamente seleccionadas.';
...
Si deja ambos valores x e y con valor 0 (su valor por defecto), el editor de texto HTML de Moodle se mostrará con los valores estándar de altura y longitud (si está disponible en contexto de usuario/espacio y/o en el perfil del usuario)';
...
$string['incorrectcourseid'] = 'El identificador (ID) del espacio es incorrecto';
$string['incorrectmodule'] = 'El identificador del módulo del espacio es incorrecto';
...
$string['misconfigured'] = 'El espacio está mal configurado';
...
* Privada  - pertenece solo al espacio en el que se ha definido

* Plantilla * - puede ser copiada y editada.

* Pública  - se puede compartir entre espacios.';
...
$string['respondenteligiblestudents'] = 'Sólamente los participantes';
$string['respondenteligibleteachers'] = 'Sólamente los facilitadores';
...
$string['restrictedtoteacher'] = 'Estas funciones están restringidas a los facilitadores';
...
$string['viewallresponses_help'] = 'Si la encuesta está en **Modo de grupo**: *Grupos Visibles* o *Grupos separados* y el usuario actual tiene la capacidad (en el contexto actual)  *moodle/site:accessallgroups* , y se han definido grupos en el espacio actual, entonces el usuario tiene acceso a una lista desplegable de grupos.

Esta lista desplegable permite al usuario "filtrar"  las respuestas a la encuesta por grupos.

Si el ajuste es **Modo de grupo**: *Grupos separados *, los usuarios que no tienen la capacidad *moodle/site:accessallgroups capacidad* (por lo general, los  Participantes o los Facilitadores sin capacidad de edición, etc), sólo podrán ver las respuestas de los grupos a los que pertenecen.';
