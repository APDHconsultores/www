...
/**
 * Strings for component 'plagiarism_compilatio', language 'es', version '3.9'.
 *
...
$string['admin_disabled_reports'] = 'El administrador no permite que los facilitadores muestren los informes de similitudes a los participantes.';
...
$string['allow_teachers_to_show_reports'] = 'Autorizar a los facilitadores para poner los informes de análisis a disposición de los participantes.';
...
<li><strong>Manual :</strong> El documento es enviado a Compilatio, pero el facilitador tiene que activar los análisis de los documentos manualmente.</li>
...
$string['compilatio:enable'] = 'Autorizar al facilitador para activar/desactivar Compilatio en una actividad';
$string['compilatio:resetfile'] = 'Autorizar al facilitador para enviar de nuevo el fichero a Compilatio después de un error';
$string['compilatio:triggeranalysis'] = 'Autorizar al facilitador para activar el análisis manualmente';
$string['compilatio:viewreport'] = 'Autorizar al facilitador para consultar el informe completo desde Compilatio';
$string['compilatio_display_student_report'] = 'Mostrar al participante el informe de análisis';
...
$string['compilatio_display_student_score'] = 'Hacer que el porcentaje de similitudes sea visible para los participantes';
...
$string['compilatio_studentemail'] = 'Enviar un e-mail al participante';
$string['compilatio_studentemail_help'] = 'Se enviará un e-mail al participante cuando un fichero ha sido tratado para informarle de que el informe está disponible.';
...
<ul>
<li>
Inmediato : <br/> Cada documento es enviado a Compilatio y analizado tan pronto como es entregado por el participante. Recomendado si desea obtener los resultados lo más rápidamente posible, y si no es necesario que todos los documentos de la actividad sean comparados entre sí.
</li>
<li>
Programado : <br/> Elige una fecha de comienzo del análisis Compilatio posterior a la fecha límite de entrega de los participantes. Recomendado si desea comparar todos los documentos de su actividad entre sí.
</li>
<li>
...
$string['owner_file_school_details'] = 'En caso de solicitud de supresión de los datos personales de un participante, el contenido de las tareas e informes se conservará y estará disponible para una futura comparación con nuevas tareas. Al vencimiento del contrato con Compilatio, todos los datos personales de su centro, incluidas las tareas, se suprimen en los plazos previstos contractualmente.';
$string['owner_file_student'] = 'El participante es el único propietario de su tarea';
$string['owner_file_student_details'] = 'En caso de solicitud de supresión de los datos personales de un participante, sus tareas e informes se suprimirán de la plataforma Moodle y de la biblioteca de referencias Compilatio. Las tareas dejarán de estar disponibles para una comparación con nuevos documentos.';
...
$string['privacy:metadata:plagiarism_compilatio_files:cm'] = 'El identificador del módulo del espacio donde se encuentra el envío';
...
$string['students_disclosure'] = 'Mensaje de prevención para los participantes';
$string['students_disclosure_help'] = 'Este texto será visible para todos los participantes en la página de carga de ficheros.';
$string['submitondraft'] = 'Enviar un fichero cuando se suba por primera vez';
$string['submitonfinal'] = 'Enviar un fichero cuando un participante lo envía para calificar';
