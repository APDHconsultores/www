...
/**
 * Strings for component 'ouwiki', language 'es', version '3.9'.
 *
 * @package     ouwiki
 * @category    string
...
Con esta pestaña puede añadir anotaciones incorporadas a las páginas wiki (por ejemplo: comentarios del facilitador en trabajos de participantes).';
...
Una wiki es un sistema basado en web que le permite a los usuarios editar un conjunto de páginas enlazadas. En Moodle, usted normalmente emplearía una wiki cuando desea que sus participantes creen contenidos.
</p>
...
<p> Además, los tutores y facilitadores del espacio tienen (por defecto) la capacidad para anular un bloqueo en cualquier momento.
</p>
