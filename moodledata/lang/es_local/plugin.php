...
/**
 * Strings for component 'plugin', language 'es', version '3.9'.
 *
 * @package     plugin
 * @category    string
...
$string['type_coursereport'] = 'Informe de espacio';
$string['type_coursereport_plural'] = 'Informes del espacio';
...
$string['type_format'] = 'Formato de espacio';
$string['type_format_plural'] = 'Formatos de espacio';
