...
/**
 * Strings for component 'block_workflow', language 'es', version '3.9'.
 *
...
$string['coursestartdate'] = 'fecha de comienzo del espacio';
$string['coursestudentclose'] = 'el espacio no está disponible para participantes';
$string['coursestudentopen'] = 'el espacio está disponible para participantes';
$string['coursetutorclose'] = 'el espacio no está disponible para tutores';
$string['coursetutoropen'] = 'el espacio está disponible para tutores';
$string['create'] = 'Crear';
