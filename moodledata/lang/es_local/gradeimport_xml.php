...
/**
 * Strings for component 'gradeimport_xml', language 'es', version '3.9'.
 *
...
$string['errduplicategradeidnumber'] = 'Error: no existen dos elementos de calificación con el número \'{$a}\' en este espacio (es imposible que ocurra).';
...
$string['fileurl_help'] = 'El archivo remoto del campo URL se usa para buscar datos de un servidor remoto, como un sistema de información del participante.';
