...
/**
 * Strings for component 'wiziq', language 'es', version '3.9'.
 *
 * @package     wiziq
 * @category    string
...
$string['manage_classes_file'] = 'Lista de clases en el espacio';
...
$string['nowiziqs'] = 'No hay clase Wiziq creada en este espacio';
...
$string['presenter_id'] = 'Elegir facilitador';
$string['presenter_name'] = 'Facilitador';
...
$string['scheduleforother_help'] = 'Por defecto la clase se programa para el admin. Si Usted marca la casilla de verificación, usted puede programar la clase para sus facilitadores eligiendo estos facilitadores del menú desplegable';
