...
/**
 * Strings for component 'message', language 'es', version '3.9'.
 *
 * @package     message
 * @category    string
...
$string['contactableprivacy_coursemember'] = 'Mis contactos y cualquier persona de mis espacios';
...
$string['removecoursefilter'] = 'Eliminar filtro para el espacio {$a}';
...
$string['searchforuserorcourse'] = 'Buscar un usuario o espacio';
