...
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad de Wiki.';
$string['indicator:socialbreadth'] = 'Wiki social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad de Wiki.';
...
* Para  los facilitadores de una escuela que planean una estrategia o reunión de trabajo en equipo
* Para participantes que trabajarán en equipo en un libro en línea, creando contenidos de un tema elegido por sus tutores
...
$string['teacherrating'] = 'Clasificación por facilitador';
