...
/**
 * Strings for component 'format_onetopic', language 'es', version '3.9'.
 *
...
$string['hidetabsbar_help'] = 'Oculta la barra de pestañas en la página principal del espacio, la navegación se llevará a cabo con la barra de navegación entre temas.';
$string['index'] = 'Inicio';
$string['level'] = 'Nivel';
...
$string['page-course-view-topics'] = 'Alguna página principal de espacio en formato onetopic';
$string['page-course-view-topics-x'] = 'Alguna página de espacio en formato onetopic';
...
$string['rebuild_course_cache'] = 'Recreando el caché del espacio';
