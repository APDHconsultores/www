...
/**
 * Strings for component 'block_tags', language 'es', version '3.9'.
 *
 * @package     block_tags
 * @category    string
...
$string['taggeditemscontext_help'] = 'Puede limitar la nube de etiquetas a las etiquetas presentes en la categoría de espacio, espacio o módulo';
