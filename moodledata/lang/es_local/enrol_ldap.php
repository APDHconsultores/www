...
/**
 * Strings for component 'enrol_ldap', language 'es', version '3.9'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['assignrole'] = 'Asignando rol \'{$a->role_shortname}\' al usuario \'{$a->user_username}\' en el espacio {$a->course_shortname}\' (id {$a->course_id})';
$string['assignrolefailed'] = 'Fallo al asignarr el rol \'{$a->role_shortname}\' al usuario \'{$a->user_username}\' en el espacio {$a->course_shortname}\' (id {$a->course_id})';
$string['autocreate'] = '<p>Los espacios pueden crearse automáticamente si existen matriculaciones en un espacio que aún no existe en Moodle.</p><p>Si Usted está empleando la creación automática de espacios, se recomienda que elimine las siguientes capacidades: moodle/course:changeidnumber, moodle/course:changeshortname, moodle/course:changefullname and moodle/course:changesummary,
de los roles relevantes para impedir modificaciones a los cuatro campos del espacio especificados arriba (ID number, shortname, fullname and summary).</p>';
$string['autocreate_key'] = 'Creación automática';
$string['autocreation_settings'] = 'Ajustes para la creación automática de espacios';
$string['autoupdate_settings'] = 'Parámetros de actualización de espacio automático';
...
$string['cannotcreatecourse'] = 'No se puede crear el espacio: faltan datos necesarios del registro LDAP';
$string['cannotupdatecourse'] = 'No se puede actualizar el espacio: faltan datos requeridos del registro LDAP. Idnumber del espacio: \'{$a->idnumber}\'';
$string['cannotupdatecourse_duplicateshortname'] = 'No se puede actualizar el espacio: nombre corto duplicado. Saltando espacio con idnumber  \'{$a->idnumber}\'';
$string['category'] = 'Categoría para espacios auto-creados.';
...
$string['course_idnumber'] = 'Mapa del identificador único en LDAP, normalmente  <em>cn</em> or <em>uid</em>. Se recomienda bloquear el valor si se está utilizando la creación automática del espacio.';
...
$string['course_settings'] = 'Ajustes de matriculación de Espacio';
...
$string['coursenotexistskip'] = 'El espacio \'{$a} no existe y la creación automática esta deshabilitada; se pasa por alto';
$string['courseupdated'] = 'El espacio con idnumber  \'{$a->idnumber}\'  ha sido actualizado correctamente.';
$string['courseupdateskipped'] = 'El espacio con número de identificación \'{$a->idnumber}\' no necesita actualización. Omitiéndose...';
$string['createcourseextid'] = 'CREAR usuario matriculado en un espacio inexistente \'{$a->courseextid}\'';
$string['createnotcourseextid'] = 'Usuario matriculado en un espacio inexistente \'{$a->courseextid}\'';
$string['creatingcourse'] = 'Creando espacio \'{$a}\'...';
$string['duplicateshortname'] = 'Fallo en la creación del espacio. Duplicar nombre de archivo corto. Omitir espacio con número de identificación \'{$a->idnumber}\'...';
$string['editlock'] = 'Bloquear valor';
$string['emptyenrolment'] = 'Matriculación vacía para el rol \'{$a->role_shortname}\' en el espacio \'{$a->course_shortname}\'';
$string['enrolname'] = 'LDAP';
$string['enroluser'] = 'Matricular al usuario \'{$a->user_username}\' en el espacio \'{$a->course_shortname}\' (id {$a->course_id})';
$string['enroluserenable'] = 'Matriculación habilitada para el usuario \'{$a->user_username}\' en el espacio \'{$a->course_shortname}\' (id {$a->course_id})';
$string['explodegroupusertypenotsupported'] = 'ldap_explode_group() no soporta el tipo de usuario seleccionado: {$a}';
$string['extcourseidinvalid'] = 'La id del espacio externo no es válido';
$string['extremovedsuspend'] = 'Matriculación deshabilitada para el usuario \'{$a->user_username}\' en el espacio \'{$a->course_shortname}\' (id {$a->course_id})';
$string['extremovedsuspendnoroles'] = 'Matriculación deshabilitada y roles eliminados para el usuario \'{$a->user_username}\' en el espacio \'{$a->course_shortname}\' (id {$a->course_id})';
$string['extremovedunenrol'] = 'Dar de baja el usuario \'{$a->user_username}\' del espacio \'{$a->course_shortname}\' (id {$a->course_id})';
$string['failed'] = 'Error';
...
$string['objectclass'] = 'objectClass usada para buscar espacios. Normalmente
\'posixGroup\'.';
...
$string['pluginname_desc'] = '<p>Usted puede utilizar un servidor LDAP para coltrolar sus matriculaciones. Se asume que su árbol LDAP contiene grupos que apuntan a los espacios y que cada uno de esos grupos o espacios contienen entradas de matriculación que hacen referencia a los participantes.</p>
<p>Se asume que los espacios están definidos como grupos en LDAP, de modo que cada grupo tiene múltiples campos de pertenencia  (<em>member</em> o <em>memberUid</em>) que contienen una identificación única del usuario.</p>
<p>Para usar la matriculación LDAP, los usuarios <strong>deben</strong> tener un campo \'idnumber\' válido. Los grupos LDAP deben contener ese \'idnumber\' en los campos de pertenencia para que un usuario pueda matricularse en un espacio. Esto normalmente funcionará bien si usted ya está usando la identificación LDAP.</p>
...
<p>Esta extensión  puede también ajustarse para crear nuevos espacios de forma automática cuando aparecen nuevos grupos en LDAP.</p>';
...
$string['role_mapping'] = 'Para cada rol que desee asignar a partir de LDAP, debe especificar la lista de contextos donde se localizan los grupos del espacio con este rol. Separe los diferentes contextos con punto y coma \';\'.
...
$string['synccourserole'] = '== Sincronizando espacio \'{$a->idnumber}\' para el rol \'{$a->role_shortname}\'';
$string['syncenrolmentstask'] = 'Sincronizar la tarea de matriculaciones LDAP';
$string['template'] = 'Opcional: los espacios auto-creados pueden copiar sus ajustes a partir de una plantilla de espacio.';
$string['template_key'] = 'Plantilla';
$string['unassignrole'] = 'Quitando la asignación al rol  \'{$a->role_shortname}\' al usuario \'{$a->user_username}\' en el espacio \'{$a->course_shortname}\' (id {$a->course_id})';
$string['unassignrolefailed'] = 'Fallo al quitar la asignación al rol \'{$a->role_shortname}\' al usuario \'{$a->user_username}\' en el espacio \'{$a->course_shortname}\' (id {$a->course_id})';
