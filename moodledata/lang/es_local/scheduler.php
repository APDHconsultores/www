...
/**
 * Strings for component 'scheduler', language 'es', version '3.9'.
 *
 * @package     scheduler
 * @category    string
...
$string['addappointment'] = 'Añadir otro participante';
...
$string['addstudenttogroup'] = 'Añadir a este participante al grupo de cita';
...
<p><ul>
<li><strong>"<emph>n</emph> citas en el organizador:</strong> El participante solamente puede reservar un número fijo de citas en esta actividad. Aun y cuando el docente las marcara como "vistas", a ellos no se les permitirá reservar más reuniones. La única manera de reiniciarle al participante la posibilidad para reservar es eliminar los registros antiguos de "visto".</li>
<li><strong>"<emph>n</emph> citas (reservas) cada vez":</strong> El participante puede reservar un número fijo de citas (reservas). Una vez que termine la reunión y el docente haya marcado al participante como "visto", el participante puede reservar más citas. Sin embargo, el participante está limitado a <emph>n</emph> fechas-horas "abiertas" (no-vistas) en cualquier momento dado.
</li>
</ul>
</p>';
$string['appointmentno'] = 'Cita {$a}';
$string['appointmentnote'] = 'Notas para cita (visible para el participante)';
...
$string['attendedlbl'] = 'Cantidad de participantes atendidos';
...
$string['bookingformoptions'] = 'Formulario de reserva y datos proporcionados por el participante';
$string['bookinginstructions'] = 'Instrucciones para hacer la reserva';
$string['bookslot'] = 'Reservar espacio';
$string['bookwithteacher'] = 'Facilitador';
$string['bookwithteacher_help'] = 'Elija un facilitador para la cita.';
...
$string['conflictremote'] = '{$a->datetime} ({$a->duration} minutos) en el espacio {$a->courseshortname}, planificador de citas {$a->schedulername}';
...
<dd> El archivo de salida contendrá una línea para cada espacio. Si un espacio contiene múltiples citas, entonces en lugar del nombre del participante, etc., se mostrará un marcador "(múltiple)". </dd>
...
$string['displayfrom'] = 'Mostrar espacios a participantes desde';
...
$string['email_applied_html'] = '<p>Se ha solicitado una cita para el {$a->date} a las {$a->time},<br/> por el participante <a href="{$a->attendee_url}">{$a->attendee}</a> para el espacio:
...
$string['email_applied_plain'] = 'Se ha solicitado una cita para el {$a->date} a las {$a->time}, por el participante {$a->attendee} para el espacio:
...
$string['email_cancelled_html'] = '<p>Su cita el <strong>{$a->date}</strong> at <strong>{$a->time}</strong>,<br/> con el participante <strong><a href="{$a->attendee_url}">{$a->attendee}</a></strong> para el espacio :</p>
...
$string['email_cancelled_plain'] = 'Su cita del {$a->date} a las {$a->time}, con el participante {$a->attendee} para el espacio:
{$a->course_short} : {$a->course}

en el planificador de citas "{$a->module}" en el sitio web : {$a->site} ha sido cancelada o movida.';
$string['email_cancelled_subject'] = '{$a->course_short}: Cita cancelada o movida por un participante';
...
con el {$a->staffrole} <strong><a href="{$a->attendant_url}">{$a->attendant}</a></strong> para el espacio:</p>
...
$string['email_teachercancelled_plain'] = 'Su reserva el {$a->date} a las {$a->time}, con el {$a->staffrole} {$a->attendant} para el espacio: {$a->course_short}:
...
$string['exclusivity_help'] = '<p>Puedes configurar un límite para la cantidad de participantes que pueden solicitar un mismo espacio. </p>
<p>Al configurar un límite de 1 (por defecto) se entenderá que el espacio es exclusivo para un único participante.</p>
<p>Configurando el límite como p.e. 3 significará que hasta tres participantes pueden reservar en ese espacio.</p>
<p>Si se deshabilita, cualquier número de participantes puede reservar el espacio; nunca se considerará "lleno".</p>';
$string['exclusivityoverload'] = 'El espacio tiene {$a} participantes citados, más de lo permitido por esta configuración.';
$string['exclusivitypositive'] = 'El número de participantes por espacio necesita ser 1 o más.';
...
$string['field-appointmentnote'] = 'Nota de cita (al participante)';
...
$string['field-maxstudents'] = 'Máximo de participantes';
$string['field-slotnotes'] = 'Notas del espacio';
$string['field-starttime'] = 'Hora de comienzo';
$string['field-studentemail'] = 'Correo del participante';
$string['field-studentfirstname'] = 'Nombre del participante';
$string['field-studentfullname'] = 'Nombre completo del participante';
$string['field-studentidnumber'] = 'ID del participante';
$string['field-studentlastname'] = 'Apellidos del participante';
$string['field-studentusername'] = 'Usuario del participante';
$string['field-teachernote'] = 'Nota confidencial (facilitador solamente)';
...
$string['forcourses'] = 'Elegir participantes en espacios';
...
$string['gradingstrategy_help'] = 'En un planificador de citas donde los participantes pueden tener varias citas, selecciona el modo en el que se agragarán las calificaciones. El libro de calificaciones puede mostrar tanto la <ul><li>calificación promedio o</li><li>la calificación máxima</li></ul> que el participante ha obtenido.';
$string['group'] = 'grupo';
$string['groupbookings'] = 'Reserva por grupos';
$string['groupbookings_help'] = 'Permitir que los participantes puedan reservar un espacio para todos los miembros de sus grupos. (Tenga en cuenta que esto está separado de la configuración de "modo de grupo", la cual controla los espacios que puede ver un participante.)';
$string['groupbreakdown'] = 'Por tamaño del grupo';
$string['groupmodeyourgroups'] = 'Modo de grupo: {$a->groupmode}. Solamente los participantes dentro de {$a->grouplist} pueden reservar citas contigo.';
$string['groupmodeyourgroupsempty'] = 'Modo de grupo: {$a->groupmode}. No eres miembro de ningún grupo, por lo tanto, los participantes no pueden reservar citas contigo';
...
$string['guardtime_help'] = 'Un tiempo de reserva impide que los participantes cambien su reserva poco antes de la cita. <p>Si se habilita el tiempo de reserva y se configura, por ejemplo, a 2 horas, entonces los participantes no podrán reservar un espacio que inicie en menos de 2 horas del momento actual, ni podrán descartar una reserva que inicie en menos de 2 horas.</p>';
$string['guestscantdoanything'] = 'Los invitados no pueden hacer nada aquí.';
$string['howtoaddstudents'] = 'Para añadir participantes a un planificador de citas de rango global use la configuración de roles para el módulo .<br/>Puedes usar las definiciones de roles del módulo para definir a los asistentes entre sus participantes.';
$string['htmlformat'] = 'HTML';
$string['ignoreconflicts'] = 'Ignorar conflictos en la reserva';
$string['ignoreconflicts_help'] = 'Si se activa esta casilla, entonces el espacio se moverá a la fecha y hora solicitada, aun cuando existan otros espacios en la misma hora. Esto puede provocar un solapamiento de reservas para varios docentes o participantes, y por esta razón debería de usarse con cautela.';
$string['includeemptyslots'] = 'Incluir espacios vacíos';
$string['includeslotsfor'] = 'Incluir espacios para';
$string['incourse'] = 'xencursox';
...
$string['markseen'] = 'Después de haber tenido una cita con un participante, por favor, márquelo como "Visto" marcando la casilla junto a la imagen del usuario arriba.';
$string['maxgrade'] = 'Tomar la calificación más alta';
$string['maxstudentlistsize'] = 'Tamaño máximo de la lista de alumnos';
$string['maxstudentlistsize_desc'] = 'La longitud máxima de la lista de participantes que necesitan hacer una reserva, como se muestra en la vista del facilitador para el planificador de citas. Si hay más participantes que este número, no se mostrará ninguna lista.';
$string['maxstudentsperslot'] = 'Número máximo de participantes por espacio';
$string['maxstudentsperslot_desc'] = 'Los espacios de grupo / espacios no exclusivos pueden tener como máximo este número de participantes. Ten en cuenta que, adicionalmente, siempre puedes elegir la configuración "ilimitada" para un espacio.';
...
Los facilitadores indican los huecos de tiempo para reuniones y después los alumnos eligen uno de los huecos en Moodle.
Los facilitadores a su vez pueden guardar el resultado de la reunión (y de forma opcional, una calificación) en el programador.

La programación grupal está disponible, es decir, cada hueco de tiempo puede tener sitio para varios participantes, y de manera opcional es posible programar citas para grupos enteros al mismo tiempo.';
...
$string['needteachers'] = 'No se pueden añadir huecos porque este espacio no tiene facilitadores';
$string['negativerange'] = 'El rango es negativo. Esto no es posible.';
$string['never'] = 'Nunca';
$string['noappointments'] = 'Sin citas';
$string['noexistingstudents'] = 'No hay participantes disponibles para programar';
...
$string['nostudents'] = 'Ningún participante para programar';
$string['nostudenttobook'] = 'Ningún participante para reservar';
$string['note'] = 'Calificación';
$string['noteacherforslot'] = 'Ningún facilitador para los huecos';
$string['noteachershere'] = 'Ningún facilitador disponible';
$string['notenoughplaces'] = 'Lo siento, no hay suficientes citas libres en este hueco.';
$string['notifications'] = 'Notificaciones';
$string['notifications_help'] = 'Cuando esta opción está activada los facilitadores y los alumnos recibirán notificaciones cuando se soliciten o se cancelen citas.';
...
$string['pagination_help'] = 'Elige si el fichero exportado debería contener una página separada para cada facilitador.
...
$string['registeredlbl'] = 'Participante citado';
...
$string['return'] = 'Volver al espacio';
...
$string['scheduler:canseeotherteachersbooking'] = 'Ver y consultar las reservas de otros facilitadores';
...
$string['scheduler:seeotherstudentsresults'] = 'Ver los resultados de otros participantes del espacio';
...
$string['scheduler:viewfullslots'] = 'Ver espacios aunque estén completamente reservados (en la pantalla del participante)';
$string['scheduler:viewslots'] = 'Ver espacios que están abiertos para reserva (en la pantalla del participante)';
$string['schedulestudents'] = 'Planificar por participante';
...
$string['showemailplain_desc'] = 'En la vista del planificador del facilitador, se mostrarán las direcciones de correo electrónico de los participantes que necesitan una cita en texto plano, además de los enlaces \'enviar a:\'.';
$string['showparticipants'] = 'Mostrar participantes';
$string['slot'] = 'Espacio';
$string['slot_is_just_in_use'] = '¡Lo sentimos, la reserva ya ha sido elegida por otro participante! Por favor, inténtelo de nuevo.';
...
$string['staffrolename'] = 'Nombre del rol facilitador';
$string['staffrolename_help'] = 'La etiqueta para el rol que atiende a los participantes. Este
no necesariamente es un "facilitador".';
$string['start'] = 'Comenzar';
$string['startpast'] = 'No puedes iniciar un espacio vacío en el pasado.';
$string['statistics'] = 'Estadísticas';
$string['student'] = 'Participante';
$string['studentbreakdown'] = 'Por participante';
$string['studentcomments'] = 'Notas del participante';
$string['studentdetails'] = 'Detalles del participante';
$string['studentmultiselect'] = 'Cada participante solo puede ser seleccionado una vez en este espacio';
$string['studentnotes'] = 'Tus notas sobre la cita';
$string['students'] = 'Participantes';
$string['sunday'] = 'Domingo';
$string['tab-otherappointments'] = 'Todas las citas de este participante';
$string['tab-otherstudents'] = 'Participantes en este espacio';
$string['tab-thisappointment'] = 'Esta cita';
$string['teacher'] = 'Facilitador';
$string['teachernote'] = 'Notas confidenciales (visibles solamente para el facilitador)';
$string['teachersmenu'] = 'Mostrar espacios para: {$a}';
$string['thiscourse'] = 'este espacio';
...
$string['usenotesstudent'] = 'Nota de cita, visible para facilitador y participante';
$string['usenotesteacher'] = 'Nota confidencial, visible solamente para facilitadores';
$string['usestudentnotes'] = 'Permitir que los participantes introduzcan un mensaje';
...
$string['yesoptional'] = 'Sí, es opcional para el participante';
$string['yesrequired'] = 'Sí, el participante debe introducir un mensaje';
