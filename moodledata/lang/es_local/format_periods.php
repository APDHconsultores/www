...
/**
 * Strings for component 'format_periods', language 'es', version '3.9'.
 *
...
$string['futuresneakpeek_help'] = 'Tratar los periodos que empiezan antes de este intervalo como si fuera el que está xencursox (por ejemplo, esto podría permitir a los participantes ver los primeros dos días de la próxima semana antes de que termine la semana xencursox)';
$string['hidecompletely'] = 'Ocultar completamente';
$string['hidefromcourseview'] = 'Ocultar en la página del espacio';
...
$string['page-course-view-periods'] = 'Cualquier página principal del espacio en formato de periodos';
$string['page-course-view-periods-x'] = 'Cualquier página del espacio en formato de periodos';
...
$string['perioddurationoverride_help'] = 'Establezca la duración para este periodo. Si no se hace, se aplicará el valor por defecto del espacio';
$string['pluginname'] = 'Formato de periodos';
$string['sameascurrent'] = 'Lo mismo que en los periodos xencursox';
...
$string['showpastperiods_help'] = 'Define si mostrar o esconder los periodos que tienen una fecha final en el pasado. "Esconder en la página del espacio" significa que las actividades no se mostrarán en la página del espacio, pero sí estarán visibles en el informe de calificaciones y en otros.';
$string['showperiods'] = 'Mostrar periodos xencursox';
