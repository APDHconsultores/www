...
/**
 * Strings for component 'block_gismo', language 'es', version '3.9'.
 *
 * @package     block_gismo
 * @category    string
...
$string['chats_ud_chart_title'] = 'Actividades: detalles del participante sobre los chats';
$string['close'] = 'Cerrar';
...
$string['err_course_not_set'] = '¡No se ha establecido Id para el Espacio!';
$string['err_missing_course_students'] = '¡No se pueden extraer los participantes del espacio!';
...
$string['exportcourselogs'] = 'Exportar sólo los espacios con bloque gismo';
$string['exportlogs'] = 'Exportación de registros';
$string['exportlogs_missing'] = 'Parámetro exportlogs no se encuentra';
$string['exportlogs_missingcourselogs'] = 'Entrar ejecuta el proceso de análisis en horas fijas, por lo general en la noche. Sus datos del espacio estarán disponibles dentro de 24 horas';
$string['exportlogsdesc'] = 'Exportar todos los registros: esta opción crea registros Gismo de todos los espacios en la plataforma moodle, esto crea una gran cantidad de registros en las tablas de la base de datos gismo, pero los datos están disponibles inmediatamente cuando se coloca el bloque Gismo en un espacio <br /> sólo exportar los espacios con bloque gismo: Exportar sólo los espacios que tienen un bloque gismo, si selecciona esta opción los datos Gismo del espacio estarán disponibles pasadas varias horas después de colocar el bloque Gismo en un espacio.';
$string['file'] = 'Fichero';
$string['forums'] = 'Foro';
...
$string['forums_ud_chart_title'] = 'Actividades: detalles de los participantes en los foros';
$string['from'] = 'De';
$string['gismo'] = 'Gismo';
$string['gismo:addinstance'] = 'Añadir un nuevo bloque gismo';
$string['gismo:trackteacher'] = 'Gismo Facilitador';
$string['gismo:trackuser'] = 'Gismo Participante';
$string['gismo:view'] = 'GISMO - Autorización fallida';
$string['gismo_help'] = '<p> Gismo funciona en aquellos espacios que cumplan los siguientes requisitos: </ p> <ul> <li> hay al menos un participante inscrito al espacio </ li> <li> hay al menos una instancia de una de los siguientes módulos: <ul> <li> Recursos </ li> <li> Asignaciones</ li> <li> Cuestionarios </ li> </ ul> </ li> </ ul>';
...
$string['homepage_chart_resources_students_overview'] = 'Recursos: resumen participantes';
$string['homepage_chart_students_access_overview'] = 'Participantes: resumen accesos';
$string['homepage_chart_students_access_overview_on_resources'] = 'Participantes: resumen de acceso a los recursos';
$string['homepage_chart_students_accesses_by_students'] = 'Participantes: acceso por participante';
...
$string['homepage_text'] = 'GISMO es una herramienta gráfica interactiva para monitorización y seguimiento de los participantes que extrae datos de seguimiento del Sistema de Gestión de Espacios Moodle. Genera representaciones gráficas útiles que pueden ser exploradas por los facilitadores del espacio y los participantes para obtener una visión general de las actividades de aprendizaje. <br />
...
$string['resources_access_detail_chart_title'] = 'Recursos: detalles de los participantes en recursos';
...
$string['resources_students_overview'] = 'Resumen de participantes';
$string['resources_students_overview_chart_title'] = 'Recursos: Resumen de participantes';
$string['save'] = 'Guardar';
$string['show'] = 'Mostrar';
$string['show_details'] = 'Mostrar detalles';
$string['show_menu'] = 'Mostrar Menú';
$string['student_accesses'] = 'Accesos por participantes';
$string['student_accesses_chart_title'] = 'Participantes: Acceso por participantes';
$string['student_accesses_overview'] = 'Resumen accesos';
$string['student_accesses_overview_chart_title'] = 'Participantes: resumen accesos';
$string['student_reporting'] = 'Informes de participantes';
$string['student_reporting_desc'] = 'Si los participantes estan habilitados podrán ver sus registros';
$string['student_reporting_disabled'] = 'Desactivado';
$string['student_reporting_enabled'] = 'Activado';
$string['student_resources_details_chart_title'] = 'Participantes: detalles de los participantes en los recursos';
$string['student_resources_overview'] = 'Resumen accesos a los recursos';
$string['student_resources_overview_chart_title'] = 'Participantes: resumen accesos a los recursos';
...
$string['wikis_ud_chart_title'] = 'Actividades: detalles de participantes en las wikis';
