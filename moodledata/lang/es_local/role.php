...
/**
 * Strings for component 'role', language 'es', version '3.9'.
 *
 * @package     role
 * @category    string
...
$string['archetypecoursecreator'] = 'ARQUETIPO: Creador de espacios';
$string['archetypeeditingteacher'] = 'ARQUETIPO: Facilitador con permiso de edición';
...
$string['archetypestudent'] = 'ARQUETIPO: Participante';
$string['archetypeteacher'] = 'ARQUETIPO: Cofacilitador';
...
rango inferior. Por ejemplo, si un usuario se le asigna el rol de participante en un espacio, también tendrá el rol de participante en todas las actividades y bloques dentro del espacio.';
...
$string['backup:backupcourse'] = 'Copia de seguridad de los espacios';
...
$string['course:changecategory'] = 'Cambiar la categoría del espacio';
$string['course:changefullname'] = 'Cambiar el nombre completo del espacio';
$string['course:changeidnumber'] = 'Cambiar el número ID del espacio';
$string['course:changeshortname'] = 'Cambiar el nombre corto del espacio';
$string['course:changesummary'] = 'Cambiar el resumen del espacio';
$string['course:create'] = 'Crear espacios';
$string['course:delete'] = 'Eliminar espacios';
$string['course:enrolconfig'] = 'Configurar ejemplos de matriculación en espacios';
$string['course:enrolreview'] = 'Revisar matriculaciones del espacio';
...
$string['course:isincompletionreports'] = 'Mostrarse en reportes de cierre';
...
$string['course:markcomplete'] = 'Marcar los usuarios como completos al completar un espacio';
$string['course:movesections'] = 'Mover secciones';
$string['course:request'] = 'Solicitar nuevos espacios';
$string['course:reset'] = 'Reiniciar espacio';
...
$string['course:tag'] = 'Cambiar etiquetas de espacio';
$string['course:update'] = 'Actualizar ajustes de espacio';
$string['course:useremail'] = 'Habilitar/deshabilitar dirección email';
$string['course:view'] = 'Ver espacios sin participación';
$string['course:viewcoursegrades'] = 'Ver calificaciones de espacio';
$string['course:viewhiddenactivities'] = 'Ver actividades ocultas';
$string['course:viewhiddencourses'] = 'Ver espacios ocultos';
...
$string['course:visibility'] = 'Ocultar/mostrar espacios';
...
$string['deletecourseoverrides'] = 'Eliminar todas las modificaciones en el espacio';
...
$string['frontpageuserdescription'] = 'Todos los usuarios identificados en el espacio de la página principal';
$string['globalrole'] = 'Rol del sistema';
$string['globalroleswarning'] = '¡ATENCIÓN! Cualquier rol que asigne desde esta página se aplicará a los usuarios asignados en todo el sitio, incluyendo la página principal y todos los espacios.';
...
$string['legacy:coursecreator'] = 'ROL HEREDADO: Creador de espacios';
$string['legacy:editingteacher'] = 'ROL HEREDADO: Facilitador (editor)';
$string['legacy:guest'] = 'ROL HEREDADO: Invitado';
$string['legacy:student'] = 'ROL  HEREDADO: Participante';
$string['legacy:teacher'] = 'ROL HEREDADO: Facilitador (no editor)';
...
$string['managerdescription'] = 'Los gestores pueden acceder a los espacios y modificarlos, por lo general no participan en los espacios.';
...
$string['rating:rate'] = 'Añada las valoraciones a los elementos';
...
$string['restore:restorecourse'] = 'Restaurar espacios';
...
$string['site:approvecourse'] = 'Aprobar la creación de espacios';
$string['site:backup'] = 'Hacer copia de seguridad de los espacios';
...
$string['site:forcelanguage'] = 'Sobrescribe idioma del espacio';
$string['site:import'] = 'Importar otros espacios a un espacio';
...
$string['site:restore'] = 'Restaurar espacios';
