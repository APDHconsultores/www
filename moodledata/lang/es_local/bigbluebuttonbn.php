...
/**
 * Strings for component 'bigbluebuttonbn', language 'es', version '3.9'.
 *
...
$string['config_importrecordings_enabled_description'] = 'Cuando esto y la función de grabación están habilitadas, es posible importar grabaciones de diferentes espacios a una actividad.';
$string['config_importrecordings_from_deleted_enabled'] = 'Activada importación de grabaciones de actividades eliminadas';
$string['config_importrecordings_from_deleted_enabled_description'] = 'Cuando esto y la función de importación de grabaciones están habilitadas, es posible importar grabaciones de actividades que ya no están en el espacio.';
...
$string['email_body_notification_meeting_end_date'] = 'Fecha de cierre';
...
$string['email_footer_sent_from'] = 'del espacio';
...
$string['indicator:cognitivedepth_help'] = 'Este indicador se basa en la profundidad cognitiva alcanzada por el participante en una actividad de BigBlueButtonBN.';
$string['indicator:socialbreadth'] = 'BigBlueButtonBN social';
$string['indicator:socialbreadth_help'] = 'Este indicador se basa en la amplitud social alcanzada por el participante en una actividad de BigBlueButtonBN.';
...
Para ver grabaciones posteriormente, añada un recurso RecordingsBN a este espacio.';
...
$string['view_error_import_no_courses'] = 'No hay espacios para buscar grabaciones';
$string['view_error_import_no_recordings'] = 'No hay grabaciones en este espacio para importar';
...
$string['view_error_no_group_student'] = 'No has sido enrolado a ningún grupo. Por favor, contacte con su facilitador con el administrador.';
...
$string['view_error_unable_join_student'] = 'Incapáz de conectarse al servidor de BigBlueButton. Por favor, póngase en contacto con su facilitador o con el administrador.';
...
$string['view_groups_nogroups_warning'] = 'La sala se configuró para usar grupos pero el espacio no tiene grupos definidos.';
...
$string['view_recording_course'] = 'Espacio';
$string['view_recording_date'] = 'Fecha';
$string['view_recording_delete_confirmation'] = '¿Está usted seguro de eliminar {$a}?';
$string['view_recording_delete_confirmation_warning_p'] = 'Esta grabación tiene {$a} enlaces asociados que fueron importados en diferentes espacios o actividades. Si se elimina la grabación, esos enlaces también se eliminarán.';
$string['view_recording_delete_confirmation_warning_s'] = 'Esta grabación tiene un enlace {$a} asociado que se importó en un espacio o actividad diferente. Si se elimina la grabación, ese enlace también se eliminará';
...
$string['view_recording_link_warning'] = 'Este es un enlace que apunta a una grabación que se creó en un espacio o actividad diferente';
...
$string['view_recording_list_course'] = 'Espacio';
...
$string['view_recording_unpublish_confirmation_warning_p'] = 'Esta grabación tiene {$a} enlaces asociados que fueron importados en diferentes espacios o actividades. Si la grabación no se publica, esos enlaces también se cancelarán.';
$string['view_recording_unpublish_confirmation_warning_s'] = 'Esta grabación tiene un enlace {$a} asociado que se importó en un espacio o actividad diferente. Si se anula la publicación de la grabación, ese enlace también se anulará.';
