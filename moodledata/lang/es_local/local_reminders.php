...
/**
 * Strings for component 'local_reminders', language 'es', version '3.9'.
 *
...
$string['contenttypecourse'] = 'Espacio';
$string['contenttypegroup'] = 'Grupo';
$string['contenttypeuser'] = 'Usuario';
$string['contentwhen'] = 'Cuando';
$string['courseheading'] = 'Recordatorios de Eventos de Espacio';
$string['days1'] = '1 Día';
$string['days3'] = '3 Días';
$string['days7'] = '7 Días';
...
$string['explaincourseheading'] = 'Configuraciones del recordatorio para eventos de espacio. Estos eventos provienen de un espacio.';
$string['explaindueheading'] = 'Configuraciones del recordatorio para eventos de actividad. Estos eventos provienen de actividades/módulos dentro de un espacio.';
...
$string['messageprovider:reminders_course'] = 'Notificaciones de Recordatorio para Eventos de Espacio';
