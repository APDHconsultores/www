...
/**
 * Strings for component 'readaloud', language 'es', version '3.9'.
 *
 * @package     readaloud
 * @category    string
...
$string['activitylink_help'] = 'Para proporcionar un enlace después del intento hacia otra actividad en el espacio, seleccione la actividad desde la lista desplegable.';
...
$string['allowearlyexit_defaultdetails'] = 'Ajustar la configuración por defecto para allow_early_exit. Puede ser anulada al nivel de la actividad. Si es verdadera, allow_early_exit significa que los participantes pueden terminar antes del límite de tiempo, al presionar un botón para terminar. Las PPM son calculadas usando sus tiempos de grabación.';
$string['allowearlyexit_details'] = 'Si se activa, los participantes pueden terminar antes del tiempo límite, al presionar un botón para terminar. Las Palabras Por Minuto son calculadas usando su tiempo de grabación.';
...
$string['enableai_details'] = 'Read Aloud puede evaluar resultados de un intento de participante usando Inteligencia Artificial (IA). Seleccionar para habilitar.';
...
$string['evaluationview_details'] = 'Qué mostrar a los participantes después de que ellos hayan intentado  y recibido una evaluación';
...
$string['humanpostattempt_details'] = 'Qué mostrar a los participantes después de que hayan intentado y recibido una evaluación humana';
$string['id'] = 'ID';
...
$string['machinepostattempt_details'] = 'Qué mostrarles a participantes después de que hayan hecho un intento y recibido una evaluación de máquina.';
...
$string['modulename_help'] = 'ReadAloud es una actividad diseñada para ayudarle a los facilitadores a evaluar la fluidez de lectura de los participantes que leen un pasaje, configurado por el facilitador, a un micrófono. Más tarde, el facilitador puede marcar las palabras como incorrectas y obtener los puntajes de  PCPM (Palabras Correctas por Minuto).';
...
$string['targetwpm_details'] = 'Las Palabras Por Minuto meta por defecto. Una calificación del participante es calculada para el Libro de calificaciones usando este valor como el puntaje máximo. Si su puntaje de PPM es igual a, o mayor que las PPM meta, obtendrá un puntaje de 100%. Las PPM meta también pueden ser configuradas al nivel de la instancia de la actividad.';
$string['targetwpm_help'] = 'El puntaje de PPM meta. Una calificación del participante es calculada para el Libro de calificaciones usando este valor como el puntaje máximo. Si su puntaje de PPM  es igual a, o mayor que las PPM meta, obtendrá puntaje de 100%.';
