...
/**
 * Strings for component 'block_use_stats', language 'es', version '3.9'.
 *
...
$string['configdisplayothertime'] = 'Mostrar tiempo "fuera del espacio"';
$string['configdisplayothertime_desc'] = 'Si está seleccionado, mostrar la linea de tiempo "fuera de espacio"';
...
$string['hidecourselist'] = 'Oculta tiempos de los espacios';
