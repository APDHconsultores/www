...
/**
 * Strings for component 'enrol_dps', language 'es', version '3.9'.
 *
 * @package     enrol_dps
 * @category    string
...
$string['dps:unenrol'] = 'Desmatricular usuarios del espacio';
$string['dps:unenrolself'] = 'Desmatricularse a si mismo del espacio';
...
$string['error_dpscurrency'] = 'El cargo asignado al espacio no está en una moneda reconocida por DPS.';
