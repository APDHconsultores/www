...
<h2>Ayuda a la navegación:</h2>
  <p>Aquí puede introducir todas las referencias necesarias para facilitar la
     navegación por sus espacios. Además, puede crear una sección para enlazar con
...
$string['nocontentdrag'] = 'Debido a la protección del copyright de nuestros espacios, esta deshabilitado arrastrar (drag & drop) algunos contenidos';
...
<h3><b>Impresión:</b></h3>
  <p>Para evitar posibles fraudes en la utilización del contenido de nuestros
     espacios, se han instalado algunas herramientas básicas para prevenir la
     impresión de ese contenido y proteger dichos derechos de autor.</p>
  <p>&nbsp;</p>
<h3><b>Obtener una copia:</b></h3>
  <p>Si usted está matriculado en alguno de nuestros espacios y necesita una
     copia del contenido, que no esté incluida en el proprio espacio, póngase en
     contacto con su Facilitador o con el Administrador del Sitio para obtener
     ayuda sobre el tema.</p>
  <p>&nbsp;</p>
<hr>
  <p style="text-align: center">Disculpe las molestias.</p>';
$string['nocontentselect'] = 'Debido a la protección del copyright de nuestros espacios, esta deshabilitado seleccionar (copy & paste) algunos contenidos';
