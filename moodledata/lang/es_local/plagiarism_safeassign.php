...
/**
 * Strings for component 'plagiarism_safeassign', language 'es', version '3.9'.
 *
...
$string['course_error_sync'] = 'Ocurrió un error al intentar sincronizar el Espacio con ID: {$a} a SafeAssign: <br>';
$string['course_success_sync'] = 'Espacios sincronizados con éxito';
$string['credentials'] = 'Credenciales y URL de Servicio';
$string['disclaimer'] = '<br>Enviar a la <a href="https://help.blackboard.com/Learn/Facilitador/Assignments/SafeAssign#global_reference" target="_blank"> Base de Datos de Referencia Global</a> de SafeAssign
permite revisar trabajos de otras instituciones <br> comparándolos con el trabajo de su participante para proteger el origen de su trabajo.';
