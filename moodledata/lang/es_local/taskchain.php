...
$string['allowfreeaccess_help'] = 'Este ajuste especifica si se da acceso libre o no a las tareas de la Tarea en Cadena a los participantes.

Una vez que los participantes tienen acceso libre, pueden acceder a cualquier tarea en la Tarea en Cadena, sin importar las condiciones previas ni posteriores de las tareas.

**No**
: No se dará acceso libre a las tareas de la Tarea en Cadena a los participantes. En otras palabras, el acceso a las tareas estará controlado en todo momento por las condiciones previas y posteriores de las tareas.

**Sí: Calificaciones**
: Se dará acceso libre a las tareas de la Tarea en Cadena a los participantes una vez que consiguen la calificación necesaria.

**Sí: Intentos**
: Se dará acceso libre a las tareas de la Tarea en Cadena a los participantes una vez que completen el número de intentos necesarios.';
...
$string['allowresume_help'] = 'Este ajuste indica si los participantes pueden o no reanudar un intento.

**No**
: Los intentos no pueden reanudarse.

**Sí**
: Se ofrecerá a los participantes la posibilidad de reanudar cualquier intento previo que estuviera en progreso o empezar un nuevo intento.

**Forzar**
: Si hay algún intento previo que estuviera aún en progreso, se obligará a los participantes a que reanuden ese intento. En caso contrario podrán empezar un nuevo intento.';
$string['allowreview'] = 'Permitir revisión';
$string['allowreview_help'] = 'Si está habilitado los participantes podrán revisar los intentos de las tareas después de que las tareas se hayan cerrado.';
...
$string['attemptlimit_help'] = 'El número máximo de intentos que un participante puede tener en esta actividad de Tarea en Cadena.';
...
$string['chainname_help'] = 'El nombre de esta actividad de Tarea en Cadena que se mostrará en la página del espacio';
...
$string['clickreporting_help'] = 'Si está habilitado, se mantendrá un registro a parte que contará cada vez que un botón de "indicio", "pista", o "comprobar" sea pulsado. Esto permite al facilitador ver un informe detallado que muestra el estado de la tarea a cada clic. En otro caso sólo se mantendrá un registro por cada intento en una tarea.';
$string['clues'] = 'Pistas';
...
**Tarea específica**
El facilitador puede seleccionar una tarea específica a la que se refiera esta condición previa.
...
El facilitador puede seleccionar una actividad específica o una de las siguientes opciones generales de ajuste:

* Actividad previa en este espacio
* Actividad previa en esta sección
* Actividad previa calificada en este espacio
* Actividad previa calificada en esta sección
* Tarea en Cadena previa en este espacio
...
$string['entrygradedcourse'] = 'Actividad previa calificada en este espacio';
$string['entrygradedsection'] = 'Actividad previa calificada en esta sección del espacio';
...
$string['entrypage_help'] = '¿Se debería mostrar a los participantes una página inicial antes de empezar una actividad de Tarea en Cadena?

**Sí**
: se mostrará a los participantes una página de entrada antes de empezar la Tarea en Cadena. Los contenidos de la página de entrada están definidos en las opciones de página de entrada de Tarea en Cadena.

**No**
: no se mostrará a los participantes una página de entrada y empezarán de forma inmediata la Tarea en Cadena.

Al facilitador siempre se le mostrará una página de entrada para proporcionarle acceso a los informes y poder editar la página de tareas';
$string['entrypagehdr'] = 'Página de entrada';
$string['entrytaskchaincourse'] = 'Tarea en Cadena previa en este espacio';
$string['entrytaskchainsection'] = 'Tarea en Cadena previa en esta sección del espacio';
...
$string['error_nocourseid'] = 'Sin identificador de espacio';
...
$string['event_attempt_started_description'] = 'El usuario con identificador "{$a->userid}" empezó un intento de una tarea en la actividad de "Tarea en Cadena" con identificador de módulo de espacio "{$a->cmid}"';
...
$string['event_attempt_submitted_description'] = 'El usuario con identificador "{$a->userid}" envió un intento de una tarea en la actividad de "Tarea en Cadena" con identificador de módulo de espacio "{$a->cmid}"';
...
$string['event_base_description'] = 'El usuario con identificador "{$a->userid}" inició un evento en la actividad de "Tarea en Cadena" con identificador de módulo de espacio "{$a->cmid}"';
...
$string['event_chains_edited_description'] = 'El usuario con identificador "{$a->userid}" editó todas las cadenas de Tarea en Cadena en el espacio con identificador "{$a->courseid}"';
$string['event_chains_edited_explanation'] = 'Un usuario acaba de editar todas las cadenas de Tarea en Cadena de un espacio';
$string['event_columnlists_edited'] = 'Listas de columnas de Tarea en Cadena editadas';
$string['event_columnlists_edited_description'] = 'El usuario con identificador "{$a->userid}" editó las listas de columnas en la actividad de "Tarea en Cadena" con identificador de módulo de espacio "{$a->cmid}"';
...
$string['event_condition_edited_description'] = 'El usuario con identificador "{$a->userid}" editó una condición en la actividad de "Tarea en Cadena" con identificador de módulo de espacio "{$a->cmid}"';
...
$string['event_report_viewed_description'] = 'El usuario con identificador "{$a->userid}" visualizó un informe en la actividad de "Tarea en Cadena" con identificador de módulo de espacio "{$a->cmid}"';
...
$string['event_task_edited_description'] = 'El usuario con identificador "{$a->userid}" editó una tarea en la actividad de "Tarea en Cadena" con identificador de módulo de espacio "{$a->cmid}"';
...
$string['event_tasks_edited_description'] = 'El usuario con identificador "{$a->userid}" editó todas las tareas en la actividad de "Tarea en Cadena" con identificador de módulo de espacio "{$a->cmid}"';
...
* Siguiente actividad en este espacio
* Siguiente actividad en esta sección
* Siguiente actividad calificada en este espacio
* Siguiente actividad calificada en esta sección
* Siguiente Tarea en Cadena en este espacio
* Siguiente Tarea en Cadena en esta sección

Si otras opciones para salir de la página están deshabilitadas y el participante ha obtenido la calificación requerida en esta actividad de Tarea en Cadena, la siguiente actividad se mostrará inmediatamente. En caso contrario se mostrará al participante un enlace a la siguiente actividad, que podrá pulsar cuando esté listo.';
$string['exitcmcourse'] = 'Siguiente actividad en este espacio';
$string['exitcmsection'] = 'Siguiente actividad en esta sección del espacio';
$string['exitgrade'] = 'Calificación de la siguiente actividad';
$string['exitgradedcourse'] = 'Siguiente actividad calificada en este espacio';
$string['exitgradedsection'] = 'Siguiente actividad calificada en esta sección del espacio';
$string['hints'] = 'Pistas';
...
$string['requirepassword_help'] = 'Si se indica una contraseña, el participante deberá introducirla para poder realizar el cuestionario.';
...
Si un participante pulsa el botón stop, los resultados hasta el momento serán devueltos a Moodle y el estado del intento de la tarea será marcado como abandonado.

El texto que se mostrará en el botón stop será una de las frases preestablecidas desde los packs de idioma de Moodle, formateado como componente_cadena (ej. portfolio_volveradondeestabas), o el que facilitador indique.';
...
$string['wrong'] = 'Mal';
$string['youneedtoenrol'] = 'Tiene que matricularse en este espacio antes de intentar esta actividad de Tarea en Cadena';
