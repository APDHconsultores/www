...
/**
 * Strings for component 'format_topics', language 'es', version '3.9'.
 *
...
$string['page-course-view-topics'] = 'Cualquier página principal de espacio en formato por temas';
$string['page-course-view-topics-x'] = 'Cualquier página de espacio en formato por temas';
