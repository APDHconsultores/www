...
/**
 * Strings for component 'webservice', language 'es', version '3.9'.
 *
 * @package     webservice
 * @category    string
...
$string['cannotgetcoursecontents'] = 'No se pueden obtener los contenidos del espacio';
...
$string['errorcoursecontextnotvalid'] = 'No puede ejecutar funciones en el contexto de espacio (course id:{$a->courseid}). El mensaje de error del contexto fue: {$a->message}';
