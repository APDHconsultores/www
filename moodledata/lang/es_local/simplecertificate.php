...
/**
 * Strings for component 'simplecertificate', language 'es', version '3.9'.
 *
...
$string['certificatenot'] = 'Intancia de Certificado Simple no encontrada';
$string['certificatetext'] = 'Texto del certificado';
$string['certificatetext_help'] = 'Este es el texto que se usará en el certificado; algunas palabras especiales se remplazarán con variables como el nombre del espacio, el nombre del participante, la calificación ...
Estas son:

{USERNAME} -> Nombre completo del usuario
{COURSENAME} -> Nombre completo del espacio (o un nombre del espacio alternativo definido)
{GRADE} -> Calificación con formato
{DATE} -> Fecha con formato
{OUTCOME} -> Competencias
{HOURS} -> Horas definidas en el espacio
{TEACHERS} -> Lista de facilitadores
{IDNUMBER} -> Número ID del usuario
...
$string['coursename'] = 'Nombre alternativo del espacio';
$string['coursename_help'] = 'Nombre alternativo del espacio';
$string['coursenotfound'] = 'Espacio no encontrado';
$string['coursetimereq'] = 'Minutos requeridos en el espacio';
$string['coursetimereq_help'] = 'Introduzca aquí el mínimo total de tiempo, en minutos, que un participante debe haber estado conectado en el espacio antes de que pueda recibir el certificado.';
...
$string['delivery_help'] = 'Elija aquí cómo quiere que sus participantes obtengan su certificado:
...
Certificado poe email: Al elegir esta opción se envía el certificado al participante mediante un anexo de un mensaje de Email.

Después de que un usuario haya recibido su certificado, si pulsa sobre el enlace del certificado dentro de la página del espacio, verá la fecha en que recibió dicho certificado y podrá verlo de nuevo.';
...
$string['emailothers_help'] = 'Introduzaca aquí las direcciones Email, separadas por comas, de quienes deben ser avisados con un email cada vez que un participante reciba un certificado.';
...
$string['emailteachermail'] = '{$a->student} ha recibido su certificado: \'{$a->certificate}\' del espacio {$a->course}.

Puede verlo aquí: {$a->url}';
$string['emailteachermailhtml'] = '{$a->student} ha recibido su certificado: \'<i>{$a->certificate}\' del espacio {$a->course}\'</i>.

Puede verlo aquí: <a href="{$a->url}">Certificate Report</a>.';
$string['emailteachers'] = 'Email de los facilitadores';
$string['emailteachers_help'] = 'Si se habilita, los facilitadores serán avisados con un email cada vez que un participante reciba un certificado.';
...
$string['keywords'] = 'certificado, espacio, PDF, Moodle';
$string['modulename'] = 'Certificado simple';
$string['modulename_help'] = 'El módulo de actividad \'simple certificate\' permite al facilitador crear certificados personalizados que pueden ser emitidos a los alumnos que han completado los requisitos que ha especificado el facilitador.';
...
$string['printdate_help'] = 'Esta es la fecha que se va a imprimir, si ha decidido imprimir una fecha. Si se selecciona la fecha de el cierre del espacio, pero el participante no ha completado el espacio, se imprimirá la fecha de recepción. También puede imprimir la fecha en función de cuándo se haya calificado una actividad. Si se emite un certificado antes de que se haya calificado la actividad, se imprimirá la fecha de recepción.';
$string['printgrade'] = 'Imprimir calificación';
$string['printgrade_help'] = 'Puede elegir cualquiera de los elementos de calificación del espacio disponibles en el libro de calificaciones para imprimirla en el certificado como calificación obtenida por el usuario. Los elementos de calificación se enumeran en el orden en el que aparecen en el libro de calificaciones. Elija el formato de la nota a continuación.';
$string['printoutcome'] = 'Imprimir competencia';
$string['printoutcome_help'] = 'Puede elegir cualquier competencia del espacio para imprimir en el certificado el nombre de dicha competencia y los resultados obtenidos por el usuario. Un ejemplo sería: Competencia en Tarea: Apto.';
...
$string['requiredtimenotmet'] = 'Debe haber utilizado al menos {$a->requiredtime} minutos en este espacio para emitir este certificado';
