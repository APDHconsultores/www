...
/**
 * Strings for component 'plagiarism_unicheck', language 'es', version '3.9'.
 *
...
$string['exclude_self_plagiarism_help'] = 'Activa esta opción para excluir el autoplagio en el mismo espacio. Las similitudes con las tareas de otros espacios serán igualmente reportados. <br> Esta opción tiene que ser activada antes de la entrega y no debe modificarse posteriormente.';
$string['explainerrors'] = 'Esta página enumera los archivos que se encuentran actualmente en un estado de error. <br/> Cuando se eliminen los archivos en esta página, no podrán ser reenviados, y los errores ya no se mostrarán a los facilitadores o participantes';
...
$string['no_index_files_help'] = 'Los trabajos de los alumnos se añaden a la Biblioteca Institucional privada sólo cuando esta opción esté activada. Los nuevos envíos se comparan con los trabajos almacenados en la Biblioteca Institucional, además de internet. Esta biblioteca sólo incluye trabajos entregados por los participantes de esta institución y no se comparte con otras instituciones.';
...
$string['privacy:metadata:plagiarism_external_unicheck_api:userscope'] = 'Alcance de permisos de usuarios: facilitador o participante';
...
$string['privacy:metadata:plagiarism_unicheck_files:userid'] = 'ID de participante.';
...
$string['privacy:metadata:plagiarism_unicheck_users:user_id'] = 'ID de participante o de facilitador';
...
$string['sent_student_report'] = 'Notificar a los participantes por correo electrónico';
$string['sent_student_report_help'] = 'Los participantes recibirán la información sobre los resultados de comprobación por correo electrónico.';
$string['show_student_report'] = 'Mostrar informes de similitud a los alumnos';
$string['show_student_report_help'] = 'Los participantes sólo ven los informes de similitud de sus propios trabajos y no ven los informes de otros participantes.';
$string['show_student_score'] = 'Mostrar calificaciones de similitud a los alumnos';
$string['show_student_score_help'] = 'Los participantes sólo ven los porcentajes de similitud de sus propios trabajos y no ven los porcentajes de otros participantes.';
...
$string['studentdisclosure'] = 'Familiarizar a los participantes con el Servicio de Plagio Unicheck';
...
$string['submitonfinal'] = 'Enviar el archivo cuando el participante lo envía para su calificación';
...
$string['unicheck:changeexcludeselfplagiarismsetting'] = 'Permitir activar/desactivar excluir el autoplagio en el espacio';
...
$string['unicheck:changesentstudentreportsetting'] = 'Permitir activar/desactivar el envío del informe de participantes por correo electrónico';
...
$string['use_assign_desc_value'] = 'Establecer configuración de envío → Requerir que los participantes hagan clic en el botón Enviar = Sí';
