...
/**
 * Strings for component 'grades', language 'es', version '3.9'.
 *
 * @package     grades
 * @category    string
...
$string['aggregatesubcatsupgradedgrades'] = 'Nota: La configuración de cálculos "Cálculos totales incluyendo subtageorías" ha sido removido tras la actualización del portal. Debido a que "Cálculos totales incluyendo subcategorías" se utilizaba en este espacio, se recomienda que compruebe el cambio en el libro de calificaciones.';
...
<ul>
    ...
    <li>Un participante consigue una calificación de 20 en el elemento 1, 40 en el 2 y 70 en el 3</li>
    <li>El total del participante en la Categoría 1 será de 95/100 puesto que 20*2 + (40 + 70)/2 = 95</li>
</ul>';
...
$string['aggregationposition_help'] = 'Este parámetro valor determina si las columnas de totales de las categorías y los espacios se muestran al principio o al final en los informes del libro de calificaciones.';
...
$string['allstudents'] = 'Todos los participantes';
...
$string['contributiontocoursetotal'] = 'Aporta al total del espacio';
$string['controls'] = 'Controles';
$string['courseavg'] = 'Promedio del espacio';
$string['coursegradecategory'] = 'Categoría de calificación de espacio';
$string['coursegradedisplaytype'] = 'Forma de mostrar calificación del espacio';
$string['coursegradedisplayupdated'] = 'La forma de mostrar la calificación del espacio ha sido actualizada.';
$string['coursegradesettings'] = 'Ajustes de la calificación del espacio';
$string['coursename'] = 'Nombre del espacio';
$string['coursescales'] = 'Escalas del espacio';
$string['coursesettings'] = 'Ajustes del espacio';
$string['coursesettingsexplanation'] = 'Los ajustes del espacio determinan cómo aparece el libro de calificaciones a todos los participantes del espacio.';
$string['coursesiamtaking'] = 'Espacios que estoy tomando';
$string['coursesiamteaching'] = 'Espacios que estoy enseñando';
$string['coursetotal'] = 'Total del espacio';
...
$string['errornocourse'] = 'No se pudo obtener información del espacio';
...
$string['exportonlyactive_help'] = 'Solo incluye en la exportación aquellos participantes cuya matrícula esté activa y no haya sido suspendida';
...
$string['feedback_help'] = '<p>Comentarios añadidos por el facilitador a la calificación. Pueden ser extensos, personalizados o un simple código que se refiere a un sistema de retroalimentación interno.</p>';
...
$string['fixedstudents'] = 'Columna de participantes fijada';
$string['fixedstudents_help'] = 'Fija la columna de participantes en el informe del calificador, permitiendo que las calificaciones se desplacen horizontalmente.';
...
$string['forstudents'] = 'Para los participantes';
...
$string['gradebookcalculationswarning'] = 'Nota: Se han detectado algunos errores al calcular las calificaciones mostradas en este libro de calificaciones. Si su espacio no ha comenzado o está en progreso, es recomendable que los errores sean corregidos haciendo clic en el botón inferior, aunque esto puede llevar a un cambio en las calificaciones.  Si su espacio ya ha finalizado y las calificaciones han sido
...
$string['gradebookhiddenerror'] = 'El libro de calificaciones está ajustado de modo que no se mostrará nada a los participantes.';
...
$string['gradegrademinmax'] = 'No recalcula calificaciones, aparece la calificación con el máximo y/o mínimo anterior hasta que esta se actualiza manualmente por el facilitador';
...
$string['gradeoutcomescourses'] = 'Resultados del espacio';
...
$string['gradesmoduledeletionpendingwarning'] = 'Advertencia: ¡Borrado de actividad xencursox! Algunas calificaciones están a punto de ser eliminadas.';
...
$string['hidden_help'] = 'Si se marca esta opción, las calificaciones se ocultarán a los participantes. Se pueden ocultar si se desea hasta en día en que se hagan públicas las calificaciones una vez completado el proceso.';
...
$string['hidetotalifhiddenitems_help'] = 'Este ajuste especifica si los totales que contienen ítems de calificación oculta se muestran a los participantes, o bien si se reemplazan con un guión (-). Si se muestran, el total puede calcularse excluyendo o incluyendo dichos ítems.

Si se excluyen los ítems ocultos, el total será diferente al que el facilitador ve en el informe del calificador, puesto que el facilitador siempre ve los totales calculados con todos los ítems, ocultos o visibles. Si se incluyen los ítems ocultos, los estudiatnes podrán calcular estos ítems.';
...
$string['importcustom'] = 'Importar como resultados personalizados (sólo este espacio)';
...
$string['includescalesinaggregation_help'] = 'Puede incluir las escalas como números en todas las calificaciones agregadas de todos los libros de calificaciones en cada espacio. PRECAUCIÓN: si modifica este ajuste todas las calificaciones serán recalculadas.';
$string['incorrectcourseid'] = 'La ID del espacio es incorrecta';
...
$string['intersectioninfo'] = 'Info Participante/Calificación';
...
$string['linkedactivity_help'] = '<p>Especifica una actividad opcional en la que este ítem de resultado esta vinculada.
   Esto se utiliza para medir el rendimiento del participante en criterios no medidos por
...
- Si tenemos marcado "No recalcula calificaciones, aparece la calificación con el máximo y/o mínimo anterior hasta que esta se actualiza manualmente por el facilitador", Carla tendrá una puntuación de 5 sobre 10 (50%) hasta que el facilitador recalifique manualmente a Carla sobre 20.<br/><br/>
...
Creamos una tarea con una calificación máxima de 10. La alumna Carla, recibe una puntuación de 5 sobre 10 (50%).  La calificación máxima de la tarea es cambiada a 20.<br />
- Si tenemos marcado "No recalcula las calificaciones pero aparece en relación al nuevo máximo y/o mínimo", Carla tendrá una puntuación de 5 sobre 20 (25%).<br />
- Si tenemos marcado "No recalcula calificaciones, aparece la calificación con el máximo y/o mínimo anterior hasta que esta se actualiza manualmente por el facilitador", Carla tendrá una puntuación de 5 sobre 10 (50%) hasta que el facilitador recalifique manualmente a Carla sobre 20.';
...
$string['no'] = 'No';
$string['nocategories'] = 'No se han añadido o no se han encontrado las categorías de calificación para este espacio';
$string['nocategoryname'] = 'No se ha dado nombre de categoría';
$string['nocategoryview'] = 'No categoría para ver por';
$string['nocourses'] = 'Aún no hay espacios';
...
$string['nooutcomes'] = 'Los ítems de resultados deben estar vinculados a un resultado de espacio, pero no existen resultados para este espacio. ¿Desea agregar uno?';
$string['nopermissiontoresetweights'] = 'No tiene permisos para resetear los pesos';
$string['nopublish'] = 'No publicar';
$string['noreports'] = 'No está matriculado o impartiendo ningún espacio en esta página.';
$string['norolesdefined'] = 'No hay roles definidos en Administración > Calificaciones > Ajustes generales > Roles calificados';
$string['noscales'] = 'Los resultados deben estar vinculados a una escala (de espacio o global), pero no existe ninguna. ¿Desea agregar una?';
$string['noselectedcategories'] = 'no se han seleccionado categorías';
$string['noselecteditems'] = 'no se han seleccionado ítems.';
$string['notenrolled'] = 'Usted no está matriculado actualmente en ningún espacio.';
$string['notteachererror'] = 'Sólo los facilitadores pueden usar esta opción.';
...
$string['outcomeassigntocourse'] = 'Asignar otro resultado a este espacio';
...
$string['outcomescourse'] = 'Resultados usados en el espacio';
...
$string['outcomestandard_help'] = '<p>Un resultado estándar esta disponible globalmente en el sitio, para todos los espacios.</p>';
...
$string['recovergradesdefault_help'] = 'Por defecto recuperar las calificaciones antiguas cuando se matricula de nuevo a un usuario en un espacio.';
...
$string['seeallcoursegrades'] = 'Ver todas las calificaciones del espacio';
...
$string['setcategorieserror'] = 'Debe ajustar las categorías del espacio antes de poder asignarles ponderaciones.';
...
$string['showallstudents'] = 'Mostrar a todos los participantes';
...
$string['showaverage_help'] = '¿Mostrar la columna de promedio? Los participantes pueden estar capacitados para estimar las calificaciones de otros participantes si el promedio es calculado a partir de un pequeño número de calificaciones. Por motivos de rendimiento el promedio es aproximado si depende de elementos ocultos.';
...
$string['showcontributiontocoursetotal'] = 'Mostrar aportación al total del espacio';
$string['showcontributiontocoursetotal_help'] = 'Se muestra una columna que indica el porcentaje que aporta cada ítem de calificación a la nota total del espacio (después de aplicar la ponderación).';
...
$string['showhiddenitems_help'] = 'Si estan totalmente ocultos los elementos de calificación  o si los nombres de los elementos de calificación ocultos son visibles para los participantes.

* Mostrar ocultos - Los nombres de los elementos de califiación ocultos se muestran, pero las calificaciones de los participante están ocultas
...
$string['showrank_help'] = '¿Mostrar la posición del participante en relación con el resto de la clase para cada elemento de calificación?';
...
$string['studentsperpage'] = 'Participantes por página';
$string['studentsperpage_help'] = 'Número de participantes a mostrar por página en el informe del calificador.';
$string['studentsperpagereduced'] = 'Se redujo el número máximo de participantes por página de  {$a->originalstudentsperpage} a {$a->studentsperpage}. Considere aumentar la variable PHP max_input_vars de {$a->maxinputvars}.';
$string['subcategory'] = 'Categoría normal';
$string['submissions'] = 'Envíos';
$string['submittedon'] = 'Enviado: {$a}';
$string['sumofgradesupgradedgrades'] = 'Nota: El método de agregación "Suma de calificaciones" ha sido cambiado a "Natural" como parte de la actualización del portal. Debido a que se usó "Suma de calificaciones" previamente en este espacio, se recomienda que revise este cambio en el libro de calificaciones.';
...
$string['unenrolledusersinimport'] = 'Esta importación incluye las siguientes calificaciones de los usuarios no matriculados actualmente en este espacio: {$a}';
...
$string['usedcourses'] = 'Espacios usados';
...
$string['weight_help'] = 'Un valor utilizado para determinar el valor relativo de elementos de calificación múltiple en un espacio o categoría.';
$string['weightcourse'] = 'Usar calificaciones no ponderadas para el espacio';
