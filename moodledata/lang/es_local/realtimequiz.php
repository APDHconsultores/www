...
/**
 * Strings for component 'realtimequiz', language 'es', version '3.9'.
 *
...
$string['awaittimedesc'] = 'Este ajuste define la frecuencia en segundos a la que se comprobará la pregunta y los datos de los resultados por cada ventana del navegador del participante. Cuando el servidor se ralentiza debido a que existen muchos participantes en el cuestionario, se deberá aumentar este número para reducir la cantidad llamadas de datos simultáneas. El valor mínimo es de 1 segundo.';
...
$string['joininstruct'] = 'Espere a que el facilitador se lo indique antes de pulsar aquí';
$string['joinquiz'] = 'Participar en el cuestionario';
$string['joinquizasstudent'] = 'Participar en el cuestionario como participante';
...
$string['quiznotrunning'] = 'El cuestionario no se está ejecutando en este momento. Espere a que el facilitador lo empiece';
...
$string['teacherstartinstruct'] = 'Utilice este para empezar un cuestionario que deberán realizar los participantes<br />Utilice el recuadro de texto para definir un nombre para esta sesión (para ayudar a visualizar los resultados posteriormente).';
...
$string['waitstudent'] = 'Esperando por los participantes para conectar';
