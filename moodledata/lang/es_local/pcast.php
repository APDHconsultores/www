...
/**
 * Strings for component 'pcast', language 'es', version '3.9'.
 *
 * @package     pcast
 * @category    string
...
Los participantes pueden subscribirse al podcast empleando su navegador web favorito o una aplicación de audio como iTunes, Winamp, Windows Media Player o Media Monkey, y oirse en un reproductor portátil de MP3, como un iPod.';
