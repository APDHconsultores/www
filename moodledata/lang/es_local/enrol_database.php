...
/**
 * Strings for component 'enrol_database', language 'es', version '3.9'.
 *
...
$string['defaultcategory'] = 'Categoría por defecto del nuevo espacio';
$string['defaultcategory_desc'] = 'Categoría por defecto para espacios de creación automática. Usada cuando no se ha especificado o no se ha encontrado el ID de una nueva categoría.';
...
$string['ignorehiddencourses'] = 'Pasar por alto espacios ocultos';
$string['ignorehiddencourses_desc'] = 'Si se activa esta opción, los usuarios no serán matriculados en espacios configurados como no disponibles para los participantes.';
$string['localcategoryfield'] = 'Campo de categoría local';
$string['localcoursefield'] = 'Campo de espacio local';
$string['localrolefield'] = 'Campo de rol local';
$string['localuserfield'] = 'Campo de usuario local';
$string['newcoursecategory'] = 'Campo de categoría del nuevo espacio';
$string['newcoursefullname'] = 'Campo de nombre completo del nuevo espacio';
$string['newcourseidnumber'] = 'Campo de número ID del nuevo espacio';
$string['newcourseshortname'] = 'Campo de nombre corto del nuevo espacio';
$string['newcoursetable'] = 'Tabla de nuevos espacios remotos';
$string['newcoursetable_desc'] = 'Se especifica el nombre de la tabla que contiene la lista de espacios que deberían crearse automáticamente. Si está vacía, significa que no está creado ningún espacio.';
$string['pluginname'] = 'Base de datos externa';
$string['pluginname_desc'] = 'Puede utilizar una base de datos externa (casi de cualquier tipo) para controlar sus matriculaciones. Se asume que su base de datos externa contiene al menos un campo que contiene un ID de espacio, y un campo que contiene un ID de usuario. Estos se comparan con los campos que usted elija en el espacio local y las tablas de usuario.';
$string['remotecoursefield'] = 'Campo espacio remoto';
$string['remotecoursefield_desc'] = 'El nombre del campo en la tabla remota que usamos para casar entradas en la tabla del espacio.';
...
$string['remoterolefield_desc'] = 'El nombre del campo en la tabla remota que usamos para casar entradas en la tabla del espacio.';
$string['remoteuserfield'] = 'Campo usuario remoto';
$string['remoteuserfield_desc'] = 'El nombre del campo en la tabla remota que usamos para casar entradas en la tabla del espacio.';
$string['settingsheaderdb'] = 'Conexión con la base de datos externa';
$string['settingsheaderlocal'] = 'Asignación de campos locales';
$string['settingsheadernewcourses'] = 'Creación de nuevos espacios';
$string['settingsheaderremote'] = 'Sincronización de matriculación remota';
$string['templatecourse'] = 'Nueva plantilla de espacio';
$string['templatecourse_desc'] = 'Opcional: Auto-crear espacios puede copiar su configuración de una plantilla de espacio. Escriba aquí el nombre corto de la plantilla de espacio.';
