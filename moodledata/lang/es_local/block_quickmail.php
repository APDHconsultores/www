...
/**
 * Strings for component 'block_quickmail', language 'es', version '3.9'.
 *
...
$string['allowstudents'] = 'Permitir a los participantes usar Quickmail';
$string['allowstudentsdesc'] = 'Permitir a los participantes usar Quickmail. Si elige \'Nunca\', no podrá configurar el bloque para que los participantes accedan a nivel de espacio.';
$string['allusers'] = 'Todos los usuarios';
$string['alternate'] = 'Emails alternativos';
$string['alternate_body'] = '<p>
{$a->fullname} añadió {$a->address} como email alternativo para el espacio {$a->course}.
</p>
...
$string['courselayout'] = 'Estilo del espacio';
...
$string['entry_activated'] = 'Ahora puede utilizar el email alternativo {$a->address} en el espacio {$a->course}.';
...
$string['ferpa_desc'] = 'Permite al sistema comportarse según el modo de grupos del espacio, ignorando el modo de grupos pero separándolos, o ignorando los grupos totalmente.';
$string['from'] = 'De';
...
$string['no_course'] = 'Espacio no válido id: {$a}';
...
$string['prepend_class'] = 'Anteponer el nombre del espacio';
$string['prepend_class_desc'] = 'Anteponer el nombre corto del espacio al asunto del email.';
$string['qm_contents'] = 'Descargar el contenido';
$string['quickmail:addinstance'] = 'Añadir un nuevo bloque Quickmail al espacio';
$string['quickmail:allowalternate'] = 'Permite a los usuarios añadir un email alternativo para los espacios.';
