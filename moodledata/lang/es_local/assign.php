...
/**
 * Strings for component 'assign', language 'es', version '3.9'.
 *
 * @package     assign
 * @category    string
...
$string['allowsubmissionsfromdate_help'] = 'Si está habilitado, los participantes no podrán hacer entregas antes de esta fecha. Si está deshabilitado, los participantes podrán comenzar las entregas de inmediato.';
...
$string['alwaysshowdescription_help'] = 'Si está deshabilitado, la Descripción de la Tarea superior solo será visible para los participantes en la fecha "Permitir entregas desde",';
...
$string['assign:editothersubmission'] = 'Editar la entrega de otro participante';
...
$string['assign:revealidentities'] = 'Mostrar las identidades de los participantes';
...
$string['assign:viewblinddetails'] = 'Ver la identidad de los participantes cuando la ocultación de identidad está activada';
...
$string['attemptreopenmethod_help'] = 'Determina cómo se configura la reapertura de intentos de entrega de la tarea de los participantes. Las opciones disponibles son las siguientes: <ul> <li> Nunca - La tarea no se puede modificar. </li> <li> Manual - El facilitador puede permitir manualmente el reenvío </li> <li> Automática hasta aprobar - el envío del participante se vuelve a abrir automáticamente hasta que alcance la calificación para aprobar establecida en el libro de calificaciones para esta tarea.';
...
$string['blindmarking_help'] = 'La ocultación de identidad al calificar oculta a los evaluadores la identidad de los participantes. En el momento en que exista alguna entrega o calificación en la tarea, esta opción se bloqueará y no podrá ser cambiada.';
...
$string['completionsubmit'] = 'El participante debe entregar esta actividad para completarla';
...
$string['confirmbatchgradingoperation'] = '¿Está seguro que quiere {$a->operation} a  {$a->count} participantes?';
...
$string['couldnotcreatecoursemodule'] = 'No se puede crear módulo de espacio';
...
$string['fixrescalednullgrades'] = 'Esta tarea contiene algunas calificaciones erróneas. Usted puede <a href="{$a->link}">corregir automáticamente estas calificaciones</a>. Esto podría afectar los totales del espacio.';
$string['fixrescalednullgradesconfirm'] = '¿ Está seguro de querer corregir calificaciones erróneas ? Todas las calificaciones afectadas serán eliminadas. Esto podría afectar los totales del espacio.';
...
$string['gradeoutofhelp_help'] = 'Introduzca aquí la calificación para las entregas del participante. Puede utilizar decimales.';
...
{$a->url}';
$string['gradestudent'] = 'Calificación del participante: (id={$a->id}, fnombre completo={$a->fullname}).';
...
$string['gradingduedate_help'] = 'Fecha prevista en que todas las tareas quedarán entregadas. Se utilizará como fecha de revisión de tareas en el tablero de facilitadores.';
...
$string['gradingstudent'] = 'Calificando participante';
$string['gradingsummary'] = 'Sumario de calificaciones';
$string['grantextension'] = 'Ampliar plazo';
$string['grantextensionforusers'] = 'Ampliar plazo para {$a} participantes';
...
$string['hidegrader'] = 'Ocultar la identidad del evaluador a los participantes';
$string['hidegrader_help'] = 'Si está habilitado, la identidad de cualquier usuario que califique una entrega de la tarea no es mostrada, por lo que los participantes no pueden ver quien puntúa su trabajo,
...
$string['inactiveoverridehelp'] = '* El participante no tiene el grupo o rol correcto para realizar la tarea';
$string['indicator:cognitivedepth'] = 'Tarea cognitiva';
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad de Tarea.';
...
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad de Tarea.';
...
$string['locksubmissionforstudent'] = 'Evita nuevas entregas del participante: (id={$a->id}, nombre={$a->fullname}).';
...
$string['markingworkflow_help'] = 'Si se habilita, las calificaciones pasan por una serie de etapas en un flujo de trabajo antes de ser publicadas para los participantes. Esto permite calificar en sucesivas rondas y que todas las calificaciones se entreguen a todos los alumnos al mismo tiempo.';
...
* En revisión - El facilitador encargado está comprobando la calidad de la calificación
* Lista para publicar - El facilitador encargado está conforme con la calificación, pero esperando antes de dar acceso a los participantes
* Publicada - el participante puede acceder a la calificación/retroalimentación';
...
$string['maxattempts_help'] = 'El número máximo de intentos de envío que puede hacer por un participante. Una vez realizado este número de intentos de envío del participante no podrá ser reabierto.';
$string['maxgrade'] = 'Calificación máxima';
$string['maxperpage'] = 'Máximo número de entregas por página';
$string['maxperpage_help'] = 'El número máximo de entregas a calificar que pueden ser mostradas en la página de calificaciones. Es útil para prevenir timeouts en espacios con un gran número de usuarios.';
$string['messageprovider:assign_notification'] = 'Notificaciones de tareas';
$string['modulename'] = 'Tarea';
$string['modulename_help'] = 'El módulo de Tareas permite a un facilitador evaluar el aprendizaje de los alumnos mediante la creación de una tarea a realizar que luego revisará, valorará, calificará y a la que podrá dar retroalimentación.

Los alumnos pueden presentar cualquier contenido digital, como documentos de texto, hojas de cálculo, imágenes, audio y vídeos entre otros. Alternativamente, o como complemento, la tarea puede requerir que los participantes escriban texto directamente en un campo utilizando el editor de texto.
Una tarea también puede ser utilizada para recordar a los participantes tareas del "mundo real" que necesitan realizar y que no requieren la entrega de ningún tipo de contenido digital. Por ejemplo, presentaciones orales, prácticas de laboratorio, etc.
...
Durante el proceso de revisión los facilitadores pueden dejar comentarios y subir archivos, tales como trabajos calificados, documentos con observaciones escritas. Las tareas  pueden ser calificadas usando una escala numérica o una escala personalizada; o usando métodos de calificación complejos como rúbricas. Las calificaciones finales se actualizan automáticamente en el módulo de calificaciones.';
$string['modulenameplural'] = 'Tareas';
$string['moreusers'] = '{$a} más...';
$string['multipleteams'] = 'Miembro de más de un grupo.';
$string['multipleteams_desc'] = 'Esta tarea requiere entrega por grupos. Usted es miembro de más de un grupo. Para poder realizar entregas debe ser miembro solamente de un grupo. Por favor, contacte con su facilitador para que modifique su pertenencia a grupos.';
...
$string['noteam_desc'] = 'Esta tarea requiere entrega por grupos. Usted no es miempro de ningún grupo, así que no puede realizar entregas. Por favor, contacte con su facilitador para que le agregue a un grupo.';
...
$string['privacy:metadata:assignmessageexplanation'] = 'Los mensajes son enviados a participantes mediante el sistema de mensajería.';
...
$string['relativedatessubmissionduedateafter'] = '{$a->datediffstr} después del inicio del espacio';
$string['relativedatessubmissionduedatebefore'] = '{$a->datediffstr} antes del inicio del espacio';
$string['relativedatessubmissiontimeleft'] = 'Calculado para cada participante';
...
$string['removesubmissionconfirmforstudent'] = '¿Está seguro de que quiere borrar la información de la entrega de participante {$a}?';
$string['removesubmissionforstudent'] = 'Borrar entrega para el participante: (id={$a->id}, fullname={$a->fullname}).';
$string['reopenuntilpassincompatiblewithblindmarking'] = 'La reapertura automática hasta aprobar es incompatible con la ocultación de identidad al calificar, ya que las calificaciones no son publicadas en el libro de calificaciones hasta que se revelen las identidades de los participantes.';
$string['requireallteammemberssubmit'] = 'Se requiere que todos los miembros del grupo entreguen';
$string['requireallteammemberssubmit_help'] = 'Si está activado, todos los miembros del grupo de participantes deben entregar la tarea para que la presentación de la misma se considere como realizada. Si está desactivado, la presentación de la tarea se considerará como entregada para todos los miembros del equipo desde el momento en que cualquiera de sus integrantes lo haga.';
$string['requiresubmissionstatement'] = 'Es necesario que los participantes acepten las condiciones de entrega';
$string['requiresubmissionstatement_help'] = 'Es necesario que los participantes acepten las condiciones de entrega para todas las entregas de tarea de este sitio Moodle.';
$string['revealidentities'] = 'Mostrar la identidad de los participantes';
$string['revealidentitiesconfirm'] = '¿Está seguro que quiere revelar las identidades de los participantes en esta tarea? Esta operación no se puede deshacer. Una vez las identidades de los participantes hayan sido reveladas, las puntuaciones se publicarán en el libro de calificaciones.';
...
$string['reverttodraftforstudent'] = 'Revertir la entrega a borrador para el participante: (id={$a->id}, nombre={$a->fullname}).';
...
$string['sendlatenotifications_help'] = 'Si está habilitado, los evaluadores (normalmente facilitadores) reciben un mensaje cuando un participante realiza una entrega a la tarea fuera de plazo . Se pueden configurar los métodos de mensajería.';
$string['sendnotifications'] = 'Enviar aviso de entregas a los que califican';
$string['sendnotifications_help'] = 'Si está habilitado, los evaluadores (normalmente facilitadores) reciben un mensaje cuando un participante realiza una entrega antes de la fecha requerida, dentro de las fechas establecidas o fuera de plazo. Se pueden configurar los métodos de mensajería.';
$string['sendstudentnotifications'] = 'Notificar a los participantes';
$string['sendstudentnotifications_help'] = 'Si se activa, los participantes reciben un mensaje cuando se actualiza su calificación o su retroalimentación.';
$string['sendstudentnotificationsdefault'] = 'Valor por defecto para "Notificar a los participantes"';
$string['sendstudentnotificationsdefault_help'] = 'Activar el valor predeterminado para la casilla de verificación "Notificar participantes" en el formulario de calificaciones.';
$string['sendsubmissionreceipts'] = 'Enviar recibo de entrega a los participantes';
$string['sendsubmissionreceipts_help'] = 'Esta opción habilita los recibos de entrega de los participantes. Los participantes recibirán una notificación cada vez que realicen correctamente una entrega';
...
$string['studentnotificationworkflowstateerror'] = 'El estado del flujo de trabajo debe estar marcado como \'Publicado\' para notificar a los participantes.';
...
$string['submissiondrafts_help'] = 'Si está habilitado, los participantes tendrán que pulsar un botón de Entrega para declarar que es su entrega definitiva. Esto permite que los participantes puedan tener una versión borrador de su entrega en el sistema. Si esta opción es cambiada de "No" a "Si" después de que los participantes hayan realizado algunas entregas, estas se considerarán como definitivas.';
$string['submissioneditable'] = 'El participante puede editar esta entrega';
$string['submissionempty'] = 'No se ha presentado nada.';
$string['submissionlog'] = 'Participante: {$a->fullname}, Estado: {$a->status}';
...
$string['submissionnoteditable'] = 'El participante no puede editar esta entrega';
...
$string['submissionstatement_help'] = 'Condiciones que cada participante debe aceptar para enviar su trabajo.';
...
$string['submissionstatementteamsubmission_help'] = 'Condiciones que cada participante debe aceptar para enviar el trabajo de su grupo.';
...
$string['submissionstatementteamsubmissionallsubmit_help'] = 'Condiciones que cada participante debe aceptar para enviar su trabajo como miembro del grupo.';
...
$string['ungroupedusersoptional'] = 'La opción \'Entregar en grupo\' está habilitada y algunos usuarios o no son miembros de ningún grupo o son miembros de más de un grupo. Por favor tener en cuenta que en estos casos los participantes entregaran sus trabajos como "Grupo Predeterminado".';
...
$string['usersnone'] = 'Ningún participante tiene acceso a esta tarea.';
...
$string['viewgradingformforstudent'] = 'Ver página de calificaciones del participante: (id={$a->id}, nombre completo={$a->fullname}).';
...
$string['viewrevealidentitiesconfirm'] = 'Ver la página de confirmación para revelar la identidad de los participantes.';
