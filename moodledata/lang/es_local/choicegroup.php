...
/**
 * Strings for component 'choicegroup', language 'es', version '3.9'.
 *
 * @package     choicegroup
 * @category    string
...
$string['event:answered_desc'] = 'El usuario con id \'{$a->userid}\' ha seleccionado un grupo en la selección de grupo con la id del módulo del espacio \'{$a->contextinstanceid}\'.';
$string['event:removed'] = 'Elección quitada';
$string['event:removed_desc'] = 'El usuario con id \'{$a->userid}\' ha eliminado su elección en la elección de grupo con la id del módulo del espacio \'{$a->contextinstanceid}\'.';
$string['event:reportviewed'] = 'Informe visto';
$string['event:reportviewed_desc'] = 'El usuario con id \'{$a->userid}\' ha visto el informe para la actividad de elección de grupo con la id de módulo del espacio \'{$a->contextinstanceid}\'.';
...
$string['groupdoesntexist'] = 'Alguno de los grupos especificados no existe en este espacio. El facilitador tendría que generar los grupos necesarios y/o modificar esta actividad.';
...
$string['modulename_help'] = 'El módulo de Elección de grupo permite que el facilitador proponga dos o más grupos del espacio para que los participantes se automatriculen en alguno de ellos.

El número de miembros para cada grupo puede limitarse a un número determinado de usuarios.

Los alumnos pueden o no cambiar libremente de grupo si el facilitador así lo considera en la configuración de la actividad.';
...
$string['pleasesetgroups'] = 'Por favor, genere al menos dos grupos en este espacio.';
$string['pleasesetonegroupor'] = 'Por favor, cree al menos un grupo dentro de este espacio.<br /><br />
<ul>
<li><a href="{$a->linkgroups}">gestionar grupos de espacio</a></li>
<li><a href="{$a->linkcourse}">regresar al espacio</a></li>
</ul>';
...
$string['publishafteranswer'] = 'Mostrar los resultados a los participantes después de su respuesta.';
$string['publishafterclose'] = 'Mostrar los resultados a los participantes después de que la actividad de elección se ha cerrado.';
$string['publishalways'] = 'Mostrar siempre los resultados a los participantes.';
$string['publishanonymous'] = 'Publicar los resultados como anónimos. No se muestran los nombres de los participantes.';
$string['publishnames'] = 'Publicar los resultados completos. Se muestran los nombres de los participantes y sus elecciones.';
$string['publishnot'] = 'No publicar los resultados a los participantes';
