...
/**
 * Strings for component 'activequiz', language 'es', version '3.9'.
 *
 * @package     activequiz
 * @category    string
...
$string['activequiz:control'] = 'Controlar un cuestionario activo. (Normalmente sólo para facilitadores)';
$string['activequiz:editquestions'] = 'Editar preguntas para un cuestionario activo.';
$string['activequiz:seeresponses'] = 'Ver respuestas de otros participantes para evaluarlas';
...
$string['anonymousresponses'] = 'Anonimizar las respuestas del participante';
$string['anonymousresponses_help'] = 'Anonimizar las respuestas del participante para la vista del facilitador, así si la pantalla es mostrada, el nombre de los participantes o el nombre de los grupos no será mostrado.';
...
$string['attemptstarted'] = 'Ya se ha iniciado un intento por su parte, por favor pulse abajo para continuar a su intento xencursox';
...
$string['feedbackintro'] = 'Retroalimentación para su pregunta. Por favor espere a que el facilitador inicie la siguiente pregunta';
$string['firstsession'] = 'Primera sesión';
$string['fullanonymize'] = 'Anonimizar totalmente las respuestas de los participantes';
$string['fullanonymize_help'] = 'Anonimizar totalmente las respuestas de los participantes. Por favor tenga en cuenta, que si selecciona esta opción, esta sesión de respuestas no será calificada y aplicada a los participantes.';
$string['gatheringresults'] = 'Buscando resultados...';
$string['gotosession'] = 'Ir a la sesión xencursox';
...
$string['groupattendance_help'] = 'Si esta casilla está habilitada, el participante que realice el cuestionario podrá seleccionar que participantes en su grupo están en la asistencia.';
$string['grouping'] = 'Agrupando';
$string['grouping_help'] = 'Seleccione el agrupamiento que desea utilizar para agrupar participantes';
...
$string['instructorquizinst'] = '<p>Por favor espere en esta página hasta que los participantes estén conectados.  Un vez presione en <b>comenzar cuestionario</b>, el cuestionario comenzará con la primera pregunta</p>
    <p>
<p>Controles:</p>
    <ul>
        <li>
            ...
            <ul>
                <li>
                    Permite al facilitador reenviar la pregunta actual o la anterior (disponible durante la revisión de una pregunta).
                </li>
            </ul>
        </li>
        <li>
        ...
        <li>
            ...
            <ul>
                <li>
                    Finaliza la pregunta actual. También le permite al facilitador finalizar antes de tiempo una pregunta con límite de tiempo (disponible mientras una pregunta está xencursox). <i>Si la pregunta no tuviera límite de tiempo, se requerirá que el facilitador presione <b>finalizar pregunta.</b></i>
                </li>
            </ul>
        </li>
        <li>
        ...
        <li>
            ...
            <ul>
                <li>
                    Cierra la sesión actual, al igual que todos los intentos para los participantes. Esto automáticamente calificará todos los intentos (disponible en cualquier momento).
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                <li>
                    Actualiza las respuestas de los participantes en el cuadro de información. Permite al facilitador ver cuántos participantes o grupos han respondido, y cuántos aún no han respondido (disponible durante la revisión de una pregunta).
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                <li>
                    Oculta o muestra el cuadro de información que presenta cuántos participantes o grupos han respondido, y cuáles participantes o grupos aún no han respondido (available when question is polling).
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                <li>
                    Da al facilitador una vista de la pregunta con la respuesta correcta seleccionada (disponible durante la revisión de una pregunta). Esta no mostrará la respuesta correcta a preguntas calificadas manualmente, como ensayos o preguntas que requieren dibujar.
                </li>
            </ul>
        </li>
    </ul>
...
$string['invalidgroupid'] = 'Se requiere un ID de grupo válido para los participantes';
...
$string['manualcomment_help'] = 'El comentario que los facilitadores pueden agregar cuando califican un intento';
...
$string['modulename_help'] = '<p>La actividad Cuestionario activo permite a un facilitador crear y administrar cuestionarios en tiempo real. Todos los tipos de preguntas regulares del cuestionario se pueden utilizar en el cuestionario activo.</p> <p>El cuestionario activo permite la participación individual o en grupo. La asistencia en grupo es posible, por lo que los puntos otorgados durante el examen activo sólo se aplicarán a los participantes que asistieron a la sesión. Las preguntas se pueden configurar para permitir múltiples intentos. Se puede establecer un límite de tiempo para finalizar automáticamente la pregunta, o el facilitador puede finalizar manualmente la pregunta y pasar a la siguiente. El facilitador también tiene la capacidad de saltar a diferentes preguntas mientras ejecuta la sesión. Los facilitadores pueden monitorear la participación en grupo o individual, las respuestas en tiempo real de los participantes y la pregunta que se está encuestando. </p> <p>Cada intento de prueba se califica automáticamente como una prueba regular (con la excepción de las preguntas de ensayo y PoodLLL) y la calificación se registra en el libro de calificaciones. La calificación para la participación en el grupo se puede hacer automáticamente transfiriendo la calificación del encuestado único a los otros miembros del grupo. </p> <p>El facilitador tiene opciones para mostrar pistas, dar retroalimentación y mostrar las respuestas correctas a los participantes al completar el cuestionario.</p> <p>Los cuestionarios activos pueden ser utilizados como un vehículo para impartir el aprendizaje en equipo dentro de Moodle.</p>.';
...
$string['nochangegroups'] = 'No puedes cambiar grupos después de crear las sesiones o no existen grupos definidos para este espacio.';
...
$string['notime_help'] = 'Marca este campo si no desea tener temporizador en esta pregunta. <p> El facilitador tendrá entonces que pinchar en el botón de fin de la pregunta para que la pregunta finalice. </p>';
...
$string['numberoftries_help'] = 'Número de intentos del usuario para intentar la pregunta. Los participantes seguirán estando sujetos al límite de tiempo de la pregunta';
...
$string['quiznotrunning'] = 'El cuestionario no ha empezado aún - espera para que el facilitador lo inicie. Usa el botón de recargar para recargar esta página y comprobarlo de nuevo.';
...
$string['showhistoryduringquiz_help'] = 'Muestra el historial de respuestas del participante/grupo para esta pregunta mientras revisa las respuestas a una pregunta durante una prueba';
...
$string['studentquizinst'] = '<p>Por favor espere al facilitador para comenzar el cuestionario. Una vez comience verá un contador de tiempo junto a la primera pregunta.</p>';
...
$string['teacherstartinstruct'] = 'Usar para empezar una prueba para que los participantes la realicen.<br />Usar el cuadro de texto para definir un nombre para esta sesión (para ayudar a ver los resultados en una fecha posterior).';
...
$string['waitforrevewingend'] = 'El facilitador está actualmente revisando la pregunta anterior. Por favor espera que empiece la siguiente pregunta';
$string['waitstudent'] = 'Esperando a los participantes para conectar';
$string['workedingroups'] = 'Se trabajará en grupos.';
$string['workedingroups_help'] = 'Seleccione esta opción para indicar que los participantes trabajarán en grupos. Debe estar seguro de seleccionar un grupo de abajo';
