...
/**
 * Strings for component 'studentquiz', language 'es', version '3.9'.
 *
 * @package     studentquiz
 * @category    string
...
Su pregunta \'{$a->questionname}\' en la actividad ExamenEstudiante (StudentQuiz) \'{$a->modulename}\' en el espacio \'{$a->coursename}\' ha sido comentada por \'{$a->actorname}\' en \'{$a->timestamp}\'.
...
El comentario con fecha \'{$a->commenttime}\' a su pregunta \'{$a->questionname}\' en la actividad ExamenEstudiante (StudentQuiz) \'{$a->modulename}\' en el espacio \'{$a->coursename}\' ha sido eliminado por \'{$a->actorname}\' en \'{$a->timestamp}\'.
...
Su comentario con fecha \'{$a->commenttime}\' a la pregunta \'{$a->questionname}\' en la actividad ExamenEstudiante (StudentQuiz) \'{$a->modulename}\' en el espacio \'{$a->coursename}\' ha sido eliminado por \'{$a->actorname}\' en \'{$a->timestamp}\'.
...
$string['filter_label_onlyapproved_help'] = 'Preguntas aprobadas por su facilitador';
...
$string['modulename_help'] = 'La actividad ExamenEstudiante (StudentQuiz) le permite a los participantes añadir preguntas para la multitud. En la vista general del ExamenEstudiante, los participantes pueden filtrar preguntas. También pueden usar las preguntas filtradas en la multitud para practicar. El facilitador tiene la opción de anonimizar la columna de \'creado por\'.<br><br>La actividad de ExamenEstudiante le otorga a los participantes puntos para motivarlos a que añadan preguntas y a que practiquen. Los puntos están listados en una tabla de ranking.';
...
$string['please_enrole_message'] = 'Por favor inscríbase en este espacio para ver su progreso personal';
...
$string['privacy:metadata:studentquiz_progress'] = 'Almacena información del progreso del participante con esta pregunta.';
...
$string['reportquiz_admin_title'] = 'Estadísticas del participante';
...
$string['reportquiz_stats_all_questions_approved_help'] = 'Los facilitadores pueden aprobar las preguntas para verificar que sean correctas. Este es el número de todas las preguntas aprobadas dentro de este ExamenEstudiante (StudentQuiz).';
...
$string['reportquiz_stats_own_questions_approved_help'] = 'Los facilitadores pueden aprobar manualmente las preguntas para verificar que sean correctas. Este es el número de sus preguntas aprobadas dentro de este ExamenEstudiante (StudentQuiz).';
...
$string['reportrank_table_title'] = 'Ranking de participantes - 10 Primeros';
$string['reportrank_table_title_for_manager'] = 'Ranking de participantes';
...
$string['settings_anonymous'] = 'Anonimizador de participantes';
$string['settings_anonymous_help'] = 'Los participantes no pueden ver los nombres de otros.';
$string['settings_anonymous_label'] = 'Hacer anónimos a los participantes';
