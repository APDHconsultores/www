...
/**
 * Strings for component 'tag', language 'es', version '3.9'.
 *
 * @package     tag
 * @category    string
...
$string['count'] = 'Contar';
$string['coursetags'] = 'Etiquetas de espacio';
$string['defautltagcoll'] = 'Colección por defecto';
$string['delete'] = 'Eliminar';
$string['deleted'] = 'Etiqueta(s) eliminada(s)';
$string['deletedcoursetags'] = 'Eliminado - etiquetas del espacio';
...
$string['rssdesc'] = 'Este canal RSS ha sido generado automáticamente por Moodle y contiene marcas de los espacios generadas por los usuarios';
$string['rsstitle'] = 'Canal RSS de las etiquetas del espacio para usuario: {$a}';
...
$string['tagarea_course'] = 'Espacios';
