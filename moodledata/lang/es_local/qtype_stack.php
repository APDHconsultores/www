...
/**
 * Strings for component 'qtype_stack', language 'es', version '3.9'.
 *
 * @package     qtype_stack
 * @category    string
...
$string['ATEquivFirst_SA_not_list'] = 'El primer argumento de la respuesta a la prueba Equiv debería de ser una lista, pero la prueba falló. Por favor póngase en contacto con su facilitador.';
...
$string['ATEquivFirst_SB_not_list'] = 'El segundo argumento de la respuesta de la prueba Equiv debería de ser una lista, pero la prueba falló. Por favor póngase en contacto con su facilitador.';
$string['ATEquiv_SA_not_list'] = 'El primer argumento de la respuesta de prueba Equiv debería de ser una lista, pero la prueba falló. Por favor póngase en contacto con su facilitador.';
$string['ATEquiv_SB_not_list'] = 'El segundo argumento de la prueba de respuesta Equiv debería de ser una lista, pero la prueba falló. Por favor póngase en contacto con su facilitador.';
...
$string['ATInt_EqFormalDiff'] = 'La derivada formal de su respuesta es igual a la expresión que se le pidió que integrara. Sin embargo, su respuesta difiere de la respuesta correcta de una forma significativa, no trivial; por ejemplo: una constante de integración. Por favor, pregunte a su facilitador a este respecto.';
$string['ATInt_STACKERROR_OptList'] = 'La prueba de respuesta falló y no se ejecutó correctamente. Por favor avise a su facilitador. Cuando la opción para ATInt es una lista, debe tener exactamente dos elementos, pero no los tiene.';
...
Su facilitador puede esperar que use el resultado de \\(\\int\\frac{1}{x} dx = \\log(|x|)+c\\), en lugar de \\(\\int\\frac{1}{x} dx = \\log(x)+c\\).  Por favor, pregúntele a su facilitador acerca de esto.';
$string['ATInt_logabs_inconsistent'] = 'Al parecer hay inconsistencias extrañas entre su uso de \\(\\log(...)\\) y \\(\\log(|...|)\\). Por favor, pregúntele a su facilitador al respecto.';
$string['ATInt_weirdconst'] = 'La derivada formal de su respuesta no es igual a la expresión que se le pidió integrar. Sin embargo, tiene una constante de integración extraña. Por favor, pregunte a su facilitador sobre esto.';
...
$string['ATNum_OutofRange'] = 'Una expresión numérica está fuera del rango soportado. Por favor, póngase en contacto con su facilitador.';
...
$string['ATNumerical_STACKERROR_tol'] = 'La tolerancia numérica para ATNumerical debería de ser un número de punto flotante, pero no lo es. Este es un error interno con la prueba. Por favor, dígale esto a su facilitador.';
...
$string['ATSysEquiv_SB_not_eq_list'] = 'La respuesta del facilitador no es una lista de ecuaciones';
$string['ATSysEquiv_SB_not_list'] = 'La respuesta del facilitador no es una lista.  Por favor, contacta al facilitador.';
$string['ATSysEquiv_SB_not_poly_eq_list'] = 'La respuesta del facilitador debe ser una lista de ecuaciones polinómicas, pero no es así. Por favor, contacta al facilitador.';
$string['AT_EmptySA'] = 'Se intentó ejecutar una prueba de respuesta con una respuesta del participante vacía, probablemente sea un problema de validación CAS al escribir la pregunta.';
$string['AT_EmptyTA'] = 'Se intentó ejecutar una prueba de respuesta con una respuesta del facilitador vacía, probablemente sea un problema de validación CAS al escribir la pregunta.';
...
$string['TEST_FAILED'] = 'La prueba a la respuesta no se ejecutó correctamente:Por favor avisa a tu facilitador. {$a->errors}';
...
$string['allowwords_help'] = 'Por defecto, los nombres de funciones o variables de más de dos caracteres de longitud no están permitidas. Esta es una lista de nombres de funciones o variables, separada por comas, que están permitidos en una respuesta del participante.';
...
$string['branchfeedback_help'] = 'Es un CASText que puede depender de variables de pregunta, elementos de entrada ó variables de retroalimentación. Se evalúa y se muestra al participante si pasan por esta rama.';
...
$string['forbidfloat_help'] = 'Si es verdadero, entonces cualquier respuesta del participante que contenga números de punto flotante será invalida.';
...
$string['forbidwords_help'] = 'Es una lista separada por comas de cadenas de texto que serán prohibidas como respuesta de participantes.';
...
$string['generalfeedback_help'] = 'Retroalimentación general es un CASText. También conocida como "solución desarrollada", está se muestra al participante después de haber intentado resolver la pregunta. La retroalimentación general se muestra a todos los participantes, a diferencia de la retroalimentación que depende de la respuesta que el alumno ingreso. Esta retroalimentación general también puede depender de las variables de la pregunta.';
...
$string['mustverify_help'] = 'Especifica si la respuesta del participante se muestra antes de ser calificada.';
...
### Silencio
Cuando es habilitado, cualquier retroalimentación automaticamente generada por la función que compara la respuesta, es suprimida, y no es mostrada al participante. Los campos de retroalimentiación en las ramas del árbol no son afectados por esta opción.';
...
$string['pluginnamesummary'] = 'STACK provee preguntas matemáticas para cuestionarios en moodle. Utiliza un sistema de álgebra computacional para establecer las propiedades matemáticas en las respuestas de participantes.';
...
$string['prtwillbecomeactivewhen'] = 'Este árbol de respuestas potenciales se activará cuando el participante haya contestado: {$a}';
...
$string['questiontext_help'] = 'El texto de la pregunta es un CASText. Esta es la "pregunta" que el participante realmente ve. Debes poner los elementos de entrada, y las cadenas de validación en este campo y sólo en este campo. Por ejemplo, usar `[[input:ans1]] [[validation:ans1]]`.';
...
$string['quiet_help'] = 'Cuando es habilitado, cualquier retroalimentación automaticamente generada por la función que compara la respuesta, es suprimida, y no es mostrada al participante. Los campos de retroalimentiación en las ramas del árbol no son afectados por esta opción.';
...
$string['syntaxhint_help'] = 'Cuando el participante deje en blanco el campo de respuesta aparecerá el contenido sugerido en esta caja.';
...
$string['teachersanswer_help'] = 'El facilitador debe especificar un modelo de respuesta para cada entrada. Este modelo debe ser una expresión de Maxima, y puede ser construida usando las variables de la pregunta.';
