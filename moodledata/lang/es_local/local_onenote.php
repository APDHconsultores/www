...
/**
 * Strings for component 'local_onenote', language 'es', version '3.9'.
 *
...
$string['errorfeedbackinstudentcontext'] = 'Se intentó crear retroalimentación en el contexto del envío del participante.';
...
$string['errorsubmissioninteachercontext'] = 'Se intentó crear un envío en el contexto de un facilitador calificando.';
