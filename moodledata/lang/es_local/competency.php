...
$string['errorcannotchangeapastduedate'] = 'La fecha de cierre ha vencido. No puede ser cambiada';
$string['errorcannotsetduedateinthepast'] = 'La fecha de cierre no puede ser anterior.';
$string['errorcannotsetduedatetoosoon'] = 'La fecha de finalizacion es demasiado pronto.';
$string['errorcompetencyrule'] = 'La regla de la competencia del espacio \'{$a}\' es desconocida';
$string['errorcoursecompetencyrule'] = 'La regla de la competencia del espacio \'{$a}\' es desconocida';
$string['errorinvalidcourse'] = 'Espacio no válido.';
...
$string['eventusercompetencyratedincourse'] = 'Competencia del usuario valorada xencursox.';
...
$string['eventusercompetencyviewedincourse'] = 'Competencia del usuario vista en un espacio.';
...
$string['evidence_coursecompleted'] = 'El espacio \'{$a}\' ha sido completado.';
$string['evidence_coursemodulecompleted'] = 'La actividad \'{$a}\' ha sido completada.';
$string['evidence_courserestored'] = 'La valoración fue restaurada junto con el espacio \'{$a}\'.';
...
$string['evidence_manualoverrideincourse'] = 'La valoración de competencia fue configurada manualmente en el espacio \'{$a}\'.';
...
$string['privacy:metadata:competency_coursecomp'] = 'Un registro de las competencias enlazadas a un espacio';
$string['privacy:metadata:competency_coursecompsetting'] = 'Un registro de las configuraciones de las competencias en un espacio';
...
$string['privacy:metadata:competency_usercompcourse'] = 'Un registro del estado de las competencias del usuario en un espacio';
...
$string['pushcourseratingstouserplans'] = 'Enviar valoraciones de espacios a planes de aprendizaje individuales';
$string['pushcourseratingstouserplans_desc'] = 'Valor por defecto de la configuración del espacio para actualizar los planes de aprendizaje individuales cuando son valoradas las competencias del espacio.';
