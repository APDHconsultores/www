...
/**
 * Strings for component 'chat', language 'es', version '3.9'.
 *
 * @package     chat
 * @category    string
...
$string['coursetheme'] = 'Plantilla del espacio';
...
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad Chat.';
...
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad Chat.';
...
* Reuniones programadas de participantes inscritos a espacios en línea, para permitirles compartir experiencias con otros compañeros del mismo espacio pero de diferentes ciudades o países
* Un participante que temporalmente no puede asistir en persona, podría chatear con su facilitador para ponerse al día del trabajo escolar
* Participantes que empiezan a trabajar se juntan para discutir sus experiencias entre ellos y con el maestro
...
* Sesiones para ayudar a los participantes a prepararse para exámenes, donde el maestro, o los participantes, hagan preguntas de ejemplo';
