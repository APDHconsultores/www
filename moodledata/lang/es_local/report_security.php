...
$string['check_crawlers_details'] = '<p>La configuración de Abrir a Google permite que los motores de búsqueda entren a los espacios que tengan acceso a invitados. No hay razón de configurarlo así cuando un sitio no  permite el acceso a invitados.</p>';
...
<p>Para el rol de usuario por defecto solo se permite heredar el tipo <em>usuario autenticado</em>. El  permiso para ver el espacio no debe estar habilitado. </p>';
...
$string['check_guestrole_details'] = '<p>El rol de invitados se emplea para el acceso a espacios para invitados, para usuarios no-identificados y para invitados temporales. Por favor asegúrese que no se permitan permisos riesgosos en este rol.</p>
