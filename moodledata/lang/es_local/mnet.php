...
/**
 * Strings for component 'mnet', language 'es', version '3.9'.
 *
 * @package     mnet
 * @category    string
...
$string['courseson'] = 'espacios activados';
...
$string['host'] = 'host';
$string['hostcoursenotfound'] = 'Host o espacio no encontrado';
...
$string['nosite'] = 'No se pudo encontrar espacio al nivel del sitio';
...
$string['remotecourses'] = 'Espacios remotos';
