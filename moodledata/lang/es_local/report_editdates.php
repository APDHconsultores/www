...
/**
 * Strings for component 'report_editdates', language 'es', version '3.9'.
 *
...
$string['page-report-editdates-index'] = 'Editar fechas del espacio';
