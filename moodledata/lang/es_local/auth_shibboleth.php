...
/**
 * Strings for component 'auth_shibboleth', language 'es', version '3.9'.
 *
...
$string['auth_shib_contact_administrator'] = 'En caso de que no esté asociado con estas organizaciones y necesite acceso a un espacio en este servidor, por favor contacte con el <a href="mailto:{$a}">Administrador</a>.';
