...
/**
 * Strings for component 'groupselect', language 'es', version '3.9'.
 *
 * @package     groupselect
 * @category    string
...
$string['assignedteacher'] = 'Asignado cofacilitador';
$string['assigngroup'] = 'Asignar cofacilitador a grupos';
$string['assigngroup_help'] = 'Si se establece, habilita un botón para asignar cofacilitadores a los grupos (si el espacio tiene cofacilitadores). Los cofacilitadores asignados no son miembros del grupo, pero aparecen en el archivo de exportación y en la vista principal (si está configurada). Puede ser útil si el espacio utiliza asistentes para manejar grupos.';
...
$string['cannotselectnoenrol'] = 'Es necesario estar matriculado en el espacio para poder convertirse en un miembro del grupo.';
$string['cannotunselectclosed'] = 'No podrá abandonar el grupo nunca más';
$string['creategroup'] = 'Crear un nuevo grupo';
$string['deleteemptygroups'] = 'Eliminar grupo cuando el último participante lo abandone';
$string['deleteemptygroups_help'] = 'Si se establece, elimina automáticamente el grupo cuando el último participante lo abandone';
...
$string['globalpassword_help'] = 'Establecer una contraseña global para apuntarse a un grupo. Sobrescribe la contraseña de los participantes.';
$string['groupid'] = 'ID Grupo';
$string['groupselect:addinstance'] = 'Añadir un nuevo grupo auto-seleccionado';
$string['groupselect:assign'] = 'Permitir asignar facilitadores a los grupos';
...
$string['maxgroupmembership'] = 'Número máximo de grupos que el participante puede seleccionar';
...
$string['modulename_help'] = '<p>Permite crear y seleccionar grupos a los propios participantes. Funcionalidades: </p><ul><li>Los participantes pueden crear grupos, con una descripción y protegerlos con una contraseña, si se quiere</li><li>Los participantes pueden elegir y unirse a grupos</li><li>Los supervisores se pueden asignar a grupos</li><li>El facilitador puede exportar la lista de grupos del espacio en un fichero csv</li><li>Plena compatibilidad con los grupos de Moodle: los grupos se pueden crear por cualquier otro método si fuese necesario, soporta entrega de tareas por grupo, etc.</li></ul>';
...
$string['showassignedteacher'] = 'Mostrar facilitadores asignados';
$string['showassignedteacher_help'] = 'Si se establece, los facilitadores asignados se mostrarán en la lista de miembros del grupo. Útil si los participantes necesitan conocer a sus facilitadores.';
$string['studentcancreate'] = 'Los participantes pueden crear grupos';
$string['studentcancreate_help'] = 'Si se establece, los participantes sin grupo (en el agrupamiento seleccionado) pueden crear grupos';
$string['studentcansetdesc'] = 'Los participantes pueden establecer y editar la descripción del grupo';
$string['studentcansetdesc_help'] = 'Si se establece, los participantes pueden fijar y editar la descripción del grupo al crearlo, y sus miembros podrán editarla';
$string['studentcansetenrolmentkey'] = 'Los participantes podrán poner una clave para unirse a los grupos';
$string['studentcansetenrolmentkey_help'] = 'Si se establece, los participantes podrán poner una clave de inscripción para apuntarse al grupo';
$string['studentcansetgroupname'] = 'Los participantes podrán poner nombre a los grupos que creen';
$string['studentcansetgroupname_help'] = 'Si se establece, los participantes podrán poner nombre a los grupos';
$string['supervisionrole'] = 'Rol de supervisor';
$string['supervisionrole_help'] = 'Define el rol de supervisor (por defecto cofacilitadores)';
