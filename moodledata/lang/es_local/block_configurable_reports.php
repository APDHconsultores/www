...
/**
 * Strings for component 'block_configurable_reports', language 'es', version '3.9'.
 *
...
$string['ccoursefield'] = 'Condición de campo del espacio';
...
$string['comp_calcs_help'] = '<p>Aqui puede usted añadir cálculos para columnas; Por ejemplo, promedio del número de usuarios matriculados en espacios</p>
...
$string['comp_calculations_help'] = '<p>Aquí puede añadir cálculos para columnas; Por ejemplo, promedio de número de usuarios inscritos en espacios</p>';
...
$string['comp_conditions_help'] = '<p>Aquí puede definir las condiciones (ejemplo: solamente espacios de esta categoría, solamente usuarios de España, etc.</p>
...
$string['coursecategories'] = 'Filtro por Categoría del Espacio';
$string['coursecategory'] = 'Espacio en categoría';
$string['coursechild'] = 'Espacios que son hijos de';
$string['coursededicationtime'] = 'Tiempo de dedicación al espacio';
$string['coursefield'] = 'Campo del espacio';
$string['coursefieldorder'] = 'Orden del campo del espacio';
$string['coursemodules'] = 'Módulo del Espacio';
$string['courseparent'] = 'Espacios cuyo padre es';
$string['courses'] = 'Espacios';
$string['coursestats'] = 'Estadisticas del espacio';
...
$string['currentreportcourse'] = 'informe de espacio actual';
$string['currentreportcourse_summary'] = 'El espacio en donde se ha creado el informe';
$string['currentuser'] = 'Usuario actual';
$string['currentuser_summary'] = 'El usuario que está viendo el informe';
$string['currentusercourses'] = 'Espacios inscritos por el usuario actual';
$string['currentusercourses_summary'] = 'Una lista de los espacios del usuario actual (solamente espacios visibles)';
$string['currentuserfinalgrade'] = 'Calificación final del espacio del usuario actual';
$string['currentuserfinalgrade_summary'] = 'Esta columna muestra la calificación final del usuario actual en el espacio-hilera';
...
$string['enableglobal'] = 'Este es un reporte global (accesible desde cualquier espacio)';
...
$string['enrolledstudents'] = 'Participantes matriculados';
...
$string['fcoursefield'] = 'Filtro de campo del espacio';
$string['field'] = 'Campo';
...
$string['filtercoursecategories'] = 'Filtro por categoría del espacio';
$string['filtercoursecategories_summary'] = 'Filtrar espacios por su ninguna categoría padre';
$string['filtercoursemodules'] = 'Módulo del Espacio';
$string['filtercoursemodules_summary'] = 'Filtro de Módulos del espacio';
$string['filtercourses'] = 'Espacios';
$string['filtercourses_summary'] = 'Este filtro muestra una lista de espacios. Solamente puede seleccionarse un espacio a la vez';
$string['filterenrolledstudents'] = 'Participantes matriculados del espacio';
$string['filterenrolledstudents_summary'] = 'Filtrar un usuario (por id) de los participantes matriculados del espacio';
$string['filterrole'] = 'Rol';
$string['filterrole_summary'] = 'Filtro del sistema de Roles (facilitador, participante, ...)';
...
$string['filteruser'] = 'Usuario del espacio actual';
$string['filteruser_summary'] = 'Filtrar un usuario (id) de los usuarios del espacio actual';
...
$string['finalgradeincurrentcourse'] = 'Evaluación final en el espacio';
...
$string['global_help'] = 'A un informe global se puede acceder desde cualquier espacio de la plataforma simplemente añadiendo &courseid=MY_COURSE_ID a la URL del informe';
...
$string['report_courses'] = 'Informe de espacios';
...
$string['role'] = 'Rol';
$string['roleincourse'] = 'Usuarios con el/los rol(es) en el informe actual de espacio';
...
$string['user'] = 'Usuario del espacio (ID)';
$string['usercompletion'] = 'Estado de cierre del usuario en el espacio';
$string['usercompletionsummary'] = 'Estado de cierre del espacio';
...
$string['usersincoursereport'] = 'Cualquier usuario en el informe de espacio actual';
$string['usersincoursereport_summary'] = 'Cualquier usuario en el informe del espacio actual';
$string['usersincurrentcourse'] = 'Usuarios en el informe del espacio actual';
$string['usersincurrentcourse_summary'] = 'Usuario con el/los rol(es) seleccionados en el informe de espacio';
