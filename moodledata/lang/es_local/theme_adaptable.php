...
/**
 * Strings for component 'theme_adaptable', language 'es', version '3.9'.
 *
...
$string['alertdesc'] = 'Introduce y personaliza el texto de las Alertas mostradas en la parte superior de la pantalla. Es posible crear más de una para mostrarse a diferentes tipos de usuarios. También existe la opción de mostrar las alertas en la página inicial y en las páginas de los espacios.';
$string['alertdisabled'] = 'Desactivado';
$string['alertdisabledesc'] = 'Desactivar esta alerta.';
$string['alerthiddencourse'] = 'Advertencia de espacio oculto';
$string['alerthiddencoursedesc'] = 'Mostrar una alerta en la página del espacio si este está oculto';
$string['alerthiddencoursetext-1'] = 'Este espacio está oculto y los participantes no pueden acceder a él.';
...
$string['alertprofilefielddesc'] = 'Añade una regla de acceso usando un campo de perfil personalizado. Ejemplo: "usertype=participante"';
$string['alertsettings'] = 'Alerta {$a}';
$string['alertsettingscourse'] = 'Configuración de las alertas del espacio';
...
$string['analyticsprofilefielddesc'] = 'Añade una regla de acceso usando un campo de perfil personalizado. Ejemplo: usertype=participante';
...
$string['breadcrumbdisplaydesc'] = 'Establezca la visualización de lo que debería estar en el área de la ruta de exploración en un espacio';
...
$string['breadcrumbtitle'] = 'Nombre del espacio en la guía de exploración';
$string['breadcrumbtitledesc'] = 'Establece el modo de visualización del título del espacio en la guía de exploración.';
...
$string['buttonloginhovercolordesc'] = 'Color del botón Entrar al pasar el espacios por encima.';
...
$string['categoryheadercustomtitledesc'] = 'Establezca un título personalizado en el encabezado para la categoría de nivel superior \'{$a->name}\' con id \'{$a->id}\'. Si está en blanco, se le presentará lo que ha sido configurado por los ajustes \'Título del sitio\' y \'Texto del título del sitio\' en páginas que no son del espacio o en páginas del espacio cuando \'Habilitar encabezado\' está \'desactivado\'. Cuando se llena en páginas vinculadas a categorías que no son del espacio, esto reemplazará el título del sitio. Cuando se complete en las páginas del espacio, aparecerá sobre el título según lo establecido por la configuración \'Habilitar encabezado\'. Pero en los móviles, cualquier \'título\' solo aparecerá dependiendo de la configuración de \'Título del sitio adaptable\' se encuentra en blanco.';
$string['categoryheadercustomtitledescchildren'] = 'Establezca un título personalizado en el encabezado para la categoría de nivel superior \'{$a->name}\' con id \'{$a->id}\' y su hija \'{$a->children}\'. Si está en blanco, se le presentará lo que ha sido configurado por los ajustes \'Título del sitio\' y \'Texto del título del sitio\' en páginas que no son del espacio o en páginas del espacio cuando \'Habilitar encabezado\' está \'desactivado\'. Cuando se llena en páginas vinculadas a categorías que no son del espacio, esto reemplazará el título del sitio. Cuando se complete en las páginas del espacio, aparecerá sobre el título según lo establecido por la configuración \'Habilitar encabezado\'. Pero en los móviles, cualquier \'título\' solo aparecerá dependiendo de la configuración de \'Título del sitio adaptable\' se encuentra en blanco.';
...
$string['coursepageactivitybottomblockregionheading'] = 'Región tras el bloque de actividad del espacio personalizada';
$string['coursepageactivitybottomblockregionheadingdesc'] = 'Una región que aparece tras el bloque de actividades del espacio.';
$string['coursepageblockactivitybottomenabled'] = 'Habilitar región tras el bloque de actividad en página del espacio';
$string['coursepageblockactivitybottomenableddesc'] = 'Habilitar esta región en todas las páginas de espacio.';
$string['coursepageblocklayoutbuilder'] = 'Regiones de Bloques de Página de Espacio';
$string['coursepageblocklayoutbuilderdesc'] = 'Abajo puede definir su propia distribución de bloques para la página de espacio.
Para añadir contenido a esta regiones deberá <strong>habilitar la edición en la página del espacio de Moodle</strong>.
¡Entonces podrá arrastrar y soltar bloques en las regiones que haya creado!';
$string['coursepageblocklayoutlayoutbottomrow'] = 'Región de bloques en la fila inferior de la página de Espacio';
$string['coursepageblocklayoutlayoutbottomrowdesc'] = 'Añadir / fijar distribución de una fila de bloques en la página de Espacio.';
$string['coursepageblocklayoutlayouttoprow'] = 'Región de bloques en la fila superior de la página de Espacio';
$string['coursepageblocklayoutlayouttoprowdesc'] = 'Añadir / fijar distribución de una fila de bloques en la página de Espacio.';
$string['coursepageblockregionsettings'] = 'Constructor de regiones de bloques en la página de Espacio';
$string['coursepageblocksenabled'] = 'Habilitar regiones de bloques personalizadas en página de Espacio';
$string['coursepageblocksenableddesc'] = 'Puede habilitar / deshabilitar regiones de bloques personalizados (superiores e inferiores) en la página de Espacio.
Luego podrá arrastrar y soltar bloques en las regiones que haya creado';
$string['coursepageblocksliderenabled'] = 'Habilitar región de bloque presentaciones personalizado en página de Espacio';
$string['coursepageblocksliderenableddesc'] = 'Habilitar esta región en todas las páginas de espacio.';
$string['coursepageheaderhidesitetitle'] = 'Ocultar título del sitio en páginas de espacio';
$string['coursepageheaderhidesitetitledesc'] = 'Ocultar título del sitio, logotipo y barra de búsqueda en páginas de espacio. Utilice esto junto con el tamaño de cabecera de página para mostrar una cabecera más compacta en páginas relacionadas con espacios.';
$string['coursepagenewssliderblockregionheading'] = 'Región de bloque de noticias personalizado';
$string['coursepagenewssliderblockregionheadingdesc'] = 'Una región de bloque personalizada diseñada para usar con el control deslizante de noticias que forma parte de la IU Adaptable. Esta región aparece encima de las actividades del espacio en una página del espacio. Para agregar un bloque deslizante de noticias, primero instale el <strong> <a href="https://moodle.org/plugins/block_news_slider"> control deslizante de noticias de UI adaptable </a> </ strong> y configúrelo para que aparezca en la región "región del deslizador de la página del espacio" en todas las páginas del espacio.';
$string['coursepagesidebarinfooterenabled'] = 'Desplazar barra lateral al pie en páginas de Espacios';
$string['coursepagesidebarinfooterenableddesc'] = 'Distribución ancha de la página de espacio desplazando la barra lateral a pie de página.';
$string['coursepagesidebarinfooterenabledsection'] = 'Opciones comunes';
$string['coursepagesidebarinfooterenabledsectiondesc'] = 'Opciones comunes para la mayoría de los formatos de espacio.';
...
$string['coursesectionactivitybordercolor'] = 'Color del borde inferior Sección del espacio Actividad';
$string['coursesectionactivitybordercolordesc'] = 'Establece el Color del borde inferior';
$string['coursesectionactivityborderstyle'] = 'Estilo del borde inferior de Espacio Sección Actividad';
$string['coursesectionactivityborderstyledesc'] = 'Establece estilo del borde inferior de Espacio Sección Actividad';
$string['coursesectionactivityborderwidth'] = 'Ancho del borde inferior de espacio Sección Actividad';
$string['coursesectionactivityborderwidthdesc'] = 'Establecer el ancho del borde que aparece en la parte inferior de una actividad de la sección del espacio.';
$string['coursesectionactivitycolors'] = 'Opciones de actividad de la sección del espacio';
...
$string['coursesectionactivityfurtherinformation'] = 'Página del espacio más información';
...
$string['coursesectionactivityheadingcolour'] = 'Espacio Sección Actividad Título Color';
$string['coursesectionactivityheadingcolourdesc'] = 'El color de las actividades en las que se puede hacer clic que se muestran en la página de inicio del espacio.';
$string['coursesectionactivityiconsize'] = 'Tamaño del icono de la actividad de la sección del espacio';
...
$string['coursesectionactivityleftborderwidth'] = 'Espacio Sección Actividad Ancho del borde izquierdo';
$string['coursesectionactivityleftborderwidthdesc'] = 'Establezca el ancho del borde que aparece a la izquierda de una actividad de la sección del espacio.';
...
$string['coursesectionbgcolor'] = 'Antecedentes de la sección del espacio';
$string['coursesectionbgcolordesc'] = 'Establece el color de fondo de la sección del espacio.';
$string['coursesectionbordercolor'] = 'Color del borde de la sección';
$string['coursesectionbordercolordesc'] = 'Establece el color del borde de la sección del espacio.';
$string['coursesectionborderradius'] = 'Radio del borde de la sección';
$string['coursesectionborderradiusdesc'] = 'Establece el radio del borde de las esquinas de la sección del espacio.';
$string['coursesectionborderstyle'] = 'Estilo del borde de la sección del espacio';
$string['coursesectionborderstyledesc'] = 'Establece el estilo del borde de la sección del espacio.';
$string['coursesectionborderwidth'] = 'Grueso del borde de la sección';
$string['coursesectionborderwidthdesc'] = 'Establece el grueso del borde de la sección del espacio.';
$string['coursesectionheaderbg'] = 'Color de fondo de la cabecera';
$string['coursesectionheaderbgdesc'] = 'Establece el color de fondo de la cabecera de la sección del espacio.';
$string['coursesectionheaderbordercolor'] = 'Color del borde inferior de la cabecera';
$string['coursesectionheaderbordercolordesc'] = 'Establece el color del borde inferior de la cabecera de la sección del espacio.';
$string['coursesectionheaderborderradiusbottom'] = 'Radio de las esquinas del borde inferior de la cabecera';
$string['coursesectionheaderborderradiusbottomdesc'] = 'Establece el radio de las esquinas del borde inferior de la cabecera de la sección del espacio.';
$string['coursesectionheaderborderradiustop'] = 'Radio de las esquinas del borde superior de la cabecera';
$string['coursesectionheaderborderradiustopdesc'] = 'Establece el radio de las esquinas del borde superior de la cabecera de la sección del espacio.';
$string['coursesectionheaderborderstyle'] = 'Estilo del borde inferior de la cabecera';
$string['coursesectionheaderborderstyledesc'] = 'Establece el estilo del borde inferior de la cabecera de la sección del espacio.';
$string['coursesectionheaderborderwidth'] = 'Grueso del borde inferior de la cabecera';
$string['coursesectionheaderborderwidthdesc'] = 'Establece el grueso del borde inferior de la cabecera de la sección del espacio.';
$string['coursesections'] = 'Secciones del espacio';
$string['coursesettings'] = 'Secciones del espacio';
$string['coursesettingsdesc'] = 'Personalice algunos de los formatos de espacio más utilizados en Moodle para adaptarlos al diseño principal.';
$string['coursesettingsheading'] = 'Configuración de las secciones del espacio.';
$string['coursetitlefullname'] = 'Nombre completo del espacio';
$string['coursetitlemaxwidth'] = 'Ancho máximo del título del espacio';
$string['coursetitlemaxwidthdesc'] = 'Establece el ancho máximo del área donde se muestra el título del espacio.';
$string['coursetitleshortname'] = 'Nombre corto / código del espacio';
...
$string['covhidebutton'] = 'Mostrar el botón del espacio en los bloques estilo Coventry';
$string['covhidebuttondesc'] = 'Mostrar / ocultar el botón del espacio cuando se utiliza el estilo Coventry.';
...
$string['customcoursesubtitle'] = 'Título del espacio personalizado';
$string['customcoursesubtitledesc'] = 'Nombre del campo personalizado del perfil de usuario para el título del espacio.';
$string['customcoursetitle'] = 'Título del espacio personalizado';
$string['customcoursetitledesc'] = 'Nombre del campo personalizado del perfil de usuario para el título del espacio.';
...
$string['disablemenuscoursepages'] = 'Desactivar menús en las páginas de los espacios';
$string['disablemenuscoursepagesdesc'] = 'Activando esta opción los menús solo se mostrarán en las páginas del sitio, la página inicial, el Área Personal, etc. y no se mostrará en las páginas de los espacios.';
$string['discardbuttontext'] = 'Cancelar';
$string['displayeditingbuttontext'] = 'Edición de texto del botón';
$string['displayeditingbuttontextdesc'] = 'Mostrar u ocultar el texto en el botón de edición. Nota: Solo se aplica al botón de edición del espacio.';
...
$string['draft'] = 'No publicado para participantes';
$string['due'] = 'Debido {$a}';
...
$string['editsettingsbuttonshowbutton'] = 'Mostrar solo el botón de edición. P.ej. Botón "Activar edición" en la página del espacio.';
...
$string['enablealertcoursepages'] = 'Activar Alertas en las páginas de los espacios';
$string['enablealertcoursepagesdesc'] = 'Activar las alertas también en las páginas de los espacios.';
...
$string['enableavailablecourses'] = 'Mostrar el texto "Espacios Disponibles"';
$string['enableavailablecoursesdesc'] = 'Mostrar el texto <i>Espacios Disponibles</i> sobre el listado de espacios en la página inicial.';
...
$string['enablecompetencieslinkdesc'] = 'Mostrar el enlace de competencias en el menú \'Este espacio\'. Nota: \'core_competency|habilitado\' debe marcarse.';
$string['enablecoursesectionsdesc'] = 'Muestre un submenú en el menú \'Este espacio\' que contiene enlaces a cada sección mostrada.';
...
$string['enableheading'] = 'Mostrar nombre del espacio';
$string['enableheadingdesc'] = 'Establece el modo de visualización del título del espacio en la cabecera.';
...
$string['enablemysitesdesc'] = 'Mostrar las actividades del espacio';
$string['enablemysitesrestriction'] = 'Restrinja el menú desplegable de espacios del usuario a un campo de perfil personalizado';
$string['enablemysitesrestrictiondesc'] = 'Restrinja el menú desplegable con los espacios de un usuario por campo de perfil personalizado. Por ejemplo, usertype = staff';
...
$string['enablethiscoursedesc'] = 'Mostrar un menú desplegable con actividades del espacio actual.';
...
$string['fonttitlecolorcourse'] = 'Color de la fuente del título del espacio';
$string['fonttitlecolorcoursedesc'] = 'Establece el color de la fuente usada en el título del espacio.';
...
$string['frontpagecoursesettings'] = 'Espacios';
$string['frontpagedesc'] = 'Configurar la forma en que los espacios son mostrados en la página inicial.';
...
$string['frontpagenumbertiles'] = 'Cantidad de mosaicos de espacio por fila';
$string['frontpagenumbertilesdesc'] = 'Número de mosaicos de espacio para mostrar por fila en la lista de espacios de la página principal';
$string['frontpagerenderer'] = 'Bloques de espacios';
$string['frontpagerendererdefaultimage'] = 'Imagen por defecto para los espacios';
$string['frontpagerendererdefaultimagedesc'] = 'Sube la imagen que se utilizará por defecto en los espacios que no dispongan de ella.  (solo se aplica en el estilo "Bloques Superpuestos")';
$string['frontpagerendererdesc'] = 'Configurar la forma en que los espacios son mostrados en la página inicial.';
...
$string['headernavbarmycoursesheading'] = 'Menú de mis espacios';
$string['headernavbarmycoursesheadingdesc'] = 'Todas las opciones para la opción de menú Mis espacios (Mis sitios) que muestra la lista de espacios del usuario actual';
$string['headernavbarthiscourseheading'] = 'Este menú del espacio';
$string['headernavbarthiscourseheadingdesc'] = 'En este menú, el participante puede acceder directamente a todas las actividades del espacio y a la lista de participantes y sus calificaciones.';
...
$string['helpprofilefielddesc'] = 'Añade una regla de acceso usando un campo de perfil personalizado. Ejemplo: usertype=participante';
...
$string['maincoursepage'] = 'Página del espacio principal';
...
NO debes utilizar la opción "Desactivar menús en las páginas de los espacios" junto a los campos de perfil. En su lugar, selecciona  "Homepages Only".
...
$string['mycoursesmenulimit'] = 'Límite del menú Mis Espacios';
$string['mycoursesmenulimitdesc'] = 'Ajuste el número máximo de espacios que aparecerán en el menú Mis Espacios. 0 mostrará todos los espacios.';
$string['mysites'] = 'Mis Espacios';
$string['mysitesdisabled'] = 'Desactivado';
$string['mysitesexclude'] = 'Mostrar excluyendo los espacios ocultos';
$string['mysitesinclude'] = 'Mostrar incluyendo los espacios ocultos';
$string['mysitesmaxlength'] = 'Longitud máxima del título del espacio en "Mis Espacios"';
$string['mysitesmaxlengthdesc'] = 'Ajusta la longitud máxima del título del espacio a mostrar en "Mis Espacios". La longitud dependerá del tamaño y de la fuente usada.';
$string['mysitesmenudisplay'] = 'Pantalla del menú Mis espacios';
$string['mysitesmenudisplaydesc'] = 'Elija qué texto mostrar para un elemento del menú y al pasar el mouse sobre él.';
$string['mysitesmenudisplayfullnamefullnameonhover'] = 'Mostrar el título completo del espacio y el título completo al pasar el mouse sobre él.';
$string['mysitesmenudisplayfullnamenohover'] = 'Mostrar el título completo del espacio y sin texto al pasar el mouse.';
$string['mysitesmenudisplayshortcodefullnameonhover'] = 'Mostrar código corto y nombre completo del espacio al pasar el ratón.';
$string['mysitesmenudisplayshortcodenohover'] = 'Mostrar código corto y sin texto al pasar el mouse.';
$string['mysitessortoverride'] = 'Activar el orden personalizado de "Mis Espacios"';
$string['mysitessortoverridedesc'] = 'Usa campos personalizados o textos (año, edad, ...) para colapsar los espacios en un desplegable.';
$string['mysitessortoverridefield'] = 'Campo personalizado o texto para filtrar "Mis Espacios"';
$string['mysitessortoverridefielddesc'] = 'Lista con delimitación por comas de los campos o textos a comprobar en el nombre corto de espacio.';
$string['mysitessortoverrideoff'] = 'Mostrar lista de espacios.';
$string['mysitessortoverrideprofilefields'] = 'Muestra los espacios coincidentes con un campo personalizado en una lista. El resto son mostrados en un submenú.';
$string['mysitessortoverrideprofilefieldscohort'] = 'Muestra los espacios coincidentes con un campo de perfil y los cohortes en primer lugar. El resto son mostrados en un submenú.';
$string['mysitessortoverridestrings'] = 'Muestra todos los espacios en los que está matriculado el participante en una lista. El resto son mostrados en un submenú.';
...
$string['newmenufielddesc'] = 'Añade una regla de acceso usando un campo de perfil personalizado. Ejemplo: usertype=participante';
...
$string['pastcourses'] = 'Espacios anteriores';
$string['people'] = 'Gente';
...
$string['putpropertiesignorecti'] = 'Ignorando todas las configuraciones de imagen del título del espacio.';
...
$string['region-course-bottom-a'] = 'Página del espacio región inferior 5';
$string['region-course-bottom-b'] = 'Página del espacio región inferior 6';
$string['region-course-bottom-c'] = 'Página del espacio, región inferior 7';
$string['region-course-bottom-d'] = 'Página del espacio, región inferior 8';
$string['region-course-section-a'] = 'Actividad de la página del espacio final región inferior';
$string['region-course-tab-one-a'] = 'Pestaña página del espacio región 1';
$string['region-course-tab-two-a'] = 'Pestaña página del espacio región 2';
$string['region-course-top-a'] = 'Página principal del espacio región 1';
$string['region-course-top-b'] = 'Página superior del espacio región 2';
$string['region-course-top-c'] = 'Página superior del espacio región 3';
$string['region-course-top-d'] = 'Página superior del espacio región 4';
...
$string['region-news-slider-a'] = 'Región del control deslizante de la página del espacio';
...
$string['rendereroverlaycolordesc'] = 'El color superpuesto sobre el bloque de espacio cuando "Bloques Superpuestos" está seleccionado.';
$string['rendereroverlayfontcolor'] = 'Color de texto en la superposición';
$string['rendereroverlayfontcolordesc'] = 'El color de la fuente cuando pasa el cursor por encima del bloque del espacio y "Bloques Superpuestos" está activado.';
...
$string['settingsoverlaycolors'] = 'Colores bloques espacios';
...
$string['showyourprogressdesc'] = 'Muestra / oculta la etiqueta \'Tu progreso\' en la parte superior del contenido del espacio. Esta etiqueta es solo para fines informativos y se puede ocultar.';
...
$string['sitetitlecoursesdisabled'] = 'Desactivado - muestra solo el título del espacio en las páginas del espacio';
$string['sitetitlecoursesenabled'] = 'Activado - muestra el nombre del sitio y el título del espacios en las páginas del espacio';
...
$string['socialwalldesc'] = 'Personaliza el estilo del <a href="https://moodle.org/plugins/format_socialwall">Formato de espacio SocialWall</a> (si se utiliza en el sitio)';
...
$string['tabbedlayoutcoursepage'] = 'Página del espacio Diseño tabulado';
$string['tabbedlayoutcoursepagedesc'] = 'Use un diseño con pestañas para la página del espacio. Esto muestra todo el contenido en pestañas, con el contenido del espacio en una pestaña y le permite adaptar el contenido en otras pestañas. Use esta configuración para configurar el orden de las pestañas.';
$string['tabbedlayoutcoursepagelink'] = 'Página del espacio Diseño del archivo con fichas Enlace del espacio';
$string['tabbedlayoutcoursepagelinkdesc'] = 'Tenga un enlace de pestaña a la página del espacio en las pestañas del espacio.';
$string['tabbedlayoutcoursepagetabcolorselected'] = 'Color de pestaña seleccionado para la página del espacio';
$string['tabbedlayoutcoursepagetabcolorselecteddesc'] = 'Elija el color para la pestaña seleccionada actualmente.';
$string['tabbedlayoutcoursepagetabcolorunselected'] = 'Color de pestaña no seleccionado para la página del espacio';
$string['tabbedlayoutcoursepagetabcolorunselecteddesc'] = 'Elija el color para cualquier otra pestaña.';
$string['tabbedlayoutcoursepagetabpersistencetime'] = 'Página de inicio del espacio Pestaña tiempo de persistencia';
$string['tabbedlayoutcoursepagetabpersistencetimedesc'] = 'La pestaña de la página de inicio del espacio persiste en la pestaña seleccionada cuando se actualiza durante un período de inactividad. Establezca el período de inactividad aquí. Por ejemplo, configure en 30 para que la primera pestaña se seleccione después de 30 minutos de inactividad';
$string['tabbedlayoutdashboard'] = 'Diseño de pestañas de la página del Panel';
$string['tabbedlayoutdashboarddesc'] = 'Use un diseño con pestañas para la página Panel. Esto muestra todo el contenido en pestañas, con el contenido del espacio en una pestaña y le permite adaptar el contenido en otras pestañas. Use esta configuración para configurar el orden de las pestañas.';
...
$string['tabbedlayouttablabelcourse'] = 'Contenido del espacio';
...
$string['tickertextprofilefielddesc'] = 'Añade una regla de acceso usando un campo de perfil personalizado. Ejemplo: "usertype=participante"';
...
$string['tilesbordercolor'] = 'Color del borde de los bloques de espacios';
$string['tilesbordercolordesc'] = 'establece el color del borde de los bloques de espacios.';
$string['tilescontactstitle'] = 'Mostrar el rol de los contactos del espacio';
$string['tilescontactstitledesc'] = 'Muestra / Oculta el rol del contacto en el espacio. Si no se muestra, se mostrará una imagen para cada contacto.';
$string['tilesshowallcontacts'] = 'Mostrar todos los contactos del espacio';
$string['tilesshowallcontactsdesc'] = 'Muestra todos los contactos del espacio o solo el principal.';
$string['tilesshowcontacts'] = 'Mostrar los contactos del espacio';
$string['tilesshowcontactsdesc'] = 'Muestra / Oculta los contactos del espacio.';
...
$string['topicsweeks'] = 'Formato de espacio Temas/Semanas';
$string['topicsweeksdesc'] = 'Establecer estilos para el formato de espacio Temas/Semanas';
