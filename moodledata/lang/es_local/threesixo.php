...
/**
 * Strings for component 'threesixo', language 'es', version '3.9'.
 *
 * @package     threesixo
 * @category    string
...
$string['allparticipants'] = 'Todos los participantes del espacio';
...
$string['commentfromuser'] = '{$a->comentario} ({$a->del usuario})';
...
$string['errornotenrolled'] = 'Debe estar inscrito en este espacio para poder participar en esta actividad de retroalimentación 360 °.';
$string['errornothingtodecline'] = 'No hay retroalimentaciones para declinar.';
$string['errornotingroup'] = 'Debes estar en un grupo para poder participar en esta actividad de retroalimentación 360 °. Por favor contacte a su administrador del espacio.';
