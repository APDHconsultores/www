...
/**
 * Strings for component 'plagiarism_ephorus', language 'es', version '3.9'.
 *
...
$string['student_disclosure'] = 'Declaración a los participantes';
$string['student_disclosure_help'] = '<p>Este texto se mostrará a todos los participantes en la página de entrega de archivos.</p>';
