...
/**
 * Strings for component 'qtype_essayautograde', language 'es', version '3.9'.
 *
...
Cada vez que uno de estos errores sea encontrado en la respuesta del ensayo, la penalización especificada será restada de la calificación del participante para esta pregunta.';
...
$string['responsesample_help'] = 'Cualquier texto aquí será mostrado como una respuesta de muestra, si el participante elige el enlace para "Mostrar muestra" en el texto de la pregunta.';
...
$string['showfeedback'] = '¿Mostrar retroalimentación al participante?';
$string['showfeedback_help'] = 'Si esta opción es habilitada, una tabla de retroalimentación accionable será mostrada en las páginas de calificación y revisión. Retroalimentación accionable es retroalimentación que le dice a los participantes lo que necesitan hacer para mejorar.';
...
$string['showtostudentsonly'] = 'Si, mostrar solamente a participantes';
$string['showtoteachersandstudents'] = 'Si, mostrar a facilitadores y a participantes';
$string['showtoteachersonly'] = 'Si, mostrar solamente a facilitadores';
