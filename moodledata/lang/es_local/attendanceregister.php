...
/**
 * Strings for component 'attendanceregister', language 'es', version '3.9'.
 *
...
Un participante no puede grabar una sesión fuera de línea mayor a este número de días.';
...
$string['force_recalc_all_session_help'] = 'Elimine y vuelva a calcular todas las sesiones en línea de todos los usuarios monitorizados. <br />¡Normalmente usted <b> no necesita hacerlo </b>! <br />Las nuevas sesiones se calculan automáticamente en segundo plano (después de algún retraso). <br />Esta operación puede ser útil <b> solamente </b>:<ul><li> Después de cambiar el rol de un usuario que actuó anteriormente en cualquiera de los espacios seguidos con un rol diferente(es decir, cambiar de Facilitador a Participante, cuando se realiza un seguimiento de Participante y no de Facilitador). </li><li> Después de modificar la configuración de Registro que afecta el cálculo de Sesiones(es decir, <i> Modo de seguimiento de asistencia </i>, <i> Tiempo de espera de sesión en línea </i>) </li></ul>¡Usted <b> no necesita volver a calcular cuando inscriba nuevos usuarios </b>! <br /> <br />El recálculo puede ejecutarse inmediatamente o programarse para su ejecución por el siguiente cron. La ejecución programada podría ser más eficiente para espacios muy concurridos.';
...
<ul>
<li> Después de cambiar el rol del usuario, el / ella actuó previamente en cualquiera de los espacios seguidos con un rol diferente
(es decir, cambiar de facilitador a Participante, cuando se realiza un seguimiento de Participante y no de Facilitador). </li>
...
$string['mandatoryofflinespecifycourse'] = 'Selección obligatoria del Espacio';
$string['mandatoryofflinespecifycourse_help'] = 'La especificación de un espacio en sesiones fuera de línea será obligatoria';
...
$string['modulename_help'] = 'El Registro de Asistencia calcula el tiempo que los usuarios emplean trabajando en espacios en línea.<br /> Opcionalmente permite además considerar actividades fuera de línea.<br /> Dependiendo del modo de asistencia, el registro puede supervisar actividades en un solo espacio, en todos los espacios de la misma categoría, o en todos los espacios "meta ligados" al espacio en donde está el registro.<br /> Las sesiones en línea son calculadas mediante las bitácoras de entradas registradas por Moodle.<br /> <b>Las sesiones nuevas se añaden con cierto retraso por el programa CRON, después que el usuario sale del sitio.</b>';
$string['modulenameplural'] = 'Registros de asistencia';
$string['never'] = '(nunca)';
$string['no_refcourse'] = '(Espacio no especificado)';
...
$string['select_a_course'] = '- Seleccione un Espacio -';
