...
/**
 * Strings for component 'assignsubmission_onlinetext', language 'es', version '3.9'.
 *
...
$string['enabled_help'] = 'Si está habilitado, los participantes pueden escribir en su envió texto ampliado (text rich) directamente en el campo del editor.';
...
$string['wordlimit_help'] = 'Si se habilitan las entregas de texto en línea, este es el número máximo de palabras que a cada participante se le permitirá entregar.';
