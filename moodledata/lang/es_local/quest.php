...
/**
 * Strings for component 'quest', language 'es', version '3.9'.
 *
 * @package     quest
 * @category    string
...
$string['allowteams_help'] = '<P align="justify">Este par&aacute;metro obliga a que cada uno de los alumnos que participe en este m&oacute;dulo QUESTOURnament pertenezca a un equipo. Cuando un participante acceda por primera vez a un m&oacute;dulo que tenga esta opci&oacute;n habilitada, tendr&aacute; que introducir el nombre del equipo al que pertenece para poder entrar. </P>
...
<P align="justify"> Cada equipo tendr&aacute; un n&uacute;mero de componentes, fijado por el par&aacute;mero <a href="help.php?component=quest&identifier=ncomponents"">N&uacute;mero de Componentes</a>, que podr&aacute; ser gestionado por los facilitadores. Los posibles errores que se poduzcan podr&aacute;n solucionarse atrav&eacute;s de la opci&oacute;n de
<a href="help.php?component=quest&identifier=changeteamteacher"">Gesti&oacute;n de Equipos</a> a la que s&oacute;lo tienen acceso los facilitadores. </P>';
...
$string['approvesubmission_help'] = '<P align="justify">Esta página permite al facilitador aprobar, guardar o borrar un desaf&iacute;o propuesto por un participante. A continuación se describe cada una de las acciones que se pueden realizar:</P>
<ul>
  <li><strong align="justify">Aprobar</strong>: al pulsar este bot&oacute;n se guardan todos los datos referentes al desaf&iacute;o, con las modificaciones realizadas por el facilitador. A partir de este instante, el desafío será visible por el resto de los alumnos que podr&aacute;n enviar respuestas una vez se abra dicho desafío.</li>
  <li><strong align="justify">Guardar</strong>: se almacenan todos los cambios realizados por el facilitador en el desaf&iacute;o, sin que éste pase a estar visible para el resto de alumnos. Esto permite que el autor del desafío realice las modificaciones necesarias para que el facilitador lo apruebe</li>
  <li><strong align="justify">Borrar</strong>: el facilitador elimina el desafío por no considerarlo adecuado o interesante.</li>
</ul>
...
<ul>
    ...
    <li><strong>T&iacute;tulo</strong>: nombre con el se designa el desaf&iacute;o, se recomienda que no incluya el nombre del autor, para conservar el anonimato sobre la autoría del desaf&iacute;o, en caso contrario podr&aacute; ser rechazado o modificado por el facilitador.</li>
      ...
      <li><strong>Fecha de Comienzo</strong>: establece la fecha en que se abre el desaf&iacute;o, este par&aacute;metro s&oacute;lo es configurable por parte de los facilitadores. Cuando el desafío lo crea un participante, se toma como fecha de comienzo el instante de creaci&oacute;n del desaf&iacute;o.</li>
      <li><strong>Fecha de Cierre</strong>: establece la fecha en la que se cierra el desaf&iacute;o, a partir de esta fecha no se podr&aacute; responder al desaf&iacute;o, aunque los autores del desaf&iacute;o y los facilitadores s&iacute; que podr&aacute;n evaluar las respuestas realizadas hasta la fecha. No puede ser posterior a la <a href="help.php?component=quest&identifier=dateend"">Fecha de Cierre</a> establecida para el m&oacute;dulo QUESTOURnament. </li>
  ...
  <li><strong>Comentarios para el Autor</strong>: en este campo se incluir&aacute;n las sugerencias o los comentarios que el facilitador quiera realizar al participante, los cuáles s&oacute;lo estarán visibles para el autor del desaf&iacute;o y para el resto de facilitadores.</li>
  <li><strong>Comentarios para los Participantes</strong>: en este campo se incluir&aacute;n los comentarios que el facilitador quiera realizar a los alumnos acerca del desaf&iacute;o, estos comentarios estarán visibles para todos los participantes en el m&oacute;dulo QUESTOURnament. </li>
</ul>';
...
<P align="justify">Asimismo es posible realizar un comentario general sobre el trabajo valorado. &Eacute;ste comentario debe ser respetuoso y constructivo. Las calificaciones y comentarios realizados se mostrar&aacute; al autor del desafío. El facilitador podrá modificar manualmente la calificación global, en caso de que desee hacer ajustes sobre la calculada de forma automática.
...
$string['challengestart_help'] = '<P align="justify">Permite establecer la fecha en la que comenzará un desaf&iacute;o. Este par&aacute;metro s&oacute;lo es configurable por un facilitador.</P>
<P align="justify">Si el desafío lo crea un participante se toma como fecha de comienzo la fecha de creaci&oacute;n del desaf&iacute;o, pudiendo los facilitadores modificar este valor al aprobar el desaf&iacute;o o al realizar alguna modificaci&oacute;n sobre él.</P>
...
$string['changeteamteacher_help'] = '<P align="justify">Esta opción permite realizar la gesti&oacute;n de los equipos del m&oacute;dulo QUESTOURnament así como cambiar a un participante de equipo si resultara necesario.</P>
<P align="justify">Se presenta la siguiente información:</P>
<div align="justify">
  <ul>
    <li><strong>Nombre/Apellido</strong>: muestra el nombre y el apellido introducido por el participante al registrarse en el sistema.</li>
      <li><strong>Nombre del Equipo</strong>: muestra el nombre del equipo al que pertenece el participante.</li>
      <li><strong>N&ordm; Componentes</strong>: indica el n&uacute;mero actual de componentes con que cuenta el equipo al que pertenece el participante.</li>
      <li><strong>Nuevo Equipo</strong>: es un campo de texto donde se puede introducir el nombre del nuevo equipo al que se desea asignar al participante en cuesti&oacute;n.</li>
  </ul>
</div>
<p align="justify">Si en el m&oacute;dulo QUESTOURnament est&aacute;n habilitados los grupos, el facilitador, al cambiar a un participante de equipo deber&aacute; seleccionar el grupo al que pertenezca dicho participante. Esto permite que pueda haber dos equipos con el mismo nombre siempre que pertenezcan a grupos distintos. </p>
<p align="justify">Si al cambiar a un participante de equipo, éste se quedase sin componentes, dicho equipo desaparecer&iacute;a.</p>';
$string['checkthat'] = 'Compruebe que';
$string['clasification'] = 'Clasificación';
$string['comment'] = 'Comentario';
$string['commentby'] = 'Comentado por';
$string['commentsforteacher'] = 'Comentarios para el Facilitador';
$string['commentsteacher'] = 'Comentario General del Facilitador';
...
$string['dateend_help'] = '<P align="justify">Este par&aacute;metro establece la fecha de cierre de este m&oacute;dulo QUESTOURnament. A partir de esta fecha los alumnos del espacio que accedan a este m&oacute;dulo no podr&aacute;n realizar ninguna de las acciones asociadas al mismo. En este momento se tendr&aacute;n las calificaciones finales del concurso. </P>
<P align="justify">Una vez cerrado el concurso, su contenido permanecer&aacute; visible para los alumnos y facilitadores del espacio, siempre que así se hubiera definido al crear el módulo QUESTOURnament, de manera que se podr&aacute; acceder a los desaf&iacute;os y respuestas realizadas por todos los participantes, así como a las calificaciones por ellos obtenidas. </P>';
...
$string['grading_help'] = '<P align="justify">Esta página permite a los facilitadores evaluar una respuesta enviada. La calificaci&oacute;n asignada deberá depender de c&oacute;mo se ajuste la respuesta a lo exigido en el desaf&iacute;o correspondiente.</P>
...
<P align="justify">El facilitador o el autor del desafío podrá modificar manualmente la calificación global, en caso de que desee hacer ajustes sobre la calculada de forma automática.
...
<div align="justify">
  <ul>
    <li><strong>Sin grupos</strong>: No hay grupos, todos los alumnos forman parte de un único gran grupo.</li>
      <li><strong>Grupos separados</strong>: Cada participante sólo puede ver el grupo al que él pertenece, el resto de grupos y los alumnos que los componen son invisibles. </li>
      <li><strong>Grupos visibles</strong>: Cada participante trabaja dentro de su grupo, pero también puede ver el resto de grupos y los alumnos que los componen. </li>
  </ul>
</div>
...
<div align="justify">
  <ul>
    <li><strong>Nivel Espacio</strong>: El modo de agrupación definido a nivel de espacio prevalece por defecto para todas las actividades definidas dentro de ese espacio.</li>
      <li><strong>Nivel Actividad</strong>: Para toda actividad que soporte grupos se puede definir su propio modo de agrupación. No obstante, si el espacio está configurado como "forzar modo de grupo" entonces no se tendrá en cuenta la configuración del modo de agrupación realizada a nivel de actividad. </li>
  </ul>
</div>';
...
<P align="justify">No obstante, el facilitador podr&aacute; modificar este valor desde la m$iacute;nima puntuaci&oacute;n hasta la m&aacute;xima puntuaci&oacute;n fijada para este m&oacute;dulo QUESTOURnament. </P>
...
$string['modifsubmission_help'] = '<P align="justify">Esta opci&oacute;n permite a un facilitador modificar un desaf&iacute;o propuesto por un participante. Los alumnos podr&aacute;n modificar los desaf&iacute;os que hayan propuesto, siempre y cuando no hayan sido aprobados todav&iacute;a por el facilitador. </P>
<P align="justify">La información que se presenta sobre el desafío y que puede modificarse es la siguiente:</P>
<ul>
   <li><strong>T&iacute;tulo</strong>: nombre con el se designa el desaf&iacute;o, se recomienda que no incluya el nombre del autor, para conservar el anonimato sobre la autoría del desaf&iacute;o, en caso contrario podr&aacute; ser rechazado o modificado por el facilitador.</li>
      <li><strong>Descripci&oacute;n</strong>: es el cuerpo del desaf&iacute;o, donde se explica la problem&aacute;tica y los aspectos que debe incluir la respuesta. Debe ser clara y completa. </li>
...
<p align="justify">El módulo QUESTOURnament incentiva el trabajo del participante, tanto de manera individual como en equipo.</p>
<p align="justify">Este m&oacute;dulo ofrece la posibilidad de responder a desaf&iacute;os o preguntas planteados por el facilitador o los alumnos a lo largo de un periodo de tiempo predeterminado. Tanto las respuestas como los desaf&iacute;os enviados por los alumnos son evaluados. Estas evaluaciones podr&aacute;n ser realizadas tanto por los facilitadores como por los alumnos que hayan propuesto desafíos. De estas evaluaciones depender&aacute; la nota final de cada participante. Esta nota final y su evoluci&oacute;n a medida que se desarrolla el concurso podr&aacute; ser visualizada en cualquier momento por los alumnos accediendo a la tabla de clasificación del concurso que se configura dinámicamente a partir de dichas notas finales. </p>
...
<ul>
  <li>
    <div align="justify"><strong>Mis Desaf&iacute;os </strong>: muestra una lista con todos los desaf&iacute;os que han sido a&ntilde;adidos por el usuario que visualiza esta p&aacute;gina. Para cada desafío se presenta su puntuaci&oacute;n actual (m&aacute;xima puntuaci&oacute;n que podr&aacute; obtener una respuesta enviada en ese instante), la fase o estado en que se encuentra, el n&uacute;mero de respuestas realizadas y número de ellas que son correctas, las fechas de inicio y de cierre y su t&iacute;tulo. Pulsando en el t&iacute;tulo se accede a la descripci&oacute;n completa del desaf&iacute;o. El facilitador podr&aacute; modificar o borrar un desaf&iacute;o cualquiera en todo momento, mientras un participante autor s&oacute;lo podr&aacute; hacerlo hasta que el desafío que ha propuesto sea aprobado por el facilitador. </div>
  </li>
  <li><strong>Mis Respuestas</strong>: muestra una tabla con todas las respuestas que ha enviado el usuario que visualiza esta página. Para cada respuesta se presenta la fecha del env&iacute;o, las acciones que se pueden realizar (Ver Evaluación, etc.), la puntuaci&oacute;n obtenida y su t&iacute;tulo. Una respuesta podr&aacute;n ser modificada o borrada por el facilitador en todo momento, mientras que un participante s&oacute;lo podr&aacute; hacerlo hasta que la respuesta que ha enviado sea evaluada. </li>
  <li><strong>Mi Clasificaci&oacute;n</strong>: muestra las distintas puntuaciones obtenidas por un participante en el m&oacute;dulo QUESTOURnament, ya sean por las respuestas evaluadas o por los desaf&iacute;os a&ntilde;adidos. Esta secci&oacute;n no se presentará si el usuario que accede es un facilitador.</li>
  <li><strong>Mi Clasificaci&oacute;n por Equipos</strong>: muestra las puntuaciones obtenidas por el equipo al que pertenece el participante. Esta opci&oacute;n s&oacute;lo se mostrará si se trata de un m&oacute;dulo QUEST que tenga habilitada la opci&oacute;n de <a href="help.php?component=quest&identifier=allowteams"">Permitir Equipos</a>. Esta secci&oacute;n tampoco se presentará si el usuario que accede es un facilitador.</li>
</ul>
...
o <a href="help.php?component=quest&identifier=changeteamteacher"">Gesti&oacute;n de Equipos</a>, &eacute;sta &uacute;ltima s&oacute;lo la podr&aacute;n llevar a cabo los facilitadores. </p>';
...
<P align="justify">Si un participante intenta inscribirse en un equipo que ya est&eacute; completo, se le avisar&aacute; de ello y tendr&aacute; que darse de alta en otro equipo. </P>';
$string['ncomponentsteam'] = 'Nº Máximo de Componentes por Equipo';
$string['need_to_be_editor'] = '(Necesita ser un editor para añadir desafíos. Solicite los permisos al facilitador.)';
...
$string['nopermissionassessment'] = 'No se puede mostrar la evaluación. Necesita ser el autor del desafío o un facilitador.';
...
Elementos antes de poner a disposición de los participantes el Questournament. Esto se consigue<br />
...
$string['password_help'] = '<p align="justify">Este campo permite introducir la contraseña de acceso para este m&oacute;dulo QUESTOURnament. La contraseña puede tener una longitud máxima de 10 caracteres, y puede modificarse en cualquier momento a lo largo del tiempo de vida de este QUESTOURnament. Seleccionando la opción &quot; <a href="help.php?component=quest&identifier=usepassword"">Usar contraseña</a>&quot; se puede garantizar que los participantes deban escribir esta contraseña para acceder a este	m&oacute;dulo QUESTOURnament.</p>';
$string['passwordprotectedquest'] = 'Módulo QUESTOURnament Protegido con Contraseña';
$string['perceivedTeacherDifficultyLevel'] = 'Estimación del facilitador de la dificultad';
$string['perceivedTeacherDifficultyLevel_help'] = 'Estimación del facilitador de la dificultad del desafío. Se usa para clasificar el desafío. Es un parámetro opcional con fines de investigación docente.';
...
$string['permitviewautors'] = 'Mostrar a los Participantes los Autores de los Desaf&iacute;os una vez cerrados';
...
$string['phase3answer'] = 'Evaluada por Facilitador';
...
$string['phase5answer'] = 'Evaluada Correct. por Facilitador';
...
$string['predictedDurationQuestion_help'] = 'Tiempo mínimo que el facilitador estima necesario para resolver el desafío. Se usa para clasificar el desafío. Es un parámetro opcional con fines de investigación docente.';
...
$string['seeassessment_help'] = '<P align="justify">Esta página muestra la evaluaci&oacute;n de una respuesta enviada, de esta forma, si no se est&aacute; de acuerdo con la misma se podr&aacute; reclamar al facilitador o al autor del desaf&iacute;o para que la revise, siendo posible indicar el motivo del desacuerdo con la evaluación realizada.
...
<P align="justify">Los facilitadores y autores de los desaf&iacute;os podr&aacute;n realizar una correcci&oacute;n manual de la calificaci&oacute;n otorgada para considerar aquellos aspectos que haya podido no tener en cuenta el formulario de evaluaci&oacute;n autom&aacute;tica. </P>';
$string['seeassessmentautor'] = 'Ver Evaluaci&oacute;n del Desaf&iacute;o';
$string['seeassessmentautor_help'] = '<P align="justify">Esta página muestra la evaluaci&oacute;n de un desafío propuesto, de esta forma, si no se est&aacute; de acuerdo con la misma se podr&aacute; reclamar al facilitador para que la revise, siendo posible indicar el motivo del desacuerdo con la evaluación realizada.
...
<P align="justify">Los facilitadores podr&aacute;n realizar una correcci&oacute;n manual de la calificaci&oacute;n asignada para cubrir aquellos aspectos que haya podido no tener en cuenta el formulario de evaluaci&oacute;n autom&aacute;tica. </P>';
...
$string['showresultssection'] = 'Información a mostrar a los participantes';
...
$string['studentsubmissionsforassessment'] = '{$a} Envíos de los participantes para valoración';
...
<P align="justify">Permite establecer la fecha en la que comenzará un desaf&iacute;o. Este par&aacute;metro s&oacute;lo es configurable por un facilitador.</P>
<P align="justify">Si el desafío lo crea un participante se toma como fecha de comienzo la fecha de creaci&oacute;n del desaf&iacute;o, pudiendo los facilitadores modificar este valor al aprobar el desaf&iacute;o o al realizar alguna modificaci&oacute;n sobre él.</P>
<P align="justify">A partir de esta fecha los alumnos podr&aacute;n visualizar el desaf&iacute;o y enviar sus respuestas. </P>
...
$string['teamporcent_help'] = '<P align="justify">Este par&aacute;metro establece el tanto por ciento de la clasificaci&oacute;n de los equipos que se a&ntilde;adir&aacute; a la clasificaci&oacute;n individual, que es la que determina la nota final de un participante en un m&oacute;dulo QUESTOURnament.</P>
<P align="justify">El porcentaje, establecido por este par&aacute;metro, de la puntuación obtenida por un equipo, se suma a la puntuación individual total de cada participante que pertenezca a dicho equipo. </P>
<P align="justify">El objetivo es premiar el trabajo en equipo de forma que &eacute;ste repercuta en la clasificaci&oacute;n final de cada participante. </P>';
...
<div align="justify">
  <ul>
    <li><strong>Equipo</strong>: nombre del equipo.</li>
      ...
      <li><strong>Punt. Desaf&iacute;os:</strong> engloba todas las puntuaciones obtenidas por los miembros del equipo correspondientes a la evaluaci&oacute;n, por parte de los facilitadores, de los desaf&iacute;os propuestos por dichos alumnos.</li>
...
$string['typegrade'] = 'Obtener Notas de Participantes o de Equipos';
...
<div align="justify">
  <ul>
    <li><strong>Participantes</strong>: la nota que se calcula para cada participante se obtiene a partir de la clasificaci&oacute;n individual. No obstante, si la opci&oacute;n de equipos est&aacute; habilitada la puntuaci&oacute;n del equipo de cada participante contribuir&aacute; a su clasificaci&oacute;n individual.</li>
      <li><strong>Equipos</strong>: para el c&aacute;lculo de las notas de cada participante &uacute;nicamente se emplea la clasificaci&oacute;n de los equipos. De esta forma, los alumnos que pertenezcan a un mismo equipo obtendr&aacute;n la misma nota. Para que esta posibilidad tenga sentido, deber&aacute; estar habilitada la opci&oacute;n de <a href="help.php?component=quest&identifier=allowteams"">Permitir Equipos</a>. </li>
  </ul>
</div>';
$string['typeindividual'] = 'Participantes';
...
$string['usepassword_help'] = '<p align="justify">Esta opción permite asociar una contraseña de acceso a este m&oacute;dulo QUESTOURnament. Proteger un módulo QUESTOURnament con contraseña puede resultar necesario, por ejemplo, cuando dicho m&oacute;dulo sea utilizado por varios grupos de participantes en un espacio y se proponga a cada grupo en un periodo de tiempo diferente, en este caso, la contraseña de acceso impedirá que un grupo de participantes pueda acceder al m&oacute;dulo QUESTOURnament una vez que éste haya sido abierto para otro grupo de participantes diferente, pero no para ellos aún.</p>';
$string['user'] = 'Usuario';
$string['validateassessment'] = 'Validar Evaluaciones';
$string['validateassessment_help'] = '<P align="justify">Si se habilita esta opción, el facilitador tendr&aacute; que validar todas las calificaciones otorgadas por los alumnos para que éstas tengan valor. Estas calificaciones se refieren a las realizadas por los alumnos autores de los desaf&iacute;os planteados a las respuestas enviadas por otros alumnos a dichos desaf&iacute;os. </P>
<P align="justify">Asimismo, la clasificaci&oacute;n de los alumnos no se modificar&aacute; hasta que el facilitador haya validado las calificaciones otorgadas por los alumnos. El facilitador podr&aacute; modificar el valor de dichas calificaciones, siendo la puntuación otorgada por el facilitador, en caso de que sea diferente a la otorgada por el participante autor del desafío, la que pase a formar parte de la nota final del participante evaluado. </P>
<P align="justify">Si esta opci&oacute;n no se habilita, el facilitador no tendr&aacute; la obligaci&oacute;n de validar todas las calificaciones otorgadas por participantes, aunque s&iacute; podr&iacute;a hacerlo si así lo deseara. Igualmente, si el facilitador modifica la calificación, será esta nueva puntuación la que pase a formar parte de la nota final del participante. Si por el contrario, el facilitador no realizase de nuevo la evaluaci&oacute;n de la respuesta, se utilizaría la puntuaci&oacute;n obtenida en la evaluaci&oacute;n realizada por el participante autor del desaf&iacute;o. </P>';
