...
/**
 * Strings for component 'theme_boost_campus', language 'es', version '3.9'.
 *
...
$string['brandinfocolorsetting_desc'] = 'Este color se usa, por ejemplo, para informar acerca de la disponibilidad de actividades o recursos del espacio.';
...
$string['catchkeyboardcommandsheadingsetting_desc'] = 'Las siguientes configuraciones están destinadas a satisfacer las necesidades de los usuarios avanzados, especialmente si su instancia de Moodle tiene un pie de página de gran tamaño. Es probable que los usuarios avanzados utilicen atajos de teclado para navegar por el sitio. Pueden usarlos para ir al final de la página con la intención de llegar rápidamente al tema más reciente del espacio (para agregar contenido o calificar actividades más recientes). Si el pie de página no es muy pequeño, tendrían que desplazarse hacia arriba nuevamente. Con estos ajustes, puede habilitar que se capturen los siguientes accesos directos y que solo se desplacen al final del contenido del espacio principal.';
$string['catchkeys_desc_addition'] = 'evite el desplazamiento predeterminado hacia la parte inferior de la página y cambia el comportamiento para desplazarse solo hasta el final del contenido del espacio principal.';
...
$string['coursehintsheadingsetting'] = 'Sugerencias relacionadas con el espacio.';
$string['courselayoutsettings'] = 'Configuración de diseño del espacio';
$string['coursesettingsheadingsetting'] = 'Configuración del espacio';
...
$string['dashboardontopsetting_desc'] = 'Al marcar esta configuración, el elemento del menú del Panel de Control siempre estará ubicado en la parte superior del cajón de navegación. Por defecto, esto es así en todas las páginas de Moodle, excepto en las de los espacios. Allí, el espacio actual y sus contenidos se colocan en la parte superior. Esto podría confundir las expectativas del usuario sobre la ubicación del enlace de página de inicio predeterminado.';
$string['defaulthomepageontopsetting'] = 'Página de inicio predeterminada en la parte superior';
$string['defaulthomepageontopsetting_desc'] = 'Al marcar esta configuración, el enlace de la página de inicio predeterminada (Panel de control o Sitio de inicio) siempre se ubicará en la parte superior del panel de navegación. Por defecto, esto es así en todas las páginas de Moodle, excepto en las páginas de los espacios. Allí, el espacio actual y sus contenidos se colocan en la parte superior. Esto podría confundir las expectativas del usuario sobre la ubicación del enlace de página de inicio predeterminado.';
...
$string['section0titlesetting_desc'] = 'Esta configuración puede cambiar el modo en que Moodle muestra el título de la primera sección del espacio. Moodle no lo muestra mientras se establezca el título predeterminado para esta sección. Tan pronto como un usuario cambie el título, aparecerá. Con esta configuración (si la opción está marcada), puede lograr un comportamiento consistente en mostrar siempre el título para la sección 0.';
$string['showhintcourseguestaccessgeneral'] = 'Estás viendo este espacio como <strong>{$a->role}</ strong>.';
$string['showhintcourseguestaccesslink'] = 'Para tener acceso completo al espacio, puede <a href="{$a->url} "> autoinscribirse en este espacio </a>.';
$string['showhintcourseguestaccesssetting_desc'] = 'Con esta configuración aparecerá una sugerencia en el encabezado del espacio cuando un usuario esté accediendo como invitado. Si el espacio proporciona una autoinscripción activa, también se le presenta un enlace a esa página.';
$string['showhintcoursehiddengeneral'] = 'Este espacio está actualmente <strong>oculto</ strong>. Solo los facilitadores inscritos pueden acceder a un espacio si está oculto.';
$string['showhintcoursehiddensetting'] = 'Mostrar advertencia en espacios ocultos';
$string['showhintcoursehiddensetting_desc'] = 'Con esta configuración aparecerá una advertencia en el encabezado del espacio siempre que la visibilidad del espacio esté oculta. Esto ayuda a identificar el estado de visibilidad de un espacio de un vistazo sin la necesidad de mirar en la configuración del espacio.';
$string['showhintcoursehiddensettingslink'] = 'Puede cambiar la visibilidad en la <a href="{$a->url}">configuración del espacio</a>.';
$string['showhintcoursguestaccesssetting'] = 'Mostrar advertencia para el acceso de invitados';
$string['showsettingsincoursesetting'] = 'En el menú de configuración del espacio';
$string['showsettingsincoursesetting_desc'] = 'Con esta configuración puede cambiar la visualización de los menús contextuales. En Boost, hay un menú contextual emergente al lado del icono del engranaje. Al habilitar esta opción, la configuración se realizará directamente debajo del encabezado del espacio. Los ajustes están organizados en pestañas, por lo que es más fácil para el usuario obtener la configuración deseada en lugar de escanear una larga lista de elementos del menú. Con esta configuración, también ocultamos el icono de configuración en la página de participantes ya que las entradas en esta página están duplicadas con el menú del espacio y, por lo tanto, no son necesarias. <br/>Tenga en cuenta que este cambio no afecta a los usuarios que han desactivado javascript en sus navegadores, que seguirán obteniendo el comportamiento desde el núcleo de Moodle con un menú contextual de espacio emergente.';
$string['showswitchedroleincoursesetting'] = 'Posición de la información del cambio de rol';
$string['showswitchedroleincoursesetting_desc'] = 'Con esta configuración puede elegir el lugar donde se muestra la información para cambiar el rol que un usuario ha modificado. Si no se verifica (valor predeterminado), la información del rol se mostrará justo debajo del nombre del usuario en el menú del usuario (como en el tema Boost). Si está marcado, esta información, junto con un enlace para volver, se mostrará debajo del espacio, puesto que esta funcionalidad está relacionada con el espacio.';
$string['sitehomeontopsetting'] = 'Menú de inicio del sitio en la parte superior';
$string['sitehomeontopsetting_desc'] = 'Al marcar esta configuración el elemento del menú de inicio del sitio siempre estará ubicado en la parte superior del panel de navegación. Por defecto, así es en todas las páginas de Moodle, excepto en las páginas de los espacios. En ese caso, el espacio actual y sus contenidos se colocan en la parte superior. Esto podría confundir las expectativas del usuario sobre la ubicación del enlace de página de inicio predeterminado.';
$string['switchedroleto'] = 'Usted está viendo este espacio actualmente como:';
...
$string['userdefinedontopsetting_desc'] = 'Al marcar esta configuración el elemento del menú principal del Panel de Control o del Sitio (depende de las preferencias del usuario) siempre estará ubicado en la parte superior del panel de navegación. Por defecto, así es en todas las páginas de Moodle, excepto en las páginas de los espacios. En ese caso, el espacio actual y sus contenidos se colocan en la parte superior. Esto podría confundir las expectativas del usuario sobre la ubicación del enlace predeterminado de la página de inicio.';
