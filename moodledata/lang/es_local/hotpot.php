...
/**
 * Strings for component 'hotpot', language 'es', version '3.9'.
 *
 * @package     hotpot
 * @category    string
...
** No **
: sólo una pregunta se añadirá al espacio

** Sí **
: si el archivo de origen es un "archivo de preguntas", se tratará como el inicio de un listado de preguntas y todas las preguntas del listado se añadirán al espacio con la misma configuración. Cada pregunta del listado debe tener un enlace al archivo siguiente en la cadena.

Si el archivo de origen es una "carpeta", todas las preguntas reconocibles en la carpeta se agregarán al espacio para formar un listado de preguntas con las mismas configuraciones.

Si el archivo de origen es un "archivo único", como un archivo Masher de HotPot o un archivo index.html las preguntas listadas en el archivo único  se añadirán al espacio como un listado de preguntas con las mismas configuraciones.';
$string['allowpaste'] = 'Permitir pegar';
$string['allowpaste_help'] = 'Si esta opción está activada, los participantes podrán copiar, pegar y arrastrar el texto en los cuadros de texto.';
$string['allowreview'] = 'Permitir revisión';
$string['allowreview_help'] = 'Si se activa, los participantes podrán revisar sus intentos después de que el cuestionario esté cerrado.';
$string['analysisreport'] = 'Análisis del Elemento';
$string['attempted'] = 'Intentado';
$string['attemptlimit'] = 'Límite de intentos';
$string['attemptlimit_help'] = 'Número máximo de intentos que un participante dispone en esta actividad HotPot';
...
$string['clickreporting_help'] = 'Si se habilita, un registro independiente se guarda cada vez que un botón de opción se pulsa. Esta opción permite que al facilitador vea un informe muy detallado que muestra el estado de las preguntas en cada clic. Si no se habilita, solo se guarda un registro por intento en cada pregunta.';
...
$string['configenablecache'] = 'Mantener el caché de HotPot puede aumentar en gran manera la velocidad de entrega de las preguntas a los participantes.';
...
$string['configmaxeventlength'] = 'Si un HotPot tiene especificadas una hora de apertura y otra de cierre, y la diferencia entre las dos es mayor que el número de días especificado aquí, entonces se añadirán dos eventos diferentes al calendario del espacio. Para periodos de tiempo inferiores, o cuando sólo se especifica una de las horas, se añadirá solo un evento al calendario. Si no se especifica ninguna hora, no se añadirá ningún evento al calendario.';
...
$string['delay3_help'] = 'El ajuste especifica el retardo entre el cierre de la prueba y la vuelta del control a la pantalla de Moodle.
...
**Esperar hasta que el participante haga clic en Aceptar**:
: el control será devuelto a Moodle después que el participante haga  clic en el botón Aceptar en el mensaje de cierre de la prueba.

**No continuar automáticamente**
: el control no será devuelto a Moodle después de que la prueba haya terminado. El participante tendrá la libertad de navegar fuera de la página del cuestionario.
...
$string['delay3afterok'] = 'Esperar hasta que el participante haga clic en Aceptar';
...
El facilitador puede seleccionar una actividad específica, o uno de los parámetros de propósito general siguientes:

* Actividad previa en el espacio
* Actividad previa en esta sección
* HotPot previo en este espacio
* HotPot previo en esta sección';
$string['entrycmcourse'] = 'Actividad previa en este espacio';
$string['entrycmsection'] = 'Actividad previa en esta sección del espacio';
...
$string['entryhotpotcourse'] = 'HotPot previo en este espacio';
$string['entryhotpotsection'] = 'HotPot previo en esta sección del espacio';
...
$string['entrypage_help'] = '¿Se mostrará a los participantes una página inicial antes de comenzar la actividad HotPot?
**Sí**
:los participantes verán una página de entrada antes de iniciar el HotPot. El contenido de la página de entrada se determina en las opciones de la página de entrada de HotPot.

**No**
:los participantes no verán una página de entrada, y se iniciará el HotPot  de inmediato.

Una página de entrada se mostrará siempre al facilitador con el fin de facilitar el acceso a los informes y editar las páginas de preguntas.';
...
$string['exit_course'] = 'Espacio';
$string['exit_course_text'] = 'Volver a la página principal del espacio';
...
$string['exit_grades_text'] = 'Mire sus calificaciones hasta el momento en este espacio';
...
**Espacio**
: si se activa, se mostrará un enlace a la página del espacios Moodle.
...
El facilitador puede seleccionar una actividad específica, o una de las siguientes acciones de propósito general:

* Siguiente actividad en este espacios
* Siguiente actividad en esta sección
* Siguiente HotPot en  este espacio
* Siguiente HotPot en esta sección

Si las demás opciones de la página de salida están deshabilitadas, el participante irá directamente a la siguiente actividad. De lo contrario, el participante verá un enlace que lo llevara a la siguiente actividad cuando esté listo.';
$string['exitcmcourse'] = 'Actividad siguiente en este espacio';
$string['exitcmsection'] = 'Actividad siguiente en esta sección del espacio';
$string['exitgrade'] = 'Calificación de la siguiente actividad';
$string['exithotpotcourse'] = 'Siguiente HotPot en este espacio';
$string['exithotpotsection'] = 'Siguiente HotPot en esta sección del espacio';
...
**No**:
no se mostrara a los participantes página de salida. En su lugar, podrán ir a la siguiente actividad o volver a la página del espacio de Moodle.';
...
$string['feedbacksendmessage'] = 'Evíe un mensaje a su facilitador';
...
$string['modulename_help'] = 'El módulo HotPot le permite a los facilitadores distribuir materiales de aprendizaje interactivos a sus participantes vía Moodle y ver reportes sobre las respuestas y resultados de sus participantes.

Una actividad única de HotPot consiste de una página opcional de entrada, un único ejercicio \'elearning\' y una página opcional de salida. El ejercicio de elearning puede ser una página web estática o una página web interactiva que les ofrece a los participantes texto, audio, y estímulos visuales y graba sus respuestas. El ejercicio de elearning se crea en la computadora del maestro empleando programas de autoría y después se sube a Moodle.
...
$string['nameadd_help'] = 'El nombre puede ser un texto específico introducido por el facilitador o puede ser generado de forma automática.
...
$string['nameedit_help'] = 'Texto que se muestra a los participantes';
...
**Nada**
: se mostrará el cuestionario sin ayudas de navegación, de manera que cuando todas las preguntas hayan sido respondidas correctamente, dependiendo del parámetro "¿Mostrar la siguiente pregunta?", Moodle volverá a la página del espacio o mostrará el siguiente cuestionario.';
...
$string['outputformat_help'] = 'El formato de salida especifica cómo se presentará el contenido al participante.
...
"El mejor posible" mostrará el contenido usando el formato de salida más óptimo según el navegador del participante.';
...
$string['sourcefile_help'] = 'Este parámetro especifica el archivo que contiene el contenido que se mostrará a los participantes.

Por lo general, el archivo de origen se ha creado fuera de Moodle, y luego se  ha subido a la zona de archivos de un espacio de Moodle.
...
El archivo de origen puede ser especificado como una ruta de archivo en una carpeta en la zona de archivos del espacio Moodle, o puede serlo con una URL que comienza con http:// o https://
...
Si el participante hace clic en el botón de parada, el resultado obtenido hasta el momento se enviará a Moodle y el estado del intento de pregunta se establecerá en Abandonada.';
...
$string['studentfeedback'] = 'Retroalimentación participante';
$string['studentfeedback_help'] = 'Si está activado, un enlace a una ventana de información emergente se mostrará cada vez que el participante hace clic en el botón "Comprobar". La ventana de retroalimentación permite a los participantes discutir sobre este cuestionario con su facilitador y suscompañeros de clase, según una de las siguientes maneras:
...
**Foro de Moodle**
: se mostrará el índice de foros del espacio

**Mensaje Moodle**
: se mostrará la ventana de mensajería instantánea de Moodle. Si el espacios tiene varios facilitadores, el participante podrá elegir un facilitador antes de que se visualize la ventana de mensajes.';
