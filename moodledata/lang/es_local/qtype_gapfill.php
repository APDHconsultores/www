...
/**
 * Strings for component 'qtype_gapfill', language 'es', version '3.9'.
 *
...
$string['coursenotfound'] = 'Espacio no encontrado, revise el nombre corto del espacio';
$string['courseshortname'] = 'Nombre corto del Espacio';
$string['courseshortname_help'] = 'Introduzca el nombre corto del espacio al que se le importarán preguntas. Esto hace una importación estándar de preguntas XML desde el archivo example_questions.xml en la carpeta del tipo de pregunta gapfill.';
...
$string['noduplicates_help'] = 'Cuando está seleccionado, cada respuesta debe ser única. Es práctico cuando cada campo tiene un operador | , por ejemplo:  “¿Cuáles son los colores de la medallas olímpicas?” y cada campo tiene [oro|plata|bronce], si un participante escribe oro en cada campo solamente el primero obtendrá una nota (aunque los otros también obtendrán un visto). Es usado más bien para descartar las respuestas duplicadas al calificar';
