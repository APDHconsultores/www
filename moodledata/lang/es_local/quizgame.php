...
/**
 * Strings for component 'quizgame', language 'es', version '3.9'.
 *
 * @package     quizgame
 * @category    string
...
$string['modulename_help'] = '¿Sus participantes son propensos a procastinar? ¿Están jugando juegos en lugar de estudiar? ¡Bueno, ahora los puede motivar al permitirles hacer ambas cosas a la vez!

Quizventure es un módulo de actividad que carga preguntas de cuestionario desde el espacio al que se agrega. Las respuestas posibles vienen bajando como naves espaciales y el participante tiene que dispararle a la respuesta correcta.

**Nota**: Quizventure está diseñado para promover el aprendizaje en lugar de la evaluación. Los participantes tendrán intentos infinitos con retroalimentación inmediata. Por esta razón, añada solamente las preguntas para las que desea que los participantes se aprendan las respuestas, en lugar de añadir las preguntas que quiere emplear para evaluar si han aprendido.';
