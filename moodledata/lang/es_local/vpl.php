...
/**
 * Strings for component 'vpl', language 'es', version '3.9'.
 *
 * @package     vpl
 * @category    string
...
$string['discard_submission_period_description'] = 'Para cada participante y tarea, se intenta descartar entregas manteniendo la última y al menos una por cada periodo';
...
<li>VPL_FILEBASEURL: URL para acceder a los ficheros del espacio.</li>
<li>VPL_SUBFILE#: cada nombre de los ficheros entregados por el participante. # va de 0 a número de ficheros entregados.</li>
...
<ul>
	...
	<Li>VPL_FILEBASEURL: URL a ficheros del espacio.</Li>
...
<li><b>Ejecutar, Depurar y Evaluar</b>: establecen si se puede usar la opción correspondiente durante la edición de la entrega. Esto sólo afecta a los participantes, los usuarios con capacidad de calificación pueden usar estas opciones en cualquier caso.</li>
...
<b>NE</b> Número de evaluaciones automáticas solicitadas por el participante.<br>
...
$string['reductionbyevaluation_help'] = 'Reducir puntuación final por un valor o porcentaje para cada evaluación automática solicitada por el participante';
...
$string['usewatermarks_description'] = 'Añade marcas de agua a los ficheros de los participantes (sólo en lenguajes soportados)';
$string['variation'] = 'Variación {$a}';
$string['variation_options'] = 'Opciones de variación';
$string['variations'] = 'Variaciones';
$string['variations_help'] = '<p>Se pueden definir variaciones para las actividades. Las variaciones se asignan de forma aleatoria a los participantes.</p>
...
variación asignada al participante a los scripts. La descripción, con formato HTML, se muestra a los participantes a los que ha sido asignada la variación
correspondiente.</p>';
