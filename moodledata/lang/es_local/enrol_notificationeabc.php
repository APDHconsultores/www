...
/**
 * Strings for component 'enrol_notificationeabc', language 'es', version '3.9'.
 *
...
$string['activarglobal_help'] = 'Activa la notificación de matriculación para todo los espacios';
...
$string['fecha'] = 'Periodo para realizar la verificación de usuarios que se matricularon a espacios';
$string['fecha_help'] = 'Coloque el periodo por el cual desea que se realice la verificación inicial de usuarios matriculados';
$string['filelockedmail'] = 'Usted ha sido matriculado en el espacio {$a->fullname} ({$a->url})';
...
<pre>
{COURSENAME} = Nombre completo del espacio
...
$string['pluginname_desc'] = 'Notificación de matriculaciones a espacios vía mail';
...
$string['unenrolmessagedefault'] = 'Usted ha sido desmatriculado del espacio {$a->fullname} ({$a->url})';
...
$string['updatedenrolmessagedefault'] = 'Su matriculación en el espacio {$a->fullname} ha sido actualizada ({$a->url})';
