...
/**
 * Strings for component 'attendance', language 'es', version '3.9'.
 *
 * @package     attendance
 * @category    string
...
$string['all'] = 'Todas';
$string['allcourses'] = 'Todos los espacios';
...
$string['attendance:viewsummaryreports'] = 'Ver informes de resumen de espacios';
...
$string['attendanceforthecourse'] = 'Asistencia para el Espacio/Asignatura';
$string['attendancegrade'] = 'Puntuación Asistencia';
$string['attendancenotset'] = 'Debe indicar su asistencia';
$string['attendancenotstarted'] = 'La asistencia todavía no ha sido iniciada para este espacio';
...
$string['autoassignstatus_help'] = 'Si se selecciona esta opción, a los participantes se les asignará automáticamente la calificación más alta disponible.';
$string['automark'] = 'Marcado automático';
$string['automark_help'] = 'Permite que el marcado se complete automáticamente.
Si la respuesta es "Sí", los alumnos se marcarán automáticamente en función de su primer acceso al espacio.
Si la respuesta es "Establecer sin marcar al final de la sesión", a los participantes que no hayan marcado su asistencia se les asignará el estado de no seleccionado.';
...
$string['categoryreport'] = 'Informe de la categoría del espacio';
...
$string['confirmdeletehiddensessions'] = '¿Está seguro de que quiere eliminar {$a->count} sesiones programadas antes de la fecha de inicio del espacio ({$a->date})?';
...
$string['coursemessage'] = 'Mensaje de los usuarios del espacio';
$string['courseshortname'] = 'Nombre corto del espacio';
$string['coursesummary'] = 'Informe del resumen del espacio';
...
$string['createmultiplesessions_help'] = 'Esta función permite crear sesiones múltiples en un sólo paso.
  ...
  * <strong>Fecha de inicio de sesión</strong>: Seleccione la fecha de inicio de su espacio (el primer día de clases)
  * <strong>Fecha de cierre de sesión</strong>: Seleccione el último día de clases (el último día en el que quiera tomar asistencia).
...
$string['createonesession'] = 'Crear una sesión para el espacio';
...
$string['defaultview_desc'] = 'Vista predeterminada mostrada a los facilitadores en el primer acceso.';
...
$string['deletingsession'] = 'Eliminando Sesión para el Espacio/Asignatura';
$string['deletingstatus'] = 'Eliminando estado del espacio';
...
$string['emailcontent_help'] = 'Cuando un aviso es remitido al participante, se recoge el contenido de este campo. Se pueden usar las siguientes variables:
<ul>
<li>%coursename%</li>
<li>%userfirstname%</li>
<li>%userlastname%</li>
...
$string['emailuser_help'] = 'Si está activado, se enviará un aviso al participante.';
...
$string['error:coursehasnoattendance'] = 'El espacio con el nombre corto {$a} no contiene actividades de Asistencia.';
$string['error:coursenotfound'] = 'No se encuentra ningún espacio con el nombre corto {$a}.';
...
$string['hiddensessions_help'] = 'Las sesiones se ocultan si la fecha de inicio de los espacios es posterior a su fecha. Cambie la fecha de inicio del espacio y las sesiones ocultas se mostrarán.
...
$string['identifyby'] = 'Identificar participantes por';
...
$string['invalidsessionenddate'] = 'La fecha de cierre no puede ser anterior a la fecha de inicio';
$string['invalidsessionendtime'] = 'La hora de cierre debe ser mayor que la hora de comienzo';
...
$string['modulename_help'] = 'El módulo de actividad de asistencia permite a un facilitador tomar asistencia en clase y a los participantes ver su propio registro de asistencia.

El facilitador puede crear múltiples sesiones y marcar el estado de asistencia como "Presente", "Ausente", "Retraso", o "Falta Justificada", o modificar dichos estados para que se ajusten a sus necesidades.

Los reportes están disponibles para toda la clase o individualmente por participante.';
...
$string['noattendanceusers'] = 'No es posible exportar ningún dato si no hay participantes matriculados en el espacio.';
...
$string['nogroups'] = 'No puede incluir sesiones grupales. No existen grupos en este espacio.';
...
$string['nosessionexists'] = 'No existen sesiones para este espacio';
$string['nosessionsselected'] = 'No hay sesiones seleccionadas.';
$string['notfound'] = 'No se ha encontrado ninguna actividad de Asistencia en este espacio';
...
$string['preventsharederror'] = 'El registro automático se ha desactivado durante una sesión porque parece que este dispositivo se ha utilizado para registrar la asistencia de otro participante';
$string['preventsharedip'] = 'Evitar que los participantes compartan la dirección IP';
$string['preventsharedip_help'] = 'Evitar que los participantes usen el mismo dispositivo (identificado con la dirección IP) para registrar la asistencia de otros participantes.';
...
$string['priorto'] = 'La fecha de la sesión es anterior a la fecha de inicio del espacio ({$ a}) para que las nuevas sesiones programadas antes de esta fecha se oculten (no accesibles). Puede cambiar la fecha de inicio del espacio en cualquier momento (consulte la configuración del espacio) para tener acceso a las sesiones anteriores. <br> <br> Por favor cambie la fecha de la sesión o simplemente haga clic en el botón "Añadir sesión" de nuevo para confirmar.';
...
$string['requiresubnet'] = 'Los participantes sólo pueden registrar la asistencia propia desde estos ordenadores.';
...
$string['resetdescription'] = 'Recuerde que eliminando los datos de la asistencia provocará el borrado de información en la base de datos. Usted puede ocultar sesiones anteriores cambiando la fecha de inicio del espacio en la zona de administración.';
...
$string['resultsperpage_desc'] = 'Número de participantes mostrados por página';
...
$string['studentid'] = 'ID de participante';
$string['studentmarked'] = 'Tu asistencia en esta sesión ha sido guardada.';
$string['studentmarking'] = 'Grabación del participante';
$string['studentpassword'] = 'Contraseña del participante';
$string['studentrecordingexpanded'] = 'Grabación del participante expandida';
$string['studentrecordingexpanded_desc'] = 'Mostrar las configuraciones de "Grabación del participante" como expandidas por defecto al crear sesiones nuevas.';
$string['studentscanmark'] = 'Permitir a los participantes registrar su propia asistencia';
$string['studentscanmark_desc'] = 'Si se marca, los facilitadores podrán permitir que los participantes marquen su propia asistencia.';
$string['studentscanmark_help'] = 'Si se marca, los participantes podrán registrar su propia asistencia a la sesión.';
...
$string['time'] = 'Tiempo';
$string['timeahead'] = 'No se pueden crear sesiones múltiples que superen un año. Ajuste las fechas de inicio y cierre.';
$string['to'] = 'a:';
