...
$string['already_enabled'] = 'Ya tiene un sistema de reservas en este espacio.';
...
$string['no_rem_labs'] = 'No hay laboratorios remotos en este espacio';
