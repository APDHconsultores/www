...
/**
 * Strings for component 'block_coursefeedback', language 'es', version '3.9'.
 *
...
$string['adminpage_html_activefeedbackb'] = 'Elija un cuestionario. Este se proporcionará para la evaluación en el bloque "Retroalimentación del espacio". <br /> Puedes cambiar las preguntas disponibles en "editar/crear cuestionario".';
$string['adminpage_html_allowhidinga'] = 'Permitir Ocultar';
$string['adminpage_html_allowhidingb'] = 'Si está habilitado, los facilitadores pueden editar la visibilidad del bloque.';
...
$string['adminpage_html_setstickyb'] = 'Si está habilitada, una instancia de este bloque, que no puede ser borrada por los facilitadores, aparece en la página principal de cada espacio.';
$string['adminpage_link_feedbackedit'] = 'editar/crear encuesta';
$string['caution'] = 'Advertencia';
$string['copyof'] = 'Copia de "{$a}"';
$string['coursefeedback:addinstance'] = 'Añadir este bloque al sitio del espacio';
$string['coursefeedback:download'] = 'Guardar el resultado de la retroalimentación del espacio actual en un archivo';
$string['coursefeedback:evaluate'] = 'Evaluar la retroalimentación del espacio actual';
$string['coursefeedback:managefeedbacks'] = 'Editar la configuración global del bloque de retroalimentación del espacio';
...
$string['coursefeedback:viewanswers'] = 'Vea el análisis de la retroalimentación actual del espacio';
$string['download_html_filename'] = 'Resultados';
$string['download_thead_questions'] = 'Pregunta';
$string['eventevaluated'] = 'Espacio evaluado';
...
$string['page_headline_admin'] = 'Administración de la retroalimentación del espacio';
$string['page_headline_listoffeedbacks'] = 'Lista de encuestas';
$string['page_headline_listofquestions'] = 'Cuestionario de \'{$a}\\';
$string['page_html_activated'] = 'La retroalimentación del espacio ({$ a}) se ha registrado como la encuesta actual.';
$string['page_html_answersdeleted'] = 'Las respuestas del usuario han sido eliminadas.';
$string['page_html_courserating'] = 'Calificación del espacio';
