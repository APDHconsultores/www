...
/**
 * Strings for component 'block_sharing_cart', language 'es', version '3.9'.
 *
...
$string['confirm_backup_section'] = '¿Desea copiar esta sección del espacio y sus actividades / recursos en carrito para compartir?';
...
$string['confirm_restore'] = '¿Quiere copiar este item al espacio?';
...
$string['restore'] = 'Copiar al espacio';
...
<dt>Copiando del espacio a Bolsa de Recursos</dt>
<dd>Aparecerá un pequeño icono de copia de Bolsa de Recurso al final de cada
recurso o actividad dentro de un espacio.
...
<dt>Copiando desde Bolsa de Recursos al espacio</dt>
<dd>Clique el icono de "copiar a un espacio" y seleccione el destino de cada sección.
