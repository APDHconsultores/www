...
/**
 * Strings for component 'accredible', language 'es', version '3.9'.
 *
 * @package     accredible
 * @category    string
...
$string['activitydescription'] = 'Este módulo crea y actualiza automáticamente Credential Group en Accredible. Cualquier certificado e insignia emitidos en este grupo y su apariencia e información pueden ser actualizados en <a href="https://www.accredible.com/issuer/dashboard" target="_blank">el Área Personal</a>.';
$string['activityname'] = 'Nombre de actividad';
$string['additionalactivitiesone'] = 'Atención: Estás añadiendo más de una actividad a un espacio.<br/>Todas las  actividades son visibles para los alumnos, así que asegúrate de darles diferentes nombres.';
...
$string['completionissuecheckbox'] = 'Sí, emitir una vez completado el espacio';
$string['completionissueheader'] = 'Criterios de emisión automática: por cierre del espacio';
$string['dashboardlink'] = 'Enlace al Área Personal de Accredible';
$string['dashboardlinktext'] = 'Para borrar o diseñar credenciales, acceda al <a href="https://accredible.com/issuer/login" target="_blank">panel de control</a>';
$string['datecreated'] = 'Fecha de creación';
$string['description'] = 'Descripción';
$string['eventcertificatecreated'] = 'Se ha enviado una credencial a Accredible.';
$string['gotodashboard'] = 'Para actualizar la apariencia de sus credenciales y certificados, visite  <a href="https://www.accredible.com/issuer/dashboard" target="_blank">https://www.accredible.com/issuer/dashboard</a>';
...
$string['modulename_help'] = 'El módulo de actividad certificado e insignia Accredible le permite emitir los certificados o insignias del espacio a los participantes en accredible.com.

Añadir la actividad donde desea que sus participantes vean su certificado o insignia.';
...
$string['passinggrade'] = 'Porcentaje necesario para pasar el espacio (%)';
...
$string['unissueddescription'] = 'Estos participantes cumplen los requisitos para este certificado pero los certificados no han sido emitidos. Seleccione aquellos para quienes desea emitir certificado.';
...
$string['viewimgincomplete'] = 'Espacio todavía en desarrollo';
$string['viewsubheader'] = 'Identificador de logro: {$a}';
