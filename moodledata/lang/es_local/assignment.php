...
/**
 * Strings for component 'assignment', language 'es', version '3.9'.
 *
 * @package     assignment
 * @category    string
...
$string['privacy:metadata:assignment_submissions:teacher'] = 'El ID de usuario del facilitador que califica el envío de la tarea.';
