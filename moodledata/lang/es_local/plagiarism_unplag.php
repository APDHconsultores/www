...
/**
 * Strings for component 'plagiarism_unplag', language 'es', version '3.9'.
 *
...
$string['explainerrors'] = 'Esta página muestra todos los archivos que se encuentran en estado de error. <br/> Cuando los archivos son eliminados en esta página, no podrán ser reenviados para comprobarlos y los errores no se mostrarán a los facilitadores o participantes';
$string['file'] = 'Archivo';
...
$string['studentdisclosure'] = 'Notificar al participante sobre la Política de Privacidad de UNPLAG';
$string['studentdisclosure_help'] = 'Este texto se mostrará a todos los participantes en la página de carga del archivo.';
...
$string['submitonfinal'] = 'Comprobar el archivo cuando el participante lo envía para evaluación';
...
$string['unplag:enable'] = 'Permitir a los facilitadores activar/desactivar UNPLAG dentro de una actividad';
$string['unplag:resetfile'] = 'Permitir al facilitador volver a comprobar un archivo con UNPLAG después de producirse un error';
$string['unplag:vieweditreport'] = 'Permitir al Facilitador ver y modificar el informe completo de Unplag';
$string['unplag:viewreport'] = 'Permitir al facilitador ver el informe completo de UNPLAG';
...
$string['unplag_show_student_report'] = 'Mostrar el informe de similitud al participante';
...
$string['unplag_show_student_score'] = 'Mostrar grado de similitud al participante';
...
$string['unplag_studentemail'] = 'Enviar un mensaje al participante';
$string['unplag_studentemail_help'] = 'Se le enviará un correo electrónico al participante cuando se haya procesado su archivo para hacerle saber que su informe está disponible.';
...
$string['use_unplag_help'] = 'Para utilizar el plugin de Unplag, active la opción "Requerir que los participantes hagan clic en Entregar", poniendo Sí (Configuración de entrega)';
$string['useunplag_assign_desc_param'] = 'Para desbloquear los ajustes de Unplag';
$string['useunplag_assign_desc_value'] = 'Establecer ajustes de entrega →  Requerir que los participantes hagan clic en Entregar = Sí';
