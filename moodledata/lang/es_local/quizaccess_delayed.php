...
/**
 * Strings for component 'quizaccess_delayed', language 'es', version '3.9'.
 *
...
Se activa un contador de tiempo con un plazo aleatorio para cada participante (hasta un tiempo configurado por su institución). Solo cuando ese plazo termina el participante puede usar el botón de comienzo del cuestionario.';
...
$string['quizaccess_delayed_allowdisable'] = 'A los facilitadores se les permite desactivar la regla';
...
$string['quizaccess_delayed_notice'] = 'Aviso para los participantes';
$string['quizaccess_delayed_startrate'] = 'Tasa de entrada (alumnos por minuto)';
$string['quizaccess_delayed_teachernotice'] = 'Este cuestionario aplicará un control de entrada gradual, que hará que los participantes entren aleatoriamente hasta con {$a} minutos de retardo.';
