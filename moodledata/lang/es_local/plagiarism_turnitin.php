...
/**
 * Strings for component 'plagiarism_turnitin', language 'es', version '3.9'.
 *
...
$string['because'] = 'Esto fue causado porque el administrador borró un ejercicio que estaba en la cola de procesamiento e interrumpió su envío a Turnitin. <br /><strong>El fichero aun existe en Moodle, por favor contacte con su facilitador.</strong><br />Por favor, compruebe los códigos de error de abajo:';
...
$string['configureerror'] = 'Debe configurar este módulo totalmente antes de usarlo en un espacio. Por favor, contacte con el administrador de Moodle.';
$string['connecttesterror'] = 'Hubo un error conectando  Turnitin. El mensaje es el siguente: <br />';
$string['course'] = 'Espacio';
$string['coursegeterror'] = 'No se pudo obtener información del espacio';
$string['cronsubmittedsuccessfully'] = 'Envío: {$a->title} (TII ID: {$a->submissionid}) del ejercicio {$a->assignmentname} en el espacio {$a->coursename} se envió correctamente a Turnitin.';
...
$string['erater_handbook_learners'] = 'Participantes Ingleses';
...
$string['otherrubric'] = 'Usar rúbricas de otro facilitador';
...
$string['student_notread'] = 'El participante no ha visto este trabajo.';
$string['student_read'] = 'El participante ha visto este trabajo el:';
$string['studentreports'] = 'Mostrar los Informes de originalidad a los participantes';
$string['studentreports_help'] = 'Permite mostrar los Informes de Originalidad Turnitin a los participantes usuarios. Si está configurado a Sí, el Informe de Originalidad generado por Turnitin estará disponible para ser visto por el participante.';
$string['submitondraft'] = 'Entregar el archivo en cuanto esté cargado';
$string['submitonfinal'] = 'Entregar el archivo cuando el participantes lo envia para su corrección';
$string['submitpapersto'] = 'Almacenar Trabajos de Participantes';
$string['submitpapersto_help'] = 'Esta opción les proporciona a los facilitadores la alternativa de decidir si los trabajos deben guardarse en un depósito de trabajos de participantes de Turnitin. El beneficio de entregar trabajos al depósito de trabajos de participantes es que los trabajos que se entreguen al ejercicio se compararán con las entregas de otros participantes dentro de tus clases, antiguas y actuales. Si seleccionas &#34;sin depósito&#34;, los trabajos de tus participantes no se guardarán en el depósito de trabajos de participantes de Turnitin.';
