...
/**
 * Strings for component 'resource', language 'es', version '3.9'.
 *
 * @package     resource
 * @category    string
...
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en un recurso Archivo.';
$string['indicator:socialbreadth'] = 'Archivo social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en un recurso Archivo.';
$string['legacyfiles'] = 'Migración de archivo antiguo de espacio';
...
$string['modulename_help'] = 'El módulo Archivo permite a los facilitadores proveer un Archivo como un recurso del espacio. Cuando sea posible, el archivo se mostrará dentro del interface del espacio; si no es el caso, se le preguntará a los participantes si quieren descargarlo. El recurso Archivo puede incluir archivos de soporte, por ejemplo, una página HTML puede tener incrustadas imágenes u objetos Flash.

Observe que los participantes necesitan tener el software apropiado en sus odenadores personales para poder abrir los archivos.

Un Archivo puede utilizarse para

* Compartir presentaciones utilizadas en clase
* Incluire una mini-web como recurso del espacio
* Proveer a los participantes de borradores de archivos para que los editen y los envíen en sus tareas';
...
$string['showdate_desc'] = '¿Mostrar la fecha de subida/modificación en la página del espacio?';
...
$string['showsize_desc'] = '¿Mostrar el tamaño del archio en la página del espacio?';
...
$string['showtype_desc'] = '¿Mostrar tipo de archivo (ej. \'Documento de Texto\') en la página del espacio?';
