...
$string['allowunenrol'] = 'Permitir a los datos IMS <strong>dar de baja</strong> a participantes/facilitadores';
$string['allowunenrol_desc'] = 'Si está activado, las matriculaciones en espacios serán eliminadas cuando así se especifique en los datos de empresa.';
$string['basicsettings'] = 'Ajustes básicos';
$string['coursesettings'] = 'Opciones de datos del espacio';
$string['createnewcategories'] = 'Crear categorías nuevas (ocultas) de espacio si no se encuentran en Moodle';
$string['createnewcategories_desc'] = '<p>Si el elemento &lt;org&gt;&lt;orgunit&gt; está presente en los datos de entrada de un espacio, su contenido se usará para especificar una categoría en el caso de que el espacio haya sido creado desde cero.</p>

<p>Este \'plugin\' no recategorizará espacios ya existentes.</p>

<p>Si no existe ninguna categoría con el nombre deseado, se creará una categoría OCULTA.</p>';
$string['createnewcourses'] = 'Crear espacios nuevos (ocultas) si no se encuentran en Moodle';
$string['createnewcourses_desc'] = 'Si está activado, la matriculación IMS Enterprise puede crear nuevos espacios para aquellos espacios que  encuentre en los datos de IMS, pero no en la base de datos de Moodle. Cualquier espacio de nueva creación estará inicialmente oculto.';
...
$string['processphotowarning'] = 'ATENCIÓN: El procesamiento de imágenes probablemente agregará una carga significativa al servidor. Se recomienda no activar esta opción si se espera procesar un número elevado de participantes.';
...
$string['roles'] = 'Roles';
$string['settingfullname'] = 'Etiqueta de descripción IMS para el nombre completo espacio';
$string['settingfullnamedescription'] = 'El nombre completo del espacio es un campo necesario por lo que tiene que definir la etiqueta de descripción IMS  seleccionada en su archivo IMS Enterprise';
$string['settingshortname'] = 'Etiqueta de descripción IMS para el nombre corto espacio';
$string['settingshortnamedescription'] = 'El nombre corto del espacio es un campo necesario por lo que tiene que definir la etiqueta de descripción IMS  seleccionada en su archivo IMS Enterprise';
$string['settingsummary'] = 'Etiqueta de descripción IMS para el resumen del espacio';
$string['settingsummarydescription'] = 'Es un campo opcional, seleccione \'Dejarlo vacio\' si no quiere especificar un resumen del espacio';
...
Algunos sistemas de información de participantes no generan el campo <userid>. Si este es el caso, debe habilitar esta configuración para permitir el uso de la <sourcedid> como el ID de usuario de Moodle. De lo contrario, deje esta opción desactivada.';
$string['truncatecoursecodes'] = 'Truncar los códigos del espacio a esta longitud';
$string['truncatecoursecodes_desc'] = '<p>En determinadas situaciones usted tendrá códigos de espacio que desee truncar a una determinada longitud antes de su procesamiento. Si éste fuera el caso, escriba el número de caracteres en esta caja. En caso contrario, déjela <strong>en blanco</strong>.</p>';
$string['usecapitafix'] = 'Marcar esta caja si se usa "Capita" (su formato XML es ligeramente erróneo)';
$string['usecapitafix_desc'] = '<p>Se ha encontrado un ligero error en la salida XML del sistema de datos de participantes producido por Capita. Si utiliza Capita deberá activar esta opción. En caso contrario, déjela desactivada.</p>';
