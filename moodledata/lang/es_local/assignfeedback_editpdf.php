...
/**
 * Strings for component 'assignfeedback_editpdf', language 'es', version '3.9'.
 *
...
$string['editpdf_help'] = 'Anotar las entregas de los participantes directamente en el navegador y producir un PDF editado y descargable.';
$string['enabled'] = 'Anotar PDF';
$string['enabled_help'] = 'Si está habilitado, el facilitador podrá crear ficheros PDF anotados cuando realice las correcciones. El facilitador podrá añadir comentarios, dibujos y sellos directamente sobre el trabajo de los participantes. La anotación se realiza en el navegador y no se requiere ningún software adicional.';
