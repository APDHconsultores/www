...
/**
 * Strings for component 'moodle', language 'es', version '3.9'.
 *
 * @package     moodle
 * @category    string
...
$string['activities_help'] = 'Actividades como foros, exámenes y wikis habilitan el contenido interactivo a ser agregado al espacio.';
...
$string['addcreator'] = 'Agregar creador de espacio';
...
$string['addedtogroupnotenrolled'] = 'No agregado al grupo "{$a}" , porque no está suscrito al espacio';
...
$string['addnewcourse'] = 'Crear un nuevo espacio';
...
$string['addstudent'] = 'Agregar participante';
$string['addsubcategory'] = 'Agregar categoría';
$string['addteacher'] = 'Agregar facilitador';
...
$string['adminhelpassigncreators'] = 'Los creadores de espacios pueden crear nuevos espacios';
$string['adminhelpassignsiteroles'] = 'Aplicar roles de sitio definidos a usuarios específicos';
$string['adminhelpassignstudents'] = 'Entra al espacio y agrega participantes desde el menú administrativo del espacio';
...
$string['adminhelpcourses'] = 'Defina espacios y categorías y asigne personas a ellos, edite los espacios pendientes';
...
$string['adminhelpreports'] = 'Clasificación de espacios por distintos criterios';
...
$string['administratordescription'] = 'Normalmente los administradores pueden hacer cualquier cosa en el sitio, en todos los espacios.';
$string['administrators'] = 'Administradores';
$string['administratorsall'] = 'Todos los administradores';
$string['administratorsandteachers'] = 'Administradores y facilitadores';
...
$string['allowstealthmodules_help'] = 'Si se encuentra activado, las actividades pueden habilitarse pero no se mostrarán en las secciones visibles del espacio. Así, los links a las actividades ocultas deben ser provistos desde otro lado, como por ejemplo, desde el recurso página. Las actividades ocultas aún se encuentran listadas en el libro de calificaciones y otros reportes.';
$string['allparticipants'] = 'Todos los participantes';
$string['allteachers'] = 'Todos los facilitadores';
...
$string['areyousuretorestorethisinfo'] = 'Más adelante en este proceso tendrá la opción de agregar esta copia a otro espacio o utilizarla para crear un espacio completamente nuevo.';
...
$string['availablecourses'] = 'Espacios disponibles';
$string['back'] = 'Atrás';
$string['backto'] = 'Regresar a {$a}';
$string['backtocourselisting'] = 'Volver a la lista de espacios';
...
$string['backupcoursefileshelp'] = 'Si se activa, los archivos del espacio se incluirán en copias de seguridad automatizadas';
...
$string['backupfailed'] = '¡Algunos de sus espacios no han sido guardados!';
...
$string['backupsitefileshelp'] = 'Si se activa esta opción, los archivos del sitio usados en los espacios se incluirán en copias de seguridad automatizadas';
...
$string['bulkmovecoursessuccess'] = 'Movidos con éxito {$a->courses} espacios a {$a->category}';
$string['bycourseorder'] = 'Por orden de espacio';
$string['byname'] = 'por {$a}';
...
$string['categoriesandcourses'] = 'Categorías de espacios y espacios';
...
$string['categorycontents'] = 'Subcategorías y espacios';
...
$string['checkingcourse'] = 'Revisando el espacio';
...
$string['childcoursenotfound'] = '¡Espacio secundario no encontrado!';
$string['childcourses'] = 'Espacios hijo';
$string['choose'] = 'Elegir';
$string['choosecourse'] = 'Seleccione un espacio';
...
$string['confirmcoursemove'] = '¿Está seguro de que desea mover este espacio ({$a->course}) a esta categoría ({$a->category})?';
...
$string['continuetocourse'] = 'Haga clic aquí para entrar a su espacio';
...
$string['copycourse'] = 'Copiar espacio';
$string['copyingcoursefiles'] = 'Copiando los archivos del espacio';
$string['copyingsitefiles'] = 'Copiando los archivos del sitio usados en el espacio';
...
$string['courseapprovedemail'] = 'El espacio que ha solicitado, {$a->name}, y usted ha sido nombrado {$a->teacher}. Para acceder a su nuevo espacio, vaya a {$a->url}';
$string['courseapprovedemail2'] = 'El espacio que ha solicitado, {$a->name}, ha sido aprobado. Para acceder a él, vaya a {$a->url}';
$string['courseapprovedfailed'] = '¡No se ha podido guardar su espacio como aprobado!';
$string['courseapprovedsubject'] = '¡Su espacio ha sido aprobado!';
$string['courseavailable'] = 'Este espacio está disponible para los participantes';
$string['courseavailablenot'] = 'Este espacio no está disponible para los participantes';
$string['coursebackup'] = 'Copia de seguridad del espacio';
$string['coursebulkaction'] = 'Acciones masivas sobre los espacios seleccionados';
$string['coursecategories'] = 'Categorías de espacios';
$string['coursecategory'] = 'Categoría de espacios';
$string['coursecategory_help'] = 'Este ajuste determina la categoría en la que aparecerá el espacio en la lista de espacios.';
$string['coursecategorydeleted'] = 'Eliminada la categoría de espacio {$a}';
$string['coursecatmanagement'] = 'Gestión de espacios y categorías';
$string['coursecompletion'] = 'Finalización del espacio';
$string['coursecompletions'] = 'Finalizaciones del espacio';
$string['coursecreators'] = 'Creador de espacio';
$string['coursecreatorsdescription'] = 'Los creadores de espacios pueden crear nuevos espacios.';
$string['coursedeleted'] = 'Eliminado el espacio {$a}';
$string['coursedetails'] = 'Detalles del espacio';
$string['coursedisplay'] = 'Paginación del espacio';
$string['coursedisplay_help'] = 'Este parámetro determina si el espacio completo se muestra en una página o se desglosa en varias páginas.';
...
$string['courseduration'] = 'Duración del espacio';
$string['courseduration_desc'] = 'La duración del espacio se usa para calcular la fecha de cierre del espacio por defecto. La fecha de cierre del espacio se usa para determinar si un espacio debe incluirse en la lista de espacios de un usuario. También puede ser utilizado por informes personalizados. Los usuarios aún pueden entrar al espacio después de la fecha de cierre.';
$string['courseenddateenabled'] = 'Fecha de cierre del espacio habilitada por defecto';
$string['courseenddateenabled_desc'] = 'Esta configuración determina si la fecha de cierre del espacio se habilitará de manera predeterminada para los espacios nuevos y se establecerá en la fecha calculada a partir de la duración del espacio.';
$string['courseextendednamedisplay'] = '{$a->shortname} {$a->fullname}';
$string['coursefiles'] = 'Archivos heredados del espacio';
$string['coursefilesedit'] = 'Editar archivos heredados del espacio';
$string['coursefileswarning'] = 'Los archivos del espacio están en desuso';
$string['coursefileswarning_help'] = 'Los archivos del espacio están en desuso desde Moodle 2.0; por favor, utilice repositorios externos en su lugar cuanto le sea posible.';
$string['courseformatdata'] = 'Datos de formato del espacio';
...
$string['coursegrades'] = 'Calificaciones del espacio';
$string['coursehelpcategory'] = 'Coloque el espacio en el listado de espacios a fin de facilitar el acceso a los participantes.';
$string['coursehelpforce'] = 'Forzar el modo de grupo en el espacio para todas las actividades del espacio.';
$string['coursehelpformat'] = 'La portada del espacio se mostrará en este formato.';
$string['coursehelphiddensections'] = 'Cómo se mostrarán a los participantes las secciones ocultas del espacio.';
$string['coursehelpmaximumupload'] = 'Definir el tamaño máximo de los archivos que los participantes pueden subir a este espacio, limitado por el ajuste general del sitio.';
$string['coursehelpnewsitemsnumber'] = 'Número de anuncios recientes que aparecen en el último bloque de anuncios en la página del espacio. Si se establece en cero, el foro de anuncios no se creará.';
$string['coursehelpnumberweeks'] = 'Número de secciones en el espacio (aplicable solo a ciertos formatos de espacio).';
...
$string['coursehidden'] = 'Este espacio no es accesible de momento a los participantes';
$string['courseinfo'] = 'Información del espacio';
$string['courselegacyfiles'] = 'Archivos de espacio heredados';
$string['courselegacyfiles_help'] = 'El área de archivos del espacio proporciona cierta compatibilidad hacia atrás con las versiones de Moodle 1.9 y anteriores. Todos los archivos de este área son siempre accesibles a todos los participantes en el espacio (tanto si enlaza a ellos como si no) y no hay manera de saber dónde se pueden estar usando en Moodle cualquiera de estos archivos.

Si utiliza este área para almacenar archivos de espacio, puede exponerse a una serie de riesgos de privacidad y de seguridad, así como a la pérdida de archivos en las copias de seguridad, en las importaciones de espacios o cada vez que el contenido del espacio sea compartido o reutilizado. Por ello se recomienda que no utilice esta área a menos que realmente sepa lo que está haciendo.';
$string['courselegacyfilesofcourse'] = 'Archivos del espacio heredados: {$a}';
$string['coursemessage'] = 'Mensaje a usuarios de espacio';
$string['coursenotaccessible'] = 'Este espacio no permite acceso público';
$string['courseoverview'] = 'Vista general del espacio';
$string['courseoverviewfiles'] = 'Archivos del resumen del espacio';
$string['courseoverviewfiles_help'] = 'Los archivos del resumen del espacio (por lo general imágenes) se muestran en la lista de espacios, junto con el resumen.';
$string['courseoverviewfilesext'] = 'Extensiones de los archivos de resumen del espacio';
$string['courseoverviewfileslimit'] = 'Límite de archivos en el resumen del espacio';
$string['courseoverviewgraph'] = 'Gráfico global del espacio';
$string['coursepreferences'] = 'Preferencias del espacio';
$string['courseprofiles'] = 'Perfiles de espacio';
...
$string['coursereject'] = 'Rechazar solicitud de espacio';
$string['courserejected'] = 'El espacio ha sido rechazado y así se ha notificado al solicitante.';
$string['courserejectemail'] = 'Lo sentimos, el espacio solicitado ha sido rechazado por la siguiente razón:

{$a}';
$string['courserejectreason'] = 'Escriba sus razones para rechazar este espacio<br />(serán enviadas al solicitante)';
$string['courserejectsubject'] = 'Su espacio ha sido rechazado';
$string['coursereport'] = 'Informe de espacio';
$string['coursereports'] = 'Informes del espacio';
$string['courserequest'] = 'Solicitud de espacio';
$string['courserequestdetails'] = 'Detalles del espacio que solicita';
$string['courserequestfailed'] = 'Por alguna razón desconocida, su solicitud de espacio no ha podido guardarse';
$string['courserequestintro'] = 'Utilice este formulario para solcitar la creación de un espacio.<br />Suministre toda la información posible para facilitar<br />a los administradores la comprensión de las razones por las que solicita el espacio.';
$string['courserequestreason'] = 'Razones para solicitar el espacio';
$string['courserequestsuccess'] = 'Su solicitud de espacio se ha guardado con éxito. Dentro de unos días se le notificará el resultado por correo electrónico.';
$string['courserequestsupport'] = 'Información de apoyo para ayudar al administrador a evaluar esta solicitud';
$string['courserequestwarning'] = 'El usuario que solicite este espacio será automáticamente matriculado y se le asignará el rol de {$a}.';
$string['courserestore'] = 'Restaurar espacio';
$string['courses'] = 'Espacios';
$string['coursesearch'] = 'Buscar espacios';
...
$string['coursesectionsummaries'] = 'Resúmenes de sección del espacio';
$string['coursesectiontitle'] = 'Espacio: {$a->course}, {$a->sectionname}: {$a->sectiontitle}';
$string['coursesettings'] = 'Ajustes por defecto del espacio';
$string['coursesmovedout'] = 'Espacios apartados de {$a}';
$string['coursespending'] = 'Espacios pendientes de aprobación';
$string['coursestart'] = 'Comienzo del espacio';
$string['coursesummary'] = 'Resumen del espacio';
$string['coursesummary_help'] = 'El resumen del espacio se muestra en la lista de espacios. Una búsqueda de espacios busca el texto del resumen del espacio además de los nombres de espacio.';
$string['coursetitle'] = 'Espacio: {$a->course}';
$string['courseupdates'] = 'Actualizaciones de espacios';
$string['coursevisibility'] = 'Visibilidad del espacio';
$string['coursevisibility_help'] = 'Este ajuste indica cuando un espacio aparece en la lista de espacios y cuando los participantes pueden acceder. Si está en oculto, entonces el acceso es restringido a los usuarios con los permisos para ver espacios ocultos (como los facilitadores).';
$string['create'] = 'Crear';
...
$string['createnewcourse'] = 'Crear nuevo espacio';
...
$string['creatingcoursemodules'] = 'Creando módulos de espacio';
$string['creatingcourseroles'] = 'Creando asignaciones y anulaciones de rol en nivel de espacio';
...
$string['creatingnewcourse'] = 'Creando nuevo espacio';
...
$string['currentcourse'] = 'Espacio actual';
$string['currentcourseadding'] = 'Espacio actual, agregando información';
$string['currentcoursedeleting'] = 'Espacio actual, borrando primero';
...
$string['defaultcoursestudent'] = 'Participante';
$string['defaultcoursestudentdescription'] = 'Los participantes tienen por lo general menos privilegios dentro de un espacio.';
$string['defaultcoursestudents'] = 'Participantes';
$string['defaultcoursesummary'] = 'Escriba aquí la descripción del espacio';
$string['defaultcourseteacher'] = 'Facilitador';
$string['defaultcourseteacherdescription'] = 'Los facilitadores pueden realizar cualquier acción dentro de un espacio, incluyendo cambiar actividades y calificar a los participantes.';
$string['defaultcourseteachers'] = 'Facilitadores';
...
$string['deletecategorycheck'] = '¿Está totalmente seguro que quiere eliminar por completo la categoría <b>\'{$a}\'</b>?<br /> Esta acción trasladará todos los espacios a la categoría padre (si existe) o a Miscelánea.';
$string['deletecategorycheck2'] = 'Si elimina esta categoría, necesita decidir qué hacer con los espacios y subcategorías que contiene.';
...
$string['deletecourse'] = 'Borrar espacio';
$string['deletecoursecheck'] = '¿Está totalmente seguro que quiere borrar definitivamente este espacio y toda la información que contiene?';
...
$string['deletingexistingcoursedata'] = 'Borrando datos del espacio';
...
$string['dndcourse'] = 'Puede arrastrar y soltar este espacio para alterar su clasificación o moverlo a otra categoría.';
...
$string['dndworkingfile'] = 'Para subir archivos, arrastrar y soltarlos dentro de las secciones de los espacios';
$string['dndworkingfilelink'] = 'Para subir archivos o enlaces, arrastrar y soltarlos dentro de las secciones de los espacios';
$string['dndworkingfiletext'] = 'Para subir archivos o texto, arrastrar y soltarlos dentro de las secciones de los espacios';
$string['dndworkingfiletextlink'] = 'Para subir archivos, textos o enlaces, arrastrar y soltarlos dentro de las secciones de los espacios';
$string['dndworkinglink'] = 'Para subir enlaces, arrastrar y soltarlos dentro de las secciones de los espacios';
$string['dndworkingtext'] = 'Para subir textos, arrastrar y soltarlos dentro de las secciones de los espacios';
$string['dndworkingtextlink'] = 'Para subir  textos o enlaces, arrastrar y soltarlos dentro de las secciones de los espacios';
$string['documentation'] = 'Documentación de Moodle';
$string['dontsortcategories'] = 'No ordenar categorías';
$string['dontsortcourses'] = 'No ordenar espacios';
$string['down'] = 'Abajo';
...
$string['editcoursesettings'] = 'Editar la configuración del espacio';
...
$string['edulevel_help'] = '* Enseñanza - acciones realizadas por un facilitador, p.e.: actualizar un recurso
* Participación - acciones realizadas por un participante, p.e.: enviar un mensaje a un foro
* Otro - acciones realizadas por un usuario con un rol que no es facilitador o participante';
...
$string['emaildisplay_help'] = 'Usuarios privilegiados (como facilitadores y gestores) siempre podrán ver su dirección de correo.';
$string['emaildisplaycourse'] = 'Mostrar mi dirección de correo sólo a mis compañeros de espacio';
...
$string['enddate'] = 'Fecha de cierre del espacio';
$string['enddate_help'] = 'La fecha de terminación del espacio es usada para determinar si un espacio debería de estar incluido dentro de la lista de espacios de un usuario. Cuando la fecha de terminación ya ha pasado, el espacio ya no está listado en la navegación y entonces está listado como pasado en la vista general del espacio. La fecha de terminación del espacio también puede ser usada por reportes personalizados. Los usuarios todavía pueden entrar al espacio después de la fecha de terminación; en otras palabras, la fecha no restringe el acceso.';
$string['english'] = 'Inglés';
$string['enrolmentmethods'] = 'Métodos de matriculación';
$string['entercourse'] = 'Haga clic aquí para entrar al espacio';
$string['enteremail'] = 'Haga clic para entrar en este espacio';
...
$string['eventcoursebackupcreated'] = 'Copia de espacio creada';
...
$string['eventcoursecontentdeleted'] = 'Contenido del espacio eliminado';
$string['eventcoursecreated'] = 'Espacio creado';
$string['eventcoursedeleted'] = 'Espacio eliminado';
$string['eventcourseinformationviewed'] = 'Sumarios de espacios vistos';
$string['eventcoursemodulecreated'] = 'Módulo de espacio creado';
$string['eventcoursemoduledeleted'] = 'Módulo de espacio eliminado';
$string['eventcoursemoduleinstancelistviewed'] = 'Instancia del módulo del espacio visualizada';
$string['eventcoursemoduleupdated'] = 'Módulo de espacio actualizado';
$string['eventcoursemoduleviewed'] = 'Módulo de espacio visto';
$string['eventcourseresetended'] = 'Reinicio de espacio finalizado';
$string['eventcourseresetstarted'] = 'Reinicio de espacio iniciado';
$string['eventcourserestored'] = 'Espacio restaurado';
$string['eventcoursesectioncreated'] = 'Sección del espacio creada';
$string['eventcoursesectiondeleted'] = 'Selección de espacio eliminada';
$string['eventcoursesectionupdated'] = 'Sección de espacio actualizado';
$string['eventcoursessearched'] = 'Espacios buscados';
$string['eventcourseupdated'] = 'Espacio actualizado';
$string['eventcourseuserreportviewed'] = 'Informe usuario del espacio visto';
$string['eventcourseviewed'] = 'Espacio visto';
...
$string['existingcourse'] = 'Espacio existente';
$string['existingcourseadding'] = 'Espacio existente, agregando información';
$string['existingcoursedeleting'] = 'Espacio existente, borrando primero';
$string['existingcreators'] = 'Creadores existentes';
$string['existingstudents'] = 'Participantes inscritos';
$string['existingteachers'] = 'Facilitadores existentes';
...
$string['findmorecourses'] = 'Encontrar más espacios...';
...
$string['format_help'] = 'El formato del espacio determina el diseño de la página del espacio.

* Formato de actividad única  - Visualiza una única actividad o recurso (como un Cuestionario o un paquete SCORM)

* Formato Social - Se muestra un foro en la página del espacio

* Formato de Temas - La página del espacio se organiza en secciones temáticas

* Formato semanal - la página del espacio está organizado en secciones semanales, con la primera semana a partir de la fecha de inicio del espacio';
...
$string['frontpagecourselist'] = 'Mostrar la lista de espacios';
$string['frontpagecoursesearch'] = 'Caja de texto de búsqueda en el espacio';
$string['frontpagedescription'] = 'Resumen de la página principal';
$string['frontpagedescriptionhelp'] = 'Este resumen puede mostrarse en la página principal utilizando el bloque Resumen del espacio/sitio.';
$string['frontpageenrolledcourselist'] = 'Espacios inscritos';
...
$string['fulllistofcourses'] = 'Todos los espacios';
$string['fullname'] = 'Nombre completo';
$string['fullnamecourse'] = 'Nombre completo del espacio';
$string['fullnamecourse_help'] = 'El nombre completo del espacio se muestra en la parte superior de cada página del espacio y en la lista de espacios.';
...
$string['guestuserinfo'] = 'Este usuario sólo tiene acceso de lectura en ciertos espacios.';
$string['help'] = 'Ayuda';
$string['helpprefix2'] = 'Ayuda con {$a}';
$string['helpwiththis'] = 'Ayuda';
$string['hiddenassign'] = 'Tarea oculta';
$string['hiddenfromstudents'] = 'No mostrado a los participantes';
$string['hiddenoncoursepage'] = 'Disponibles pero no visibles en la página del espacio';
$string['hiddensections'] = 'Secciones ocultas';
$string['hiddensections_help'] = 'Este ajuste determina si las secciones ocultas se muestran a los participantes en forma colapsada o están completamente ocultas';
...
$string['hidefromstudents'] = 'Ocultar a participantes';
$string['hideoncoursepage'] = 'Hacerlo disponible pero no mostrarlo en la página del espacio';
...
$string['idnumbercourse'] = 'Número ID del espacio';
$string['idnumbercourse_help'] = '<P>El número ID de un espacio únicamente se usa cuando se compara este espacio contra un sistema externo - lo cual nunca es mostrado dentro de Moodle. Si tiene un código oficial para este espacio úselo aquí ... de otra forma lo puede dejar en blanco.</p>';
$string['idnumbercoursecategory'] = 'Número ID de la categoría';
$string['idnumbercoursecategory_help'] = 'El número de identificación ID de una categoría de espacios sólo se usa cuando se compara la categoría contra un sistema externo y no se muestra en ningún lugar del sitio. Si la categoría tiene un código oficial, este puede ser introducido, de lo contrario, el campo puede dejarse en blanco.';
...
$string['importdata'] = 'Importar datos del espacio';
$string['importdataexported'] = 'Datos correctamente exportados \'desde\' el espacio.<br />Continúe importando \'hacia\' su espacio.';
$string['importdatafinished'] = 'Importación completa. Continúe con su espacio';
$string['importdatafrom'] = 'Encontrar un espacio desde el que importar datos:';
$string['inactive'] = 'Inactivo';
$string['include'] = 'Incluir';
$string['includeallusers'] = 'Incluir a todos los usuarios';
$string['includecoursefiles'] = 'Incluir los archivos del espacio';
$string['includecourseusers'] = 'Incluir los usuarios del espacio';
...
$string['includesitefiles'] = 'Incluir archivos del sitio usados en este espacio';
$string['includeuserfiles'] = 'Incluir los archivos de los usuarios';
$string['increasesections'] = 'Aumentar el número de secciones';
$string['indicator:accessesafterend'] = 'Acceso al espacio después de la fecha límite';
$string['indicator:accessesafterend_help'] = 'Este indicador refleja que el participante accedió al espacio después de la fecha límite,';
$string['indicator:accessesbeforestart'] = 'Espacio accedido antes de la fecha de inicio';
$string['indicator:accessesbeforestart_help'] = 'Este indicador refleja si el participante accedió al espacio antes de la fecha de inicio del espacio.';
...
$string['indicator:anycourseaccess'] = 'Acceso a cualquier espacio';
$string['indicator:anycourseaccess_help'] = 'Este indicador refleja el acceso a cualquier espacio en que el usuario esté matriculado.';
$string['indicator:anywrite'] = 'Cualquier acción de escritura';
$string['indicator:anywrite_help'] = 'Este indicador representa cualquier acción de escritura (envío) realizada por el participante.';
$string['indicator:anywriteincourse'] = 'Cualquier acción de escritura en el espacio';
$string['indicator:anywriteincourse_help'] = 'Este indicador representa cualquier acción de escritura (envío) realizada por el participante en cualquier actividad del espacio.';
$string['indicator:completeduserprofile'] = 'El perfil de usuario se completa';
$string['indicator:completeduserprofile_help'] = 'Este indicador representa que el participante ha completado su perfil de usuario.';
$string['indicator:completeduserprofiledef'] = 'El perfil de usuario está completo';
$string['indicator:completionenabled'] = 'Seguimiento de cierre habilitado';
$string['indicator:completionenabled_help'] = 'Este indicador representa que se ha habilitado el seguimiento de cierre para este espacio.';
$string['indicator:nostudent'] = 'No hay participantes';
$string['indicator:nostudent_help'] = 'Este indicador refleja que este espacio no tiene participantes.';
$string['indicator:noteacher'] = 'No hay facilitadores';
$string['indicator:noteacher_help'] = 'Este indicador refleja que este espacio no tiene facilitadores.';
$string['indicator:potentialcognitive'] = 'Profundidad cognitiva potencial del espacio';
$string['indicator:potentialcognitive_help'] = 'Este indicador se basa en la profundidad cognitiva potencial que podría alcanzar un participante que participa en las actividades del espacio.';
$string['indicator:potentialsocial'] = 'Amplitud social potencial del espacio';
$string['indicator:potentialsocial_help'] = 'Este indicador se basa en la amplitud social potencial que podría alcanzar el participante que participa en las actividades del espacio.';
$string['indicator:readactions'] = 'Cantidad de acciones de lectura';
$string['indicator:readactions_help'] = 'Este indicador representa el número de acciones de lectura (vista) realizadas por el participante.';
$string['indicator:userforumstracking'] = 'El usuario está rastreando foros';
$string['indicator:userforumstracking_help'] = 'Este indicador representa si el participante ha activado o no el seguimiento en los foros.';
$string['info'] = 'Información';
$string['institution'] = 'Institución';
$string['instudentview'] = 'en vista participante';
...
$string['lastcourseaccess'] = 'Último acceso al espacio';
...
$string['listofcourses'] = 'Listado de espacios';
...
<p>Para acceder a todos los espacios necesita crear una cuenta.</p>
...
$string['mailstudents'] = 'Informar a participantes';
$string['mailteachers'] = 'Informar a facilitadores';
$string['maincoursepage'] = 'Página principal del espacio';
...
$string['managecourses'] = 'Gestionar espacios';
...
$string['maximumupload_help'] = '<P>Esta variable determina el tamaño máximo permitido para los archivos subidos
 por los participantes a este espacio, limitado por el tamaño máximo del sitio, que es determinado por el administrador.
...
$string['maxnumberweeks_desc'] = 'El valor máximo del número de secciones del menú desplegable (se aplica sólo a ciertos formatos de espacio).';
$string['maxnumcoursesincombo'] = 'Examinar <a href="{$a->link}">{$a->numberofcourses} espacios</a>.';
$string['maxsectionslimit'] = 'No se puede crear nueva sección ya que excedería el número máximo de secciones permitidas para este espacio ({$a}).';
...
$string['memberincourse'] = 'Personas en el espacio';
...
$string['messageprovider:courserequestapproved'] = 'Notificacíón de aprobación de solicitud de creación de espacio';
$string['messageprovider:courserequested'] = 'Notificación de solicitud de creación de espacio';
$string['messageprovider:courserequestrejected'] = 'Notificacíón de rechazo de solicitud de creación de espacio';
...
$string['modvisible_help'] = 'Si la disponibilidad es configurada como \'Mostrar en la página del espacio\', la actividad o recurso estará disponible para los participantes (sujeta a las restricciones que haya dispuesto).<br><br>
Si la disponibilidad es configurada como \'Ocultar a los participantes\', la actividad o recurso estará solo disponible para usuarios con permiso para ver las actividades ocultas (por defecto, usuarios con el rol de facilitador o cofacilitador)';
$string['modvisiblehiddensection'] = 'Disponibilidad';
$string['modvisiblehiddensection_help'] = 'Si la disponibilidad es configurada como \'Ocultar a los participantes\', la actividad o recurso estará solo disponible para usuarios con permiso para ver las actividades ocultas (por defecto, usuarios con el rol de facilitador o cofacilitador).<br><br>
Si el espacio contiene muchas actividades o recursos, la página del espacio puede simplificarse al configurar la disponibilidad como \'Hacer disponible pero no mostrar en la página del espacio\'. En este caso, un link a la actividad o recurso debe ser facilitado desde otro lugar, como por ejemplo desde el recurso página. La actividad aún estaría listada en el libro de calificaciones y otros informes.';
$string['modvisiblewithstealth'] = 'Disponibilidad';
$string['modvisiblewithstealth_help'] = 'Si la disponibilidad es configurada como \'Mostrar en la página del espacio\', la actividad o recurso estará disponible para los participantes (sujeta a las restricciones que haya dispuesto).<br><br>
Si la disponibilidad es configurada como \'Ocultar a los participantes\', la actividad o recurso estará solo disponible para usuarios con permiso para ver las actividades ocultas (por defecto, usuarios con el rol de facilitador o cofacilitador).<br><br>
Si el espacio contiene muchas actividades o recursos, la página del espacio puede simplificarse al configurar la disponibilidad como \'Hacer disponible pero no mostrar en la página del espacio\'. En este caso, un link a la actividad o recurso debe ser facilitado desde otro lugar, como por ejemplo desde el recurso página. La actividad aún estaría listada en el libro de calificaciones y otros informes.';
$string['month'] = 'Mes';
$string['months'] = 'Meses';
...
$string['movecourseto'] = 'Mover espacio a:';
...
$string['moveselectedcoursesto'] = 'Mover los espacios seleccionados a...';
...
$string['newcourse'] = 'Nuevo espacio';
...
$string['newsitemsnumber_help'] = 'El foro de anuncios es un foro especial que es creado automáticamente en el espacio, tiene suscripción forzada configurada por defecto, y solamente los usuarios con permisos apropiados (por defecto, los facilitadores) pueden publicar en él.

Esta configuración determina cuantos anuncios recientes aparecen en el bloque de últimos anuncios.

Si no se necesita un foro de anuncios en el espacio, esta configuración debería de configurarse a cero.';
...
$string['nocourses'] = 'Sin espacios';
$string['nocoursesfound'] = 'No se encontraron espacios con las palabras {$a}';
$string['nocoursestarttime'] = 'El espacio no tiene un momento de inicio';
$string['nocoursesyet'] = 'No hay espacios en esta categoría';
...
$string['nofilesyet'] = 'Aún no se han subido archivos a su espacio';
...
$string['noimagesyet'] = 'Aún no se han subido  imágenes a su espacio';
$string['nologsfound'] = 'No se han encontrado registros';
$string['nomatchingusers'] = 'Ningún usuario coincide con {$a}';
$string['nomorecourses'] = 'No se encontraron más espacios que cumplan el criterio';
$string['nomoreidnumber'] = 'No se usa un número de identificación para evitar colisiones';
$string['none'] = 'Ninguno';
$string['noneditingteacher'] = 'Cofacilitador';
$string['noneditingteacherdescription'] = 'Los cofacilitadores pueden enseñar en los espacios y calificar a los participantes, pero no pueden modificar las actividades.';
$string['nonstandard'] = 'No estándar';
$string['nopendingcourses'] = 'No hay espacios pendientes de aprobación';
$string['nopotentialadmins'] = 'No hay administradores potenciales';
$string['nopotentialcreators'] = 'No hay creadores potenciales';
$string['nopotentialstudents'] = 'No hay participantes potenciales';
$string['nopotentialteachers'] = 'No hay facilitadores potenciales';
...
$string['nosite'] = 'No se encontró espacio en el nivel de sitio';
$string['nostudentsfound'] = 'No se encuentra {$a}';
$string['nostudentsingroup'] = 'Aún no hay participantes en este grupo';
$string['nostudentsyet'] = 'Aún no se ha matriculado ningún participante en este espacio';
$string['nosuchemail'] = 'No existe esa dirección de correo';
$string['notavailable'] = 'No disponible';
$string['notavailablecourse'] = '{$a} no disponible';
$string['noteachersyet'] = 'Aún no hay facilitadores en este espacio';
$string['noteachingupcomingcourses'] = 'Espacios próximos sin facilitadores o participantes';
$string['notenrolled'] = '{$a} no está matriculado en este espacio.';
$string['notenrolledprofile'] = 'Este perfil no está disponible porque el usuario no está matriculado en este espacio.';
...
$string['noteuserschangednonetocourse'] = '<strong>Nota:<strong>Los usuarios de los espacios deben ser restaurados cuando se restauran los datos de usuario (en actividades, archivos o mensajes). Esta configuración ha sido cambiada para usted.';
...
$string['novalidcourses'] = 'No hay espacios válidos para mostrar';
$string['now'] = 'ahora';
$string['numattempts'] = '{$a} intento(s) de identificación fallido(s)';
$string['numberofcourses'] = 'Número de espacios';
...
$string['parentcoursenotfound'] = '¡Espacio raíz no encontrado!';
...
$string['paymentrequired'] = 'Para entrar a este espacio es necesario pagar.';
$string['payments'] = 'Pagos';
$string['paymentsorry'] = '¡Gracias por su pago! Por desgracia, su pago aún no ha sido procesado por completo, y usted todavía no está registrado para entrar al espacio "{$a->fullname}". Por favor, intente continuar el espacio dentro de unos segundos. Si continúa teniendo problemas, avise al {$a->teacher} o al administrador del sitio';
$string['paymentthanks'] = '¡Gracias por su pago! Ya está matriculado en el espacio:<br />"{$a}"';
...
$string['potentialstudents'] = 'Participantes potenciales';
$string['potentialteachers'] = 'Facilitadores potenciales';
...
$string['privacy:metadata:log:course'] = 'espacio';
...
$string['profilenotshown'] = 'Esta descripción de perfil no se mostrará hasta que esta persona se matricule al menos en un espacio.';
...
$string['removestudent'] = 'Quitar participante';
$string['removeteacher'] = 'Quitar facilitador';
$string['rename'] = 'Renombrar';
$string['renamefileto'] = 'Renombrar <b>{$a}</b> a';
$string['report'] = 'Informe';
$string['reports'] = 'Informes';
$string['repositories'] = 'Repositorios';
$string['requestcourse'] = 'Solicitar un espacio';
$string['requestedby'] = 'Solicitado por';
$string['requestedcourses'] = 'Espacios solicitados';
$string['requestreason'] = 'Razón para solicitar el espacio';
$string['requests'] = 'Peticiones';
$string['required'] = 'Obligatorio';
$string['requirespayment'] = 'Para acceder a este espacio es preciso pagar';
$string['resendemail'] = 'Reenviar correo';
$string['reset'] = 'Reiniciar';
$string['resetcomponent'] = 'Componente';
$string['resetcourse'] = 'Reiniciar espacio';
$string['resetinfo'] = 'Esta página le permite vaciar un espacio de datos de usuario, en tanto que se conservan las actividades y otros ajustes. Por favor, tome nota de que al seleccionar los ítems de más abajo y enviar esta página, eliminará definitivamente de este espacio los datos de los usuarios seleccionados.';
...
$string['resortcourses'] = 'Ordenar espacios';
...
$string['resources_help'] = 'Los tipos de recurso posibilitan que prácticamente cualquier contenido web se pueda insertar en el espacio.';
...
$string['restorecoursenow'] = 'Restaurar este espacio ahora';
...
$string['rolerenaming_help'] = 'Esta configuración permite cambiar los nombres mostrados en los roles usados en el espacio. <P>Sólo se cambia el nombre mostrado - los permisos de los roles no se vean afectados. <P>Los nuevos nombres de los roles aparecerán en la página de participantes en el espacio y allá donde se muestren estos.
<P>Si el rol renombrado corresponde a un rol de gestor del espacio, asignado por el administardor, el nuevo nombre del rol también aparecerá como parte de las listas de espacios.';
$string['roles'] = 'Roles';
$string['rss'] = 'RSS';
...
$string['savechangesandreturntocourse'] = 'Guardar cambios y regresar al espacio';
...
$string['scalestandard_help'] = '<p>Una escala estándar es una que esta disponible globalmente en el sitio, para todos los espacios.</p>';
$string['scalestip'] = 'Para crear escalas personalizadas utilice el enlace \'Escalas...\' en el menú de administración del espacio.';
$string['scalestip2'] = 'Para crear escalas personalizadas, haga clic en el enlace Calificaciones del menú de administración del espacio, luego seleccione Editar, Escalas.';
...
$string['searchcourses'] = 'Buscar espacios';
...
$string['selectacourse'] = 'Seleccionar un espacio';
$string['selectacoursesite'] = 'Seleccione un espacio o un sitio';
...
$string['selectcoursesortby'] = 'Seleccione cómo le gustaría ordenar los espacios';
...
$string['shortnamecollisionwarning'] = '[*] = Este nombre corto ya está en uso por un espacio, y necesita cambiarse hasta que se apruebe';
$string['shortnamecourse'] = 'Nombre corto del espacio';
$string['shortnamecourse_help'] = '<P>Muchas instituciones asignan nombres cortos a sus espacios para efectos
...
$string['shortnametaken'] = 'Este nombre corto ya está en uso en otro espacio ({$a})';
...
$string['showallcourses'] = 'Mostrar todos los espacios';
$string['showallusers'] = 'Mostrar todos los usuarios';
$string['showblockcourse'] = 'Mostrar lista de espacios que contienen bloque';
...
$string['showdescription'] = 'Muestra la descripción en la página del espacio';
$string['showdescription_help'] = 'Si se activa, la descripción anterior se mostrará en la página del espacio justo debajo del enlace a la actividad o recurso.';
$string['showgrades'] = 'Mostrar libro de calificaciones a los participantes';
$string['showgrades_help'] = 'Muchas actividades en el espacio permiten otorgar calificaciones. Esta configuración determina si es que un participante puede o no ver una lista de todas sus calificaciones para el espacio vía un enlace hacia calificaciones en el bloque de administración del espacio.';
$string['showingacourses'] = 'Mostrando todos {$a} espacios';
$string['showingxofycourses'] = 'Mostrando espacios {$a->start} a {$a->end} de {$a->total} espacios';
$string['showlistofcourses'] = 'Mostrar listas de espacios';
$string['showmodulecourse'] = 'Mostrar lista de espacios que contienen actividad';
$string['showoncoursepage'] = 'Mostrar en la página del espacio';
...
$string['showreports_help'] = '<p>Los informes de actividades están disponibles para todos los participantes que muestren sus actividades en el presente espacio. Al igual que las listas de contribuciones, estos informes incluyen un detallado registro de los accesos.</p>

<p>Los facilitadores siempre tendrán acceso a estos informes usando el enlace existente en el página de información personal de cada participante.</p>

<p>El acceso de los participantes a sus propios informes es controlado por el facilitador a través la configuración misma del espacio. En algunos espacios estos informes pueden ser una herramienta muy útil para que el participante sepa su evolución en el espacio, si bien en otros casos es posible que no sea necesario.</p>
...
$string['sitefilesused'] = 'Archivos del sitio usados en este espacio';
...
$string['sitepartlist0'] = 'Para poder ver la lista de participantes, usted debe ser un facilitador del sitio';
$string['sitepartlist1'] = 'Para poder ver la lista de participantes, usted debe ser un facilitador';
$string['sites'] = 'Sitios';
$string['sitesection'] = 'Incluir una sección de tema';
$string['sitesettings'] = 'Configurar el sitio';
$string['siteteachers'] = 'Facilitadores del sitio';
$string['size'] = 'Tamaño';
$string['sizeb'] = 'bytes';
$string['sizegb'] = 'GB';
$string['sizekb'] = 'KB';
...
$string['skiptocoursedetails'] = 'Ir a la información detallada del espacio';
$string['skiptocourselisting'] = 'Ir a la lista de espacios';
$string['skypeid'] = 'ID Skype';
$string['socialheadline'] = 'Foro social, últimos temas';
$string['someallowguest'] = 'Algunos espacios permiten el acceso de invitados';
...
$string['starpending'] = '([*] = espacio pendiente de aprobación)';
$string['startdate'] = 'Fecha de inicio del espacio';
$string['startdate_help'] = 'Este ajuste determina el comienzo de la primera semana para un espacio en formato semanal. También determina la fecha más temprana para la que existirá registro de las actividades del espacio. Si el espacio es restablecido y la fecha de inicio del espacio modificada, todas las fechas en el espacio se moverán en relación a la nueva fecha de inicio.';
...
$string['statsnodata'] = 'No existen datos disponibles para esa combinación de espacio y período de tiempo.';
$string['statsnodatauser'] = 'No existen datos disponibles para esa combinación de espacio, usuario y período de tiempo.';
...
$string['statsreport11'] = 'Espacios más activos';
$string['statsreport12'] = 'Espacios más activos (ponderados)';
$string['statsreport13'] = 'Espacios con más participación (matriculaciones)';
$string['statsreport14'] = 'Espacios con más participación (vistas/mensajes)';
...
$string['statsreport9'] = 'Accesos (sitio y espacio)';
$string['statsreportactivity'] = 'Toda la actividad (facilitador y participante)';
...
$string['statsstudentactivity'] = 'Actividad del participante';
$string['statsstudentreads'] = 'Vistas del participante';
$string['statsstudentwrites'] = 'Mensajes del participante';
$string['statsteacheractivity'] = 'Actividad del facilitador';
$string['statsteacherreads'] = 'Vistas del facilitador';
$string['statsteacherwrites'] = 'Mensajes del facilitador';
...
$string['studentnotallowed'] = 'Lo sentimos, pero no puede entrar a este espacio como \'{$a}\'';
$string['students'] = 'Participantes';
$string['studentsandteachers'] = 'Participantes y facilitadores';
...
semana). El texto se muestra en la página del espacio bajo el nombre de la sección.';
...
$string['switchroleto_help'] = 'Elija un rol para tener una idea de cómo alguien con ese rol verá este espacio.
...
$string['therearecourses'] = 'Hay {$a} espacios';
$string['thereareno'] = 'No hay {$a} en este espacio';
$string['thiscategory'] = 'Esta categoría';
$string['thiscategorycontains'] = 'Esta categoría contiene';
$string['time'] = 'Hora';
$string['timecreatedcourse'] = 'Hora de creación del espacio';
$string['timesplitting:deciles'] = 'Décimas';
$string['timesplitting:deciles_help'] = 'Este método de división del tiempo divide el espacio en décimas (10 partes iguales), y cada predicción se basa en los datos de la décima anterior más reciente.';
$string['timesplitting:decilesaccum'] = 'Décimas acumuladas';
$string['timesplitting:decilesaccum_help'] = 'Este método de división del tiempo divide el espacio en décimas (10 partes iguales), y cada predicción se basa en los datos de todas las décimas anteriores.';
...
$string['timesplitting:quarters_help'] = 'Este método de división del tiempo divide el espacio en cuartos (4 partes iguales), y cada predicción se basa en los datos del cuarto anterior más reciente.';
$string['timesplitting:quartersaccum'] = 'Cuartiles acumulativos';
$string['timesplitting:quartersaccum_help'] = 'Este método de división del tiempo divide el espacio en cuartos (4 partes iguales), y cada predicción se basa en los datos de todos los cuartos anteriores.';
$string['timesplitting:singlerange'] = 'Rango único';
$string['timesplitting:singlerange_help'] = 'Este método de división de tiempo considera todo el espacio como un único lapso.';
$string['timesplitting:tenpercentafterstart'] = '10% después del inicio';
$string['timesplitting:tenpercentafterstart_help'] = 'Este intérvalo de análisis genera una predicción después de completar el 10% del espacio.';
...
$string['unusedaccounts'] = 'Las personas que no entren al espacio durante {$a} días se darán de baja automáticamente. Su cuenta seguirá existiendo y podrán reinscribirse en cualquier momento.';
...
$string['updatethiscourse'] = 'Actualizar este espacio';
...
$string['usingexistingcourse'] = 'Usando un espacio existente';
$string['valuealreadyused'] = 'Este valor ya ha sido usado.';
$string['version'] = 'Versión';
$string['view'] = 'Vista';
$string['viewallcourses'] = 'Ver todos los espacios';
$string['viewallcoursescategories'] = 'Ver todos los espacios y categorías';
...
$string['visible_help'] = 'Esta opción determina si el espacio aparece en la lista de espacios. Excepto los facilitadores y administradores, los usuarios no pueden entrar al espacio.';
...
$string['wordforstudent'] = 'Su palabra para Participante';
$string['wordforstudenteg'] = 'por ejemplo: participante, Alumno, Participante, etc.';
$string['wordforstudents'] = 'Su palabra para Participantes';
$string['wordforstudentseg'] = 'por ejemplo: participantes, Alumnos, Participantes, etc.';
$string['wordforteacher'] = 'Su palabra para Facilitador';
$string['wordforteachereg'] = 'por ejemplo: Facilitador, Tutor, Asesor, etc.';
$string['wordforteachers'] = 'Su palabra para Facilitadores';
$string['wordforteacherseg'] = 'por ejemplo: Facilitadores, Tutores, Asesores, etc.';
...
$string['writingcoursedata'] = 'Escribiendo información del espacio';
...
$string['youneedtoenrol'] = 'Para llevar a cabo esta acción necesita matricularse en este espacio.';
