...
/**
 * Strings for component 'quiz_overview', language 'es', version '3.9'.
 *
...
$string['overviewreportgraph'] = 'Gráfico de barras del número de participantes que alcanzan los rangos de calificación';
$string['overviewreportgraphgroup'] = 'Número de participantes del grupo \'{$a}\' que han alcanzado los rangos de calificación';
