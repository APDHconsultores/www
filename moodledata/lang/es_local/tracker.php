...
/**
 * Strings for component 'tracker', language 'es', version '3.9'.
 *
 * @package     tracker
 * @category    string
...
$string['backtocourse'] = 'Regresar al espacio';
...
$string['constantcurrentcourseidnumber'] = 'Número ID del espacio actual';
$string['constantcurrentcourseshortname'] = 'Nombre corto del espacio actual';
$string['constantcurrentidnumber'] = 'ID de usuario actual';
$string['constantsitefullname'] = 'Nombre completo del espacio';
...
$string['errorcoursemisconfigured'] = 'El espacio esta desconfigurado';
$string['errorcoursemodid'] = 'El ID del módulo del espacio es incorrecto';
...
$string['errormoduleincorrect'] = 'El módulo del espacio es incorrecto';
...
$string['modulename_help'] = 'La actividad Rastreador (Tracker) permite rastrear boletos (tickets) para ayuda, reporte de errores (bugs) o también actividades rastreables en un espacio.
