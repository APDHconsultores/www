...
/**
 * Strings for component 'reengagement', language 'es', version '3.9'.
 *
...
$string['completiontime'] = 'Tiempo de cierre';
$string['completionwillturnon'] = 'Tenga en cuenta que agregar esta actividad al espacio permitirá completar la actividad.';
...
$string['emailcontentdefaultvalue'] = 'Este es un recordatorio por correo electrónico del espacio %coursename%.';
...
$string['emailcontentmanagerdefaultvalue'] = 'Este es un recordatorio por correo electrónico del espacio %coursename%, con respecto al usuario %userfirstname% %userlastname%.';
...
$string['emailcontentthirdpartydefaultvalue'] = 'Este es un recordatorio por correo electrónico del espacio %coursename%, con respecto al usuario %userfirstname% %userlastname%.';
...
$string['emailrecipient_help'] = 'Cuando hay que enviar un correo electrónico para solicitar la reintegración de un usuario en el espacio, esta configuración controla si se envía un correo electrónico al usuario, a su administrador o a ambos.';
