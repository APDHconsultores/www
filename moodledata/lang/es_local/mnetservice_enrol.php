...
/**
 * Strings for component 'mnetservice_enrol', language 'es', version '3.9'.
 *
...
$string['availablecourseson'] = 'Espacios disponibles en {$a}';
$string['availablecoursesonnone'] = 'El host remoto <a href="{$a->hosturl}">{$a->hostname}</a> no ofrece ningún espacio a nuestros usuarios.';
...
$string['noroamingusers'] = 'Los usuarios necesitan la capacidad \'{$a}\' en el contexto del sistema para inscribirse/matricularse en los espacios a distancia, sin embargo actualmente no hay usuarios con esta capacidad. Haga clic en el botón Continuar para asignar la capacidad necesaria a uno o más roles de su sitio.';
