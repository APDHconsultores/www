...
/**
 * Strings for component 'plagiarism_urkund', language 'es', version '3.9'.
 *
...
$string['allowallsupportedfiles_help'] = 'Permite que el facilitador restrinja qué tipos de archivo serán enviados a URKUND para su procesamiento. No impide que los participantes realicen entregas de otros tipos de archivo.';
...
$string['explainerrors'] = 'Esta página muestra los archivos actualmente en estado de error.  <br/>Los archivos eliminados en esta página no serán reenviados y los errores dejarán de ser mostrados a facilitadores y participantes';
$string['file'] = 'Archivo';
...
$string['urkund_show_student_report'] = 'Mostrar al participante informe de similaridad';
