...
/**
 * Strings for component 'analytics', language 'es', version '3.9'.
 *
 * @package     analytics
 * @category    string
...
$string['errornoroles'] = 'No se han definido roles de participante o facilitador. Defínalos en la página de configuraciones de analítica.';
...
$string['nocourses'] = 'Sin espacios para analizar';
...
$string['percentonline_help'] = 'Si su institución ofrece espacios mezclados o híbridos, ¿qué porcentaje del trabajo del participante es realizado en línea en Moodle? Introduzca un número entre 0 y 100.';
