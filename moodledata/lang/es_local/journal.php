...
$string['modulename_help'] = 'La actividad de revista (journal) les permite a los facilitadores obtener retroalimentación de participantes sobre un tema específico';
$string['modulenameplural'] = 'Diarios';
$string['newjournalentries'] = 'Nuevas entradas en el Diario';
$string['noentriesmanagers'] = 'No hay facilitadores';
