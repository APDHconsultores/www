...
/**
 * Strings for component 'block_fn_marking', language 'es', version '3.9'.
 *
...
$string['allcourseswithblock'] = 'Todos los espacios con bloque';
...
$string['close'] = 'Cerrar';
$string['config_days'] = 'Establecer el número de participantes no conectados en x días';
$string['config_days_help'] = '<p>Este ajuste permite configurar </p>
<p>el número de días que el participante no ha iniciado sesión en el espacio.</p>';
...
<p>el porcentaje de calificaciones y después de establecer el porcentaje verá el número de calificaciones del participante por debajo de x porciento.</p>';
$string['config_sectiontitles'] = 'Titulos de sección';
$string['config_sectiontitles_help'] = '<p>en blanco=espacio predeterminado.</p>';
...
<p>u ocultar las actividades preliminares del participante en el bloque.</p>';
$string['config_showstudentmarkslessthanfiftypercent'] = 'Mostrar los participantes con calificaciones inferiores a 50%';
$string['config_showstudentmarkslessthanfiftypercent_help'] = '<p>Este ajuste permite mostrar </p>
<p>u ocultar el número de participantes con calificaciones inferiores a 50%.</p>';
$string['config_showstudentnotsubmittedassignment'] = 'Mostrar al participante la tarea no enviada';
$string['config_showstudentnotsubmittedassignment_help'] = '<p>Este ajuste permite mostrar </p>
<p>u ocultar el número de participantes con tarea no enviada la semana pasada.</p>';
...
$string['coursecategoriesincluded'] = 'Categorías de espacios incluidas';
...
$string['includecourses'] = 'Espacios a incluir';
...
$string['listcourseszeroungraded'] = 'Lista de espacios con cero actividades sin calificar';
$string['manualgrading'] = 'Calificación manual';
$string['marked'] = 'Calificado';
$string['markinmanagerscoursecats'] = 'Administrador de Marcado - Categorías de Espacio';
$string['markinmanagerscoursecatsdesc'] = 'Seleccionadas las categorías de espacios que serán procesadas por el Administrador de Marcado en la página principal de Moodle y en el panel de control.';
$string['moodledefaultview'] = 'Vista predeterminada de Moodle';
$string['moodlegradebook'] = 'Abrir el Libro de calificaciones de Moodle';
$string['morethan10'] = 'Hay más de 10 espacios con trabajo sin calificar.';
$string['name'] = 'Nombre';
...
$string['refreshmodecourse'] = 'Bloquear modo de actualización - Espacio';
...
$string['selectedcourses'] = 'Espacios seleccionados (abajo)';
...
$string['showstudentnotsubmittedassignment'] = 'Mostrar el número de participantes que no han enviado la tarea';
...
$string['studentlist'] = 'Lista de Participantes';
$string['studentssubmission'] = 'Envío del participante';
$string['successful'] = 'Exitoso';
$string['teachersfeedback'] = 'Comentarios del Facilitador';
...
$string['title:notlogin'] = 'Los siguientes participantes no se han conectado en';
$string['title:notsubmittedanyactivity'] = 'Los siguientes alumnos no han enviado ninguna actividad en';
$string['title:saved'] = 'Los siguientes participantes tienen actividades en borrador';
