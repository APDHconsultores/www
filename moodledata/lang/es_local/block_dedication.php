...
/**
 * Strings for component 'block_dedication', language 'es', version '3.9'.
 *
...
$string['access_info'] = 'Sólo para facilitadores:';
$string['connectionratiorow'] = 'Conexiones por día';
$string['dedication:addinstance'] = 'Permitir añadir bloque de dedicación al espacio';
$string['dedication:use'] = 'Permitir usar bloque de dedicación al espacio';
$string['dedication_estimation'] = 'Tu tiempo de dedicación estimado es';
$string['dedicationall'] = 'Dedicación de todos los miembros del espacio. Haz clic en el nombre de un miembro para ver su dedicación detallada.';
...
$string['dedicationrow'] = 'Dedicación al espacio';
$string['form'] = 'Configuración de dedicación al espacio';
...
$string['pagetitle'] = '{$a}: dedicación al espacio';
...
$string['pluginname'] = 'Dedicación al espacio';
$string['sessionduration'] = 'Duración';
$string['sessionstart'] = 'Inicio de sesión';
$string['show_dedication'] = 'Mostrar el tiempo de dedicación a los participantes';
$string['show_dedication_help'] = 'Por defecto, el tiempo de dedicación sólo pueden verlo los facilitadores. Si marca esta opción, los alumnos podrán ver su tiempo de dedicación total en el bloque.';
