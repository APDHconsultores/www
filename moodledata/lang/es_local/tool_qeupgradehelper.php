...
/**
 * Strings for component 'tool_qeupgradehelper', language 'es', version '3.9'.
 *
...
$string['areyousuremessage'] = '¿Desea continuar con la actualización de todos los {$a->numtoconvert} intentos del cuestionario \'{$a->name}\' en el espacio {$a->shortname}?';
$string['areyousureresetmessage'] = 'El cuestionario \'{$a->name}\' en el espacio {$a->shortname} tiene {$a->totalattempts} intentos, de los que {$a->convertedattempts} fueron actualizados a partir del sistema anterior. De todos ellos, {$a->resettableattempts} pueden ser reiniciados, para posteriormente reconvertirlos. ¿Esta seguro que quiere continuar con ello?';
...
$string['cronstophour'] = 'Hora de cierre';
...
$string['upgradingquizattempts'] = 'Actualizando los intentos para el cuestionario \'{$a->name}\' en el espacio {$a->shortname}';
