...
/**
 * Strings for component 'qtype_ddmatch', language 'es', version '3.9'.
 *
...
$string['pluginname_help'] = 'Las preguntas de emparejamiento mediante arrastrar y soltar requieren que el participante relacione correctamente una lista de nombres o de oraciones (preguntas) contra otra lista de nombres o de oraciones (respuestas).';
