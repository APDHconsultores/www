...
/**
 * Strings for component 'enrol_lti', language 'es', version '3.9'.
 *
 * @package     enrol_lti
 * @category    string
...
$string['lti:unenrol'] = 'Desmatricular usuarios de un espacio';
...
$string['roleinstructor'] = 'Rol para el facilitador';
$string['rolelearner'] = 'Rol para el participante';
