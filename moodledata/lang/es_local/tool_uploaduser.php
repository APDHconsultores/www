...
/**
 * Strings for component 'tool_uploaduser', language 'es', version '3.9'.
 *
...
$string['uploadusers_help'] = 'Los usuarios pueden subirse (y, opcionalmente, matricularse en espacios) por medio de un archivo de texto. El formato debe ser el siguiente:
...
$string['uulegacy1role'] = '(Participante original) tipo N=1';
$string['uulegacy2role'] = '(Facilitador original) tipo N=2';
$string['uulegacy3role'] = '(Facilitador no editor original) tipo N=3';
