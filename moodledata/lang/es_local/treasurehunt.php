...
/**
 * Strings for component 'treasurehunt', language 'es', version '3.9'.
 *
...
Para que las actividades del espacio se muestren en la lista debe estar habilitada
la terminación de actividad en la configuración de Moodle, en el espacio y en la propia actividad.';
...
$string['addstage_tour'] = 'Añade varias etapas para que los participantes puedan seguir el camino. Cada etapa debe contener una pista para descubrir la siguiente etapa del camino. Además puedes poner una pregunta de verificación o establecer otras condiciones de desbloqueo.';
$string['aerialmap'] = 'Aéreo';
$string['aerialview'] = 'Aérea';
$string['allowattemptsfromdate'] = 'Permitir intentos desde';
$string['allowattemptsfromdate_help'] = 'Si está habilitado, los participantes no podrán jugar antes de esta fecha.
Si está deshabilitado, los participantes podrán comenzar a jugar de inmediato.';
...
visible para los participantes en la fecha "Permitir intentos desde".';
...
$string['editend_tour'] = '¡Ya estás listo para diseñar emocionantes juegos de Caza del Tesoro para tus participantes!';
...
$string['gradefromabsolutetime'] = 'Puntuación por hora de cierre';
...
de cierre, siendo el 50% de la calificación máxima el peor tiempo de cierre y el 100% el mejor.
...
<P><B>Puntuación por hora de cierre</B><P>
<UL>
...
$string['groupmode_help'] = 'Si está habilitado, los participantes se dividirán en grupos en función de la configuración de grupos del espacio.
...
útil en muchas situaciones: individual / equipo, movimiento / marcado manual en escritorio, puntuación de tiempo, posición, cierre, etc.
...
$string['notreasurehunts'] = 'No existe ninguna caza del tesoro en este espacio';
...
que desplazarse. Para ello, cada vez que el participante realiza un click simple sobre el mapa se crea una marca,
...
$string['playstagewithqr_help'] = 'Si se rellena, los participantes pueden descubrir esta etapa escaneando este QR.';
...
Para ello, cada vez que el participante realiza un click simple sobre el mapa se crea una marca,
...
$string['usersprogress_help'] = 'Indica el progreso de las etapas de cada participante/grupo en función de los colores:
...
Para poder usar el GPS para localizar a los participantes durante la Caza del Tesoro se debe acceder al servidor mediante
URLs seguras con HTTPS. En caso contrario, sólo se podrá usar el modo "Jugar sin moverse" en el que los jugadores
tienen que marcar manualmente en el mapa cada una de las etapas.
