...
/**
 * Strings for component 'tool_analytics', language 'es', version '3.9'.
 *
...
$string['scheduledanalysisresultscli'] = 'Resultados usando la división de tiempo del espacio {$a->name} (id: {$a->id})';
...
$string['weeksenddatedefault'] = 'Fecha de terminación calculada automáticamente a partir de la fecha de inicio del espacio.';
