...
/**
 * Strings for component 'qtype_essay', language 'es', version '3.9'.
 *
 * @package     qtype_essay
 * @category    string
...
$string['pluginname_help'] = 'En respuesta a una pregunta (puede incluir una imagen) el alumno escribe una respuesta de uno o dos párrafos. La pregunta de ensayo no se le asignará una calificación hasta que haya sido revisada por el facilitador y calificada de forma manual.';
...
$string['responseisrequired'] = 'Requerir al participante que introduzca texto';
