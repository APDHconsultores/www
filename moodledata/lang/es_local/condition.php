...
/**
 * Strings for component 'condition', language 'es', version '3.9'.
 *
 * @package     condition
 * @category    string
...
$string['availablefrom_help'] = '<strong>Permitir el acceso desde/hasta la fecha</strong>, determina el periodo de tiempo durante el que los participantes pueden acceder a la actividad mediante un enlace situado en la página del espacio.

La diferencia entre las fechas de <strong>acceso desde/hasta</strong> y las condiciones de temporalización de la actividad <strong>abrir/cerrar actividad</strong> es que estos últimos parámetros muestran a los participantes la descripción de la actividad en el espacio mientras que  <strong>Permitir el acceso  desde/hasta la fecha</strong> restringen incluso la visualización de esta descripción.';
...
$string['completioncondition'] = 'Condición de cierre de actividad';
$string['completioncondition_help'] = 'Este ajuste determina cualesquiera condiciones de cierre de la actividad, que deben cumplirse para acceder a la actividad. Note que el rastreo de cierre debe ajustarse antes de que se pueda determinar la condición de cierre de la actividad.

Si se desea, se pueden ajustar múltiples condiciones de cierre de la actividad. Si se hace así, la actividad sólo estará disponible cuando se cumplan TODAS las condiciones de cierre.';
...
$string['configenableavailability'] = 'Si se activa, esta opción le permite fijar las condiciones (basadas en la fecha, la calificación o el grado de cierre) que controlan si una actividad está disponible.';
