...
/**
 * Strings for component 'customcert', language 'es', version '3.9'.
 *
 * @package     customcert
 * @category    string
...
$string['code'] = 'Código';
$string['copy'] = 'Copia';
$string['coursetimereq'] = 'Minutos necesarios en el espacio';
$string['coursetimereq_help'] = 'Introduce aquí la cantidad mínima de tiempo, en minutos, que los participantes deben estar conectados al espacio antes de recibir su certificado.';
...
$string['customcert:manageemailstudents'] = 'Administrar la configuración del email de participantes';
$string['customcert:manageemailteachers'] = 'Gestionar configuraciones de Email de facilitadores';
...
$string['customcert:viewreport'] = 'Ver informe de espacio';
...
$string['emailnonstudentbody'] = 'Se adjunta el certificado\'{$a->certificatename}\' para \'{$a->userfullname}\' del espacio \'{$a->coursefullname}\'.';
$string['emailnonstudentbodyplaintext'] = 'Se adjunta el certificado\'{$a->certificatename}\' para \'{$a->userfullname}\' del espacio \'{$a->coursefullname}\'.';
...
$string['emailstudentbody'] = 'Adjunto se encuentra tu certificado  \'{$a->certificatename}\' por el espacio \'{$a->coursefullname}\'.';
$string['emailstudentbodyplaintext'] = 'Se adjunta su certificado \'{$a->certificatename}\' para el espacio \'{$a->coursefullname}\'.';
...
$string['emailstudents_help'] = 'Si se activa, esto enviará Email a los participantes con una copia del certificado cuando se vuelva disponible.';
$string['emailstudentsubject'] = '{$a->coursefullname}: {$a->certificatename}';
$string['emailteachers'] = 'Email a los facilitadores';
$string['emailteachers_help'] = 'Si se activa, esto enviará Email a los facilitadores con una copia del certificado cuando se vuelva disponible.';
...
$string['managetemplatesdesc'] = 'Este enlace le llevará a una nueva pantalla donde podrá manejar plantillas usadas por las actividades de certificados en los espacios.';
...
$string['nocustomcerts'] = 'Todavía no hay certificados para este espacio';
...
$string['requiredtimenotmet'] = 'Debes pasar un mínimo de {$a->requiredtime} minutos en el espacio antes de acceder a este certificado.';
