...
/**
 * Strings for component 'block_analytics_graphs', language 'es', version '3.9'.
 *
...
$string['analytics_graphs:bemonitored'] = 'El usuario se encuentra monitorizado en el espacio';
...
$string['grades_mail_dialog_title'] = 'Participantes con calificaciones menores o iguales que';
$string['graphs'] = 'Gráficas';
$string['hits'] = 'Aciertos de espacio';
...
$string['info_coursetype'] = 'Espacio';
$string['largest_grade'] = 'La nota más alta';
$string['late'] = 'Tarde';
$string['late_submission'] = 'Envío tardío';
$string['lbl_ccteachers'] = 'Enviar copias a otros facilitadores en este espacio';
...
$string['no_messages'] = 'Este participante no tiene mensajes';
$string['no_student_task'] = 'Esta actividad no contiene participantes en el grupo seleccionado';
$string['no_students'] = 'No hay participantes en el espacio';
...
$string['number_of_students'] = 'Número de participantes';
...
$string['timeaccesschart_tip'] = 'Participantes activos';
$string['timeaccesschart_title'] = 'Número de participantes activos';
$string['title_access'] = 'Distribuciones de accesos por contenido (Recursos, URL o páginas)';
$string['title_students'] = 'Participantes';
...
$string['typename_subcourse'] = 'Sub-espacio';
