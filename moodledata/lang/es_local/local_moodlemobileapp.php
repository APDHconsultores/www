...
/**
 * Strings for component 'local_moodlemobileapp', language 'es', version '3.9'.
 *
...
$string['addon.coursecompletion.couldnotloadreport'] = 'No se puede cargar el informe de cierre del espacio, por favor inténtalo de nuevo más tarde.';
...
$string['addon.notes.warningnotenotsent'] = 'No se pudieron añadir notas al espacio {{course}}. {{error}}';
...
$string['addon.storagemanager.deletecourse'] = 'Descargar todos los datos del espacio';
$string['addon.storagemanager.deletecourses'] = 'Borrar toda la información de los espacios.';
...
- Navegar por el contenido de sus espacios, incluso sin conexión
- Recibir notificaciones instantáneas de mensajes y otros eventos
- Encontrar y contactar de forma rápida a otras personas en sus espacios
- Subir imágenes, audio, vídeos y otros archivos desde su dispositivo móvil
- Ver las calificaciones de los espacios
- ¡y más!
...
$string['core.course.errordownloadingcourse'] = 'Error al descargar el espacio.';
...
$string['core.course.refreshcourse'] = 'Refrescar espacio';
$string['core.course.useactivityonbrowser'] = 'Puede acceder a esta actividad mediante el navegador de su dispositivo.';
$string['core.course.warningmanualcompletionmodified'] = 'La cierre manual de una actividad fue modificada en el sitio.';
$string['core.course.warningofflinemanualcompletiondeleted'] = 'Una parte de el cierre manual del espacio \'{{name}}\' ha sido eliminada. {{error}}';
$string['core.coursenogroups'] = 'Usted no es miembro de ningún grupo de este espacio.';
$string['core.courses.cannotretrievemorecategories'] = 'No se pueden recuperar categorías más profundas que el nivel {{$a}}.';
$string['core.courses.confirmselfenrol'] = '¿Está seguro que desea auto-matricularse en este espacio?';
$string['core.courses.downloadcourses'] = 'Descargar espacios';
$string['core.courses.enrolme'] = 'Matricularme';
$string['core.courses.errorloadcategories'] = 'Ocurrió un error al cargar categorías.';
$string['core.courses.errorloadcourses'] = 'Se ha producido un error cargando los espacios.';
$string['core.courses.errorloadplugins'] = 'Los plugins requeridos por este espacio no se han podido cargar correctamente. Por favor, reinicie la aplicación e inténtelo de nuevo.';
...
$string['core.courses.filtermycourses'] = 'Filtrar mis espacios';
$string['core.courses.notenrollable'] = 'No puede auto-matricularse en este espacio.';
$string['core.courses.password'] = 'Clave';
$string['core.courses.searchcoursesadvice'] = 'Puede utilizar el botón de buscar espacios para acceder como invitado o auto-matricularse en los espacios que lo permitan.';
$string['core.courses.selfenrolment'] = 'Auto-matriculación';
$string['core.courses.totalcoursesearchresults'] = 'Total de espacios: {{$a}}';
...
$string['core.login.changepasswordhelp'] = 'Si tiene problemas cambiando su contraseña por favor contacto al administrador de su sitio. "El administrador del sitio" es el encargado de la gestión de Moodle en su escuela/Universidad/empresa. Si desconoce como contactarle, por favor, contacte con su facilitador.';
...
<p>Los "Administradores del sitio" son las personas que gestionan el Moodle en su escuela/universidad/compañía o su organización educativa. Si no sabe a quien contactar, por favor póngase en contacto con sus facilitadores/entrenadores.</p>';
...
$string['core.login.onboardingenrolmanagestudents'] = 'Matricular y gestionar sus participantes';
...
$string['core.login.onboardingimalearner'] = 'Soy un participante';
$string['core.login.onboardingimaneducator'] = 'Soy un mentor/facilitador';
...
$string['core.whoissiteadmin'] = '"El administrador del sitio" es el encargado de la gestión de Moodle en su escuela/Universidad/empresa. Si desconoce como contactarle, por favor, contacte con su facilitador.';
