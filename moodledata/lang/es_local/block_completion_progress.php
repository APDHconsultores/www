...
/**
 * Strings for component 'block_completion_progress', language 'es', version '3.9'.
 *
...
$string['completion_not_enabled'] = 'El rastreo de cierre no está habilitado en este sitio.';
$string['completion_not_enabled_course'] = 'El rastreo de cierre no está habilitado en este espacio.';
...
$string['completion_progress:overview'] = 'Ver el resumen del espacio del Estado de Finalización para todos los participantes';
...
$string['config_orderby_course_order'] = 'Ordenación xencursox';
$string['config_orderby_due_time'] = 'Tiempo usando fecha "{$a}"';
$string['config_percentage'] = 'Mostrar porcentaje a participantes';
...
$string['coursenametoshow'] = 'Nombre del espacio a mostrar en el Panel';
$string['defaultlongbars'] = 'Presentación predeterminada para las barras largas';
$string['fullname'] = 'Nombre completo del espacio';
...
$string['how_activitiesincluded_works_help'] = '<p>De manera predeterminada, todas las actividades con el conjunto de ajustes de cierre de la actividad se incluyen en la barra. </p> <p> También puede seleccionar manualmente las actividades a ser incluidas.</p>';
...
$string['how_ordering_works_help'] = '<p>Hay dos formas de ordenar las actividades en el bloque de Estado de cierre.</p> <ul> <li> <em>El tiempo usando "Esperando el cierre en" fecha </em> (predeterminado) <br />Las fechas de cierre previstas de actividades/recursos se utilizan para ordenar la barra. En el caso de que las actividades/recursos no tengan una fecha de cierre prevista, en su lugar se utiliza el orden en el espacio. Cuando se utiliza esta opción, se muestra el indicador AHORA. </li> <li> <em> Ordenamiento xencursox </em> <br /> Las actividades/recursos se presentan en el mismo orden en que están en la página del espacio. Cuando se utiliza esta opción, las fechas de cierre prevista se ignoran. Cuando se utiliza esta opción, no se muestra el indicador AHORA. </li> </ul>';
$string['how_selectactivities_works'] = 'Como funciona incluyendo actividades';
$string['how_selectactivities_works_help'] = '<p> Para seleccionar manualmente las actividades a incluir en la barra, asegúrese que "Actividades incluidas" esté marcado como "actividades seleccionadas". </p> <p> Sólo las actividades con ajustes de cierre pueden ser incluidas. </p> <p> Mantenga pulsada la tecla CTRL para seleccionar múltiples actividades. </p>';
$string['lastonline'] = 'Último en el espacio';
$string['mouse_over_prompt'] = 'Coloque el puntero del ratón encima o toque la barra para más información.';
$string['no_activities_config_message'] = 'No hay actividades o recursos con el cierre de actividad establecida o no se han seleccionado actividades o recursos. Configure los requisitos de cierre de las actividades en las actividades y los recursos, y luego configure este bloque.';
...
$string['no_blocks'] = 'No hay bloques de Estado de Finalización establecidos para sus espacios.';
$string['no_courses'] = 'No está inscrito en ningún espacio. Sólo se mostrarán las barras de espacios matriculados.';
...
$string['not_all_expected_set'] = 'No todas las actividades con cierre tienen una fecha establecida "{$a}".';
$string['now_indicator'] = 'AHORA';
$string['overview'] = 'Vista general de participantes';
$string['pluginname'] = 'Estado de Finalización';
$string['progress'] = 'Progreso';
$string['progressbar'] = 'Estado de Finalización';
$string['shortname'] = 'Nombre corto de espacio';
$string['showallinfo'] = 'Mostrar toda la información';
$string['showinactive'] = 'Mostrar participantes inactivos en Vista general';
...
$string['why_set_the_title_help'] = '<p>Pueden existir múltiples instancias del bloque de estado de cierre. Es posible utilizar diferentes bloques de estado de cierre para seguir diferentes tipos de actividades o recursos. Por ejemplo, podría hacer seguimiento del progreso de las tareas en un bloque y los cuestionarios en otro. Por esta razón puede anular el título predeterminado y establecer un título más adecuado para cada caso. </p>';
$string['why_show_precentage'] = '¿Porqué mostrar un porcentaje de progreso a participantes?';
$string['why_show_precentage_help'] = '<p> Es posible mostrar un porcentaje global del progreso a los participantes. </ p> <p>Se calcula como el número de actividades realizadas dividido por el número total de actividades en la barra. </ p> <p>El porcentaje de progreso aparece hasta que el participante pasa el ratón sobre un elemento de la barra. </ p>';
$string['why_use_icons'] = '¿Porqué querría Usted usar íconos?';
$string['why_use_icons_help'] = '<p>Es posible que desee añadir iconos de marca y cruz en el Estado de Finalización para hacer este bloque visualmente más accesible para los participantes con ceguera al color. </p> <p>Se puede también hacer que el significado del bloque sea más claro si cree que los colores no son intuitivos, ya sea por razones culturales o personales. </p>';
