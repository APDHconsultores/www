...
/**
 * Strings for component 'block_course_contents', language 'es', version '3.9'.
 *
...
$string['course_contents:addinstance'] = 'Añadir un nuevo bloque de contenido del espacio';
$string['notusingsections'] = 'Este formato de espacio no usa secciones.';
$string['pluginname'] = 'Contenido del espacio';
