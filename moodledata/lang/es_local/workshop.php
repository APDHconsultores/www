...
/**
 * Strings for component 'workshop', language 'es', version '3.9'.
 *
 * @package     workshop
 * @category    string
...
$string['configmaxbytes'] = 'Por defecto, tamaño máximo del archivo enviado en todos los talleres del sitio (sujeto a las limitaciones del espacio y a otros parámetros locales)';
...
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad de Taller.';
$string['indicator:socialbreadth'] = 'Taller social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad de Taller.';
...
$string['modulename_help'] = 'El módulo de actividad taller permite la recopilación, revisión y evaluación por pares del trabajo de los participantes.

Los participantes pueden enviar cualquier contenido digital (archivos), tales como documentos de procesador de texto o de hojas de cálculo y también pueden escribir el texto directamente en un campo empleando un editor de texto (dentro de Moodle).

Los envíos son evaluados empleando un formato de evaluación de criterios múltiples definido por el facilitador. El proceso de revisión por pares  y el formato para comprender cómo funciona la evaluación se pueden practicar por anticipado con envíos de ejemplo proporcionados por el maestro, junto con una evaluación de referencia. A los participantes se les dará la oportunidad de evaluar uno o más de los envíos de sus pares participantes. Los que envían y los que evalúan pueden permanecer anónimos si se requiere así.

Los participantes tendrán dos calificaciones para la actividad de taller: una calificación por  enviarlo y otra por la evaluación de sus pares. Ambas calificaciones se guardan en el libro de calificaciones.';
...
$string['noworkshops'] = 'No hay talleres en este espacio';
...
$string['switchphase10info'] = 'Está a punto de entrar a la <strong>Fase de instalación </strong> del taller. En esta fase, los usuarios no pueden modificar sus envíos o evaluaciones. Los facilitadores pueden usar esta fase para cambiar la configuración del taller, modificar la estrategia de calificación o retocar los formularios de evaluación.';
$string['switchphase20'] = 'Cambiar a la fase de envío';
$string['switchphase20info'] = 'Está a punto de cambiar a la <strong>Fase de envíos </strong> del taller. En esta fase, los participantes pueden enviar sus trabajos (dentro de los plazos de control de acceso existentes). Los facilitadores pueden asignar los envíos para ser revisados por pares.';
...
$string['switchphase40info'] = 'Está a punto de cambiar a la <strong>Fase de Calificación de Evaluaciones </strong> del taller. En esta fase, los usuario no pueden modificar sus trabajos ni sus evaluaciones. Los facilitadores pueden emplear las herramientas de calificación de evaluaciones para calcular las calificaciones finales y proporcionar  retroalimentación a los evaluadores.';
$string['switchphase50'] = 'Cerrar taller';
$string['switchphase50info'] = 'Está a punto de cerrar el taller. Esto dará como resultado que las calificaciones calculadas aparecerán en el libro de calificaciones. Los participantes pueden ver sus envíos y las evaluaciones de estos.';
...
$string['usepeerassessment_desc'] = 'Los participantes pueden evaluar el trabajo de otros';
...
$string['useselfassessment_desc'] = 'Los participantes pueden evaluar su propio trabajo';
