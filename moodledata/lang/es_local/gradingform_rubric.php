...
/**
 * Strings for component 'gradingform_rubric', language 'es', version '3.9'.
 *
...
$string['name'] = 'Nombre';
$string['needregrademessage'] = 'La definición de la rúbrica fue cambiada después de que este participante hubiera sido calificado. El participante no puede ver esta rúbrica hasta que usted la verifique y  actualice la calificación.';
$string['pluginname'] = 'Rúbrica';
$string['previewrubric'] = 'Previsualizar rubrica';
$string['regrademessage1'] = 'Usted está a punto de guardar los cambios en una rúbrica que ya ha sido utilizada para calificar. Por favor, indique si las calificaciones existentes deben ser revisadas. Si decide que debe ser así, entonces la rúbrica se ocultará a los participantes hasta el elemento sea recalificado.';
$string['regrademessage5'] = 'Usted está a punto de guardar cambios significativos en una rúbrica que ya ha sido utilizada para la clasificación. El valor del libro de calificaciones no se verá afectado, pero la rúbrica no será visible para los participantes hasta que sus elementos  sean recalificados.';
