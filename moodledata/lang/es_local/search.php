...
/**
 * Strings for component 'search', language 'es', version '3.9'.
 *
 * @package     search
 * @category    string
...
$string['incourse'] = 'en el espacio {$a}';
$string['index'] = 'Índice';
...
$string['search:customfield'] = 'Campos personalizados del espacio';
$string['search:message_received'] = 'Mensajes - recibidos';
$string['search:message_sent'] = 'Mensajes - enviados';
$string['search:mycourse'] = 'Mis espacios';
