...
/**
 * Strings for component 'local_moodlecloudsignup', language 'es', version '3.9'.
 *
...
$string['portal:list.table.titles.sites'] = 'Sitios';
...
$string['regions:eu-west-1'] = 'Irlanda';
$string['regions:us-west-2'] = 'Estados Unidos';
$string['signup:authcode.body.lead'] = 'Acabamos de enviar un código de verificación a tu teléfono vía SMS, necesitarás introducirlo a continuación.';
...
$string['signup:page.breadcrumb'] = 'Registrarse';
$string['signup:page.description'] = 'Software de aprendizaje gratuito Moodle alojado en servidores en la nube para que facilitadores e facilitadores desplieguen sitios Moodle en un instante';
$string['signup:page.title'] = 'MoodleCloud: Registro para Alojamiento Moodle gratuito';
$string['signup:password.body.restoredpassword'] = '¡Buenas noticias! Hemos encontrado una contraseña para tu cuenta actual de MoodleCloud. Si quieres continuar utilizando esta contraseña, puedes saltarte esta sección.';
...
$string['signup:reserve.body.lead'] = 'Elige un nombre único para tu sitio y selecciona una localización (en ella es donde tu sitio será alojado, así que te recomendamos que elijas la más próxima a tí y tus participantes).';
...
$string['signup:reserve.form.tooltips.region'] = 'La localización es donde tu sitio será alojado. Recomendamos que elijas la más próxima a ti y tus participantes.';
...
$string['validators:site.email.mustexist'] = 'Debes especificar tu dirección de email';
$string['validators:site.email.validformat'] = 'Por favor, especifica tu dirección de email con un formato correcto';
