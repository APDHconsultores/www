...
/**
 * Strings for component 'block_coupon', language 'es', version '3.9'.
 *
...
$string['coupon:extendenrolments'] = 'Generar cupones para extender matriculación a espacios';
...
Seleccionar espacio(s): {$a->courses}<br/>
...
$string['coupon:type:course'] = 'Matriculación al espacio';
...
$string['coupon:user:info'] = 'Use el formulario de abajo para configurar las opciones y los espacios  accesibles para los que este usuario puede pedir cupones';
...
$string['default-coupon-page-template-main'] = 'Con este cupón podrá activar su acceso exclusivo al espacio:<br/>
{courses}<br/><br/>
...
$string['error:missing_course'] = 'El espacio asociado a este cupón ya no existe.';
...
$string['heading:input_course'] = 'Seleccionar espacio';
