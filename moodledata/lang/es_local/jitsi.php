...
/**
 * Strings for component 'jitsi', language 'es', version '3.9'.
 *
 * @package     jitsi
 * @category    string
...
$string['finishandreturnex'] = 'Volver al espacio cuando termine la sesión';
$string['help'] = 'Ayuda';
...
$string['modulename_help'] = 'Usar el modulo Jitsi para videoconferencias';
