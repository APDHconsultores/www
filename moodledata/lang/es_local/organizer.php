...
/**
 * Strings for component 'organizer', language 'es', version '3.9'.
 *
 * @package     organizer
 * @category    string
...
Sistema de Mensajería TUWEL';
$string['appointment_reminder:teacher:digest:smallmessage'] = 'Ha recibido un mensaje resumen de sus citas para mañana.';
$string['appointment_reminder:teacher:digest:subject'] = 'Resumen de citas';
...
Sistema de Mensajería TUWEL';
$string['appointment_reminder:teacher:group:digest:smallmessage'] = 'Ha recibido un mensaje resumen de sus citas para mañana.';
$string['appointment_reminder:teacher:group:digest:subject'] = 'Resumen de citas';
$string['configdigest_label'] = 'Enviar resumen de citas a los facilitadores';
...
$string['modulename_help'] = 'Los organizadores permiten que el facilitador concierte citas con los participantes creando celdas de tiempo donde los participantes se pueden registrar.';
...
$string['mymoodle_attended'] = '{$a->attended}/{$a->total} participantes han completado una cita';
...
$string['mymoodle_registered'] = '{$a->registered}/{$a->total} participantes se han registrado para una cita';
...
$string['mymoodle_registered_short'] = '{$a->attended}/{$a->total} participantes registrados';
...
$string['notificationtime_help'] = 'Define con cuanta antelación hay que avisar a un participante antes de una cita registrada.';
$string['numentries'] = 'Entradas mostradas por página';
$string['numentries_help'] = 'Elija "óptimo" para optimizar la distribución de la lista de entradas de acuerdo con el tamaño de texto y orientación de página elegidos, si hay muchos participantes registrados en su espacio';
...
$string['organizer:assignslots'] = 'Asignar celda de tiempo a un participante';
