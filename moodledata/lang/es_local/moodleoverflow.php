...
/**
 * Strings for component 'moodleoverflow', language 'es', version '3.9'.
 *
...
$string['allowcoursereputation'] = 'Suma de reputación dentro de un espacio.';
$string['allownegativereputation'] = '¿Permitir reputación negativa?';
$string['allownegativereputation_help'] = 'Si se selecciona sí, la reputación de los usuarios en un espacio o en un módulo puede ser negativa. Si se selecciona no, la reputación no bajará más de 0.';
...
$string['bestanswer'] = 'Los propietarios de la pregunta y del espacio han aceptado ésta como la mejor respuesta.';
...
$string['configallowcoursereputation'] = '¿Quieres permitir la suma de reputación de todas las instancias del espacio actual?';
...
$string['configforcedreadtracking'] = 'Permite establecer forzosamente a Moodleoverflow para el seguimiento de leídos. Resultará en un peor rendimiento para algunos usuarios, particularmente en espacios con muchos moodleoverflows y mensajes. Estando desactivado, cualquier moodleoverflow anteriormente establecido como forzoso será tratado como opcional.';
...
$string['configmaxbytes'] = 'Tamaño máximo por defecto para todos los adjuntos de los foros del sitio (sujeto a límites de espacio y otros ajustes locales)';
...
$string['configpreferteachersmark'] = 'Un mensaje de respuesta marcado como resuelto por el administrador del espacio prevalecerá sobre un mensaje marcado como útil por el creador del tema.';
...
$string['coursewidereputation_help'] = 'Si seleccionas "Sí", la reputación de los usuarios en todas las actividades moodleoverflow de todo el espacio serán sumadas';
...
$string['generalmoodleoverflows'] = 'Foros en este espacio';
...
$string['notteacher'] = 'Solo los administradores del espacio pueden hacer esto.';
...
$string['preferteachersmark'] = '¿Preferir marcas del propietario del espacio?';
...
* Resuelto - Un mensaje marcado como resuelto por un facilitador será fijado en la parte superior del tema';
