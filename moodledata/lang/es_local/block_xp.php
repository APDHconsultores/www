...
/**
 * Strings for component 'block_xp', language 'es', version '3.9'.
 *
 * @package     block_xp
 * @category    string
...
$string['admindefaultrulesintro'] = 'Las siguientes reglas serán usadas por defecto para los espacios en los que se añada el bloque.';
$string['admindefaultsettingsintro'] = 'La configuración que aparece a continuación será usada por defecto cuando el bloque sea añadido por primera vez a un espacio.';
$string['admindefaultvisualsintro'] = 'Las siguientes imágenes serán usadas por defecto cuando el bloque sea añadido por primera vez a un espacio.';
...
$string['awardaxpwhen'] = '<strong>{$a}</strong> puntos son ganados cuando:';
...
$string['courselog'] = 'Registro del espacio';
$string['coursereport'] = 'Reporte del espacio';
$string['courserules'] = 'Normas del espacio';
$string['coursesettings'] = 'Configuraciones del espacio';
$string['coursevisuals'] = 'Visuales del espacio';
...
$string['discoverlevelupplus'] = 'Descubre Level up! Plus';
$string['enableinfos'] = 'Habilitar página de información';
$string['enableinfos_help'] = 'Cuando se configura a \'No\', los participantes no podrán ver la página de información.';
$string['enableladder'] = 'Habilitar el ranking';
$string['enableladder_help'] = 'Cuando se configura a \'No\', los participantes no podrán ver el ranking.';
$string['enablelevelupnotif'] = 'Habilitar notificación de subida de nivel';
$string['enablelevelupnotif_help'] = 'Cuando se configura a \'Si\', a los participantes se les mostrará una ventana emergente felicitándolos por el nuevo nivel alcanzado.';
$string['enablelogging'] = 'Habilitar registro';
$string['enablexpgain'] = 'Habilitar ganancia de experiencia';
$string['enablexpgain_help'] = 'Este es el switch Si/No para el plugin en este espacio. Cuando se configura como NO, nadie podrá ganar puntos de experiencia en el espacio. Es útil para congelar por un tiempo los niveles.
...
$string['incourses'] = 'En los espacios';
...
$string['participatetolevelup'] = '¡Participe en el espacio para ganar puntos de experiencia y subir de nivel!';
...
$string['rank'] = 'Ranking';
$string['reallyresetdata'] = '¿Realmente desea reiniciar los niveles y puntos de experiencia de todos en este espacio?';
$string['resetcoursedata'] = 'Reiniciar datos del espacio';
$string['rule'] = 'Regla';
...
$string['rulesformhelp'] = '<p>Este plugin hace uso de EVENTOS para otorgar punto de experiencia en acciones llevadas a cabo por los participantes. Puede utilizar la forma sigueinte para agregar sus propias reglas y ver las que vienen por defecto.</p>
<p>Se aconseja que cheque el <a href="{$a->log}">log</a> del plugin para identificar que eventos se gatillan cuando se llevan a cabo ciertas acciones en el espacio y también para leer más sobre eventos: <a href="{$a->list}">lista de todos los eventos</a>, <a href="{$a->doc}">Documentos del desarrollador</a>.</p>
