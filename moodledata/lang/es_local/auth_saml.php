...
/**
 * Strings for component 'auth_saml', language 'es', version '3.9'.
 *
 * @package     auth_saml
 * @category    string
...
$string['auth_saml_course_field_id'] = 'Campo usado para identificar un espacio';
$string['auth_saml_course_field_id_description'] = 'Nosotros podemos mapear el espacio SAML con el nombre corto de Moodle o con el número de ID del Espacio';
$string['auth_saml_course_mapping_dsn'] = 'DNS del espacio';
$string['auth_saml_course_mapping_sql'] = 'SQL del espacio';
$string['auth_saml_course_not_found'] = 'Saml  del espacio {$a->course} no encontrado para el usuario  {$a->user}n';
$string['auth_saml_courses'] = 'Mapeo de espacios SAML';
$string['auth_saml_courses_description'] = 'Atributo SAML que contiene datos de espacios (por defecto schacUserStatus)';
$string['auth_saml_courses_not_found'] = 'IdP devolvió un conjunto de datos que no contienen el campo para mapeo de espacios SAML  ({$a}). Este campo se requiere para inscribir al usuario';
...
$string['auth_saml_error_attribute_course_mapping'] = 'Error en nombres de atributos (índice) del mapeo de tablas del espacio. Revise la sintaxis de externalcoursemappingsql';
...
$string['auth_saml_error_executing_course_mapping_query'] = 'Error al ejecutar búsqueda de mapeo del espacio';
...
$string['auth_saml_errorsamlexternal'] = 'Dice que el mapeo orígen para el espacio y el rol deberían de ser externos y, por lo tanto, Usted debe especificar todos los parámetros de las búsquedas DSN y SQL.';
...
$string['auth_saml_ignoreinactivecourses'] = 'Ignorar espacios inactivos';
$string['auth_saml_ignoreinactivecourses_description'] = 'Si no se activa, el plugin va a des-inscribir los espacios \'inactivos\'';
...
$string['auth_saml_mapping_dsn_description'] = 'Cadena con el nombre del Orígen de los Datos para conectar a la base de datos de mapeo del espacio/rol (dsn debe ser una ruta absoluta en caso de estar usando SQLite)';
...
$string['auth_saml_not_authorize'] = '{$a} no tiene espacio CAV activo';
...
$string['auth_saml_supportcourses'] = 'Espacios soporte SAML';
$string['auth_saml_supportcourses_description'] = 'Elija entre Interna o Externa, para que Moodle auto inscriba usuarios a los espacios (Use externa si su mapeo de espacios/roles es una Base de Datos externa)';
