...
/**
 * Strings for component 'choice', language 'es', version '3.9'.
 *
 * @package     choice
 * @category    string
...
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad Elección.';
...
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad Consulta.';
...
$string['modulename_help'] = 'El módulo Consulta permite al facilitador hacer una pregunta especificando las posibles respuestas posibles.

Los resultados de la elección puede ser publicados después que los participantes hayan respondido, después de cierta fecha, o no publicarse. Los resultados pueden ser publicados, con los nombres de los participantes o de forma anónima.

Una Consulta puede utilizarse

* Para realizar una encuesta rápida que estimule a los alunmos a reflexionar sobre un tema

* Para comprobar rápidamente que los participantes han entendido algo concreto

* Para facilitar la toma de decisiones, por ejemplo permitiendo a los participantes votar algún aspecto relacionado con el espacio.';
...
$string['publishafteranswer'] = 'Mostrar los resultados al participante después de su respuesta';
$string['publishafterclose'] = 'Mostrar los resultados a los participantes sólo después de cerrar la consulta';
...
$string['showpreview_help'] = 'Permitir a los participantes ver las opciones disponibles antes de que la consulta esté abierta para enviar.';
