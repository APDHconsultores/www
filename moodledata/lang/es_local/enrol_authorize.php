...
$string['adminemailexpiredsort'] = 'Cuando el número de órdenes a expirar pendientes se envían a los facilitadores por email, ¿cuál es importante?';
...
y el usuario podrá matricularse en el espacio; en caso contrario, expirará en on {$a->expireon} y no podrá ser capturada después de ese día.

Asimismo, usted puede aceptar o rechazar el pago para matricular al participante inmediatamente siguiendo este enlace:
{$a->url}';
...
$string['adminteachermanagepay'] = 'Los facilitadores pueden gestionar los pagos del espacio.';
...
$string['anemailexpiredteacher'] = 'Notificación de expiración - Facilitador';
...
$string['authorize:unenrol'] = 'Dar de baja usuarios del espacio';
$string['authorize:unenrolself'] = 'Darse de baja del espacio';
...
$string['captureyes'] = 'La tarjeta de crédito será capturada y el participante será matriculado en el espacio. ¿Está seguro?';
...
$string['choosemethod'] = 'Si conoce la clave de matriculación en el espacio, escríbala;<br />en caso contrario, necesitará pagar para acceder al espacio.';
$string['chooseone'] = 'Rellene uno o ambos de los siguientes dos campos';
$string['cost'] = 'Coste';
$string['costdefaultdesc'] = '<strong>En los ajustes del espacio, escriba -1</strong> en el campo de costo para usar dicho costo por defecto.';
...
$string['description'] = 'El módulo Authorize.net le permite ajustar espacios de pago vía proveedores CC. Si el costo de cualquier espacio es cero, no se pedirá a los participantes que paguen. Existe un costo del sitio que usted ajusta aquí por defecto para todo el sitio y además un ajuste por espacio que puede efectuar para cada espacio individualmente. El costo del espacio pasa por alto el costo del sitio.';
...
$string['new'] = 'Nuevo';
$string['nocost'] = '¡No hay ningún coste asociado a la matriculación en este espacio a través de Authorize.Net';
...
$string['paymentpending'] = 'El pago de este espacio está pendiente con este número de orden {$a->orderid}. Vea <a href=\'{$a->url}\'>Detalles de la orden</a>.';
...
{$a->enrolurl}';
$string['pendingordersemailteacher'] = 'Estimado facilitador,

{$a->pending} transacciones por un costo de {$a->currency} {$a->sumcost} para el espacio "{$a->course}"
...
$string['reviewnotify'] = 'Su pago será revisado. En unos días recibirá un email de su facilitador.';
...
$string['unenrolselfconfirm'] = '¿Realmente desea darse de baja del espacio "{$a}"?';
$string['unenrolstudent'] = '¿Dar de baja al participante?';
...
Gracias por enviar su pago. Usted está matriculado en los siguientes espacios:
