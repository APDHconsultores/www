...
/**
 * Strings for component 'tool_dataprivacy', language 'es', version '3.9'.
 *
...
$string['contextlevelname40'] = 'Categorías de espacio';
$string['contextlevelname50'] = 'Espacios';
...
$string['dataregistryinfo'] = 'El registro de datos habilita las categorías (tipos de datos) y propósitos (la razón para procesar los datos) para que sean configurados para todos los contenidos del sitio - desde usuario y espacios hasta actividades y bloques. Para cada propósito, puede configurarse un período de retención. Cuando un período de retención haya expirado, los datos son señalizados y listados para eliminación, esperando la confirmación administrativa.';
...
$string['effectiveretentionperiodcourse'] = '{$a} (después de la fecha de terminación del espacio)';
...
$string['errorrequestalreadyexists'] = 'Ya tiene una solicitud xencursox.';
...
$string['frontpagecourse'] = 'Espacio en la Portada';
...
$string['purpose_help'] = 'El propósito describe la razón para procesar los datos. Puede añadirse un nuevo propósito, o si se selecciona Heredar, el propósito de un contexto superior es aplicado. Los contextos son (de bajo a alto): Bloques  > Módulos de actividad > Espacios > Categorías de espacio > Usuario > Sitio.';
$string['purposecreated'] = 'Propósito creado';
$string['purposedefault'] = 'Propósito por defecto';
$string['purposedefault_help'] = 'El Propósito por defecto es el propósito que es aplicado a cualquier nueva instancia. Si se selecciona Heredar, el propósito de un contexto superior es aplicado. Los contextos son (de bajo a alto): Bloques  > Módulos de actividad > Espacios > Categorías de espacio > Usuario > Sitio.';
...
$string['requireallenddatesforuserdeletion'] = 'Considerar espacios sin fecha de terminación como activos';
...
* si es que el usuario está activamente inscrito en algún espacio.

Al revisar las inscripciones activas de un espacio, si el espacio no tiene fecha de término entonces esta configuración es usada para determinar si es que ese espacio es considerado activo o no.

Si el espacio no tiene fecha de término, y esta configuración es habilitada, entonces el usuario no puede ser eliminado';
