...
/**
 * Strings for component 'gradeexport_checklist', language 'es', version '3.9'.
 *
...
$string['checklist:viewall'] = 'Ver informe de lista de verificación para todos los participantes del espacio';
$string['checklist:viewdistrict'] = 'Ver informe de lista de verificación para  los participantes del mismo distrito';
...
$string['percentcol2'] = 'Mostrar (ítems requeridos) porcentaje completo para cada participante';
...
$string['percentrow2'] = 'Mostrar porcentaje de participantes que hayan palomeado cada ítem';
