...
/**
 * Strings for component 'offlinequiz', language 'es', version '3.9'.
 *
 * @package     offlinequiz
 * @category    string
...
$string['allstudents'] = 'Mostrar todos los participantes';
...
$string['attemptsonly'] = 'Muestra los participantes con resultados';
...
$string['closestudentview'] = 'Cerrar vista del participante';
$string['closewindow'] = 'Cerrar ventana';
$string['cmmissing'] = 'No se encuentra el módulo del espacio con ID {$a} para el cuestionario offline';
...
$string['marginwarning'] = '¡Por favor, imprima los siguientes archivos PDF sin márgenes adicionales!<br /> Evite repartir fotocopias a los participantes. Si tiene alguna duda, solicite copias al equipo de soporte.';
$string['marks'] = 'Puntos';
$string['matrikel'] = 'número de participante';
...
$string['modulename_help'] = 'Este módulo permite al facilitador diseñar cuestionarios offline compuestos por preguntas de opción múltiple.
Estas preguntas son conservadas en el banco de preguntas de Moodle y pueden ser reutilizadas en el mismo espacio e incluso en otros.
Los cuestionarios offline pueden ser descargados como archivos PDF, DOCX o LaTeX. Los participantes marcan sus respuestas en formularios en papel. Los formularios en papel son escaneados y las respuestas importadas al sistema.';
...
<br />¡Esto implica la intervención manual de un facilitador y el retraso en la publicación de los resultados del cuestionario offline (sin conexión)!</strong>';
...
$string['noattemptsonly'] = 'Mostrar sólo participantes sin resultados';
$string['nocourse'] = 'No se ha encontrado el espacio con el id {$a->course} al que pertenece el cuestionario offline con ID {$a->offlinequiz}.';
...
$string['oneclickenroldesc'] = 'Si se activa esta opción los facilitadores tienen la posibilidad de matricular usuarios con un clic mientras están corrigiendo los formularios de respuestas (error "El usuario no está en el espacio").';
$string['oneclickroledesc'] = 'Elija el rol usado para matriculación en un clic. Sólo pueden seleccionarse roles con el arquetipo "Participante".';
...
Ayudan al facilitador a comprobar qué participantes participan en el cuestionario y si todos los resultados fueron importados correctamente.
...
Las listas de participantes pueden ser descargadas como documentos PDF, impresas y marcadas con cruces igual que los formularios de respuesta. Después pueden ser cargados y los participantes marcados se guardan como presentes en la base de datos.
Por favor, evite manchas en el código de barras ya que estos son usados para identificar a los participantes.</p>';
...
$string['printstudycodefield_help'] = 'Si se marca, el código de estudio será impreso en la primera página de la hoja de preguntas.';
...
$string['privacy:metadata:offlinequiz_queue:importuserid'] = 'El id de usuario del facilitador que importó los archivos';
...
$string['quizopenclose_help'] = 'Los participantes sólo pueden ver sus intentos después de la fecha de apertura y antes de la fecha de cierre.';
...
$string['showcopyrightdesc'] = 'Si habilita esta opción , un mensaje de copyright será mostrado en la hoja de revisión de resultados del participante.';
...
$string['showmissingattemptonly'] = 'Mostrar todos los participantes marcados sin resultados';
$string['showmissingcheckonly'] = 'Mostrar todos los participantes desmarcados con resultados';
...
$string['showstudentview'] = 'Mostrar vista del participante';
$string['showtutorial'] = 'Mostrar un tutorial del cuestionario offline a los participantes.';
$string['showtutorial_help'] = 'Esta opción determina si los participantes pueden ver un tutorial básico sobre los cuestionarios offline.
...
<b>Nota:</b><br />
Si usted deja esta opción en "Sí" pero oculta el cuestionario offline, el enlace al tutorial no será visible. En este caso, puede añadir un enlace al tutorial en la página del espacio.';
$string['showtutorialdescription'] = 'Puede añadir un enlace al tutorial en la página del espacio utilizando esta URL:';
...
$string['usernotincourse'] = 'El usuario {$a} no está en el espacio.';
$string['usernotinlist'] = '¡Usuario no registrado en la lista!';
$string['usernotregistered'] = 'El usuario {$a} no está registrado en el espacio.';
