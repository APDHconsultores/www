...
/**
 * Strings for component 'local_mass_enroll', language 'es', version '3.9'.
 *
...
$string['enablemassenrol'] = 'Permite la matriculación masiva por parte del administrador del espacio';
$string['enablemassenrol_help'] = 'Marque esta opción para permitir extender la matriculación masiva en el árbol de administración del espacio';
$string['enablemassunenrol'] = 'Permitir la desmatriculación masiva por parte del administrador del espacio';
$string['enablemassunenrol_help'] = 'Marque esta opción para permitir extender la desmatriculación masiva en el árbol de administración del espacio';
$string['enroll'] = 'Matricularlos a mi espacio';
...
$string['im:error_add_grp'] = 'error al agregar el agrupamiento {$a->groupe} al espacio {$a->courseid}';
$string['im:error_addg'] = 'error al agregar el grupo {$a->groupe} al espacio {$a->courseid}';
...
Ha matriculado a la siguiente lista de usuarios a su espacio \'{$a->course}\'.
...
Ha desmatriculado la siguiente lista de usuarios de su espacio \'{$a->course}\'.
Aquí está el reporte de operaciones:
{$a->report}
Atentamente.';
...
$string['mass_enroll:enrol'] = 'Matricular usuarios a un espacio con un archivo CSV';
$string['mass_enroll:unenrol'] = 'Desmatricular usuarios de un espacio con un archivo CSV';
...
Deberá prepararlo con un sistema de hojas de cálculo de su preferencia en base a una lista oficial de participantes, por ejemplo,
y añadir si es necesario una columna con los grupos a los cuales desea añadir estos participantes. Finalmente deberá exportar el archivo a formato CSV. (*)</p>
...
<p>
Si el nombre del grupo no existe, se creará uno en su espacio, junto con un agrupamiento con el mismo nombre al cual será añadido el grupo.<br/>
...
<p>
Puede desmarcar opciones para crear grupos y agrupamientos si está seguro de que estos ya existen en el espacio.
</p>

<p>
Por defecto, los usuarios serán matriculados como participantes, pero puede seleccionar otros roles que pueda administrar (facilitador, cofacilitador
u otros roles)
</p>
...
Números _ID y un grupo para ser creado en el espacio (*)
<pre>
"idnumber";"group"
" 2513110";" 4GEN"
" 2512334";" 4GEN"
...
<p>
Puede repetir esta operación tantas veces como lo necesite sin correr riesgos, por ejemplo si se olvida de desmatricular a algunos participantes.
</p>
...
<p>
<span <font color=\'red\'>(**) </font></span>: las cuentas deben existir en Moodle y deben estar matriculadas en este espacio.
</p>';
...
$string['unenroll'] = 'Desmatricularlos de mi espacio';
