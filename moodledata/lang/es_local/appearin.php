...
/**
 * Strings for component 'appearin', language 'es', version '3.9'.
 *
 * @package     appearin
 * @category    string
...
<p>Las salas serán asignadas de acuerdo con su idnumbre de espacio, nombre corto o nombre largo, pero podrá escoger libremente su propio nombre.</p>
...
$string['room'] = 'Sala';
$string['room_help'] = 'Las salas serán asignadas de acuerdo con su idnumbre de espacio, nombre corto o nombre largo, pero podrá escoger libremente su propio nombre.';
