...
/**
 * Strings for component 'certificate', language 'es', version '3.9'.
 *
 * @package     certificate
 * @category    string
...
$string['certificate:printteacher'] = 'Figurarás como facilitador en el certificado si el ajuste de impresión facilitador está habilitado';
...
$string['code'] = 'Código';
$string['completiondate'] = 'Finalización del espacio';
$string['course'] = 'Para';
$string['coursegrade'] = 'Calificación del Espacio';
$string['coursename'] = 'Espacio';
$string['coursetimereq'] = 'Minutos requeridos en el espacio';
$string['coursetimereq_help'] = 'Escriba aquí la cantidad mínima de tiempo, en minutos, que el participante debe mantener la sesión en el espacio antes de que pueda recibir el certificado.';
$string['credithours'] = 'Horas de crédito';
$string['customtext'] = 'Texto personalizado';
$string['customtext_help'] = 'Si quiere que el certificado imprima nombres diferentes para el facilitador en lugar de aquellos que tienen asignado el rol de facilitador, no elija \'Imprimir Facilitador\' ni seleccione imagen de firma, exceptuando la imagen de línea. Introduzca los nombres de los facilitadores en este cuadro de texto tal como usted quiera que aparezcan. Por defecto, este texto se coloca en la parte inferior izquierda del certificado. Las siguientes marcas (tags) HTML están disponibles:<br>, <p>, <b>, <i>, <u>, <img> (src y width/height son obligatorias), <a> (href es obligatoria), <font> (los atributos posibles son: color, (hex color code), face, (arial, times, courier, helvetica, symbol)).';
$string['date'] = 'En';
...
$string['delivery_help'] = 'Elija aquí cómo desea que sus participantes obtengan su certificado.
...
Certificado por email: Eligiendo esta opción manda el certificado al participante como un anexo de email.
Después de que un usuario reciba su certificado, si seleccionan en enlace del certificado en la página inicial del espacio, verán la fecha en que recibieron el certificado y podrán visualizar el certificado recibido.';
...
$string['emailothers_help'] = 'Introduzca las direcciones de correo electrónico aquí, separadas por coma, de quienes deberán ser avisados por correo cuando los participantes reciban un certificado.';
...
$string['emailteachers'] = 'Email a Facilitadores';
$string['emailteachers_help'] = 'Si se habilita, entonces los facilitadores serán alertados por correo electrónico cuando los participantes reciban un certificad';
...
$string['incompletemessage'] = 'Para descargar su certificado, usted debe primero completar todas las actividades requeridas. Por favor, vuelva al espacio para completar su trabajo.';
...
$string['modulename_help'] = 'Este módulo permite la generación dinámica de certificados basados en condiciones predefinidas configuradas por el facilitador.';
...
$string['nocertificatesreceived'] = 'no ha recibido ningún certificado de espacio.';
...
Si se selecciona la fecha de cierre del espacio, pero el participante no lo hubiese finalizado aún, se imprimirá la fecha recibida.
...
$string['printgrade_help'] = 'Puede elegir cualquier ítem de calificación del espacio, disponible en
...
$string['printoutcome_help'] = 'Usted puede elegir cualquier competencia del espacio para imprimir el nombre de la competencia y el resultado obtenido por el usuario en el certificado. Un ejemplo sería:
...
$string['printteacher'] = 'Imprimir nombre(s) de facilitador(es)';
$string['printteacher_help'] = 'Para imprimir el nombre del facilitador en el certificado, asigne el rol de facilitador a nivel del módulo. Para hacer esto, por ejemplo, usted tiene más de un facilitador para el espacio o tiene más de un certificado en el espacio y desea imprimir diferentes nombres en cada certificado.

Elija \'editar el certificado\', después elija la pestaña para roles asignados localmente. Después asigne el rol de facilitador-editor al certificado (no necesitan SER facilitadores en el espacio --  puede asignar este rol a quien desee). Estos nombres serán impresos en los certificados como facilitador.';
...
$string['reportcert_help'] = 'Si elige sí aquí, entonces la fecha de recepción, número de código y el nombre del espacio para este certificado se mostrarán en los informes de certificado de usuario. Si selecciona imprimir una calificación en este certificado, entonces dicha calificación también aparecerá en el informe del certificado.';
$string['requiredtimenotmet'] = 'Usted debe pasar al menos un mínimo de {$a->requiredtime} minutos en el espacio antes de poder acceder a este certificado';
...
$string['statement'] = 'ha completado el espacio';
