...
/**
 * Strings for component 'lesson', language 'es', version '3.9'.
 *
 * @package     lesson
 * @category    string
...
$string['activitylink_help'] = '<p>El menú emergente contiene todas las actividades del espacio. Si se selecciona una de ellas, al final de la        lección aparecerá un enlace a dicha actividad.</p>';
...
Múltiple llamada de <b>&quot;Elección múltiple y respuestas múltiples"</b>.  Si escoge esta opción en la pregunta entonces requieren que el participante seleccione todas las respuestas correctas del conjunto de respuestas.  La pregunta puede o no decir al participante <i>cuántas</i> respuestas correctas existen. Por ejemplo "¿Cuáles han sido presidentes de
EE.UU.?", o "Seleccione a dos presidentes de EE.UU. de la siguiente lista.".  El número de respuestas correctas pueden ser de <b>una</b> hasta todas las opciones.  (Una pregunta de Elección múltiples y respuestas múltiples con una respuesta correcta <b>es</b> diferente de una pregunta de Opción Múltiple pues la primera permite al participante la posibilidad de elegir más de una respuesta mientras que la última no lo permite.)</p></li>
...
$string['completionendreached_desc'] = 'El participante deberá llegar al final de la página de la lección para completar esta actividad';
$string['completiontimespent'] = 'El participante deberá realizar esta actividad al menos durante';
$string['completiontimespentdesc'] = 'El participante deberá realizar esta actividad durante al menos {$a}';
...
$string['defaultessayresponse'] = 'Su ensayo será calificado por su facilitador.';
...
$string['dependencyon_help'] = '<p>Esta opción permite que la lección actual dependa del rendimiento de los participantes en otra lección del         mismo espacio. Si no alcanza el rendimiento exigido, el participante no podrá acceder a esta lección.</p>

<p>Las condiciones de la dependencia incluyen:
    <ul>
        <li><b>Tiempo empleado:</b> el participante debe emplear en la lección el tiempo que aquí se señale.</li>
        <li><b>Completa:</b> el participante debe completar la lección.</li>
        <li><b>Calificación superior a:</b> el participante debe alcanzar en la lección una calificación superior     a la especificada en esta opción.</li>
    </ul>
...
$string['displayleftif_help'] = 'Esta configuración determina si un participante debe obtener una cierta puntuación para poder ver el menú de la izquierda. Esto obliga al participante a pasar por toda la lección en su primer intento y así obtener la puntuación necesaria para poder utilizar el menú de la izquierda para la revisión.';
...
$string['displayofgrade'] = 'Mostrar calificación (sólo para participantes)';
$string['displayreview'] = 'Proporcionar una opción para tratar de nuevo la pregunta';
$string['displayreview_help'] = 'Si se activa, cuando una pregunta se responde incorrectamente, se le da al participante la opción de intentarlo de nuevo sin crédito de puntos, o continuar con la lección.';
...
$string['groupsnone'] = 'No existen grupos en este espacio';
...
$string['inactiveoverridehelp'] = '* El participante no está en el grupo correcto o no posee el rol adecuado para ver/realizar un intento en esta lección';
$string['indicator:cognitivedepth'] = 'Lección cognitiva';
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad Lección.';
$string['indicator:socialbreadth'] = 'Lección social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad Lección.';
$string['insertedpage'] = 'Página insertada';
$string['invalidfile'] = 'Archivo no válido';
$string['invalidid'] = 'No se superó ningún ID de módulo o de lección en el espacio';
...
Este valor se puede cambiar en cualquier momento ya que sólo afecta a lo que el facilitador ve, no a los datos.';
...
$string['modattempts'] = 'Permitir revisión al participante';
$string['modattempts_help'] = '<p>Esta opción permite al participante volver atrás para cambiar sus respuestas.</p>';
$string['modattemptsnoteacher'] = 'La revisión del participante sólo está disponible para los participantes.';
$string['modulename'] = 'Lección';
$string['modulename_help'] = 'La actividad lección permite a un facilitador presentar contenidos y/ o actividades prácticas de forma interesante y flexible. Un facilitador puede utilizar la lección para crear un conjunto lineal de páginas de contenido o actividades educativas que ofrezcan al participante varios itinerarios u opciones. En cualquier caso, los facilitadores pueden optar por incrementar la participación del participante y asegurar la comprensión mediante la inclusión de diferentes tipos de pregunta, tales como la elección múltiple, respuesta corta y correspondencia. Dependiendo de la respuesta elegida por el participante y de cómo el facilitador desarrolla la lección, los participantes pueden pasar a la página siguiente, volver a una página anterior o dirigirse a un itinerario totalmente diferente.
...
$string['ongoing_help'] = '<p>Cuando se activa esta opción, cada página mostrará los puntos que el participante ha obtenido del total de          puntos posible. Por ejemplo, si un participante ha contestado correctamente cuatro preguntas de 5 puntos y ha      fallado una pregunta, la puntuación provisional será de 15/20 puntos.</p>';
...
$string['retakesallowed_help'] = '<p>Esta opción determina si los alumnos pueden tomar una lección más de una vez.
   El facilitador puede decidir que la lección contiene material que los alumnos
     deben conocer en profundidad, en cuyo caso se debería permitir que el participante repita
...
$string['returnto'] = '{$a}';
$string['returntocourse'] = 'Volver al espacio';
...
$string['teacherjumpwarning'] = 'En esta lección se ha utilizado un salto {$a->cluster} o un salto a {$a->unseen}. En su lugar se usará el salto a la  siguiente página. Acceda a su cuenta como participante para comprobar estos saltos.';
$string['teacherongoingwarning'] = 'La puntuación acumulada sólo se muestra al participante. Acceda  como participante para probar la puntuación acumulada.';
$string['teachertimerwarning'] = 'El temporizador sólo funciona con participantes. Entre como participante para probar el temporizador.';
...
$string['usepassword_help'] = '<p>Si se selecciona esta opción, el participante no podrá acceder a la lección a menos que escriba la contraseña.</p>';
