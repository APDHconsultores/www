...
/**
 * Strings for component 'enrol_stripepayment', language 'es', version '3.9'.
 *
...
$string['charge_description2'] = 'Cargo por coste de inscripción al espacio.';
...
$string['enrolenddaterror'] = 'La fecha de cierre de la inscripción no puede ser anterior a la fecha de inicio';
...
$string['expiredaction_help'] = 'Seleccione la acción a llevar a cabo cuando caduque la inscripción del usuario. Tenga en cuenta que algunos datos de usuario y configuraciones se eliminan del espacio durante la cancelación del mismo.';
$string['mailadmins'] = 'Notificar administrador';
$string['mailstudents'] = 'Notificar participantes';
$string['mailteachers'] = 'Notificar facilitadores';
...
$string['nocost'] = '¡No hay ningún coste asociado con la inscripción en este espacio!';
$string['pluginname'] = 'Pago con Stripe';
$string['pluginname_desc'] = 'El módulo Stripe le permite configurar espacios de pago. Si el coste de cualquier espacio es cero, no se les solicitará a los participantes un pago por la inscripción. Hay un coste predeterminado que aplica para todo el sitio y una configuración de espacio que permite establecer el coste para cada espacio individualmente. El coste del espacio anula el coste del predeterminado del sitio.';
...
$string['status_desc'] = 'Permitir que los usuarios utilicen Stripe para inscribirse en un espacio de forma predeterminada.';
$string['stripe:config'] = 'Configurar instancias de registro Stripe';
$string['stripe:manage'] = 'Administrar usuarios inscritos';
$string['stripe:unenrol'] = 'Desinscribir usuarios del espacio';
$string['stripe:unenrolself'] = 'Desinscribirme del espacio';
...
$string['unenrolselfconfirm'] = '¿Realmente quieres darte de baja del espacio "{$a}"?';
