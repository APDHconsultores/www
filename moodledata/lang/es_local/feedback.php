...
/**
 * Strings for component 'feedback', language 'es', version '3.9'.
 *
 * @package     feedback
 * @category    string
...
$string['cannotaccess'] = 'Sólo puedes acceder a este feedback desde un espacio';
...
$string['courseid'] = 'Id del espacio';
...
$string['drop_feedback'] = 'Eliminar de este espacio';
...
$string['email_notification_help'] = 'Si está habilitado, los facilitadores recibirán notificaciones al enviarse las respuestas de la encuesta.';
...
$string['feedback:mapcourse'] = 'Asignar espacios a encuestas globales';
...
$string['file'] = 'Archivo';
$string['filter_by_course'] = 'Filtrar por espacio';
...
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad Retroalimentación.';
$string['indicator:socialbreadth'] = 'Retroalimentación social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad Retroalimentación.';
...
$string['mapcourse'] = 'Asignar encuesta a espacios';
$string['mapcourse_help'] = 'Por defecto, los formularios de encuesta creados en su página de inicio están disponibles en todo el sitio y aparecerá en todos los espacios utilizando el bloque de encuestas. Puede forzar que el formulario de encuestas se visualice haciendo que sea un bloque fijo o puede limitar los espacios en los que se mostrará el formulario de encuesta mediante su asignación a espacios específicos.';
$string['mapcourseinfo'] = 'Esta encuesta está disponible en todos los espacios que usan el bloque Encuesta. Sin embargo, usted puede  limitar los espacios en los que aparece. Busque el espacio y asígnelo a esta encuesta.';
$string['mapcoursenone'] = 'No hay espacios asignados. La encuesta está disponible en todos los espacios';
$string['mapcourses'] = 'Asignar encuesta a espacios';
$string['mappedcourses'] = 'Espacios asignados';
$string['mappingchanged'] = 'El mapeo del espacio ha cambiado';
...
$string['modulename_help'] = 'El módulo de actividad Encuesta permite que un facilitador pueda crear una encuesta personalizada para obtener la opinión de los participantes utilizando una variedad de tipos de pregunta, como  opción múltiple, sí/no o texto.

Las respuestas de la Encuesta pueden ser anónimas si así se quiere, y los resultados pueden ser mostrados a todos los participantes o bien sólo a los facilitadores. Cualquier Encuesta situada en la página principal del sitio podrá ser cumplimentada por usuarios no registrados.

La actividad Encuesta puede ser utilizada

* Para la evaluación del espacio, ayudando a mejorar el contenido del mismo para los futuros participantes
* Para permitir que los participantes se inscriban en módulos de espacios, eventos, etc
* Para encuestar a los invitados a la hora de la elección de espacios, las políticas escolares, etc
* Para que en caso de "acoso escolar" los participantes pueden reportar incidentes de forma anónima';
...
$string['non_respondents_students'] = 'Participantes sin responder  ({$a})';
...
$string['search_course'] = 'Buscar espacio';
$string['searchcourses'] = 'Buscar espacios';
$string['searchcourses_help'] = 'Buscar el código o el nombre del (los) espacio(s) que desea asociar con esta encuesta.';
...
$string['sort_by_course'] = 'Ordenar por espacio';
...
$string['url_for_continue_help'] = 'De manera predeterminada, cuando se envía una encuesta, el botón Continuar lleva a la página del espacio. Usted puede definir aquí otra dirección URL de destino para el botón Continuar.';
