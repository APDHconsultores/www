...
/**
 * Strings for component 'forum', language 'es', version '3.9'.
 *
 * @package     forum
 * @category    string
...
$string['blockperiod_help'] = 'Se puede impedir que los participantes puedan publicar más aportaciones que las especificadas por número determinado dentro de un periodo de tiempo.
...
$string['cannotaddteacherforumto'] = 'No se ha podido convertir el ejemplo de foro de facilitadores a la sección 0 del espacio';
$string['cannotcreatediscussion'] = 'No se pudo crear un debate nuevo';
$string['cannotcreateinstanceforteacher'] = 'No se pudo crear un nuevo ejemplo de móduno de espacio para el foro de facilitadores';
...
$string['cannotmovetonotfound'] = 'Foro de destino no encontrado en este espacio.';
...
$string['cannotviewpostyet'] = 'No puede leer las preguntas planteadas por otros participantes en este debate porque usted aún no ha realizado ninguna aportación';
...
$string['completiondiscussionsdesc'] = 'El participante debe crear al menos {$a} discusión(es)';
...
$string['completionpostsdesc'] = 'El participante debe publicar al menos {$a} discusión(es) o respuesta(s)';
...
$string['completionrepliesdesc'] = 'El participante debe publicar al menos {$a} respuesta(s)';
...
$string['configmaxbytes'] = 'Tamaño máximo por defecto para los archivos adjuntos a los mensajes de los foros en este sitio (sujeto a los límites del espacio y otras configuraciones del servidor)';
...
$string['disallowsubscribeteacher'] = 'No se permiten suscripciones (excepto para facilitadores)';
...
$string['errorenrolmentrequired'] = 'Es necesario estar matriculado en este espacio para poder acceder al contenido.';
...
$string['eventcoursesearched'] = 'Espacio buscado';
...
$string['forcedreadtracking_desc'] = 'Permite que en los foros se establezca forzar el rastreo de lectura. Dará como resultado una disminución del rendimiento para algunos usuarios, sobre todo en espacios con muchos foros y mensajes. Cuando está deshabilitado, los foros establecidos previamente en Siempre se tratarán como opcional.';
...
* Cada persona plantea un tema - Cada persona puede plantear un nuevo tema de debate (y todos pueden responder). Esta modalidad es útil cuando usted quiere que cada participante empiece una discusión sobre, digamos, sus reflexiones sobre el tema de la semana, y que todos los demás le respondan.
...
* Foro P y R: Pregunta y Respuestas. -  Los participantes primero deben fijar sus puntos de vista antes de ver los mensajes de los demás.
...
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad Foro.';
$string['indicator:socialbreadth'] = 'Foro social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad Foro.';
$string['inforum'] = 'en {$a}';
$string['inreplyto'] = 'En respuesta a {$a}';
$string['introblog'] = 'Los mensajes de este foro fueron copiados aquí de forma automática a partir de los blogs de los usuarios de este espacio debido a que esas entradas de blog ya no están disponibles';
$string['intronews'] = 'Avisos y novedades generales';
$string['introsocial'] = 'Foro abierto a todos los temas';
$string['introteacher'] = 'Foro exclusivo para facilitadores';
...
Hay varios tipos de foro para elegir, como el foro estándar donde cualquier persona puede iniciar una nueva discusión en cualquier momento, un foro en el que cada participante puede iniciar una única discusión, o un foro de pregunta y respuesta en el que los participantes primero deben participar antes de poder ver los mensajes de otros participantes. El facilitador puede permitir que se adjunten archivos a las aportaciones al foro. Las imágenes adjuntas se muestran en el mensaje en el foro.

Los participantes pueden suscribirse a un foro para recibir notificaciones cuando hay nuevos mensajes en el foro. El facilitador puede establecer el modo de suscripción,  opcional, forzado o auto, o prohibir completamente la suscripción. Si es necesario, los participantes pueden ser bloqueados a la hora de publicar más de un número determinado de mensajes en un determinado período de tiempo; esta medida puede evitar que determinadas personas dominen las discusiones.

Los mensajes en el foro puede ser evaluado por facilitadores o participantes (evaluación por pares). Las clasificaciones pueden agregarse a una calificación final que se registra en el libro de calificaciones.

Los foros tiene muchos usos, como por ejemplo

* Un espacio social para que los participantes se conozcan
* Para los avisos del espacio (usando un foro de noticias con suscripción forzada)
* Para discutir el contenido del espacio o de materiales de lectura
* Para continuar en línea una cuestión planteada previamente en una sesión presencial
* Para discusiones solo entre facilitadores del espacio (mediante un foro oculto)
* Un centro de ayuda donde los tutores y los participantes pueden dar consejos
* Un área de soporte uno-a-uno para comunicaciones entre participante y facilitador (usando un foro con grupos separados y con un participante por grupo)
* Para actividades complementarias, como una "lluvia de ideas" donde los participantes puedan reflexionar y proponer ideas';
...
$string['namenews_help'] = 'El foro de Avisos es un foro especial para avisos que se crea automáticamente cuando se crea un espacio. Un espacio puede tener sólo un foro de Avisos. Sólo los facilitadores y los administradores pueden escribir en el foro de Avisos. El bloque de "Avisos recientes" muestra los avisos recientes.';
$string['namesocial'] = 'Foro social';
$string['nameteacher'] = 'Foro de facilitadores';
...
$string['sendstudentnotificationsdefault_help'] = 'Establece el valor por defecto para la casilla de verificación "Notificar participantes" en el formulario de calificación.';
$string['sendstudentnotificationsyes'] = 'Sí, enviar notificación al participante';
...
Nota: Cualquier cambio en el modo de suscripción sólo afectará a los usuarios que se registren en el espacio en el futuro y no a los usuarios existentes.';
...
$string['timedhidden'] = 'Estado por período: Oculto para los participantes';
