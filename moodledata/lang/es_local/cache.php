...
/**
 * Strings for component 'cache', language 'es', version '3.9'.
 *
 * @package     cache
 * @category    string
...
$string['cachedef_calendar_categories'] = 'Categorías de espacio del calendario a las que puede acceder un usuario';
...
$string['cachedef_completion'] = 'Estado de cierre de la actividad';
...
$string['cachedef_coursecat'] = 'Listas de categorías de espacios para un usuario en particular';
$string['cachedef_coursecatrecords'] = 'Registros de categorías de espacios';
$string['cachedef_coursecattree'] = 'Árbol de categorías de espacios';
$string['cachedef_coursecompletion'] = 'Estado de cierre del espacio';
$string['cachedef_coursecontacts'] = 'Lista de contactos del espacio';
$string['cachedef_coursemodinfo'] = 'Información acumulada sobre los módulos y secciones para cada espacio';
...
$string['cachedef_groupdata'] = 'Información de grupos del espacio';
...
$string['cachedef_navigation_expandcourse'] = 'Espacios expandibles en la navegación';
...
$string['cachedef_suspended_userids'] = 'Listado de usuarios suspendidos por espacio';
...
$string['cachedef_user_group_groupings'] = 'Grupos y agrupamientos de usuarios por espacio';
