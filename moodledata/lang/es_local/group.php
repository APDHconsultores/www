...
/**
 * Strings for component 'group', language 'es', version '3.9'.
 *
 * @package     group
 * @category    string
...
$string['enrolmentkey_help'] = 'Una clave de acceso permite que el acceso al espacio esté limitado sólo a aquellos que conocen la clave. Si se especifica una clave de acceso grupal, entonces dicha clave no sólo permitirá a los usuarios entrar al espacio, sino que los hará miembros del grupo.';
...
$string['grouping_help'] = 'Un agrupamiento es un conjunto de grupos dentro de un espacio. Si se selecciona un agrupamiento, los usuarios asignados a los grupos dentro del agrupamiento podrán trabajar juntos.';
...
$string['groupingnameexists'] = 'El nombre de agrupamiento {$a} ya existe en este espacio. Por favor, elija otro.';
$string['groupings'] = 'Agrupamientos';
$string['groupingsection'] = 'Acceso agrupamientos';
$string['groupingsection_help'] = 'Un agrupamiento es una colección de grupos dentro de un espacio. Si aquí se selecciona un agrupamiento, solamente los participantes asignados a grupos incluídos en este agrupamiento tendrán acceso a la sección.';
...
$string['groupmode_help'] = '<p>El modo grupo puede ser de alguno de estos tres niveles:
   <ul>
      ...
      <li>Grupos separados - Cada participante sólo puede ver su propio grupo; los demás son invisibles</li>
      <li>Grupos visibles - Cada participante trabaja dentro de su grupo, pero también puede ver a los otros grupos</li>
   </ul>
</p>
...
<dl>
   <dt><b>1. Nivel Espacio</b></dt>
   <dd>El modo grupal definido a nivel de espacio viene por defecto para todas las actividades definidas dentro del espacio<br /><br /></dd>
   <dt><b>2. Nivel Actividad</b></dt>
   <dd>Toda actividad que soporte grupos puede definir su propio modo de agrupación. Si el espacio está configurado como  "<a href="help.php?module=moodle&file=groupmodeforce.html">forzar modo de grupo</a>" entonces no se tendrá en cuenta la configuración de cada actividad.</dd>
</dl>';
$string['groupmodeforce'] = 'Forzar el modo de grupo';
$string['groupmodeforce_help'] = 'Si se fuerza el modo grupo, entonces el modo de grupo en el espacio se aplica a todas las actividades del espacio. En ese caso se pasan por alto los ajustes del modo de grupo.';
$string['groupmy'] = 'Mi grupo';
$string['groupname'] = 'Nombre del grupo';
$string['groupnameexists'] = 'El nombre de grupo \'{$a}\' ya existe en este espacio; por favor, elija otro.';
...
$string['nogroups'] = 'Aún no se han formado grupos en este espacio';
