...
/**
 * Strings for component 'theme_pioneer', language 'es', version '3.9'.
 *
...
$string['activitybackground'] = 'Color de Fondo de la Actividad en Espacio';
...
$string['blockbordercolor_desc'] = 'Este es el color del borde del bloque del espacio. Es el color de fondo del área de título.';
$string['blockcolor'] = 'Color Bloque';
$string['blockcolor_desc'] = 'Este es el color de fondo del bloque de espacio.';
...
$string['choosereadme'] = '<p> Pioneer es un tema hermoso y adaptable cargado con grandes características desde pestañas personalizadas y un libro de calificaciones de espacio deslizable a la capacidad para los facilitadores de subir su propia imagen de cabecera en los resúmenes de los espacios! Cada uno de los elementos principales del tema puede ser personalizado en la página de configuración del tema. Pioneer está desarrollado en Michigan en las Escuelas Públicas de Dearborn. </p> <p> Somos un distrito escolar K-12 en Dearborn, Michigan. Pioneer es la mascota de Dearborn High School. </p>';
...
$string['contentbackgroundcolor_desc'] = 'Este es el color del fondo del área de contenido principal del espacio. Si borra el color aquí se aplicará el color de Fondo del Cuerpo así como los ajustes de imagen de fondo.';
...
$string['coursecomplete'] = 'Mostrar Cumplimiento del Espacio de forma Radial';
$string['coursecomplete_desc'] = 'Si un espacio utiliza cumplimiento del espacio y está activado, Pioneer mostrará el estado del mismo de forma radial al participante arriba a la izquierda de la página.';
$string['coursegradebutton'] = 'Calificaciones del Espacio';
$string['coursegradeinfo'] = 'Área de Cabecera del Espacio (Pestañas Página principal y Calificaciones del Espacio)';
$string['coursegradeinfodesc'] = 'Estos ajustes controlan el botón de desplazamiento que aparece en la página principal y del espacio. Las calificaciones del espacio muestran al participante todos los elementos calificables y su calificación. Las pestañas de la página principal necesitan que agregue contenido a las pestañas en la página de ajustes de Pestañas de la Página principal. A fin de que las calificaciones del espacio que aparezcan, los ajustes del espacio en Apariencia deben estar en Sí en \'Mostrar libro de calificaciones a los participantes\'.';
$string['coursegradestext'] = 'Texto del Botón de Calificaciones del Espacio';
$string['coursegradestextdesc'] = 'Escriba el texto que quiera que aparezca para el botón de activación.';
$string['coursegradetoggle'] = 'Mostrar/Ocultar Deslizamiento Calificaciones del Espacio';
$string['coursegradetoggle_desc'] = 'Permitirá a los participantes ver la lista de todas las actividades y su calificación justo encima del área de cabecera, encima de las \'migas de pan\' y debajo del título del espacio.';
$string['coursetitlebkg'] = 'Color de Fondo del Título del Espacio';
$string['coursetitlebkg_desc'] = 'Este es el color de la caja que aparece debajo del Título del Espacio. Se utiliza también como color de fondo del Carrusel del Espacio y los Títulos de los Espacios Disponibles para crear una apariencia consistente.';
$string['coursetitletxt'] = 'Color de Texto del Título del Espacio';
$string['coursetitletxt_desc'] = 'Este es el color del texto del título del espacio.';
...
$string['displaymycourses'] = 'Espacios Matriculados';
$string['displaymycoursesdesc'] = 'Muestra, en el Menú Personal, los espacios en que el usuario está matriculado';
...
$string['enablethiscourse'] = 'Menú Actividades Espacio';
$string['enablethiscoursedesc'] = 'Mostrar un menú desplegable con las actividades del espacio.';
...
$string['fpcreatortextbox'] = 'Cuadro de texto Página Principal Rol Creador de Espacio';
$string['fpcreatortextbox_desc'] = 'Agregar contenido solo visible para los usuarios con rol de Creador de Espacio.';
...
$string['fpsearch'] = 'Buscar espacios';
$string['fpsearchboxmain'] = 'Mostrar Buscar Espacio en área de Contenido Principal';
$string['fpsearchboxmain_desc'] = 'Muestra una caja de búsqueda de espacios en el área de la página principal. Esta opción depende de los ajustes de la navegación por iconos y solo se mostrará si la navegación por iconos está activada en el área de contenido.';
$string['fpsearchboxtop'] = 'Mostrar Buscar Espacio en la barra de Navegación Principal';
...
$string['fptoppromotedpadding'] = 'Altura del carrusel de Espacios';
$string['fptoppromotedpadding_desc'] = 'Controla la altura de las imágenes del pase de diapositivas de los espacios.';
$string['frontpagecoursesettings'] = 'Espacios Página Principal';
$string['frontpagedesc'] = 'Configure la forma como se van a presentar las cajas de los espacios en la página principal.';
$string['frontpageheading'] = 'Opciones de la Página Principal';
$string['frontpagerenderer'] = 'Caja Espacios Página Principal';
$string['frontpagerendererdefaultimage'] = 'Imagen predeterminada del espacio';
$string['frontpagerendererdefaultimagedesc'] = 'La imagen predeterminada que se utilizará cuando no se encuentra imagen para el espacio (solo se aplica a mosaicos con superposición)';
$string['frontpagerendererdesc'] = 'Controla la forma en la que se van a presentar las cajas de los espacios en la página principal.';
...
$string['gradecomplete'] = 'Indicador Radial Calificación Total Espacio';
$string['gradecomplete_desc'] = 'Si se activa un espacio para que se muestren las calificaciones de participante, Pioneer mostrará la calificación total del espacio en un indicador radial animado en la parte superior izquierda de la página del participante.';
...
$string['headerbackgroundtoggle'] = 'Los facilitadores pueden subir imágenes de cabecera';
$string['headerbackgroundtoggle_desc'] = 'Si está activada, el facilitador puede subir una imagen a <a href="https://docs.moodle.org/all/es/Configuraciones_del_curso#Archivos_del_resumen_del_curso" target="_new">Archivos Resumen del Espacio</a>. Esta imagen debe ser pequeña para reducir el tiempo de carga. El tamaño recomendado es de un ancho de 1024 y un peso menor de 500KB. Si no lo está, todos los espacios utilizarán la imagen que se encuentra debajo como imagen de cabecera.';
$string['headerimageinfo'] = 'Altura Imagen de Cabecera';
$string['headerimageinfodesc'] = 'Estos ajustes controlan la altura de la imagen de la cabecera en el sitio y en las actividades del espacio.';
$string['headerimagepadding'] = 'Relleno Imagen Cabecera';
$string['headerimagepadding_desc'] = 'Controla el relleno y la altura de la imagen en los espacios. Se debe seleccionar un mínimo de 120px si se utilizan los indicadores radiales para mostrar las calificaciones y el cumplimiento del espacio.';
$string['headerimagepage'] = 'Ajustes Imagen de Cabecera';
$string['headerincourseimagepadding'] = 'Relleno Imagen Cabecera Actividades (xencursox)';
$string['headerincourseimagepadding_desc'] = 'Después de la página del espacio esta será la altura de relleno para la imagen de la cabecera. El harcerla pequeña permite que se muestre mas contenido';
...
$string['iconnavbackgroundcolortop_desc'] = 'Este es el color de fondo de la navegación con iconos y de la caja de búsqueda de espacios que se encuentran arriba a la derecha de la página.';
...
$string['mybkg'] = 'Fondo Diapositivas Mis Espacios';
$string['mybkg_desc'] = 'Elija un color para el fondo de las diapositivas de Mis Espacios.';
$string['myclasses'] = 'Mis Clases';
$string['mycorusesinfo'] = 'Opciones Menú Navegable';
$string['mycorusesinfodesc'] = 'Estos ajustes controlan la barra de navegación superior incluyendo los menús desplegables Mis Espacios y Este Espacio.';
$string['mycourses'] = 'Mis Espacios';
$string['mycoursesheading'] = 'Diapositivas Mis Espacios';
$string['mycoursesheadingdesc'] = 'Mostrará los espacios en los que un usuario está matriculado o está impartiendo. Se mostrarán en diapositivas adaptables, ideal para entornos de escritorio.';
$string['mycoursesinfo'] = 'Lista Espacios Matriculación Dinámica';
$string['mycoursesinfodesc'] = 'Muestra una lista dinámica de los espacios en que el usuario está matriculado.';
$string['mycoursetitle'] = 'Terminología';
$string['mycoursetitledesc'] = 'Cambiar la terminología para el enlace del menú desplegable "Mis Espacios"';
...
$string['pcourseenable'] = 'Activar Espacios Destacados';
$string['pcourses'] = 'Cola Espacios Destacados';
$string['pcoursesdesc'] = 'Por favor, los id de los espacios destacados deber ir separados por una coma.';
$string['people'] = 'Compañeros';
$string['pluginname'] = 'Pioneer';
$string['promotedcoursesheading'] = 'Cola Diapositivas Espacios Destacados';
$string['promotedlink'] = 'URL Ver Más Espacios Destacados';
$string['promotedlink_desc'] = 'Entre una URL a una de las categorías de espacios. Se muestra a continuación del título de Espacios Destacados.';
$string['promotedlinktext'] = 'Texto Ver Más Espacios Destacados';
$string['promotedlinktext_desc'] = 'Proporciona una opción para enlazar a una categoría de espacios para mostrar más espacios en la cola del pase de diapositivas. Entre una URL debajo.';
$string['promotedmylink'] = 'URL Diapositivas Mis Espacios Ver Más';
$string['promotedmylink_desc'] = 'Pase una URL a una de las categorías de sus espacios. Se mostrará al lado del título de las Diapositivas Mis Espacios.';
$string['promotedmylinktext'] = 'Texto Diapositivas Mis Espacios Ver Más';
$string['promotedmylinktext_desc'] = 'Proporciona un enlace opcional a una categoría de espacios para mostrar más espacios. Pase la URL debajo.';
$string['promotedmytextbox'] = 'Caja Texto Descripción Diapositivas Mis Espacios';
$string['promotedmytextbox_desc'] = 'Una caja de texto que aparecerá con el bloque de Diapositivas de Mis Espacios.';
$string['promotedmytitle'] = 'Título Diapositivas Mis Espacios';
$string['promotedmytitledesc'] = 'Por favor, de un título al bloque de diapositivas de Mis Espacios.';
$string['promotedtaglink'] = 'URL Ver Más Espacios Recomendados';
$string['promotedtaglink_desc'] = 'La URL que apunta a la categoría de los espacios.  Se muestra al nado del título de espacios destacados.';
$string['promotedtaglinktext'] = 'Texto Ver Más Espacios Recomendados';
$string['promotedtaglinktext_desc'] = 'Proporciona una opción para enlazar a una categoría de espacios para mostrar más espacios. Pase la URL debajo.';
$string['promotedtagtextbox'] = 'Caja Texto Descripción Personalizada';
$string['promotedtagtextbox_desc'] = 'Utilícelo para explicar al usuario como agregar etiquetas a su perfil y a los espacios para que puedan aparecer los espacios recomendados al usuario.';
$string['promotedtagtitle'] = 'Título Espacios Personalizados Recomendados';
$string['promotedtagtitledesc'] = 'Por favor, de un título al bloque de los Espacios Personalizados Recomendados.';
$string['promotedtitledefault'] = 'Espacios Destacados';
$string['promotedtitledesc'] = 'Por favor, ponga un título a los espacios Promocionados.';
$string['radialboxbackground'] = 'Fondo Radial Calificación y Cumplimiento del Espacio';
$string['radialboxbackground_desc'] = 'Este es el color de fondo de la caja que contiene los elementos del Indicador Radial de la Calificación y Cumplimiento del Espacio arriba a la izquierda de la página.';
...
$string['recommendedbkg_desc'] = 'El color se aplicará a los Espacios Destacados, Personalizados Recomendados y Mis Espacios. Están localizados en la página principal.';
$string['recommendedcoursesheading'] = 'Diapositivas Espacios Personalizados Recomendables';
$string['recommendedcoursesheadingdesc'] = 'Las Diapositivas Espacios Personalizados Recomendables buscarán coincidencias entre las etiquetas del usuario (intereses) y las etiquetas de los espacios. Las que se encuentre formarán una lista que se mostrará un diapositivas adaptables en la página principal. Los ajustes son automáticos y no se necesita otra interacción salvo la de proporcionar etiquetas a los espacios y en los perfiles de usuario.';
...
$string['sectionheadericondesc'] = 'Este icono aparece justo antes del título de cada tema para los espacios con formatos semanales y por temas. Use los ajustes de unicode de Font Awesome. La lista está <a href="https://fortawesome.github.io/Font-Awesome/icons/" target="_new">aquí</a>. El icono f02d (predeterminado) es un libro.';
$string['settingfeaturedmyslider'] = 'Mis Matriculaciones';
$string['settingfeaturedslider'] = 'Espacios Destacados';
$string['settingfeaturedtagslider'] = 'Espacios Personalizados Recomendados';
$string['settinggradebutton'] = 'Ver Calificaciones';
$string['settingpromotedlink'] = 'ejemplo: http://misitiomoodle/espacio/';
$string['settingpromotedlinktext'] = 'Ver Más Espacios Destacados';
$string['settingpromotedmylink'] = 'ejemplo: http://misitiomoodle/espacios/';
$string['settingpromotedmylinktext'] = 'Diapositivas Mis Espacios Ver Más';
$string['settingpromotedtaglink'] = 'ejemplo: http://misitiomoodle/espacios/';
$string['settingpromotedtaglinktext'] = 'Ver Más Espacios Recomendados';
...
$string['showmycourses'] = 'Diapositivas de Mis Espacios';
$string['showmycourses_desc'] = 'Actívelo si quiere que se muestren las diapositivas de Mis Espacios.';
$string['showrecommendedcourses'] = 'Espacios Personalizados Recomendados';
$string['showrecommendedcourses_desc'] = 'Selecciónelo si desea mostrar espacios personalizados recomendados.';
...
$string['socialwallheaddesc'] = 'Las opciones del Espacio Social son un conjunto de formatos para la extensión de Moodle que proporciona a los facilitadores con un espacio fácil de usar que opera de forma similar a Facebook.  Puede descargar el Formato Social de Moodle.org <a href="https://moodle.org/plugins/browse.php?list=set&id=74">https://moodle.org/plugins/browse.php?list=set&id=74</a>.  Los ajustes que siguen permiten configurar los colores del muro.';
$string['socialwallheading'] = 'Formatos del Espacio Social';
$string['stylinginfo'] = 'Estilos y Alertas';
$string['stylinginfodesc'] = 'Personalizaciones adicionales y ajustes de la alerta.';
$string['swaddpost'] = 'Fondo Agregar Publicación Espacio Formato Social';
$string['swaddpost_desc'] = 'Si utiliza el Formato Social en un espacio, este ajuste cambiará el color de fondo del área Agregar Publicación del muro.';
$string['swattach'] = 'Fondo Adjunto Espacio Formato Social';
$string['swattach_desc'] = 'Si utiliza el Formato Social en un espacio, este ajuste cambiará el color de fondo del área de adjuntos en el muro.';
$string['swcomment'] = 'Fondo Comentario Espacio Formato Social';
$string['swcomment_desc'] = 'Si utiliza el Formato Social en un espacio, este ajuste cambiará el color de fondo del área de comentarios en el muro.';
$string['swicontext'] = 'Icono y Texto de espacio con Formato Social';
$string['swicontext_desc'] = 'Si utiliza un espacio con Formato Social estos ajustes cambiarán el color de los iconos y de las palabras Adjunto, Publicación, Mensaje y Comentario en el muro.';
...
$string['swmessage'] = 'Fondo Mensaje Espacio Formato Social';
$string['swmessage_desc'] = 'Si utiliza el Formato Social en un espacio, este ajuste cambiará el color de fondo del área de texto del mensaje en el muro.';
...
$string['swpost'] = 'Fondo Publicación Espacio Formato Social';
$string['swpost_desc'] = 'Si utiliza el Formato Social en un espacio, este ajuste cambiará el color de fondo de los mensajes publicados en el muro.';
...
$string['tabbuttoncolor_desc'] = 'El color de los botones utilizados para conmutar las pestañas de la página principal y el desplazamiento de las calificaciones del espacio que aparecen justo debajo del título de la página donde están activados.';
$string['tabbuttonhovercolor'] = 'Color Botón Pestaña al Apuntar';
$string['tabbuttonhovercolor_desc'] = 'El color del botón de la pestaña al pasar el ratón sobre él acción que hace que conmute el deslizamiento de las pestañas de la página central y las calificaciones de los espacios. Aparecen justo debajo del título de la página si están activadas.';
...
$string['thiscourse'] = 'Éste Espacio';
$string['title'] = 'Título';
...
$string['toggleiconnav_desc'] = 'Determina dónde quiere que aparezcan los iconos y la caja de búsqueda de espacios.';
...
$string['topclosefeatured'] = 'Enlace a Cerrar Listado de Espacios Destacados';
$string['topclosefeatureddesc'] = 'Este texto aparece por encima del listado de los espacios destacados y cerrará la lista de espacios destacados. "Cerrar Listado de Espacios" es el texto que se sugiere.';
$string['topclosefeaturedtext'] = 'Cerrar Listado de Espacios';
$string['topichighlight'] = 'Color Tema Resaltado';
$string['topichighlight_desc'] = 'El color utilizado cuando un tema o semana se resalta en el espacio.';
$string['topicweekcolor'] = 'Fondo Temas y Sección Semanal';
$string['topicweekcolor_desc'] = 'En espacios por Temas y Semanales, éste es el color de fondo para cada tema o semana del espacio.';
$string['toppcourseenable'] = 'Diapositivas Espacios Destacados';
$string['toppcourses'] = 'Diapositivas Espacios Destacados';
$string['toppcoursesdesc'] = 'LIMITE=10 No puede entrar más de 10 ID de espacios. Por favor, introduzca los id de los espacios destacados separados por una coma.';
$string['toppromotedcoursesheading'] = 'Diapositivas Espacios Destacados';
$string['toppromotedtitledefault'] = 'Espacios destacados';
$string['toppromotedtitledesc'] = 'Este texto aparece debajo del Título del Espacio en la diapositiva. "Matricúlate Ahora" sería el lema ideal.';
$string['topsearch'] = 'Buscar espacios';
$string['topsearchbutton'] = 'Encontrar';
$string['topshowfeatured'] = 'Mostrar Enlace a Todos los Espacios';
$string['topshowfeatureddesc'] = 'Este texto aparece el el pase de diapositivas y mostrará un listado de todos los espacios destacados. "Ver Todos Los Espacios Destacados" es el texto que se sugiere.';
$string['topshowfeaturedtext'] = 'Ver Todos Los Espacios Destacados';
