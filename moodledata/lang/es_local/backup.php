...
/**
 * Strings for component 'backup', language 'es', version '3.9'.
 *
 * @package     backup
 * @category    string
...
$string['asyncrestorecompletedetail'] = 'El proceso de restauración ha sido completado exitosamente. Seleccionar continuar lo llevará al <a href="{$a}">espacio restaurado.</a>';
...
$string['asyncrestoreinprogress_help'] = 'Las restauraciones de espacio asincrónicas que están en progreso son mostradas aquí.';
...
$string['asyncreturn'] = 'Regresar al espacio';
...
$string['automatedmaxkepthelp'] = 'Esto especifica el número máximo de copias de seguridad automáticas recientes que guardar para cada espacio. Las copias anteriores serán eliminadas automáticamente.';
$string['automatedminkept'] = 'Número mínimo de copias de seguridad guardadas';
$string['automatedminkepthelp'] = 'Si las copias de seguridad anteriores a un número de días especificado se eliminan, puede suceder que un espacio inactivo acabe sin copias de seguridad. Para prevenir esto, se debería especificar un número mínimo de copias de seguridad guardadas.';
...
$string['backupcourse'] = 'Copia de seguridad espacio: {$a}';
$string['backupcoursedetails'] = 'Detalles del espacio';
$string['backupcoursesection'] = 'Sección: {$a}';
$string['backupcoursesections'] = 'Secciones del espacio';
...
$string['backupmode30'] = 'Central de espacios';
...
$string['backupsection'] = 'Copia de seguridad sección de espacio: Copia de seguridad espacio: {$a}';
...
$string['backuptypecourse'] = 'Espacio';
...
$string['choosefilefromcoursebackup'] = 'Zona de copia de seguridad de espacio';
$string['choosefilefromcoursebackup_help'] = 'Cuando se realiza una copia de seguridad de un espacio utilizando los valores preestablecidos, los archivos de la copia se guardan aquí.';
$string['choosefilefromuserbackup'] = 'Zona de copia de seguridad privada de usuario';
$string['choosefilefromuserbackup_help'] = 'Cuando la copia de seguridad de los espacios tiene marcada la opción "Hacer anónima la información de usuario", los archivos de copia de seguridad se guardan aquí';
...
$string['config_overwrite_conf'] = 'Permite al usuario anular la configuración actual del espacio';
$string['config_overwrite_course_fullname'] = 'Por defecto sobrescribir el nombre completo del espacio con el nombre completo del archivo de respaldo. Esto necesita que esté activado el "Sobrescribir configuración del espacio" y que el usuario actual tenga la capacidad para cambiarle el nombre completo al espacio (moodle/course:changefullname)';
$string['config_overwrite_course_shortname'] = 'Por defecto sobrescribir el nombre corto del espacio con el nombre completo del archivo de respaldo. Esto necesita que esté activado el "Sobrescribir configuración del espacio" y que el usuario actual tenga la capacidad para cambiarle el nombre corto al espacio (moodle/course:changeshortname)';
$string['config_overwrite_course_startdate'] = 'Por defecto sobrescribir la fecha de inicio del espacio con la fecha del archivo de respaldo. Esto necesita que esté activado el "Sobrescribir configuración del espacio" y que el usuario actual tenga la capacidad para cambiar fechas del espacio al restaurar (moodle/restore:rolldates)';
...
$string['configrestoreuserscompletion'] = 'Si se habilita, la información de cierre del usuario  será restaurada si fue incluida en la copia de seguridad.';
...
$string['confirmnewcoursecontinue'] = 'Alerta de espacio nuevo';
$string['confirmnewcoursecontinuequestion'] = 'Se creará un espacio temporal (oculto) en el proceso de restauración de espacios. Para cancelar la restauración pulse en Cancelar. No cierre el navegador mientras se restaura.';
$string['coursecategory'] = 'Categoría en la que se restaurará el espacio';
...
$string['error_block_for_module_not_found'] = 'Encontrada instancia de bloque huérfano (id: {$a->bid}) para el módulo del espacio (id: {$a->mid}) Este bloque no se copiará';
$string['error_course_module_not_found'] = 'Encontrado módulo de espacio huérfano (id: {$a}). Este modulo no se copiará';
...
$string['importcurrentstage0'] = 'Selección de espacios';
...
$string['importgeneralmaxresults'] = 'Número máximo de espacios listados para importación';
$string['importgeneralmaxresults_desc'] = 'Controla el número de espacios que son listados durante el primer paso del proceso de importación';
...
$string['importsuccess'] = 'Importación completada. Pulse para volver al espacio.';
...
$string['mergerestoredefaults'] = 'Restablecer a los valores predeterminados al restaurar en otro espacio fusionando la copia de seguridad';
...
$string['morecoursesearchresults'] = 'Más de {$a} espacios encontrados, mostrando los primeros {$a} resultados';
$string['moreresults'] = 'Hay demasiados resultados, escriba una búsqueda más específica.';
$string['nomatchingcourses'] = 'No hay espacios para mostrar';
$string['norestoreoptions'] = 'No hay categorías o espacios que pueda restaurar';
$string['originalwwwroot'] = 'URL de la copia de seguridad';
$string['overwrite'] = 'Sobrescribir';
$string['pendingasyncdeletedetail'] = 'Este espacio tiene una copia de seguridad asincrónica pendiente.<br/> Los espacios no pueden ser eliminados hasta que termine esta copia de seguridad.';
...
$string['pendingasyncedit'] = 'Hay una copia de seguridad asincrónica pendiente para este espacio. Por favor no edite este espacio hasta después de que esté completada la copia de seguridad.';
...
$string['privacy:metadata:backup:detailsofarchive'] = 'Este archivo puede contener varios datos del usuario relacionados con un espacio, tales como calificaciones, matriculaciones de usuario y datos de actividades.';
$string['privacy:metadata:backup:externalpurpose'] = 'El propósito de este archivo es almacenar información relacionada con un espacio, la cual puede ser restaurada en el futuro.';
$string['privacy:metadata:backup_controllers'] = 'La lista de operaciones de copias de seguridad';
$string['privacy:metadata:backup_controllers:itemid'] = 'La ID del espacio';
...
$string['qcategory2coursefallback'] = 'La categoría de preguntas "{$a->name}", originalmente el contexto de categoría sistema/espacio, serán creadas en el contexto espacio al ser restauradas.';
$string['qcategorycannotberestored'] = 'La categoría de preguntas "{$a-> name}" no puede ser creada por restauración';
$string['question2coursefallback'] = 'La categoría de preguntas "{$a->name}", originalmente en la categoría de contesto sistema/espacio dentro del archivo de copia de seguridad, se creará en el contexto del espacio al ser restaurada';
...
$string['replacerestoredefaults'] = 'Restablecer a los valores predeterminados al restaurar en otro espacio borrando el contenido actual';
$string['restoreactivity'] = 'Actividad de la restauración';
$string['restorecourse'] = 'Restaurar espacio';
$string['restorecoursesettings'] = 'Configuración del espacio';
$string['restoreexecutionsuccess'] = 'Se ha restaurado el espacio con éxito. Si pulsa en el botón \'Continuar\' podrá ver el espacio que ha restaurado.';
$string['restorefileweremissing'] = 'Algunos archivos no pudieron restaurarse debido a que faltaban en la copia de seguridad.';
$string['restorenewcoursefullname'] = 'Nombre del nuevo espacio';
$string['restorenewcourseshortname'] = 'Nombre corto del nuevo espacio';
...
$string['restoretocourse'] = 'Restaurar al espacio:';
$string['restoretocurrentcourse'] = 'Restaurar en este espacio';
$string['restoretocurrentcourseadding'] = 'Fusionar la copia de seguridad con este espacio';
$string['restoretocurrentcoursedeleting'] = 'Borrar el contenido del espacio actual y después restaurar';
$string['restoretoexistingcourse'] = 'Restaurar en un espacio existente';
$string['restoretoexistingcourseadding'] = 'Fusionar la copia de seguridad del espacio con el espacio existente';
$string['restoretoexistingcoursedeleting'] = 'Borrar el contenidodel espacio actual y después restaurar';
$string['restoretonewcourse'] = 'Restaurar como espacio nuevo';
$string['restoringcourse'] = 'Restauración del espacio iniciada';
...
$string['rootsettinglogs'] = 'Incluir archivos "log" de espacios';
...
$string['selectacourse'] = 'Seleccione un espacio';
$string['setting_course_fullname'] = 'Nombre del espacio';
$string['setting_course_shortname'] = 'Nombre corto del espacio';
$string['setting_course_startdate'] = 'Inicio del espacio';
...
$string['setting_overwrite_conf'] = 'Sobrescribir la configuración del espacio';
$string['setting_overwrite_course_fullname'] = 'Sobrescribir el nombre completo del espacio';
$string['setting_overwrite_course_shortname'] = 'Sobrescribir el nombre corto del espacio';
$string['setting_overwrite_course_startdate'] = 'Sobrescribir la fecha de inicio del espacio';
...
$string['skiphidden'] = 'Pasar por alto espacios ocultos';
$string['skiphiddenhelp'] = 'Elija si desea o no pasar por alto espacios ocultos';
$string['skipmodifdays'] = 'Pasar por alto espacios no modificados desde';
$string['skipmodifdayshelp'] = 'Seleccione para pasar por alto espacios que no han sido modificados desde un número de días';
$string['skipmodifprev'] = 'Pasar por alto espacios no modificados desde copia de seguridad anterior';
$string['skipmodifprevhelp'] = 'Elija si desea o no pasar por alto espacios que no han sido modificados desde la copia de seguridad anterior. Requiere logearse para ser activada.';
...
$string['totalcoursesearchresults'] = 'Espacios totales: {$a}';
