...
/**
 * Strings for component 'auth_enrolkey', language 'es', version '3.9'.
 *
...
$string['settings_visible_description'] = 'Añade un nuevo elemento a la página de registro para los usuarios que se auto registran. Esto se comprobará con las claves de matriculación disponibles y matriculará al usuario en los espacios con los que coincida.';
...
$string['signup_view'] = 'Matriculación en el espacio';
$string['signup_view_message_basic'] = 'Has sido matriculado como {$a->role} en el espacio \'<a href="{$a->href}">{$a->course}</a>';
$string['signup_view_message_basic_dates'] = 'Te has matriculado en {$a->course} como {$a->role}. <a href={$a->href}>Haz clic aquí para ver el espacio.</a><br />El espacio empieza: {$a->startdate}<br />El espacio termina: {$a->enddate}';
$string['signup_view_message_basic_dates_endonly'] = 'Te has matriculado en {$a->course} como {$a->role}. <a href={$a->href}>Haz clic aquí para ver el espacio.</a><br />El espacio termina: {$a->enddate}';
$string['signup_view_message_basic_dates_startonly'] = 'Te has matriculado en {$a->course} como {$a->role}. <a href={$a->href}>Haz clic aquí para ver el espacio.</a><br />El espacio empieza: {$a->startdate}';
