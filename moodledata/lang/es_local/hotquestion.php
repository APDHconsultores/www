...
$string['alwaysshowdescription_help'] = 'Si se deshabilita, la Descripción de Pregunta Caliente no será visible para los participantes.';
...
$string['modulename_help'] = 'Una actividad de Preguntas que Queman les permite a los participantes publicar/votar preguntas, en respuesta a solicitudes hechas por sus facilitadores del espacio.';
...
$string['privacy:metadata:hotquestion_questions:tpriority'] = '¿Le ha dado el facilitador una prioridad a esta entrada?';
...
$string['requireapproval_descr'] = 'Si se habilita, las preguntas requieren aprobación por un facilitador antes de que sean visibles para todos.';
$string['requireapproval_help'] = 'Si se habilita, las preguntas requieren aprobación por un facilitador antes de que sean visibles para todos.';
...
$string['teacherpriorityvisibility'] = 'Visibilidad de columna de prioridad del facilitador';
$string['teacherpriorityvisibility_descr'] = 'Si se habilita, la columna de Prioridad de facilitador es visible, en caso contrario está oculta.';
$string['teacherpriorityvisibility_help'] = 'Si se habilita, la columna de Prioridad de facilitador es visible.';
$string['time'] = 'Hora';
