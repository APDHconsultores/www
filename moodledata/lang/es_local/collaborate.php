...
/**
 * Strings for component 'collaborate', language 'es', version '3.9'.
 *
 * @package     collaborate
 * @category    string
...
$string['completionlaunch'] = 'El participante debe unirse a la sesión para finalizar esta actividad';
...
$string['meetingtimecurrent'] = 'Sesión xencursox';
...
$string['openended'] = 'Duración del espacio';
