...
/**
 * Strings for component 'block_notifications', language 'es', version '3.9'.
 *
...
$string['end_of_tooltip'] = 'hora(s) si nuevos contenidos o actividades son añadidas al espacio.';
$string['folder'] = 'Carpeta';
$string['forum'] = 'Foro';
$string['global_configuration_comment'] = 'Canales de notificación globalmente activados';
$string['global_configuration_presets_comment'] = 'Las configuraciones predeterminadas le permiten establecer configuraciones de usuario para los canales de correo y SMS. Las predeterminadas son globales pero pueden ser cambiadas al interior del espacio.';
...
$string['mailsubject'] = 'Actualizaciones en el espacio';
$string['notification_frequency'] = 'Frecuencia en horas, para verificar nuevo contenido:';
$string['notification_frequency_comment'] = 'La verificación de nuevo contenido en los espacios será efectuada cada cierto número de horas como se especifique aquí. Éste valor puede ser sobrescrito por la configuración del espacio.';
...
$string['rss'] = 'RSS';
$string['rss_empty_description'] = 'Este RSS está vacío. Espere a que la plataforma escanee y obtenga el contenido del espacio.';
...
$string['rss_not_enabled'] = 'El RSS en este espacio está desactivado.';
$string['scorm'] = 'Paquete SCORM';
$string['set_mobile_number_instructions'] = 'Diríjase a la página del espacio y haga clic en su nombre (Situado en la esquina superior derecha). Luego dar clic en "Editar perfil" y vaya hasta el final de la página. Coloque su número en el campo de teléfono móvil y luego clic en Actualizar.';
$string['sms'] = 'SMS';
