...
/**
 * Strings for component 'format_tiles', language 'es', version '3.9'.
 *
...
$string['allcoursescomplypalette'] = 'Todos los espacios ya tienen colores de mosaico permitidos. Nada que reiniciar. Asegúrese de guardar cualquier cambio a colores permitidos antes de pulsar reiniciar.';
$string['allowlabelconversion'] = 'Permitir conversión de etiqueta a página (experimental)';
$string['allowlabelconversion_desc'] = 'Si se activa, a los facilitadores editores se les dará una opción en cada desplegable para configuración de edición de etiqueta para convertir la etiqueta a una página. Esta es una configuración experimental.';
$string['allowphototiles'] = 'Permitir mosaicos de fotos';
$string['allowsubtilesview'] = 'Permitir vista de sub mosaicos';
$string['allowsubtilesview_desc'] = 'Permitir el uso de una configuración de espacio, la cual, si se selecciona, muestra las actividades (excepto etiquetas) como sub mosaicos, en lugar de la lista estándar';
...
$string['basecolour_help'] = 'El color aquí configurado será aplicado a todos los mosaicos en el espacio';
...
$string['changedcolour'] = 'Color del mosaico se reinicia al predeterminado para el espacio {$a}';
...
$string['colourname_descr'] = 'Mostrar el nombre para el color (por ejemplo “Azul”) que se usará en menús desplegables al elegir un color para un espacio';
...
$string['complete-n-auto'] = 'Ítem incompleto. Será marcado como completo cuando cumpla con los criterios de cierre. No puede cambiar esto manualmente.';
$string['complete-y-auto'] = 'Ítem completo. Se marcó como completo cuando cumplió los criterios de cierre. No puede cambiar esto manualmente.';
...
Dependiendo de la configuración, una marca de verificación (V) puede aparecer automáticamente cuando haya completado la actividad de acuerdo a las condiciones configuradas por el facilitador.<br><br>
...
$string['completionswitchhelp'] = '<p>Ha seleccionado mostrar el seguimiento de cierre en cada mosaico. Por lo tanto, hemos configurado "Seguimiento de cierre > Habilitar" más abajo en esta página a "Sí".</p>
<p>Además, necesita activar el seguimiento de cierre para <b>cada ítem</b> que esté monitorizando; por ejemplo para un PDF, haga clic en "Editar configuraciones", vaya a Finalización de actividad, y elija la configuración que necesite.</p>
<p>También puede hacer esto <b>masivamente</b> según se explica en  la <a href="https://docs.moodle.org/all/es/Configuraciones_de_finalizaci%C3%B3n_de_actividad" target="_blank">explicación detallada del seguimiento de cierre en moodle.org</a></p>';
$string['completionwarning'] = 'Tiene activado el seguimiento de cierre a nivel del espacio, pero al nivel de la actividad individual ningún ítem tiene el seguimiento habilitado, por lo que no hay nada que monitorizar.';
$string['completionwarning_changeinbulk'] = 'Cambiar masivamente';
$string['completionwarning_help'] = 'Necesita hacer monitorizables los ítems individuales al editarlos (en Finalización de actividad > Seguimiento de cierre) o puede hacer esto masivamente en Administración del espacio  > Finalización del espacio > Editar masivamente cierre de actividad';
...
$string['courseshowtileprogress_error'] = 'Tiene \'Seguimiento de cierre > Habilitar seguimiento de cierre\' configurado a \'No\' (vea más abajo en esta página) lo que provoca conflicto con esta configuración. Si quiere mostrar el progreso en los mosaicos, por favor configure \'Seguimiento de cierre > Habilitar seguimiento de cierre\' a \'Sí\'. En caso contrario, por favor ajuste esta configuración a \'No\'.';
$string['courseshowtileprogress_help'] = '<p>Cuando se selecciona, el progreso del usuario en las actividades será mostrado en cada mosaico, ya sea como una <em>fracción</em> (por ejemplo \'Progreso 2/10\' significa 2 de 10 actividades completadas), o como un <em>porcentaje</em> en un círculo.</p><p>Esto solamente puede ser usado si se ha activado la  \'Finalización > Habilitar seguimiento de cierre\' .</p><p>Si no hubiera actividades monitorizables dentro de un mosaico dado, no será mostrado el indicador para ese mosaico.</p>';
$string['courseusebarforheadings'] = 'Enfatizar encabezados con pestaña coloreada';
$string['courseusebarforheadings_help'] = 'Mostrar una pestaña coloreada a la izquierda del encabezado en el espacio en todos los sitios donde esté seleccionado un estilo de encabezado en el editor de texto';
...
$string['customcssdesc'] = 'CSS personalizado que se aplicará a la sección de contenido del espacio mientras es usado el formato de espacio. Esto no será validado, por lo que debe tener cuidado de introducir un código válido. Por ejemplo: <p>.section { color: red; }</p><p>li.activity.subtile.resource.pdf { background-color: orange !important; }</p>';
...
$string['defaultthiscourse'] = 'Ajuste por defecto para este espacio';
$string['defaulttilecolour'] = 'Color de mosaico por defecto';
$string['defaulttileicon'] = 'Ícono del mosaico';
$string['defaulttileicon_help'] = 'El ícono aquí seleccionado aparecerá en <em>todos</em> los mosaicos en este espacio. Los mosaicos individuales pueden tener un ícono diferente seleccionado, usando la configuración diferente en el nivel del mosaico.';
...
$string['displayfilterbar_error'] = 'A menos que haya configurado resultados para este espacio, solamente puede mostrar una barra de filtro en números de mosaico, y no basados en resultados. Cree algunos resultados primero y después regrese aquí. Vea';
$string['displayfilterbar_help'] = '<p>Cuando se selecciona, mostrará automáticamente una matriz de botones antes de la pantalla del mosaico en un espacio, en donde los usuarios pueden hacer click para filtrar mosaicos acorde a ciertos rangos</p><p>Cuando está seleccionado \'basado en los números\', serán mostrados una serie de botones; por ejemplo, un botón para mosaicos del 1 al 4, un botón para mosaicos del 5 al 8, etc.</p><p>Cuando está seleccionado \'basado en resultados del espacio\' habrá un botón por cada resultado del espacio. Cada mosaico puede ser asignado a un resultado dado (y por ende a un botón dado) desde la página de configuraciones de ese mosaico.</p>';
...
$string['filterboth'] = 'Mostrar botones basados en números de mosaico y resultados del espacio';
$string['filternumbers'] = 'Mostrar botones basados en números de mosaicos';
$string['filteroutcomes'] = 'Mostrar botones basados en resultados del espacio';
$string['filteroutcomesrestore'] = 'El espacio original empleaba resultados en la barra del filtro, lo que aun no está soportado durante el proceso de restauración. Por ello, la configuración de la barra del filtro ha sido cambiada en el espacio restaurado. Si desea usar resultados para filtrar mosaicos en el espacio restaurado, por favor configure los resultados nuevamente. El espacio original no ha sido cambiado.';
...
$string['followthemecolour_desc'] = 'Si se configura a sí, a los facilitadores no se les dará una opción y todos los colores de mosaicos debajo serán ignorados. En su lugar se hará un intento para obtener los colores principales de la marca del tema y usarlos';
...
$string['home'] = 'Página inicial del espacio';
...
$string['reopenlastsection_desc'] = 'Cuando se activa, si un usuario visita de nuevo un espacio, la última sección que haya abierto será abierta al entrar';
$string['resetallcoursecolours'] = 'Reiniciar los colores de todos los espacios';
...
$string['showseczerocoursewide_desc'] = 'Si se activa, la sección cero (la sección más superior) será mostrada en la página de inicio del espacio y en la parte superior de <b>cada página de sección de espacio</b> por ejemplo en la parte superior de cada contenido de mosaico). Si no se activa (recomendado), solamente será mostrado en la página inicial del espacio';
$string['showseparatewin'] = 'Mostrar archivo en ventana separada';
$string['sitename'] = 'Nombre del sitio';
$string['snapwarning'] = 'Sería posible editar su espacio en formato Mosaicos usando otro tema, y después cambiar de regreso al tema Snap una vez que haya terminado de editar.';
...
$string['sureresetcolours'] = '¿Está seguro de querer reiniciar los colores de mosaico del espacio a predeterminados? Esto afectará a {$a} espacios';
$string['tilecolourgeneral'] = 'Paleta de colores - color opcional';
$string['tilecolourgeneral_descr'] = 'Un color opcional será ofrecido a usuarios como el color de mosaico del espacio en el menú desplegable debajo de Administración del espacio > Editar Configuraciones - dejarlo vacío para deshabilitar este color';
...
$string['tileicon_help'] = 'El ítem aquí seleccionado anulará, solamente para este mosaico, cualquier ícono que haya sido configurado a nivel del espacio.';
$string['tileicons'] = 'Iconos del mosaico';
$string['tileoutcome'] = 'Resultado para este mosaico';
$string['tileoutcome_help'] = 'Si selecciona un resultado para este mosaico podrá mostrar, debajo de configuraciones del espacio, un conjunto de <em>botones filtro</em>, uno para cada resultado, los cuales cuando son presionados, filtran los mosaicos mostrados de acuerdo a los resultados que han sido asignados';
$string['tileselecttip'] = 'No necesita preocuparse de usar este formato para cambiar un ícono de mosaico. Una manera más sencilla es, dentro del espacio, hacer clic en el ícono que desea cambiar (con el modo de edición activado)';
$string['tilesformatregistration'] = 'Registrar formato mosaicos';
$string['tip'] = 'Sugerencia';
$string['togglecompletion'] = 'Hacer clic para alternar estado de cierre';
...
$string['usejavascriptnav_desc'] = 'Cuando se activa, si un usuario hace clic en la página de vista general del espacio, y tiene javascript habilitado, se usará JS para hacer la transición a contenidos de mosaico. Los contenidos serán almacenados localmente en el navegador de acuerdo a las otras configuraciones debajo. Si no se activa, JS no será usado y en su lugar se empleará la navegación antigua. Las otras configuraciones JS debajo serán ignoradas.';
$string['usejsnavforsinglesection'] = 'Usar navegación javascript para página de sección única';
$string['usejsnavforsinglesection_desc'] = 'Cuando se activa, cualquier llamada a una página de sección única (&section=xx) será manejada usando javascript, al invocar la página principal del espacio para abrir la sección solicitada vía JS, en lugar de llamar a la página de sección única con el estilo PHP antiguo';
$string['usesubtilesseczero'] = 'Usar sub mosaicos en sección superior';
$string['usesubtilesseczero_help'] = 'Si se selecciona serán usados sub mosaicos en la sección superior del espacio además de dentro de los mosaicos. Esto es porque los sub mosaicos usan mucho espacio en la parte superior del espacio. Sería mejor dejar esto sin seleccionar, para que en vez de esto, cualquier ítem en la sección superior sea mostrado en formato de lista estándar.';
$string['width'] = 'ancho';
