...
$string['badcourse'] = 'El espacio no existe';
...
$string['badsection'] = 'La sección no existe en el espacio "{$a}"';
$string['badteachers'] = 'No se encontró el email de facilitador especificado ({$a})';
$string['badteachersmail'] = 'El email de facilitador especificado ({"a}) es incorrecto';
$string['badtimeclose'] = 'La fecha de cierre es incorrecta';
$string['badtimeend'] = 'La fecha de cierre es incorrecta';
...
$string['completionreserved'] = 'Los participantes deben hacer una reserva para completar la actividad';
...
$string['err_timeendlower'] = 'La fecha de cierre del evento se ha establecido antes de la fecha de inicio.';
$string['err_timeopengreater'] = 'La fecha de inicio de las reservas se ha establecido después de la fecha de cierre del evento.';
...
$string['gradedmail'] = 'El facilitador {$a->teacher} ha realizado algún comentario en tu reserva \'{$a->reservation}\'

Puedes acceder desde aquí:

      {$a->url}';
$string['gradedmailhtml'] = 'El facilitador {$a->teacher} ha realizado algún comentario en tu reserva \'<i>{$a->reservation}</i>\'<br /><br /> Puedes verlo <a href=\\"{$a->url}\\">aquí</a>.';
...
$string['modulename_help'] = '<p>El objetivo principal de esta actividad es programar sesiones de laboratorio y exámenes, pero puede programar todo lo que desee.</p><p>El facilitador puede definir el número de asientos disponibles para el evento, la fecha del evento, las fechas de apertura y cierre de la reserva.<br />Una reserva puede tener una calificación o escala.<br />Los participantes pueden apuntarse o desapuntarse de una sesión y añadir una nota sobre esta reserva. </p><p> Después de que comience el evento, el facilitador puede calificar el evento. Los participantes serán notificados por correo electrónico.</p><p> La lista de reserva puede descargarse en varios formatos.</ P>';
...
$string['nocourseswithnsections'] = 'No se encontraron espacios con {$a} secciones';
...
$string['note'] = 'Nota';
$string['noteachers'] = 'No hay facilitadores disponibles';
$string['notequal'] = 'no es igual a';
$string['notifies'] = 'Notificaciones enviadas';
$string['notifygrades'] = 'Notificar las calificaciones de las reservas a los participantes';
$string['notifystudents'] = 'Notificar tiempo de cierre de reserva a los participantes';
$string['notifyteachers'] = 'Notificar tiempo de cierre de reserva a los facilitadores';
...
$string['reservationevent'] = 'Crear un evento de espacio desde la apertura al cierre de fechas (tiempo de reserva)';
