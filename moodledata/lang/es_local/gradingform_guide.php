...
/**
 * Strings for component 'gradingform_guide', language 'es', version '3.9'.
 *
...
$string['alwaysshowdefinition'] = 'Mostrar las definiciones de la guía a los participantes';
...
$string['descriptionstudents'] = 'Descripción para los participantes';
...
$string['err_nodescription'] = 'La descripción para los participantes no puede dejarse en blanco';
...
$string['hidestudentdesc'] = 'Ocultar las descripciones del criterio para el participante';
...
$string['regrademessage1'] = 'Está a punto de guardar cambios en una guía de evaluación que ya ha sido utilizada para calificar. Por favor, indique si las calificaciones existentes deben ser revisadas. Si así lo establece, la guía de calificacion se ocultará a los participantes hasta que sean recalificados.';
$string['regrademessage5'] = 'Está a punto de guardar cambios en una guía de evaluación que ya ha sido utilizada para calificar. La calificación guardada en el libro de calificaciones no se modificará, pero la guía de calificaciones se ocultará a los participantes hasta que sean recalificados.';
$string['regradeoption0'] = 'No recalificar';
$string['regradeoption1'] = 'Recalificar';
$string['restoredfromdraft'] = 'NOTA: El último intento de calificación de este participante no se ha guardado correctamente, por lo que se han restaurado las calificaciones anteriores guardadas como borrador. Si desea cancelar estos cambios pulse sobre el botón "Cancelar"';
$string['save'] = 'Guardar';
...
$string['showmarkspercriterionstudents'] = 'Mostrar las puntuaciones por criterio a los participantes';
$string['showstudentdesc'] = 'Mostrar la descripció para el participante de los criterios';
