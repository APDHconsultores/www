...
/**
 * Strings for component 'tool_bloglevelupgrade', language 'es', version '3.9'.
 *
...
<p>Para preservar la visibilidad basada en el espacio o en el grupo de las entradas de blog en este sitio debe ejecutar el script de actualización siguiente, lo que creará un foro de blog especial en cada espacio cuyos usuarios inscritos hayan publicado entradas de blog, y copiará estas entradas en este foro especial.</p>
