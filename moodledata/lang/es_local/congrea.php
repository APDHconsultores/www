...
/**
 * Strings for component 'congrea', language 'es', version '3.9'.
 *
 * @package     congrea
 * @category    string
...
$string['audio'] = 'Audio';
$string['audio_help'] = 'Si lo habilita, por defecto el audio de todos los participantes estará habilitado.';
...
$string['modulename_help'] = 'Utilice el módulo Congrea para aprender en línea en tiempo real. El módulo Congrea le permite participar en el aprendizaje sincrónico, lo que significa que el facilitador y los participantes están conectados en el entorno de aprendizaje virtual e interactúan con los demás al mismo tiempo.
Este módulo proporciona a los participantes herramientas de comunicación asíncronas, como la pizarra y el chat';
...
$string['selectteacher'] = 'Seleccionar facilitador';
$string['selectteacher_help'] = 'Seleccionar facilitador como moderador para el aula virtual';
