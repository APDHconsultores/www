...
/**
 * Strings for component 'glossary', language 'es', version '3.9'.
 *
 * @package     glossary
 * @category    string
...
$string['allowprintview_help'] = '<p>Se puede permitir que los participantes usen la vista de impresión del glosario.</p>

<p>Usted puede elegir si desea activar o desactivar esta opción.</p>

<p>Los facilitadores pueden utilizar la vista de impresión en todo momento.</p>';
...
$string['cnfapprovalstatus'] = 'Define el estado por defecto de las entradas colocadas por los participantes';
...
$string['cnfstudentcanpost'] = 'Define si por defecto los participantes pueden o no colocar entradas';
...
$string['completionentries'] = 'El participante debe crear entradas:';
...
$string['defaultapproval_help'] = 'Si se establece en No, las entradas requieren la aprobación de un facilitador antes de que puedan ser visibles para todos.';
...
$string['editalways_help'] = '<P>Esta opción permite decidir si los participantes pueden editar sus entradas
...
$string['entryusedynalink_help'] = 'Si el <strong>Enlace automático al glosario</strong> ha sido habilitada por un administrador y esta opción está activada, la opción del formulario "Agregar una nueva entrada" permite vincular automáticamente las palabras y frases del concepto allá donde aparezcan en el resto del espacio.';
...
$string['explainexport'] = 'Se ha generado un archivo.<br />Descárguelo y guárdelo. Podrá importarlo en cualquier momento en éste u otro espacio.';
...
$string['glossarytype_help'] = 'Un glosario principal es un glosario en el que se pueden importar entradas de glosarios secundarios. Solo puede haber un glosario principal en cada espacio. Si no se necesita importar entradas entre glosarios, todos los glosarios en el espacio pueden ser de tipo secundario.';
...
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad Glosario.';
$string['indicator:socialbreadth'] = 'Glosario social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad Glosario.';
$string['isglobal'] = '¿Este es el glosario global?';
$string['isglobal_help'] = 'Un glosario global tiene entradas que están enlazadas desde cualquier lugar del sitio, no solo desde el espacio en que reside el glosario. Únicamente los administradores pueden determinar que un glosario sea global.';
$string['letter'] = 'letra';
$string['linkcategory'] = 'Enlazar automáticamente esta categoría';
$string['linkcategory_help'] = 'Si el enlace automático al glosario ha sido habilitado y este parámetro está habilitado, el nombre de la categoría se enlazará automáticamente allá donde aparezca en el resto del espacio. Cuando un participante enlace con un nombre de la categoría, será llevado a la página del glosario "Búsqueda por categoría"';
...
El facilitador puede permitir que se adjunten archivos a las entradas del glosario. Las imágenes adjuntas se mostrarán en la entrada. Las entradas se pueden buscar y se puede navegar por ellas en orden alfabético o por categoría, fecha o autor. Las entradas pueden aprobarse por defecto o requerir la aprobación de un facilitador antes de que sean visibles para los demás alumnos.

Si se ha habilitado el filtro de vinculación automática del glosario, las entradas se enlazan automáticamente cuando las palabras o frases aparecen en el espacio.

El facilitador puede permitir comentarios en las entradas. Las entradas también se pueden calificar por facilitadores o por los demás participantes (evaluación por pares). Las calificaciones pueden agregarse para formar una calificación final que se registra en el libro de calificaciones.

Los glosarios tienen muchos usos, como

* Un registro cooperativo de términos clave
* Un espacio para darse a conocer, donde los participantes nuevos añadan su nombre y sus datos personales
...
$string['studentcanpost'] = 'Los participantes pueden agregar entradas';
