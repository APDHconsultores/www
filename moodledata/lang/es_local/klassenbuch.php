...
/**
 * Strings for component 'klassenbuch', language 'es', version '3.9'.
 *
 * @package     klassenbuch
 * @category    string
...
*¿Pueden editar libros los participantes?*

Sólo los facilitadores pueden crear y editar libros. No hay planes de implementar la edición de libros para participantes, pero alguien podría crear algo similar (Portfolio). La razón principal de esta medida es mantener el módulo Libro tan simple como sea posible.
...
$string['hiddentostudent'] = 'Oculto al participante';
