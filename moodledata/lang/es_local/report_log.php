...
/**
 * Strings for component 'report_log', language 'es', version '3.9'.
 *
 * @package     report_log
 * @category    string
...
$string['log:view'] = 'Ver registros del espacio';
...
$string['page-report-log-index'] = 'Informe de \'logs\' del espacio';
$string['page-report-log-user'] = 'Informe de \'logs\' de usuario del espacio';
