...
/**
 * Strings for component 'booking', language 'es', version '3.9'.
 *
 * @package     booking
 * @category    string
...
<li>{eventtype}</li>
<li>{teacher}</li>
<li>{teacherN} - N es el número de facilitador; ejemplo: {teacher1}</li>
<li>{pollstartdate}</li>
...
$string['autoenrol_help'] = 'Si se selecciona, los usuarios se inscribirán en el espacio correspondiente tan pronto como realicen la reserva y se darán de baja en ese espacio tan pronto como se cancele la reserva.';
...
$string['bookingpollurlteachers'] = 'URL de encuesta de facilitadores';
$string['bookingsaved'] = 'Su reserva fur guardada exitosamente. Usted puede ahora proceder a reservar otros espacios.';
...
$string['btncacname'] = 'Nombre del botón "Confirmar el cierre de la actividad"';
...
$string['choosecourse'] = 'Elija un espacio';
...
Para ver todos tus espacios reservados haz clic en el siguiente enlace: {$a->bookinglink}
El espacio asociado se puede encontrar aquí: {$a->courselink}';
$string['confirmationmessagesettings'] = 'Confirmación de ajustes de correo';
$string['confirmationmessagewaitinglist'] = 'Hola {$a->name}, Su solicitud de reserva ha sido registrada. Status: {$a->status} Participante: {$a->name} Espacio: {$a->bookingname} Fecha: {$a->date} Para ver todos sus espacios reservados, elija el enlace siguiente: {$a->link}';
...
$string['confirmbookingoffollowing'] = 'Por favor confirme la reserva para el siguiente espacio';
$string['confirmdeletebookingoption'] = '¿Realmente desea eliminar esta opción de reserva?';
$string['coursedate'] = 'Fecha';
$string['courseendtime'] = 'Hora de cierre del espacio';
$string['coursestarttime'] = 'Hora de inicio del espacio';
...
$string['deletebooking'] = '¿Realmente desea des-inscribirse en el espacio siguiente? <br /><br /> <b>{$a} </b>';
$string['deletebookingoption'] = 'Eliminar esta opción de reserva';
$string['deletecategory'] = 'Borrar';
$string['deletedbookingmessage'] = 'Reserva eliminada para el espacio siguiente: {$a->bookingname} Usuario: {$a->name} Liga: {$a->link};';
...
$string['donotselectcourse'] = 'No seleccionó espacio';
...
$string['error:failedtosendconfirmation'] = 'El usuario siguiente no recibió un correo de confirmación de Reserva. Status: {$a->status} Participante: {$a->name} Espacio: {$a->bookingname} Fecha: {$a->date} Liga: {$a->link}';
...
$string['startendtimeknown'] = 'Las horas de principio y fin del espacio son conocidas';
$string['starttimenotset'] = 'No se configuró fecha de inicio';
$string['statuschangebookedmessage'] = 'Hola {$a->name}, Su estatus de reserva ha cambiado. Usted está ahora registrado en {$a->bookingname}. Estatus de reserva: {$a->status} Participante: {$a->name} Espacio: {$a->bookingname} Fecha: {$a->date} Para ver todos sus espacios reservados pulse el enlace siguiente: {$a->link}';
...
$string['subscribetocourse'] = 'Inscribir usuarios al espacio';
$string['subscribeuser'] = '¿Realmente quiere inscribir a los usuarios en el espacio siguiente?';
$string['taken'] = 'Tomado';
