...
/**
 * Strings for component 'hvp', language 'es', version '3.9'.
 *
 * @package     hvp
 * @category    string
...
$string['completionpass_help'] = 'Si se habilita, esta actividad es considerada completada cuando el participante recibe una calificación aprobatoria (según sea especificada en la sección de Calificación de las configuraciones de H5P) o mayor.';
$string['completionpassdesc'] = 'El participante debe lograr una calificación aprobatoria para completar esta actividad';
...
Gracias por enviar tus respuestas a \'{$a->hvpname}\' en el espacio \'{$a->coursename}\'.
...
{$a->studentname} ha completado \'{$a->hvpname}\' ({$a->hvpurl}) en el espacio \'{$a->coursename}\'.
...
$string['gradetopassmustbeset'] = 'La calificación aprobatoria no puede ser cero porque esta actividad H5P tiene su método de cierre configurado para requerir calificación aprobatoria. Por favor configure un valor diferente de cero.';
...
$string['noh5ps'] = 'No hay contenido interactivo disponible para este espacio.';
...
$string['offlinedialogbody'] = 'No hemos podido enviarle información sobre el cierre de esta tarea. Por favor, compruebe su conexión a Internet.';
