...
/**
 * Strings for component 'format_menutopic', language 'es', version '3.9'.
 *
...
$string['menuposition_help'] = '<p>Define la posición donde el menú aparecerá en el espacio. Las opciones posibles son: <ul> <li><b>No mostrar:</b> no se genera el menú</li> <li><b>Izquierda:</b> el menú se genera verticalmente en la columna de bloques izquierda, si existe.</li> <li><b>Media:</b> el menú se genera horizontalmente como una barra en medio del espacio, sobre la sección</li> <li><b>Derecha:</b> el menú se genera verticalmente en la columna de bloques derecha, si existe.</li> </ul></p>';
...
$string['page-course-view-topics'] = 'Cualquier página principal de espacio en formato temas desde menú';
$string['page-course-view-topics-x'] = 'Cualquier página de espacio en formato temas desde menú';
...
$string['tree_struct_help'] = '<p>La base del menú es una estructura de árbol en donde cada rama u hoja del árbol puede asociarse a una URL. La URL puede ser externa o estar ligada directamente a una sección del espacio. Cuando Usted entra por primera vez a configurar el árbol de sección, la plataforma le sugiere una estructura lineal, sin ramas, con una cantidad de hojas igual al número de secciones del espacio</p>
...
<li><strong>Sección destino:</strong> Si la hoja se usa para una sección de espacio, esta opción indica cual sección será seleccionada; si se selecciona una sección, no puede seleccionarse una URL a donde dirigir la liga de la opción del menú.</li>
