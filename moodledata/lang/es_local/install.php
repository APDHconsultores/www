...
/**
 * Strings for component 'install', language 'es', version '3.9'.
 *
 * @package     install
 * @category    string
...
<p><b>Dirección Web:</b>
Especifique la dirección web completa en la que se accederá a Moodle. Si su sitio web es accesible a través de varias URLs, seleccione la que resulte de acceso más natural a sus participantes.  No incluya la diagonal invertida final (/).</p>
...
la más natural que sus participantes deberían utilizar. No incluya la diagonal invertida final ().
<br />
<br />
...
<p>Moodle aún puede ser instalado, pero sin esta funcionalidad, usted no podrá subir archivos a los espacios ni imágenes nuevas de perfil de usuario.</p>
