...
/**
 * Strings for component 'badges', language 'es', version '3.9'.
 *
 * @package     badges
 * @category    string
...
$string['addcourse'] = 'Añadir espacios';
$string['addcourse_help'] = 'Seleccionar todos los espacios que deben agregarse a este requisito para la insignia. Mantener pulsada la tecla CTRL para seleccionar varios elementos.';
...
$string['allmethodcourseset'] = 'Todos los espacios seleccionados están finalizados';
...
$string['allowcoursebadges'] = 'Habilitar insignias del espacio';
$string['allowcoursebadges_desc'] = 'Permitir crear y otorgar insignias en el contexto del espacio.';
...
$string['anymethodcourseset'] = 'Cualquiera de los espacios seleccionados está finalizado';
...
$string['badgesview'] = 'Insignias de espacio';
...
$string['completionnotenabled'] = 'La cierre del espacio no está habilitada en este espacio, por lo que no puede incluirse en los criterios de la insignia. La cierre del espacio puede habilitarse en la configuración del espacio.';
...
$string['coursebadgesdisabled'] = 'Las insignias de espacio no están habilitadas en este sitio.';
$string['coursecompletion'] = 'Los usuarios deben finalizar este espacio.';
...
$string['criteria_1_help'] = 'Permite que una insignia se conceda a los usuarios en base a la realización de un conjunto de actividades dentro de un espacio.';
$string['criteria_2'] = 'Concesión manual por rol';
$string['criteria_2_help'] = 'Permite que una insignia se conceda a los usuarios de forma manual por los usuarios que tienen un rol particular en el sitio o en el espacio.';
$string['criteria_3'] = 'Participación social';
$string['criteria_3_help'] = 'Social';
$string['criteria_4'] = 'Finalización del espacio';
$string['criteria_4_help'] = 'Permite que una insignia se conceda a los usuarios que hayan completado el espacio. Este criterio puede tener parámetros adicionales como una calificación mínima y la fecha de cierre del espacio.';
$string['criteria_5'] = 'Finalización de una serie de espacios';
$string['criteria_5_help'] = 'Permite que una insignia se conceda a los usuarios que han completado una serie de espacios. Cada espacio puede tener parámetros adicionales como una calificación mínima y la fecha de cierre del espacio.';
...
$string['criteria_descr'] = 'Los participantes son galardonados con esta insignia cuando han cumplido el siguiente requisito:';
$string['criteria_descr_0'] = 'A los participantes se les concede esta insignia cuando finalizan <strong>{$a}</strong> de los requisitos enumerados.';
...
$string['criteria_descr_4'] = 'Los usuarios deben finalizar el espacio';
$string['criteria_descr_5'] = '<strong>{$a}</strong> de los siguientes espacios han sido finalizados:';
...
$string['criteria_descr_short4'] = 'Finalice el espacio';
...
$string['criteria_descr_single_4'] = 'Los usuarios deben finalizar el espacio';
$string['criteria_descr_single_5'] = 'Finalizar los siguientes espacios:';
...
$string['criteria_descr_single_short4'] = 'Finalizar el espacio';
...
$string['criterror_help'] = 'Este conjunto de campos muestra todos los parámetros que inicialmente se añadieron a los requisitos de la insignia, pero que ya no están disponibles. Se recomienda que estos parámetros se desactiven para asegurar que los participantes puedan obtener esta insignia en el futuro.';
...
$string['error:noactivities'] = 'No hay actividades con criterios de cierre habilitados en este espacio';
$string['error:nobadges'] = 'No hay insignias de espacio o de sitio habilitadas para ser añadidas como criterio.';
$string['error:nocohorts'] = 'Sin cohortes';
$string['error:nocourses'] = 'La cierre del espacio no está habilitada en ninguno de los espacios de este sitio, por lo que ninguno se mostrará. Puede habilitar el cierre del espacio en la configuración del espacio.';
...
$string['error:nosuchcourse'] = 'Advertencia: Este espacio ya no está disponible.';
...
$string['error:notifycoursedate'] = 'Advertencia: Las insignias asociadas con el cierre del espacio y con el cierre de actividades no se emitirán hasta la fecha de inicio del espacio.';
...
$string['localbadgesh_help'] = 'Todas los insignias conseguidas en este sitio web por finalizar espacios, actividades de los espacios y otros requisitos.
...
$string['noteendorsement'] = 'La aprobación por un tercero puede ser usada para añadirle valor a la insignia. Por ejemplo, una insignia emitida por un facilitador puede ser aprobada por la escuela, o una insignia emitida por una entidad local puede ser aprobada por una entidad nacional.';
...
$string['requiredcourse'] = 'Al menos un espacio debe ser añadido al grupo de criterios de espacio';
...
$string['sitebadges_help'] = 'Las insignias del sitio sólo pueden ser otorgadas a los usuarios de las actividades relacionadas con el sitio. Estos incluyen completar una serie de espacios o partes de los perfiles de usuario. Las insignias del sitio también pueden ser emitidas manualmente por un usuario para otro.

La insignias para las actividades relacionadas con los espacios deben ser creados a nivel de espacio. Las insignias de espacio se pueden encontrar en Administración >  Insignias';
