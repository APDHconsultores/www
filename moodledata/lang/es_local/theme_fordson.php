...
/**
 * Strings for component 'theme_fordson', language 'es', version '3.9'.
 *
...
$string['activityiconsize_desc'] = 'Ajusta el tamaño de los iconos de actividad utilizados en los espacios.';
$string['activitylinkstitle'] = 'Actividades';
$string['activitylinkstitle_desc'] = 'Mostrar todas las actividades del espacio';
$string['activitymenu'] = 'Mostrar el menú de actividades agrupadas';
$string['activitymenu_desc'] = 'Muestra los listados de actividades agrupadas en los paneles de participantes y facilitadores. Este menú muestra una lista agrupada de todas las actividades para el participante y el facilitador.';
...
$string['cardbkg_desc'] = 'Color de fondo para el contenido y bloques del espacio.';
$string['catsicon'] = 'Icono de Categoría';
$string['catsicon_desc'] = 'Elige un icono para representar las categorías de los espacios.';
...
$string['collapsibletopics'] = 'Formato Espacio de temas plegables';
$string['collapsibletopics_desc'] = 'Si instalas el formato de temas plegables (<a href="https://moodle.org/plugins/format_collapsibletopics"> format_collapsibletopics </a>), el tema de Fordson puede proporcionar una vista de formato de espacio mejorada y un estilo especial que se integra mejor con aspecto general de Fordson. Se ha desarrollado con un cuidado y atención especiales para proporcionar una experiencia de usuario más fluida para usuarios de todas las edades y habilidades.';
...
$string['courseactivities'] = 'Actividades del espacio';
$string['courseblockpanelbtn'] = 'Bloques del Espacio';
$string['courseblockpanelbtnclose'] = 'Cerrar';
$string['courseboxheight'] = 'Altura del mosaico del espacio';
$string['courseboxheight_desc'] = 'Controla la altura del mosaico del Espacio en la primera página y categorías del espacio.';
$string['courseeditingcog'] = 'Mostrar el menú de configuración predeterminada del espacio';
$string['courseeditingcog_desc'] = 'Si utilizas el Panel de Administración del Espacio, el menú predeterminado está oculto. Al activar esta opción, puedes mostrar el menú predeterminado, así como el panel de administración del espacio del facilitador. Es ideal si se utiliza un complemento de terceros que utiliza el menú de espacio para acceder a la configuración.';
$string['coursehome'] = 'Página de Inicio';
$string['courseinfo'] = 'Descripción del espacio';
$string['coursemanage'] = 'Configuración del espacio';
$string['coursemanage_desc'] = 'Gestiona tu espacio';
$string['coursemanagementbutton'] = 'Gestión del espacio';
$string['coursemanagementinfo'] = 'Menú Panel de Administración del Espacio';
$string['coursemanagementinfodesc'] = 'Fordson ofrece un Panel de Administración de Espacios único y organizado al que los facilitadores pueden acceder desde cualquier lugar de un espacio para acceder a los enlaces de administración de su espacio. Los participantes también pueden acceder a un Tablero del Espacio del Participante que incluye información relevante del espacio. Es muy recomendable que lo mantengas activado.';
$string['coursemanagementtextbox'] = 'Mensaje de gestión del espacio';
$string['coursemanagementtextbox_desc'] = 'Añade un mensaje para los facilitadores en el panel de administración del espacio en cada página del espacio.';
$string['coursemanagementtoggle'] = 'Mostrar los Paneles de Gestión Espacio de alumnos y facilitadores';
$string['coursemanagementtoggle_desc'] = 'Muestra los enlaces de Administración del Espacio en un panel organizado para facilitadores que proporciona un tablero de todos los enlaces que necesitan para administrar el espacio y los usuarios. También mostrará un panel de descripción general del espacio para los participantes con calificaciones, cierre del espacio y otros elementos del espacio.';
$string['coursestaff'] = 'Facilitadores del espacio';
$string['coursestyle1'] = 'Estilo Uno de Mosaico';
$string['coursestyle10'] = 'Pantalla predeterminada del Espacio Moodle';
$string['coursestyle2'] = 'Estilo Dos de Mosaico';
$string['coursestyle3'] = 'Estilo Tres de Mosaico';
$string['coursestyle4'] = 'Estilo Cuatro de Mosaico con resumen del espacio';
$string['coursestyle5'] = 'Estilo Uno Horizontal';
$string['coursestyle6'] = 'Imagen horizontal de fondo con detalles completos';
$string['coursestyle7'] = 'Imagen horizontal de fondo solo título y facilitadores';
$string['coursestyle8'] = 'Columna Horizontal Dos';
$string['coursestyle9'] = 'Formación corporativa: mínimo con la barra de progreso de cierre';
$string['coursetileinfo'] = 'Opciones de visualización del espacio';
$string['coursetileinfodesc'] = 'Estos ajustes te permiten personalizar cómo se mostrarán los espacios en la página principal, así como en las categorías de los espacios.';
$string['coursetilestyle'] = 'Mostrar Mosaico del espacio';
$string['coursetilestyle_desc'] = 'A la hora de ver las categorías de espacio, puedes elegir entre los siguientes estilos para mostrar los espacios. <a href="https://goo.gl/fMXzSo" target="_new"> Instrucciones para el tema Fordson 3.5</a>';
$string['createinfo'] = 'Botón especial para crear un espacio';
$string['createinfodesc'] = 'Este botón aparece en la página de inicio cuando un usuario puede crear nuevos espacios. Aquellos con el rol de Creador de Espacios a nivel del sitio verán este botón.';
...
$string['displaymycoursesdesc'] = 'Mostrar los espacios en los que están matriculados los usuarios en la barra de navegación superior.';
$string['displaythiscourse'] = 'Mostrar el menú Este espacio';
$string['displaythiscoursedesc'] = 'Muestra el salto a sección en el menú del espacio en la barra de navegación superior para los usuarios. Contiene elementos de menú situados previamente en el cajón de navegación.';
...
$string['easyenrollmentintegration_desc'] = 'El complemento Easy Enrollment (<a href="https://moodle.org/plugins/enrol_easy"> Easy Enrollment Plugin </a>) permite a los participantes inscribirse en espacios directamente desde la página de inicio de Moodle. El complemento de inscripción utiliza un código de 6 dígitos o un código QR generado automáticamente con soporte para cámara web para inscribir a los participantes. El participante ingresa el código o escanea el código QR y se inscribe instantáneamente en el espacio o grupo previsto dentro del espacio. Este complemento se activa automáticamente una vez que instala Easy Enrollment y lo activa en Administración del Sitio. Solo se activa si el complemento está instalado y configurado correctamente.';
$string['editoff'] = 'Desactivar Edición';
$string['editon'] = 'Activar Edición';
$string['enablecategoryicon'] = 'Iconos para mostrar categorías';
$string['enablecategoryicon_desc'] = 'Cuando se selecciona esta opción se mostrarán las categorías de espacios como iconos';
$string['enablefrontpageavailablecoursebox'] = 'Habilitar visualización mejorada del espacio';
$string['enablefrontpageavailablecoursebox_desc'] = 'La visualización mejorada del espacio mostrará los espacios en mosaico y utilizará iconos en una vista de cuadrícula para las categorías de espacio. Para utilizar la presentación predeterminada de Moodle, desmarcar esta opción.';
...
$string['fptextbox_desc'] = 'Este cuadro de texto aparece en la página principal una vez que el usuario se autentica. Es ideal para poner un mensaje de bienvenida y proporcionar instrucciones para el participante.';
...
$string['frontpagemycoursessorting'] = 'Ordena la página Mis espacios por el último acceso';
$string['frontpagemycoursessorting_desc'] = 'Cuando está marcada, se clasificará la página Mis espacios (espacios inscritos) por el último acceso del usuario. Esto anulará la configuración "Ordenar mis espacios" en Navegación. Si no está marcada, la página Mis espacios se mostrará de forma normal.';
...
$string['headerdefaultimage_desc'] = 'Imagen predeterminada para los encabezados de los espacios y las páginas que no son del espacio';
...
$string['headerimagepadding_desc'] = 'Controla el relleno y la altura de la imagen de cabecera de los espacios.';
...
$string['homemycourses'] = 'Página de inicio del espacio';
...
$string['jitsibuttontextdesc'] = 'El texto del botón que se añadirá a la parte superior de cada espacio de Moodle. Este botón llevará a los usuarios a una sala de Jitsi Meeting que forma la URL a partir del nombre del espacio y el número de ID del espacio. Debes contar con un servidor de conferencia web Jitsi.';
$string['jitsibuttonurl'] = 'URL del servidor Jitsi';
$string['jitsibuttonurldesc'] = 'Un ejemplo de servidor público: https://meet.jit.si <br>NO AÑADAS UNA BARRA INVERTIDA<br> Esta URL se utilizará para el botón que se añadirá automáticamente a cada espacio de Moodle en el área de encabezado. Te recomendamos configurar tu propio servidor Jitsi y forzar el inicio de sesión en la sala de reuniones Jitsi.';
...
$string['learningcontentpadding_desc'] = 'Controla el espacio entre la parte superior de la página y el contenido del espacio. Normalmente, preferirás que sea menor que la altura de la imagen de encabezado.';
...
$string['mycoursesinfo'] = 'Lista dinámica de espacios matriculados y menús de navegación del espacio';
$string['mycoursesinfodesc'] = 'Muestra una lista dinámica con los espacios en los que está matriculado el usuario en la barra de navegación superior. También controlará el menú desplegable de navegación del espacio para cada espacio individual.';
$string['mycoursetitle'] = 'Terminología';
$string['mycoursetitledesc'] = 'Cambiar la terminología para el enlace "Mis Espacios" en el menú desplegable';
...
$string['navbarcolorswitch_desc'] = 'Esta función cambia el color de la barra de navegación según el rol del usuario. Un participante verá un color y un facilitador verá otro color. Es útil cuando un facilitador cambia los roles y ayuda a distinguir entre la vista de un participante y la vista de un facilitador.';
...
$string['naviconbutton4textdefault'] = 'Todos los espacios';
$string['naviconbuttoncreatetextdefault'] = 'Crear un espacio';
...
$string['nomycourses'] = 'No estás inscrito en ningún espacio.';
...
$string['pagelayout5'] = 'Diseño por defecto de Boost/Imagen de encabezado en el cuadro del título del espacio';
...
$string['sectionicon'] = 'Icono de la sección del espacio';
$string['sectionicon_desc'] = 'Permite cambiar el icono que aparece junto a cada tema/semana de un espacio. Son iconos Font-Awesome.';
...
$string['sectionlayout7'] = 'Participante universitario';
$string['sectionlayout8'] = 'Participante corporativo';
...
$string['showalltomanager_desc'] = 'Esta configuración permitirá a los usuarios que tienen el rol de Gestor ver y acceder a TODAS las actividades y recursos incluso si está configurado para mostrar únicamente el menú personalizado. Generalmente, se da el rol de Gestor a un usuario por sitio o categoría. Los Facilitadores sólo verán el menú personalizado. Esta función está determinada por los permisos de usuario: Ver el Árbol de Administración del Sitio - moodle/site:configview. Los Administradores del sitio siempre verán todas las actividades y recursos.';
$string['showbacktotop'] = 'Mostrar el botón de Volver arriba y activar el Scrollspy';
$string['showbacktotop_desc'] = 'Activa el botón de volver arriba en páginas largas. Scrollspy devolverá al facilitador a su posición en la página del espacio al activar y desactivar la edición. Estas son mejoras de usabilidad para los usuarios.';
...
$string['showcourseadminstudents'] = 'Mostrar el menú Administrador del Espacio al Participante';
$string['showcourseadminstudents_desc'] = 'Muestra la configuración del espacio a los participantes. Esto es necesario si deseas permitirles cancelar su inscripción en los espacios.';
$string['showcourseheaderimage'] = 'Mostrar imágenes del espacio';
$string['showcourseheaderimage_desc'] = 'Permite a los facilitadores personalizar la imagen del encabezado del espacio subiendo una imagen a la configuración del espacio.';
...
$string['shownavdrawer_desc'] = 'Fordson ha eliminado la necesidad del cajón de navegación mediante la utilización de un menú desplegable para la navegación en el espacio. Si debe usar el cajón de navegación, puede marcar esta casilla para volver a habilitarlo.';
$string['showonlycustomactivities'] = 'Mostrar sólo el menú personalizado';
$string['showonlycustomactivities_desc'] = 'Si se selecciona, sólo se mostrará el menú personalizado. Esto permite a una organización escoger qué actividades y recursos se utilizarán en los espacios. ADVERTENCIA: Debes tener una lista de actividades/recursos separados por comas en el cuadro de texto anterior. De no ser así, no verás ninguna actividad o recurso al editar un espacio.';
$string['showonlygroupteachers'] = 'Mostrar solo facilitadores del grupo';
$string['showonlygroupteachers_desc'] = 'Cuando se habilita, solo se mostrarán los facilitadores del mismo grupo que el participante en el Panel de administración del espacio del participante.';
...
$string['showstudentcompletion'] = 'Mostrar la consecución del participante';
$string['showstudentcompletion_desc'] = 'Mostrar la consecución del participante en el área personal del participante. Aunque esté activado, para que se muestre, el espacio debe tener activada la opción de "Habilitar rastreo del grado de cierre".';
$string['showstudentgrades'] = 'Mostrar calificaciones de los participantes';
$string['showstudentgrades_desc'] = 'Mostrar el enlace al libro de calificaciones del participante en el área personal del participante. Aunque esté activado, para que se muestre, el espacio debe tener activada la opción de "Mostrar libro de calificaciones a los participantes".';
...
$string['sliderinfodesc'] = 'Este botón mostrará/ocultará un cuadro de texto especial que se desliza hacia abajo desde la barra de navegación de iconos. Es ideal para ofrecer espacios, proporcionar ayuda o listar la capacitación necesaria del personal.';
...
$string['studentdashboardtextbox'] = 'Mensaje en el área personal del participante';
$string['studentdashboardtextbox_desc'] = 'Agrega un mensaje para los participantes en el panel personal del participante en cada página del espacio.';
$string['studentdashbutton'] = 'Este espacio';
...
$string['thismycourses'] = 'Este espacio';
...
$string['titletooltip'] = 'Sugerencias en Títulos de Espacio';
$string['titletooltip_desc'] = 'Si utilizas el recorte del título de espacio se pueden utilizar sugerencias para mostrar el título completo del espacio en un mensaje emergente. Marca esta casilla para activar las sugerencias.';
...
$string['topnavbarteacherbg'] = 'Barra superior de navegación rol de facilitador';
$string['topnavbarteacherbg_desc'] = 'Color de fondo del contenido para la barra de navegación superior cuando un usuario es un facilitador. Esta función debe estar activada en la configuración del menú. Por favor, vea la configuración de navbarcolorswitch.';
$string['trimsummary'] = 'Ajustar el resumen del espacio';
$string['trimsummary_desc'] = 'Introduce un número para ajustar la longitud del resumen del espacio. El número representa los caracteres que se mostrarán.';
$string['trimtitle'] = 'Ajustar el título del espacio';
$string['trimtitle_desc'] = 'Introduce un número para ajustar la longitud del título del espacio. El número representa los caracteres que se mostrarán.';
...
$string['userlinks_desc'] = 'Gestiona tus participantes';
