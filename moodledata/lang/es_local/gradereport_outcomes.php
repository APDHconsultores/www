...
/**
 * Strings for component 'gradereport_outcomes', language 'es', version '3.9'.
 *
...
$string['courseoutcomes'] = 'Resultados del espacio';
$string['coursespecoutcome'] = 'Resultados del espacio';
