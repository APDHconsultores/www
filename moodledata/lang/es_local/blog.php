...
$string['assocdescription'] = 'Si está escribiendo sobre un espacio y/o módulos de actividad, selecciónelos aquí.';
$string['associated'] = 'Asociado {$a}';
$string['associatewithcourse'] = 'Blog del espacio {$a->coursename}';
$string['associatewithmodule'] = 'Blog sobre {$a->modtype}: {$a->modname}';
$string['association'] = 'Asociación';
$string['associations'] = 'Asociaciones';
$string['associationunviewable'] = 'Esta entrada no puede ser vista por otros hasta que se asocie un espacio con ella o se cambie el campo \'Publicar a\'';
...
$string['blogaboutthiscourse'] = 'Añadir una entrada en el blog de espacio';
...
$string['blogs'] = 'Blogs';
$string['blogscourse'] = 'Blogs de espacio';
$string['blogssite'] = 'Blogs del sitio';
$string['blogtags'] = 'Etiquetas del Blog';
$string['cannotviewcourseblog'] = 'No tiene permiso para ver los blogs de este espacio';
$string['cannotviewcourseorgroupblog'] = 'No tiene permiso para ver los blogs de este espacio/grupo';
...
$string['configuseblogassociations'] = 'Habilita la asociación de las entradas del blog con espacios y módulos de espacio.';
...
$string['courseblog'] = 'Blog del espacio: {$a}';
$string['courseblogdisable'] = 'Los blogs del espacio están deshabilitados';
$string['courseblogs'] = 'Los usuarios sólo pueden ver los blogs de las personas que comparten un espacio';
$string['deleteblogassociations'] = 'Eliminar asociaciones de blog';
$string['deleteblogassociations_help'] = 'Si se selecciona esta opción, las entradas de blog quedarán desvinculadas de este espacio o de las actividades o recursos del espacio. Las entradas de blog no serán eliminadas.';
...
$string['publishtocourse'] = 'Usuarios que comparten espacio con usted';
$string['publishtocourseassoc'] = 'Miembros del espacio asociado';
$string['publishtocourseassocparam'] = 'Miembros de {$a}';
$string['publishtogroup'] = 'Usuarios que comparten grupo con usted';
$string['publishtogroupassoc'] = 'Sus miembros de grupo en el espacio asociado';
...
$string['viewcourseblogs'] = 'Ver todas las entradas de este espacio';
$string['viewentriesbyuseraboutcourse'] = 'Ver las entradas sobre este espacio por {$a}';
...
$string['viewmyentriesaboutcourse'] = 'Ver mis entradas en el blog de este este espacio';
