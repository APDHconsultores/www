...
$string['errormustbeteacher'] = 'Necesita ser un facilitador para usar esta página';
...
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad Base de Datos.';
$string['indicator:socialbreadth'] = 'Base de Datos social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad Base de Datos.';
...
$string['maxentries_help'] = 'Número máximo de entradas que un participante puede enviar en esta actividad.';
...
$string['modulename_help'] = 'El módulo de actividad de base de datos permite a los participantes crear, mantener y buscar información en un repositorio de registros. La estructura de las entradas la define el facilitador según una lista de campos. Los tipos de campo incluyen casilla de verificación, botones de radio, menú desplegable, área de texto, URL, imagen y archivo cargado.

La presentación visual de la información al listar, ver o editar las entradas de la base de datos se controla mediante plantillas de base de datos. Las actividades de base de datos pueden ser compartidos entre los espacios como opción preestablecida de manera que un facilitador también puede importar y exportar las entradas de base de datos.

Si el filtro de base de datos "auto enlace" está activo, cualquier entrada de la base de datos  será enlazada automáticamente cuando sus palabras o frases aparezcan dentro en el espacio.

Un facilitador puede permitir comentarios en las entradas. Las entradas también pueden se calificadas por facilitadores u otros participantes (evaluación por pares). Las calificaciones se agregarán para formar una calificación final que se registrará en el libro de calificaciones.
...
* Visualizar fotos, carteles, sitios web o poemas de los participantes, que puedan ser comentados por otros participantes.';
...
$string['requireapproval_help'] = '<p>¿Debería un facilitador aprobar las entradas antes de que los participantes puedan verlas? Esta opción es útil para moderar el contenido que potencialmente pudiera resultar ofensivo o inadecuado.</p>';
