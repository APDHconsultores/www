...
/**
 * Strings for component 'local_obf', language 'es', version '3.9'.
 *
 * @package     local_obf
 * @category    string
...
$string['addnewcriterion'] = 'Añadir espacio';
...
$string['coursebadgelisttitle'] = 'Insignias relacionadas con este espacio';
$string['coursecompletedby'] = 'Completado por';
$string['courseobfbadges'] = 'Insignias';
$string['courserequired'] = 'Debe seleccionar al menos un espacio';
$string['courseuserbadges'] = 'Insignias del usuario';
$string['criteriaaddcourse'] = 'Añadir espacio';
$string['criteriacompletedwhen'] = 'Esta regla se cumple cuando...';
$string['criteriacompletedwhenall'] = 'Tienen que completarse todos los espacios siguientes:';
$string['criteriacompletedwhenany'] = 'Tiene que completarse cualquiera de los espacios siguientes:';
$string['criteriacompletionmethodall'] = 'Todos estos espacios están completados';
