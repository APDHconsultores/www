...
/**
 * Strings for component 'repository', language 'es', version '3.9'.
 *
 * @package     repository
 * @category    string
...
$string['areacourseintro'] = 'Introducción del espacio';
$string['areacourseoverviewfiles'] = 'Resumen de los archivos del espacio';
...
$string['coursebackup'] = 'Copias de seguridad del espacio';
...
$string['enablecourseinstances'] = 'Permitir a los usuarios agregar una instancia de repositorio dentro del espacio';
...
$string['instancesforcourses'] = '{$a} Repositorio(s) común(es) de todo el espacio';
$string['instancesforsite'] = '{$a} Repositorio(s) común(es) de todo el espacio';
...
$string['repositorycourse'] = 'Repositorios del espacio';
