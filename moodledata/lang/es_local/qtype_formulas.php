...
/**
 * Strings for component 'qtype_formulas', language 'es', version '3.9'.
 *
...
$string['correctfeedback_help'] = 'Estos comentarios serán mostrados a participantes que obtengan la puntuación máxima en esta parte. Pueden incluir variables globales y locales que serán remplazadas por sus valores';
...
$string['feedback_help'] = 'Los comentarios de esta parte se mostrarán a los participantes que no obtengan la máxima calificación en esta parte. Pueden incluir las variables locales y globales que se sustituirán por sus valores';
...
$string['incorrectfeedback_help'] = 'Estos comentarios serán mostrados a participantes que no obtengan ninguna puntuación en esta parte. Pueden incluir variables globales y locales que serán remplazadas por sus valores';
...
$string['partiallycorrectfeedback_help'] = 'Estos comentarios serán mostrados a participantes que no obtengan la puntuación máxima en esta parte. Pueden incluir variables globales y locales que serán remplazadas por sus valores';
...
Los participantes deben utilizar el mismo formato de entrada. Por ejemplo:
...
$string['unitpenalty_help'] = 'Esta opción especifica la puntuación con la que desea penalizar al participante por cada unidad incorrecta.

Tiene un valor de entre 0 y 1. Si adopta el valor de 1, la unidad y la respuesta deben ser correctas al mismo tiempo para poder obtener la puntuación. Es decir, la unidad y la respuesta se consideran una sola entidad. Por otra parte, si adopta un valor 0, los participantes podrán obtener la puntuación total únicamente si introducen la respuesta correcta, y ninguna cadena aleatoria tendrá ningún efecto al final de la respuesta.
...
$string['vars2_help'] = 'Aquí se pueden utilizar todas las variables locales y las respuestas del participante. Consulte la documentación sobre los usos avanzados.';
