...
/**
 * Strings for component 'jclic', language 'es', version '3.9'.
 *
 * @package     jclic
 * @category    string
...
$string['event_course_module_viewed'] = 'Módulo de espacio visto';
...
$string['filetype_help'] = 'Este ajuste determina cómo se incluye en el espacio la actividad JClic. Hay 2 opciones:
...
Este módulo le permite a los maestros añadir actividades JClic a cualquier espacio y seguir el resultado de los pupilos (tiempo empleado en cada actividad, número de intentos, puntuación, etc).';
