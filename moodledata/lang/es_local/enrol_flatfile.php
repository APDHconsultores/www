...
/**
 * Strings for component 'enrol_flatfile', language 'es', version '3.9'.
 *
...
$string['expiredaction_help'] = 'Seleccione la acción a realizar cuando finalice el periodo de matriculación del usuario. Por favor, tenga en cuenta que algunos datos de usuario y de configuración se eliminan del espacio durante el proceso de baja.';
...
$string['flatfile:unenrol'] = 'Dar de baja usuarios del espacio manualmente';
