...
/**
 * Strings for component 'block_section_links', language 'es', version '3.9'.
 *
...
$string['numsections1_help'] = 'Una vez que el número de secciones en el espacio alcanza este número, se utilizará el incremento por valor.';
$string['numsections2'] = 'Número alternativo de secciones';
$string['numsections2_help'] = 'Una vez que el número de secciones en el espacio alcanza este número, se utilizará el incremento por valor.';
