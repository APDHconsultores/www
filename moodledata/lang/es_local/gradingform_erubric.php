...
/**
 * Strings for component 'gradingform_erubric', language 'es', version '3.9'.
 *
...
$string['enrichshareconfirm'] = '<p style="text-align:center;color:red;font-weight:bold">¡ADVERTENCIA!</p>
   ...
   Si otros usuarios en su sitio utilizaran este formato en cualquier otro espacio, ¡<b>no funcionará tal como está</b>! La estructura principal de la rúbrica permanecerá intacta, pero tendrá que reemplazar todos los módulos de espacio incrustados con módulos similares del espacio destino.';
...
$string['privacy:metadata:fillings:enrichedbenchmarkstudent'] = 'El valor de referencia del participante, creado de Minería de Datos y Análisis del Aprendizaje.';
$string['privacy:metadata:fillings:enrichedbenchmarkstudents'] = 'El valor de referencia de todos los participantes participantes, creado de Minería de Datos y Análisis del Aprendizaje.';
