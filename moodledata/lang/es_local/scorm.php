...
/**
 * Strings for component 'scorm', language 'es', version '3.9'.
 *
 * @package     scorm
 * @category    string
...
$string['completionstatusallscos'] = 'Requiere que todos los scos devuelvan el estado de cierre';
...
$string['completionstatusrequired_help'] = 'Al comprobar uno o más estados se requerirá que el participante cumpla al menos con uno de esos estados para que se marque como finalizada esta  actividad SCORM, así como cualquier otro requerimiento de Finalización de Actividad';
...
$string['coursepacket'] = 'Paquete de espacio';
$string['coursestruct'] = 'Estructura de espacio';
$string['crontask'] = 'Procesamiento en segundo plano para SCORM';
$string['currentwindow'] = 'Ventana actual';
$string['datadir'] = 'Error del sistema de archivos: No se puede crear el directorio de datos del espacio';
...
$string['displayattemptstatus_help'] = 'Esta preferencia permite mostrar un resumen de los intentos de los usuarios en el bloque Vista general del espacio en Mi Tablero y/o en la página de entrada del SCORM.';
$string['displayattemptstatusdesc'] = 'Mostrar un resumen de los intentos del usuario  en el bloque Vista general del espacio en Mi Tablero y/o la página de inicio del SCORM';
$string['displaycoursestructure'] = 'Mostrar estructura del espacio en la página de entrada';
$string['displaycoursestructure_help'] = 'Si está activado, la tabla de contenidos se mostrará en la página de resumen SCORM.';
$string['displaycoursestructuredesc'] = 'Esta preferencia fija el valor por defecto para mostrar el ajuste de estructura del espacio en la página de entrada';
...
$string['enter'] = 'Entrar';
$string['entercourse'] = 'Introducir el espacio SCORM';
...
$string['finishscormlinkname'] = 'haga clic aquí para volver a la página del espacio';
$string['firstaccess'] = 'Primer acceso';
$string['firstattempt'] = 'Primer intento';
$string['floating'] = 'Flotante';
$string['forcecompleted'] = 'Forzar cierre';
...
* No: si un intento anterior se completa, pasa o falla, se le proporcionará al participante la opción de ingresar en modo de revisión o comenzar un nuevo intento.
...
* Siempre: cada reingreso a la actividad SCORM generará un nuevo intento y el participante no regresará al mismo punto al que llegó en su intento anterior.';
...
<p>En caso contrario, el participante puede elegir entre previsualizar la actividad o realizar un intento de forma normal.</p>
...
$string['hidetoc'] = 'Mostrar la estructura del espacio en el reproductor';
...
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad SCORM.';
$string['indicator:socialbreadth'] = 'SCORM social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad SCORM.';
$string['info'] = 'Info';
...
$string['lastattemptlock_help'] = 'Si se activa, al participante se le impide el lanzamiento del reproductor SCORM después de haber utilizado todos los intentos que tenía asignados.';
...
$string['modulename_help'] = 'Un paquete SCORM es un conjunto de archivos que se empaquetan conforme a una norma estándar para los objetos de aprendizaje. El módulo de actividad SCORM permite cargar y añadir a los espacios paquetes SCORM o AICC como archivos zip.
...
<p>El paquete es un archivo particular con extensión <strong>zip</strong>
  (o pif) que contiene archivos válidos de definición de espacio SCORM o AICC</p>
<p>Un paquete SCORM contiene en la raíz del zip un archivo llamado<strong>
  imsmanifest.xml </strong>el cual define la estructura de un espacio SCORM,la localización
...
<ul>
  <li>CRS - Archivo de descripción del espacio (obligatorio)</li>
  <li>AU - Archivo de asignación de unidad (obligatorio)</li>
  <li>DES - Archivo de descripción (obligatorio)</li>
  <li>CST - Archivo de estructura del espacio (obligatorio)</li>
...
$string['popuplaunched'] = 'Este paquete SCORM se ha abierto en una nueva ventana, si has terminado de ver este recurso, haz clic aquí para regresar a la página del espacio';
...
$string['scormcourse'] = 'Espacio de Aprendizaje';
...
$string['scormtype_help'] = 'Este ajuste determina cómo se incluye el paquete en el espacio. Hay 4 opciones:
...
$string['skipview'] = 'Pasar por alto al participante la página de estructura de contenidos';
...
$string['tracklatency_help'] = 'Tiempo transucrrido entre el momento en que la se puso a disposición del participante la interacción para respoder y el momento de la primera respuesta';
...
$string['trackresponse_help'] = 'Esta es la respuesta dada por el participante para esta pregunta';
$string['trackresult'] = 'Resultado';
$string['trackresult_help'] = 'Resultado en base a la respuesta del participante y el resultado correcto';
...
$string['trackscoreraw_help'] = 'Número que refleja el resultado del participante en relación con el rango delimitado por los valores de mínimo y máximo';
...
* Algunos paquetes SCORM son inteligentes sobre los nuevos intentos, pero muchos no lo son. Lo que significa que si el participante vuelve a ha hacer un intento y contenido SCORM no tiene lógica interna para evitar sobrescribir los intentos anteriores, estos se pueden sobrescribir, incluso si el  intento estaba en estado "completado" o "pasado".
