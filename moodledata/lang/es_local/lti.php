...
/**
 * Strings for component 'lti', language 'es', version '3.9'.
 *
 * @package     lti
 * @category    string
...
$string['course_tool_types'] = 'Tipos de herramientas del espacio';
$string['courseactivitiesorresources'] = 'Actividades o recursos del espacio';
$string['courseid'] = 'Número ID del Espacio';
$string['courseinformation'] = 'Información del espacio';
$string['courselink'] = 'Ir al espacio';
$string['coursemisconf'] = 'El espacio está mal configurado';
...
$string['default_launch_container_help'] = 'El contenedor de inicio afecta a la visualización de la herramienta cuando se inicia desde el espacio. Algunos contenedores de inicio proporcionan un mayor espacio de pantalla real a la herramienta, mientras que otros ofrecen una sensación más integrada en el entorno de Moodle.
...
$string['delegate'] = 'Delegar al facilitador';
...
$string['enableemailnotification_help'] = 'Si se activa, los participantes recibirán notificación por correo electrónico cuando sus entregas sean calificadas.';
...
* **Automático, basada en Launch URL** - Esta configuración debería ser empleada en la mayoría de los casos. Moodle elegirá la configuración de la utilidad más apropiada      basada en Launch URL. Se usarán herramientas configurada tanto por el administrador como desde el propio espacio.
...
* **Añadir** - Crea una configuración de herramienta a nivel de espacio. Todas las instancias de la herramienta externa en este espacio pueden emplear esta configuración de herramienta.

* **Editar** - Selecciona un tipo de herramienta a nivel de espacio a partir de una lista desplegable y eligiendo después este ícono. Los detalles de la configuración de la herramienta pueden editarse.

* **Borrar** - Elimina el tipo de herramienta del espacio seleccionado.';
...
$string['forced_help'] = 'Este ajuste ha sido configurado a nivel espacio o sitio. Es posible que no pueda modificarlo desde esta interfaz.';
...
$string['icon_url_help'] = 'La URL de icono permite modificar el icono que se muestra en la lista de espacios para esta actividad. En vez del icono LTI se puede especificar un icono adecuado al tipo de actividad.';
$string['id'] = 'id';
$string['indicator:cognitivedepth'] = 'LTI cognitiva';
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad LTI.';
$string['indicator:socialbreadth'] = 'LTI social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad LTI.';
...
$string['launchinpopup_help'] = 'El contenedor que inicia la herramienta afecta al modo de visualización en el espacio. Algunos contenedores proporcionan más espacio en pantalla y otros proporcionan una apariencia más integrada en Moodle.
...
<p>Otra opción es <a href="{$a->course_tool_editor}">crear una configuración para el proveedor de herramientas al nivel del espacio</a>.</p>';
...
Mediante un protocolo especial de inicio la herramienta externa tendrá acceso a alguna información general del usuario que la inicia, como por ejemplo, el nombre de la institución, el id del espacio y otras informaciones como el nombre de usuario o la dirección de correo.

Los tipos de herramienta se clasifican en tres categorías:

**Activo** Estos proveedores de herramientas han sido aprobados y configurados por el administrador. Pueden ser utilizados en todos los espacios de la plataforma Moodle. Si se dispone de clave de usuario y clave compartida, se establecerá una comunicación segura entre el sitio Moodle y la herramienta externa.
...
* Las herramientas externas están conscientes del contexto, por ejemplo: tienen acceso a información acerca del usuario que invocó la herramienta, como por ejemplo sa institución, espacio y nombre
...
$string['return_to_course'] = 'Haz clic <a href="{$a->link}" target="_top">aquí</a> para volver al espacio.';
...
$string['share_roster'] = 'Permitir acceder a la herramienta a la lista de este espacio';
$string['share_roster_admin'] = 'La herramienta puede acceder a la lista del espacio';
