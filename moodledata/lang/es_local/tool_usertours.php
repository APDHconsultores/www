...
/**
 * Strings for component 'tool_usertours', language 'es', version '3.9'.
 *
...
$string['filter_category_help'] = 'Mostrar el tour en una página que está asociada con un espacio en la categoría seleccionada.';
$string['filter_course'] = 'Espacios';
$string['filter_course_help'] = 'Mostrar el tour en una página que está asociada con el espacio seleccionado.';
$string['filter_courseformat'] = 'Formato del espacio';
$string['filter_courseformat_help'] = 'Mostrar el tour en una página que está asociada con un espacio usando el formato de espacio seleccionado.';
...
$string['filter_role_help'] = 'Un tour puede estar restringido a usuarios con roles seleccionados en el contexto en donde se muestra el tour. Por ejemplo, el restringir un tour del Área personal a usuarios con el rol de participante no funcionará si los usuarios tienen el rol de participante en un espacio (como generalmente sucede). Un tour del Área personal solamente puede restringirse a usuarios con un rol del sistema.';
...
* /course/view.php?id=2 - para coincidir con un espacio específico
...
$string['tour2_content_addblock'] = 'Si habilita el modo de edición, puede añadir bloques desde el cajón de navegación. Sin embargo, piense cuidadosamente acerca de incluir algun bloque en sus páginas. Los bloques no se muestran en la App de Moodle Mobile, por lo que para una mejor experiencia para el usuario, sería mucho mejor que se asegure de que su espacio funciona bien sin bloques.';
...
$string['tour2_content_customisation'] = 'Para cambiar cualquier configuración de espacio, utilice el menú de configuración de la esquina de este encabezado. También encontrará un menú de configuración similar en la página principal de todas las actividades. Prueba a cambiar la edición en este momento.';
...
$string['tour2_content_navigation'] = 'La navegación es ahora a través de este bloque de navegación. Utilice el botón en la parte superior para ocultarlo o mostrarlo. Verá que hay enlaces para secciones de su espacio.';
$string['tour2_content_opendrawer'] = 'Intentar abrir el cajón de navegación ahora.';
$string['tour2_content_participants'] = 'Ver los participantes aquí. Aquí además es donde podrás añadir o quitar participantes.';
$string['tour2_content_welcome'] = 'Bienvenido al tema Boost. Si su sitio ha sido actualizado desde una versión anterior, es posible que las cosas se vean un poco diferentes en la página del espacio.';
...
$string['tour2_title_participants'] = 'Participantes del espacio';
...
$string['tour3_content_displayoptions'] = 'Los espacios pueden ordenarse por nombre o por su última fecha de acceso.

También puede optar por mostrar los espacios en una lista, con información de resumen o la vista de "tarjeta" predeterminada.';
$string['tour3_content_overview'] = 'El bloque de Vista general del espacio muestra todos los espacios en los cuales está matriculado.

Puede elegir mostrar espacios actualmente en progreso, o en el pasado, o en el futuro, o espacios que ha marcado como destacados.';
$string['tour3_content_recentcourses'] = 'El bloque de "Espacios de Acceso Reciente" muestra los espacios que han sido vistos por última vez, lo que le permite volver a encontrarlos y acceder de un modo más inmediato.';
$string['tour3_content_starring'] = 'Puede elegir iniciar un espacio para destacarlo u ocultar un espacio que ya no es importante.

Estas acciones solo afectan a su vista.

También puede optar por mostrar los espacios en una lista, o con información resumida, o la vista de "tarjeta" predeterminada.';
...
$string['tour3_title_overview'] = 'Vista general de espacio';
$string['tour3_title_recentcourses'] = 'Espacios accedidos recientemente';
$string['tour3_title_starring'] = 'Destacar y ocultar espacios';
...
Las conversaciones en grupo del espacio permiten interactuar con los demás miembros de su grupo en una zona privada.';
...
$string['tour4_content_messaging'] = 'Esta nueva versión de Moodle proporciona una nueva interfaz para la mensajería, la capacidad de enviar mensajes de grupo dentro de un espacio, junto con un mejor control sobre quién puede enviarle mensajes.';
