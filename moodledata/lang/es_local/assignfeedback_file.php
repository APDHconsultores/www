...
/**
 * Strings for component 'assignfeedback_file', language 'es', version '3.9'.
 *
...
$string['enabled_help'] = 'Si está habilitado, el facilitador, cuando evalúe las tareas, podrá subir los comentarios de retroalimentación en archivos  Estos archivos pueden ser, sin estar limitados a estos ejemplos,  documentos de texto o archivos de audio.';
$string['feedbackfileadded'] = 'Nuevo archivo de retroalimentación "{$a->filename}" para participante "{$a->student}"';
$string['feedbackfileupdated'] = 'Archivo de retroalimentación modificado "{$a->filename}" para participante "{$a->student}"';
$string['feedbackzip'] = 'Archivo ZIP con archivos de retroalimentación';
$string['feedbackzip_help'] = 'Un archivo ZIP que contiene una lista de archivos de retroalimentación para uno o más participantes. Los archivos de retroalimentación serán asignados a los participantes basándose en la ID del participante que debería ser la segunda parte de cada nombre de archivo inmediatamente después del nombre completo de los usuarios. Esta convención para los nombres se emplea al descargar las entregas, de tal forma que usted puede usar la opción "Descargar todas las entregas", realizar las correcciones a algunos archivos y después comprimir de nuevo los archivos y subirlos mediante esta opción. Los archivos que no tengan cambios serán ignorados.';
...
$string['privacy:metadata:filepurpose'] = 'Archivos de retroalimentación del facilitador para el participante.';
