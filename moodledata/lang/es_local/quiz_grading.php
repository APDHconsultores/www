...
/**
 * Strings for component 'quiz_grading', language 'es', version '3.9'.
 *
...
$string['bystudentfirstname'] = 'Por nombre del participante';
$string['bystudentidnumber'] = 'Por número id de participante';
$string['bystudentlastname'] = 'Por apellido del participante';
...
$string['grading:viewidnumber'] = 'Ver los números id de los participantes mientras se califica';
$string['grading:viewstudentnames'] = 'Ver los nombres de los participantes mientras se califica';
...
$string['showstudentnames'] = 'Mostrar nombres de participantes';
