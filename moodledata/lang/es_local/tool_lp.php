...
/**
 * Strings for component 'tool_lp', language 'es', version '3.9'.
 *
 * @package     tool_lp
 * @category    string
...
$string['addcoursecompetencies'] = 'Agregar una competencia al espacio';
...
$string['competenciesmostoftennotproficientincourse'] = 'Competencias que más a menudo no se superan en este espacio';
...
$string['configurecoursecompetencysettings'] = 'Configurar competencias del espacio';
$string['configurescale'] = 'Configurar escalas';
$string['coursecompetencies'] = 'Competencias del espacio';
$string['coursecompetencyratingsarenotpushedtouserplans'] = 'Las valoraciones de competencias de este espacio no afectan los planes de aprendizaje.';
$string['coursecompetencyratingsarepushedtouserplans'] = 'Las valoraciones de competencias en este espacio actualizan de inmediato los planes de aprendizaje.';
$string['coursecompetencyratingsquestion'] = 'Cuando se valora una competencia de espacio, ¿aplica también al plan de aprendizaje o únicamente al espacio?';
$string['coursesusingthiscompetency'] = 'Espacios vinculados a esta competencia';
...
$string['findcourses'] = 'Encontrar espacios';
...
$string['linkedcourses'] = 'Espacios vinculados';
$string['linkedcourseslist'] = 'Espacios vinculados:';
...
$string['modcompetencies'] = 'Competencias del espacio';
$string['modcompetencies_help'] = 'Competencias de espacio vinculadas a esta actividad';
$string['move'] = 'Mover';
...
$string['nocompetenciesincourse'] = 'No se han vinculado competencias con este espacio.';
...
$string['uponcoursecompletion'] = 'Al terminar el espacio:';
...
$string['when'] = 'Cuando';
$string['xcompetencieslinkedoutofy'] = '{$a->x} de {$a->y} competencias vinculadas a espacios';
$string['xcompetenciesproficientoutofy'] = '{$a->x} de {$a->y} competencias superadas';
$string['xcompetenciesproficientoutofyincourse'] = 'Has superado {$a->x} de las {$a->y} competencias del espacio.';
