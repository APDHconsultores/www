...
/**
 * Strings for component 'format_grid', language 'es', version '3.9'.
 *
 * @package     format_grid
 * @category    string
...
$string['cannotgetimagesforcourse'] = 'No se pueden obtener imágenes para el espacio.  Informe al desarrollador de los detalles del error.';
...
$string['defaultcoursedisplay'] = 'Visualización del espacio predeterminada';
...
$string['on'] = 'Activado';
$string['page-course-view-grid'] = 'Cualquier página principal del espacio en el formato rejilla';
$string['page-course-view-grid-x'] = 'Cualquier página del espacio en el formato rejilla';
...
$string['resetallfitpopup_help'] = 'Restablece los valores predeterminados de la opción «Ajustar elementos emergentes de la sección a la ventana» de todos los espacios para que sean los mismos que los valores iniciales de un espacio en formato rejilla.';
$string['resetallgrp'] = 'Resetear todo:';
$string['resetallimagecontainersize'] = 'Tamaños de contenedor de imagen';
$string['resetallimagecontainersize_help'] = 'Restablece los valores predeterminados de los tamaños del contenedor de la imagen en todos los espacios para que sean los mismos que los valores iniciales de un espacio en formato rejilla.';
$string['resetallimagecontainerstyle'] = 'Estilos de contenedor de imagen';
$string['resetallimagecontainerstyle_help'] = 'Restablece los valores predeterminados de los estilos del contenedor de la imagen en todos los espacios para que sean los mismos que los valores iniciales de un espacio en formato rejilla.';
$string['resetallimageresizemethod'] = 'Métodos de cambio de tamaño de la imagen';
$string['resetallimageresizemethod_help'] = 'Restablece los valores predeterminados de los métodos de cambio de tamaño de la imagen en todos los espacios para que sean los mismos que los valores iniciales de un espacio en formato rejilla.';
$string['resetallnewactivity'] = 'Nuevas actividades';
$string['resetallnewactivity_help'] = 'Restablece los valores predeterminados de las imágenes de notificación de una nueva actividad en todos los espacios para que sean los mismos que los valores iniciales de un espacio en formato rejilla.';
$string['resetfitpopup'] = 'Ajustar elemento emergente de la sección a la ventana';
$string['resetfitpopup_help'] = 'Restablece los valores predeterminados de la opción «Ajustar elemento emergente de la sección a la ventana» para que sean los mismos que los valores iniciales de un espacio en formato rejilla.';
$string['resetgrp'] = 'Resetear:';
$string['resetimagecontainersize'] = 'Tamaño del contenedor de la imagen';
$string['resetimagecontainersize_help'] = 'Restablece los valores predeterminados del tamaño del contenedor de la imagen para que sean los mismos que los valores iniciales de un espacio en formato rejilla.';
$string['resetimagecontainerstyle'] = 'Estilo del contenedor de la imagen';
$string['resetimagecontainerstyle_help'] = 'Restablece el valor predeterminado del estilo del contenedor de la imagen para que sea el mismo que el valor inicial de un espacio en formato rejilla.';
$string['resetimageresizemethod'] = 'Método de cambio de tamaño de la imagen';
$string['resetimageresizemethod_help'] = 'Restablece el valor predeterminado del método de cambio de tamaño de la imagen para que sea el mismo que el valor inicial de un espacio en formato rejilla.';
$string['resetnewactivity'] = 'Nueva actividad';
$string['resetnewactivity_help'] = 'Restablece los valores predeterminados de la imagen de notificación de nueva actividad para que sean los mismos que los valores iniciales de un espacio en formato rejilla.';
$string['scale'] = 'Escala';
