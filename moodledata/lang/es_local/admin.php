...
$string['allowcoursethemes'] = 'Permitir estilos en el espacio';
...
$string['alternativefullnameformat_desc'] = 'Define como se muestran los nombres a los usuarios que tienen activada la capacidad "viewfullnames" (por defecto, disponible en usuarios con roles de gestor, facilitador o cofacilitador). Los marcadores que pueden ser usados vienen determinados por el parámetro \'Formato de nombre completo\'.';
...
$string['backup_shortname'] = 'Usar nombre del espacio en el nombre del archivo de copia de seguridad';
$string['backup_shortnamehelp'] = 'Usar el nombre del espacio como parte del nombre del archivo de copia de seguridad.';
...
$string['calendartype_desc'] = 'Elija un tipo de calendario por defecto para todo el sitio. Este ajuste se puede sobrescribir por los ajustes de la configuración del espacio o por los del perfil personal del usuario';
...
$string['configallowcategorythemes'] = 'Si activa esta opción, los temas pueden ajustarse al nivel de la categoría. Esto afectará a todas las categorías y espacios de nivel inferior (\'hijos\') a menos que tengan especificado su propio tema. ATENCIÓN: Habilitar esta opción puede afectar al rendimiento.';
...
$string['configallowcoursethemes'] = 'Si activa esta opción, se permitirá a los espacios ajustar sus propios temas. Los temas de los espacios pasan por alto cualesquiera otras opciones de tema (sitio, usuario o sesión)';
...
$string['configallowuserthemes'] = 'Si se activa esta opción, los usuarios podrán elegir sus propios temas. Los temas de los usuarios anulan los temas del sitio (pero no los temas del espacio)';
...
$string['configallusersaresitestudents'] = 'En lo que concierne a las actividades de la página principal del sitio, ¿deberían todos los usuarios ser considerados como participantes? Si la respuesta es "Sí", cualquier usuario con cuenta confirmada podrá participar como participante en tales actividades. Si la respuesta es "No", sólo los usuarios que ya participan en al menos un espacio podrán tomar parte en las actividades de la página principal. Sólo los administradores y facilitadores especialmente asignados pueden actuar como facilitadores en las actividades de la página principal.';
...
$string['configautologinguests'] = '¿Deberá permitirse a los visitantes automáticamente el acceso como invitados cuando entran a los espacios con acceso de invitado?';
...
$string['configcoursegraceperiodafter'] = 'Clasificar espacios pasados como en progreso por este número de días después de la fecha de fin del espacio.';
$string['configcoursegraceperiodbefore'] = 'Clasificar espacios futuros como en progreso por este número de días antes de la fecha de inicio del espacio.';
$string['configcourseoverviewfilesext'] = 'Una lista separada por comas de extensiones permitidas de archivos de imágenes del espacio.';
$string['configcourseoverviewfileslimit'] = 'El número de archivos que pueden ser mostrados junto al resumen del espacio en la página de lista de espacios. El primer archivo añadido es usado como la imagen del espacio en la vista general del espacio en los Tableros de los usuarios; los archivos adicionales son mostrados solamente en la página de la lista de espacios.';
$string['configcourserequestnotify'] = 'Escriba el nombre de usuario a quien se enviará una notificación cuando se solicite un nuevo espacio';
$string['configcourserequestnotify2'] = 'Usuarios a quienes se notificará cuando un campo es requerido. En esta lista figuran únicamente los usuarios que pueden aprobar las solicitudes de espacio.';
$string['configcoursesperpage'] = 'Introduzca el número de espacios a mostrar por página en un listado de espacios.';
$string['configcourseswithsummarieslimit'] = 'El número máximo de espacios que se mostrarán en un listado de espacios que incluye resúmenes antes de volver de nuevo a una lista simple.';
...
$string['configdefaultrequestcategory'] = 'Los espacios que sean solicitados por usuarios con capacidad para solicitar nuevos espacios en el ámbito del sistema serán ubicados en esta categoría, a menos que los usuarios puedan seleccionar una categoría diferente.';
$string['configdefaultrequestedcategory'] = 'Categoría por defecto en la que incluir los espacios solicitados, en el caso de que sean aprobados.';
$string['configdefaultuserroleid'] = 'A todos los usuarios identificados se les asignarán los permisos del rol que usted especifique aquí, en el nivel del sitio, ADEMÁS de cualesquiera otros roles que puedan tener. El rol por defecto es el de Usuario identificado. Advierta que esto no entrará en conflicto con otros roles que tengan a menos que prohiba permisos. Simplemente asegura que todos los usuarios tengan permisos que no son asignables a nivel de espacio (e.g., enviar entradas al blog, gestionar su propio calendario, etc.).';
...
$string['configenableanalytics'] = 'Los modelos analíticos, tal como \'Riesgo de que los participantes abandonen\' o \'Vencimiento de próximas actividades\', pueden generar predicciones, enviar notificaciones de advertencia y ofrecer más acciones como contactar a los usuarios.';
...
$string['configenablestats'] = 'Si selecciona \'sí\', el cronjob de Moodle procesará los registros y recopilará algunas estadísticas. Dependiendo de la cantidad de tráfico del sitio, esta operación puede demorarse. Si activa esta opción, podrá ver algunos gráficos y estadísticas interesantes sobre cada uno de sus espacios, o bien sobre todo el sitio.';
...
$string['configforcelogin'] = 'Normalmente la página principal del sitio y las listas de los espacios (pero no los espacios) pueden ser leídos por cualquier visitante sin necesidad de identificarse. Si desea forzar a los visitantes a identificarse antes de acceder a CUALQUIER CONTENIDO debería activar esta opción.';
...
$string['configfrontpagecourselimit'] = 'Número máximo de espacios';
$string['configfrontpagecourselimithelp'] = 'Número máximo de espacios que se mostrará en la página principal del sitio en los listados de espacios.';
...
$string['configgradebookroles'] = 'Esta opción le permite controlar quién aparece en el libro de calificaciones. Los usuarios necesitan tener al menos uno de estos roles en un espacio para poder aparecer en el libro de calificaciones de ese espacio.';
...
$string['confighiddenuserfields'] = 'Para aumentar la privacidad de los participantes, seleccione qué campos de información sobre el usuario desea ocultar a otros usuarios distintos de los facilitadores del espacio o los administradores. Mantenga pulsada la tecla CTRL para seleccionar varios campos.
...
$string['configlockrequestcategory'] = 'En caso de habilitarse, los usuarios con competencias para solicitar nuevos espacios en el contexto del sistema, no podrán seleccionar una categoría en la solicitud de nuevo espacio. Una vía alternativa para restringir a los usuarios poder solicitar un nuevo espacio en una sola categoría es pedir la competencia de solicitar nuevos espacios en la categoría contexto';
...
$string['configmaxbytes'] = 'Esta opción especifica el tamaño máximo que deben tener los archivos subidos al sitio. Está limitada por los ajustes post_max_size y upload_max_size de  PHP y por el ajuste LimitRequestBody de Apache. A su vez, la opción limita el rango de tamaños que pueden elegirse en el nivel de espacio o de módulo. Si se elige la opción \'Límite de Servidor\' se usará el máximo permitido por el servidor.';
...
$string['configmaxusersperpage'] = 'Número máximo de usuarios que se mostrará en el selector de usuarios dentro de espacios, grupos, cohortes, servicios web, etc.';
...
$string['configmycoursesperpage'] = 'Número máximo de espacios que se mostrará en cualquier lista de espacios propios de un usuario';
...
$string['confignavcourselimit'] = 'Limita el número de espacios mostrados al usuario en la navegación.';
$string['confignavshowallcourses'] = 'Este ajuste determina si los usuarios que están inscritos en los espacios pueden ver Espacios (lista de todos los espacios) en la barra de navegación, además de mis espacios (espacios en los que están inscritos de la lista).';
$string['confignavshowcategories'] = '<p>Mostrar las categorías de espacio en la barra de navegación y en los bloques de navegación. </p>
<p>No afecta a los espacios en los que el usuario está actualmente matriculado, de manera que todavía aparecerán en la lista \'Mis espacios\' sin categorías.</p>';
...
$string['configprofilesforenrolledusersonly'] = 'Para prevenir el abuso de los creadores de spam, se ocultan las descripciones del perfil de los usuarios que aún no están matriculados en ningún espacio. Los usuarios nuevos deben matricularse en al menos un espacio antes de que puedan agregar la descripción del perfil.';
...
$string['configrequestcategoryselection'] = 'Permitir la selección de una categoría cuando se solicita un espacio.';
$string['configrequestedstudentname'] = 'Término utilizado para \'participante\' en los espacios solicitados';
$string['configrequestedstudentsname'] = 'Término utilizado para \'participantes\' en los espacios solicitados';
$string['configrequestedteachername'] = 'Término utilizado para \'facilitador\' en los espacios solicitados';
$string['configrequestedteachersname'] = 'Término utilizado para \'facilitadores\' en los espacios solicitados';
...
$string['configsectionrequestedcourse'] = 'Solicitudes de espacios';
...
$string['configshowsiteparticipantslist'] = 'Todos los participantes y facilitadores del sitio aparecerán en la lista de participantes. ¿Quién puede ver esa lista?';
...
$string['configstatsuserthreshold'] = 'Este ajuste especifica el número mínimo de usuarios matriculados en un espacio para que este valor sear incluidos en los cálculos de las estadísticas.';
...
$string['configuseblogassociations'] = '¿Deberían los usuarios poder organizar su blog asociando entradas con los espacios y con los módulos de espacio?';
...
$string['configvisiblecourses'] = 'Mostrar normalmente los espacios de categorías ocultas';
...
$string['contextlocking_desc'] = 'Esta configuración le permite configurar acceso de solo lectura para  categorías, espacios, actividades o bloques seleccionados.';
$string['cookiehttponly'] = 'Sólo \'cookies\' http';
$string['cookiesecure'] = 'Sólo \'cookies\' seguras';
$string['country'] = 'País por defecto';
$string['course_customfield'] = 'Campos personalizados del espacio';
$string['coursecolor'] = 'Color {$a}';
$string['coursecolorheading_desc'] = 'Cualquier espacio sin imagen preestablecida en los ajustes del espacio serán mostrados en la pantalla principal con una credencial estandarizada del espacio. Los colores usados en el modelo se especificarán abajo.';
$string['coursecolorsettings'] = 'Colores de la credencial del espacio';
$string['coursecontact'] = 'Gestores (contactos) del espacio';
$string['coursecontact_desc'] = 'Esta opción le permite controlar quién aparece en la descripción del espacio. Los usuarios deben tener al menos uno de estos roles en un espacio a fin de poder mostrarlos en la descripción de ese espacio.';
$string['coursecontactduplicates'] = 'Mostrar todos los roles de contacto del espacio';
$string['coursecontactduplicates_desc'] = 'Si se habilita, los usuarios con más de uno de los roles de contacto del espacio serán mostrados en la descripción del espacio con cada uno de sus roles. De lo contrario, se mostrarán con solamente un rol (el que esté  listado más arriba en \'Definir roles\' en la Administración del sitio).';
$string['coursegraceperiodafter'] = 'Período de gracia para espacios pasados';
$string['coursegraceperiodbefore'] = 'Periodo de gracia para espacios futuros';
$string['courselistshortnames'] = 'Mostrar nombres extendidos del espacio';
$string['courselistshortnames_desc'] = 'Si está activado, en las listas de espacios se mostrarán los nombres cortos además de los nombres largos. Si es necesario, los nombres largos de los espacios pueden personalizarse editando la cadena "courseextendednamedisplay" utilizando la función de personalización de idioma.';
$string['coursemgmt'] = 'Administrar espacios y categorías';
$string['courseoverview'] = 'Vista general del espacio';
$string['courserequestnotify'] = 'Notificación de solicitud de espacio';
$string['courserequestnotifyemail'] = 'El usuario {$a->user} ha solicitado un nuevo espacio en {$a->link}';
$string['courserequests'] = 'Solicitudes de espacios';
$string['courserequestspending'] = 'Solicitudes de espacio pendientes';
$string['courses'] = 'Espacios';
$string['coursesperpage'] = 'Espacios por página';
$string['courseswithsummarieslimit'] = 'Límite de espacios con resúmenes';
$string['creatornewroleid'] = 'Rol de los creadores en espacios nuevos';
$string['creatornewroleid_help'] = 'Si el usuario no tiene aún permiso para administrar el nuevo espacio, el usuario es matriculado  automáticamente utilizando este rol.';
$string['cron'] = 'Cron';
...
$string['defaultformatnotset'] = 'Error para determinar el formato del espacio por defecto. Compruebe la configuración del sitio.';
$string['defaulthomepage'] = 'Página de inicio predeterminada para los usuarios';
$string['defaultrequestcategory'] = 'Categoría por defecto de las solicitudes de espacio';
...
$string['enablecourserelativedates'] = 'Habilitar fechas de espacio relativas';
$string['enablecourserelativedates_desc'] = 'Permitir a los espacios ser configurados para mostrar fechas relativas a la fecha de inicio del usuario dentro del espacio.';
$string['enablecourserequests'] = 'Habilitar solicitudes de espacio';
...
$string['enrolinstancedefaults_desc'] = 'Ajustes predeterminados de matriculación en nuevos espacios.';
...
$string['formatuninstallwithcourses'] = 'Hay {$a->count} espacios que usan {$a->format}. Sus formatos serán cambiados a {$a->defaultformat} (el formato por defecto para este sitio). Algunos datos específicos de este formato se pueden perder. ¿Está Usted seguro de querer hacerlo?';
...
$string['guestroleid_help'] = 'Este rol se le asigna automáticamente a los invitados. También se asigna, temporalmente, por medio del plugin de matriculación de invitados a los usuarios que no están inscritos en un espacio.';
...
$string['legacyfilesaddallowed'] = 'Permitir añadir a archivos de espacio heredados';
$string['legacyfilesaddallowed_help'] = 'Si un espacio tiene archivos de espacio heredados, permitir agregarle nuevos archivos y carpeta';
$string['legacyfilesinnewcourses'] = 'Archivos heredados en los espacios nuevos';
$string['legacyfilesinnewcourses_help'] = 'De forma predeterminada, los archivos heredados solo están disponibles en los espacios actualizados desde versiones anteriores de Moodle (1.9.x a 2.0 por ejemplo). Tenga en cuenta que algunas características como la copia de seguridad y la restauración no son compatibles con esta configuración.';
...
$string['linkcoursesections'] = 'Enlazar siempre las secciones de los espacios';
$string['linkcoursesections_help'] = 'Intenta proporcionar siempre un enlace a la secciones de los espacios. Las secciones de los espacios son mostradas normalmente como enlaces si el formato del espacio muestra una sección por página. Si este ajuste está habilitado se mostrará siempre un enlace.';
...
$string['maintinprogress'] = 'Mantenimiento xencursox...';
...
$string['manageformats'] = 'Gestionar formatos de espacio';
...
$string['mnetrestore_extusers_noadmin'] = '<strong> Nota: </strong> Este archivo de copia de seguridad parece venir de otra instalación de Moodle y contiene cuentas de usuario de  Moodle Network. No tiene permiso para ejecutar este tipo de restauración. Póngase en contacto con el administrador del sitio o bien,  restaure este espacio sin ningún tipo de información de usuario (módulos, archivos ...)';
...
$string['moodleapp_help'] = '<p>Si tiene una cuenta en un sitio Moodle, puede acceder a todos sus espacios en sus dispositivos móviles con nuestra App móvil gratuita para Moodle.</p>
...
$string['mycoursesperpage'] = 'Número de espacios';
...
$string['navadduserpostslinks_help'] = 'Si está habilitado, dos enlaces se añadirán a la navegación del usuario  para ver las discusiones que el usuario ha comenzado y los mensajes que el usuario ha hecho en foros en todo el sitio o en espacios específicos.';
$string['navcourselimit'] = 'Límite del espacio';
$string['navigationupgrade'] = 'Esta actualización introduce dos nuevos bloques de navegación que sustituirán a estos bloques: Administración, Espacios, Actividades y Participantes. Si tiene establecido algún permiso especial en estos  bloques debe asegurarse de que todo se está comportando como usted desea.';
$string['navshowallcourses'] = 'Mostrar todos los espacios';
$string['navshowcategories'] = 'Mostrar las categorías de los espacios';
...
$string['navshowfullcoursenames'] = 'Ver nombres completos de espacio';
$string['navshowfullcoursenames_help'] = 'Si se habilita, el nombre completo de los espacios se mostrarán en los elementos de navegación en lugar de sus nombres cortos.';
$string['navshowmycoursecategories'] = 'Mostrar mis categorías de espacio';
$string['navshowmycoursecategories_help'] = 'Si se habilita, los espacios mostrados en la opción de menú "Mis espacios" se mostrarán en categorías';
$string['navsortmycourseshiddenlast'] = 'Ordenar mis espacios ocultos al final';
$string['navsortmycourseshiddenlast_help'] = 'Si está habilitado, los espacios ocultos se enumerarán después de los espacios visibles (para los usuarios que pueden ver los espacios ocultos). De lo contrario, todos los espacios, independientemente de su visibilidad, se enumerarán de acuerdo con la configuración "Ordenar mis espacios".';
$string['navsortmycoursessort'] = 'Ordenar mis espacios';
$string['navsortmycoursessort_help'] = 'Determina si se mostrarán los espacios en \'Mis espacios\' siguiendo un orden determinado (orden establecido en Administración del sitio > Espacios > Administrar espacios y categorías) o alfabéticamente.';
$string['never'] = 'Nunca';
...
<br/><br/>Este cambio afecta a las siguientes bases de datos de su sistema: (Por favor, guarde ahora esta lista y, después de la actualización, compruebe que estas actividades siguen funcionando del modo que desea el facilitador.)<br/><strong>{$a->text}</strong><br/>';
...
$string['restorecourse'] = 'Restaurar espacio';
$string['restorernewroleid'] = 'Rol de los restauradores en los espacios';
$string['restorernewroleid_help'] = 'Si el usuario no tiene todavía permiso para administrar el espacio recién restaurado, se le asignar este permiso automáticamente y se le da de alta  en caso necesario. Seleccione "Ninguno" si no quieres que los restauradores puedan gestionar todos los espacios restaurados.';
...
$string['searchablecourses'] = 'Espacios en los que se puede buscar';
$string['searchallavailablecourses'] = 'Espacios en los que se puede buscar';
$string['searchallavailablecourses_desc'] = 'En algunas situaciones el motor de búsqueda puede no funcionar correctamente si se busca en un gran número de espacios. Realice la búsqueda sólo en los espacios matriculados para restringir la búsqueda.';
$string['searchallavailablecourses_off'] = 'Buscar solo entre los espacios matriculados';
$string['searchallavailablecourses_on'] = 'Buscar entre todos los espacios a los que el usuario tiene acceso';
$string['searchallavailablecoursesdesc'] = 'Si se configura a buscar solamente dentro  de espacios inscritos, la información del espacio (nombre y resumen) y el contenido del espacio solamente será buscada en los espacios en los cuales el usuario está inscrito. De otra forma, la información del espacio y el contenido del espacio será buscada en todos los espacios a los cuales el usuario puede acceder, como por ejemplo los espacios con acceso de invitados habilitado.';
...
$string['searchincludeallcourses'] = 'Incluir todos los espacios visibles';
$string['searchincludeallcourses_desc'] = 'Si se habilita, los resultados de búsqueda incluirán información de los espacios (nombre y resumen) visibles para el usuario, aún no disponiendo de acceso al contenido del espacio.';
...
$string['searchindexwhendisabled_desc'] = 'Permite que la tarea programada construya el índice de búsqueda aun y cuando esté deshabilitada la búsqueda. Esto es útil si quiere construir el índice antes de que a los participantes les aparezca la opción de búsqueda.';
...
$string['sort_fullname'] = 'Nombre completo del espacio';
$string['sort_idnumber'] = 'Número ID del espacio';
$string['sort_shortname'] = 'Nombre corto del espacio';
...
$string['stickyblockscourseview'] = 'Página del espacio';
...
$string['taskcompletiondaily'] = 'Marcado diario de cierre de actividades y espacios';
$string['taskcompletionregular'] = 'Marcado continuo de cierre de actividades y espacios';
