...
/**
 * Strings for component 'quiz', language 'es', version '3.9'.
 *
 * @package     quiz
 * @category    string
...
Por ejemplo, si una respuesta se marca como incorrecta, el participante podrá volver a intentarlo de inmediato. Sin embargo, según se establezca  "Aplicar penalizaciones", se restará una penalización por cada intento equivocado.';
$string['add'] = 'Agregar';
...
$string['addingquestions'] = 'Esta parte de la página es donde puede gestionar su base de datos de preguntas. Las preguntas se agrupan en categorías para obtener una mejor organización, pero pueden ser utilizadas por cualquier cuestionario en su espacio o en otro espacio si usted decide \'publicarlas\'.<br />Después seleccionar o crear una categoría podrá crear o editar preguntas. Puede seleccionar cualquiera de estas preguntas para agregarlas a su cuestionario en el otro lado de esta página.';
...
$string['attempterrorcontentchange'] = 'Esta vista previa del cuestionario ya no existe. (Cuando se edita un cuestionario, cualquier vista previa xencursox se borra automáticamente).';
...
$string['attemptsonly'] = 'Mostrar solamente participantes con intentos';
$string['attemptstate'] = 'Estado';
$string['attemptstillinprogress'] = 'Intento aún xencursox';
...
$string['autosaveperiod_desc'] = 'Las respuestas de los participantes se pueden guardar automáticamente cada pocos minutos durante los intentos del cuestionario. Esto supone una cierta elección ya que salvar las respuestas aumenta la carga del servidor, pero reduce la posibilidad de que los participantes pierden su trabajo.';
$string['back'] = 'Volver a la vista previa de la pregunta';
$string['backtocourse'] = 'Volver al espacio';
...
$string['bothattempts'] = 'Mostrar participantes con y sin intentos';
...
* El cuestionario sólo se iniciará si el participante tiene un navegador con JavaScript activado
...
* Se impide a los participantes, en la medida de lo posible, el uso de acciones como copiar y pegar';
...
$string['canredoquestions_desc'] = 'Si esta opción está habilitada, cuando los participantes hayan terminado de realizar un intento en una pregunta concreta, verán un botón de interrogación denominado Rehacer. Este botón les permitirá realizar un intento con otra versión de la misma pregunta sin tener que enviar el intento del cuestionario completo e iniciar uno nuevo. Esta opción resulta útil principalmente para los cuestionarios de práctica.

Esta configuración solo afecta a las preguntas (p. ej., las preguntas que no sean ensayos) y las actuaciones (por ejemplo, los comentarios inmediatos o los interactivos con múltiples intentos) en las que el participante puede finalizar la pregunta antes de que se envíe el intento.';
$string['canredoquestions_help'] = 'Si esta opción está habilitada, cuando los participantes hayan terminado de realizar un intento en una pregunta concreta, verán un botón de interrogación denominado Rehacer. Este botón les permitirá realizar un intento con otra versión de la misma pregunta sin tener que enviar el intento del cuestionario completo e iniciar uno nuevo. Esta opción resulta útil principalmente para los cuestionarios de práctica.

Esta configuración solo afecta a las preguntas (p. ej., las preguntas que no sean ensayos) y las actuaciones (por ejemplo, los comentarios inmediatos o los interactivos con múltiples intentos) en las que el participante puede finalizar la pregunta antes de que se envíe el intento.';
$string['canredoquestionsyes'] = 'Los participantes pueden volver a hacer otra versión de cualquier pregunta terminada';
...
$string['completionattemptsexhausted_help'] = 'Marcar el cuestionario como completo cuando el participante haya agotado el máximo número de intentos.';
$string['completionpass'] = 'Requerir calificación aprobatoria';
$string['completionpass_help'] = 'Si está habilitada, esta actividad se considera completa cuando el participante recibe una calificación aprobatoria , siendo reflejada en el libro de calificaciones';
$string['completionpassdesc'] = 'El participante debe obtener una calificación aprobatoria para completar esta actividad';
$string['configadaptive'] = 'Si selecciona Sí en esta opción, el participante podrá dar múltiples respuestas a una pregunta incluso dentro del mismo intento de resolver el cuestionario.';
$string['configattemptsallowed'] = 'Restricción del número de intentos que los participantes tienen para resolver el cuestionario.';
...
$string['configdelay1'] = 'Si ajusta una demora, el participante deberá esperar ese tiempo antes de que pueda intentar resolver el cuestionario tras el primer intento.';
$string['configdelay1st2nd'] = 'Si aquí se fija un tiempo de demora, el participante no puede comenzar su segundo intento hasta que haya transcurrido ese tiempo después de terminar su primer intento.';
$string['configdelay2'] = 'Si establece aquí una demora, el participante tendrá que esperar ese tiempo antes de efectuar su tercer intento (o posteriores) de resolver el cuestionario.';
$string['configdelaylater'] = 'Si aquí se fija un tiempo de demora, el participante no puede comenzar su tercero, cuarto... intento hasta que haya transcurrido ese tiempo después de terminar su anterior intento.';
...
$string['configgrademethod'] = 'Método que se usará para calcular la calificación final del participante en el cuestionario cuando se permiten múltiples intentos.';
...
$string['configrequirepassword'] = 'Los participantes deben escribir su contraseña antes de intentar resolver el cuestionario.';
$string['configrequiresubnet'] = 'Los participantes únicamente pueden intentar resolver el cuestionario desde estos ordenadores.';
...
$string['configshufflewithin'] = 'Si habilita esta opción, las respuestas se ordenarán al azar cada vez que un participante intente resolver este cuestionario, en el supuesto de que la opción esté también habilitada en los ajustes de la pregunta.';
...
$string['coursetestmanager'] = 'Formato de Administración de Test de Espacio';
...
$string['delay1st2nd_help'] = '<p>Si especifica un lapso de tiempo, el participante tendrá que esperar ese tiempo antes de poder volver a contestar el cuestionario después del primer intento.</p>';
$string['delay2'] = 'Tiempo entre los intentos posteriores';
$string['delaylater'] = 'Forzar demora entre intentos posteriores';
$string['delaylater_help'] = '<p>Si especifica un lapso de tiempo, el participante tendrá que esperar a que transcurra ese tiempo antes de poder intentar contestar el cuestionario por tercera vez o en lo sucesivo.</p>';
...
$string['downloadextra'] = '(el archivo se almacena también en el directorio /quiz de archivos del espacio)';
...
* Preguntas aleatorias: Cada vez que se intenta resolver el cuestionario aparecen preguntas diferentes (cada uno de los participantes debe contestar preguntas diferentes)';
...
Usted comenzó un intento en \'{$a->quizname} \' en el espacio {$a->coursename}, pero nunca lo envió. Debería haber sido enviado en {$a->attemptduedate}.
...
$string['generalfeedback_help'] = '<p>La retroalimentación general sobre las preguntas es un texto que se muestra al participante una vez que ha intentado responder a una pregunta. A diferencia de la retroalimentación, que depende del tipo de pregunta y de la respuesta dada por el participante, aquí se muestra el mismo texto de retroalimentación general a todos los participantes.</p>

<p>Usted puede controlar cuándo se muestra a los participantes la retroalimentación general utilizando las casillas de verificación "Los participantes pueden revisar:" del formulario de edición del cuestionario.</p>

<p>Puede usar la retroalimentación general para dar a los participantes información sobre qué conocimientos tratan de comprobar las preguntas, o bien para suministrarles un enlace a más información que podrían usar en el caso de no entender las preguntas.</p>';
...
$string['graceperiodmin_desc'] = 'Existe un problema potencial al final de la realización de los cuestionarios. Por un lado, queremos permitir a los participantes que trabajen hasta el último segundo de la prueba (con la ayuda del temporizador que envía automáticamente el cuestionario cuando finaliza el tiempo). Por otra parte, el servidor puede estar sobrecargado y entonces tardar algún tiempo para procesar las respuestas. Por lo tanto, aceptaremos las respuestas enviadas este número de segundos después de que el tiempo haya expirado, por lo que no se producirán sanciones por causa de un servidor lento. Sin embargo, el participante puede engañarnos y utilizar estos segundos extras para seguir contestando el cuestionario. Usted debe establecer el valor de esta compensación en función del nivel de confianza que tenga en el rendimiento del servidor durante la realización de los cuestionarios.';
...
$string['groupsnone'] = 'No hay grupos en este espacio';
...
$string['importfilearea'] = 'Importar de un archivo que ya está en los archivos del espacio...';
...
$string['inactiveoverridehelp'] = '* El participante no tiene el rol o el grupo correctos para intentar resolver el cuestionario';
$string['incorrect'] = 'Incorrecta';
$string['indicator:cognitivedepth'] = 'Cuestionario cognitivo';
$string['indicator:cognitivedepth_help'] = 'Este indicador está basado en la profundidad cognitiva alcanzada por el participante en una actividad Cuestionario.';
$string['indicator:socialbreadth'] = 'Cuestionario social';
$string['indicator:socialbreadth_help'] = 'Este indicador está basado en la amplitud social alcanzada por el participante en una actividad Cuestionario.';
...
$string['modulename_help'] = 'La actividad Cuestionario permite al facilitador diseñar y plantear cuestionarios con preguntas tipo opción múltiple, verdadero/falso, coincidencia, respuesta corta y respuesta numérica

El facilitador puede permitir que el cuestionario se intente resolver varias veces, con las preguntas ordenadas o seleccionadas aleatoriamente del banco de preguntas. Se puede establecer un tiempo límite.
...
El facilitador puede determinar si se muestran y cuándo se muestran al usuario los resultados, los comentarios de retroalimentación y las respuestas correctas.

Los cuestionario pueden usarse para hacer

* Exámenes del espacio
...
$string['navmethod_help'] = 'Cuando la navegación secuencial está activada el participante debe avanzar a través del cuestionario en un orden determinado y no puede volver a las páginas anteriores ni saltar hacia delante.';
...
$string['notavailabletostudents'] = 'Nota: Sus participantes no pueden acceder en este momento a este cuestionario';
...
$string['onlyteachersexport'] = 'Sólo los facilitadores pueden exportar preguntas';
$string['onlyteachersimport'] = 'Sólo los facilitadores con permiso de edición pueden importar preguntas';
...
$string['overallfeedback_help'] = '<p>La retroalimentación global consiste en un texto que se muestra al participante una vez que ha completado un intento de resolver el cuestionario. El texto puede
depender de la calificación que el participante haya obtenido.</p>
...
revisar el trabajo de esta semana", los participantes que puntúen 40% o más verán el mensaje
...
$string['overduehandling_desc'] = '¿Qué debe suceder  por defecto si un participante no envía el cuestionario antes de que expire el plazo de entrega.?';
$string['overduehandling_help'] = 'Este ajuste controla qué sucede si el participante no envía su intento de resolver el cuestionario antes de que el tiempo expire. Si el participante está trabajando activamente en el cuestionario en ese momento, entonces el temporizador enviará automáticamente el intento, pero en caso de haber cerrado la sesión, esta opción controla lo que sucede.';
...
$string['popupnotice'] = 'Los participantes verán este cuestionario en una ventana segura';
...
$string['publishedit'] = 'Necesita tener permiso en el espacio para añadir o editar preguntas en esta categoría';
$string['qbrief'] = 'P. {$a}';
$string['qname'] = 'nombre';
...
$string['questiondeleted'] = 'Esta pregunta ha sido eliminada. Por favor, contacte con su facilitador';
...
$string['quizopenclose_help'] = 'Los participantes sólo podrán comenzar un intento de resolver el cuestionario después de la apertura y deben completarlo antes de la hora de cierre.';
...
$string['reportmulti_q_x_student'] = 'Opciones multi-participante';
...
$string['requirepassword_help'] = 'Si se especifica una contraseña, los participantes deben introducirla para poder intentar resolver el cuestionario.';
...
$string['reviewoptions'] = 'Los participantes pueden revisar';
$string['reviewoptionsheading'] = 'Opciones de revisión';
$string['reviewoptionsheading_help'] = 'Estas opciones controlan qué información pueden ver los participantes cuando revisan un intento del cuestionario o cuando consultan los informes del cuestionario.
...
$string['reviewoverallfeedback_help'] = 'La retroalimentación que se da al final del intento, según la puntuación final del participante.';
...
$string['savedfromdeletedcourse'] = 'Guardado del espacio eliminado "{$a}"';
...
$string['shownoattempts'] = 'Mostrar participantes sin intentos';
$string['shownoattemptsonly'] = 'Mostrar sólo participantes sin intentos';
$string['shownoimage'] = 'sin imagen';
$string['showreport'] = 'Mostrar informe';
$string['showsmallimage'] = 'Imagen pequeña';
$string['showteacherattempts'] = 'Mostrar intentos del facilitador';
$string['showuserpicture'] = 'Mostrar la imagen del usuario';
$string['showuserpicture_help'] = '<p> Si usted habilita esta opción, el nombre del participante y su imagen serán
...
Ello puede dificultar a los participantes que puedan compartirse las respuestas entre ellos, aunque también complica que los alumnos puedan identificar una pregunta para consultársela al profesorado.';
$string['shufflewithin'] = 'Ordenar al azar las respuestas';
$string['shufflewithin_help'] = 'Si habilita esta opción, las respuestas se ordenarán al azar cada vez que un participante comience a contestar el cuestionario, suponiendo que la opción también esté habilitada en los ajustes de la pregunta.
...
$string['subnetnotice'] = 'Este cuestionario ha sido bloqueado, de modo que sólo es accesible desde ciertas ubicaciones. Su ordenador no está en una sub-red habilitada. Como facilitador, puede acceder en cualquier caso a la vista previa.';
...
$string['theattempt_help'] = 'Si el participante puede revisar el intento.';
$string['time'] = 'Tiempo';
...
$string['url'] = 'URL';
$string['usedcategorymoved'] = 'Esta categoría ha sido trasladada al sitio porque, tras eliminar el espacio, sus preguntas estaban en uso por otros cuestionarios del servidor.';
$string['useroverrides'] = 'Excepciones de usuario';
$string['useroverridesdeleted'] = 'Excepciones de usuario eliminadas';
$string['usersnone'] = 'Ningún participante tiene acceso a este cuestionario';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'Necesita matricularse en este espacio antes de responder al cuestionario';
