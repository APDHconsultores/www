...
/**
 * Strings for component 'error', language 'es', version '3.9'.
 *
 * @package     error
 * @category    string
...
$string['cannotaddcoursemodule'] = 'No ha sido posible añadir un nuevo módulo de espacio';
$string['cannotaddcoursemoduletosection'] = 'No se ha podido añadir el nuevo módulo de espacio a esa sección';
...
$string['cannotassignrole'] = 'No se ha posido asignar rol en el espacio';
...
$string['cannotcreateorfindstructs'] = 'Error al encontrar o crear estructuras de la sección de este espacio';
...
$string['cannotdeletecategorycourse'] = 'Fallo al borrar el espacio \'{$a}\'.';
$string['cannotdeletecategoryquestions'] = 'No se ha podido borrar las preguntas de la categoría \'{$a\'}';
$string['cannotdeletecourse'] = 'No tiene los permisos para borrar este espacio';
...
$string['cannoteditsiteform'] = 'No puede editar el sitio del espacio utilizando este formulario';
...
$string['cannotfindcourse'] = 'No se ha podido encontrar el espacio';
...
$string['cannotfindteacher'] = 'No se ha podido encontrar al facilitador';
...
$string['cannothaveparentcate'] = 'La categoría del espacio no pueden tener una categoría padre!';
...
$string['cannotinsertgrade'] = 'No se puede insertar el ítem de calificación sin el id de espacio';
...
$string['cannotmanualctrack'] = 'La actividad no prevé seguimiento manual de cierre';
$string['cannotmapfield'] = 'Colisión del mapeo detectada - dos campos se mapean al mismo ítem de calificación {$a}';
$string['cannotmarktopic'] = 'No se pudo marcar el tema de este espacio';
...
$string['cannotmovecourses'] = 'No se pueden mover los espacios de la categoría en la que están a otra.';
...
$string['cannotremovefrommeta'] = '¡No se puede eliminar el espacio seleccionado de este meta espacio!';
...
$string['cannotrestoreadminorcreator'] = 'Usted necesita ser un usuario creador o  administrador para restaurar a un espacio nuevo!';
$string['cannotrestoreadminoredit'] = 'Usted necesita ser un usuario facilitador o  administrador para restaurar en el espacio seleccionado!';
...
$string['cannotsetparentforcatoritem'] = 'No se puede establecer el padre para la categoría o ítem del espacio!';
...
$string['cannotshowhidecoursesincategory'] = 'No se puede mostrar/ocultar los espacios en la categoría {$a}';
...
$string['cannotupdatesubcourse'] = 'No se puede actualizar un espacio hijo!';
...
$string['cannotuseadminadminorteacher'] = 'Usted necesita ser un usuario facilitador o administrador para usar esta página';
$string['cannotusepage'] = 'Sólo facilitadores y administradores pueden usar esta página';
$string['cannotusepage2'] = 'Lo sentimos, usted no puede usar esta página';
$string['cannotviewcategory'] = 'No tiene permisos para ver la lista de espacios.';
...
$string['coursedoesnotbelongtocategory'] = 'El espacio no pertenece a esta categoría';
$string['courseformatnotfound'] = 'El formato del espacio \'{$a}\' no existe o no se reconoce';
$string['coursegroupunknown'] = 'No se ha especificado el espacio correspondiente al grupo {$a}';
$string['courseidnotfound'] = 'El Id del espacio no existe';
$string['courseidnumbertaken'] = 'El número ID ya se está usando en otro espacio ({$a})';
$string['coursemisconf'] = 'El espacio está mal configurado';
$string['courserequestdisabled'] = 'Lo sentimos, pero la solicitud de espacios ha sido deshabilitada por el administrador.';
...
$string['destinationcmnotexit'] = 'El módulo del espacio destino no existe';
...
$string['enddatebeforestartdate'] = 'La fecha de cierre del espacio debe ser después de la de inicio del espacio.';
...
$string['gradesneedregrading'] = 'Las calificaciones de este espacio necesitan ser recalculadas';
$string['groupalready'] = 'El usuario ya pertence al grupo {$a}';
$string['groupexistforcourse'] = 'En este espacio ya hay un grupo "{$a}".';
$string['groupexistforcoursewithidnumber'] = '{$a->problemgroup}: El grupo "{$a->name}" con un idnumber "{$a->idnumber}" ya existe en este espacio';
...
$string['groupunknown'] = 'El grupo {$a} no está asociado al espacio especificado';
...
$string['invalidcourse'] = 'Espacio no válido';
$string['invalidcourseformat'] = 'Formato de espacio inválido';
$string['invalidcourseid'] = 'Está intentando usar una ID de espacio no válida';
$string['invalidcourselevel'] = 'Nivel de contexto incorrecto';
$string['invalidcoursemodule'] = 'ID de módulo de espacio no válida';
$string['invalidcoursenameshort'] = 'El nombre corto del espacio no es valido';
...
$string['invalidsection'] = 'El registro del módulo del espacio contiene una sección no válida';
$string['invalidsesskey'] = 'La \'sesskey\' enviada es incorrecta, y el formulario no ha sido aceptado.';
$string['invalidshortname'] = 'Esto es un nombre corto de espacio no válido';
...
$string['loginasnoenrol'] = 'No puede usar las opciones matricular o dar de baja  cuando está xencursox una sesión "Entrar como"';
$string['loginasonecourse'] = 'No puede entrar a este espacio.<br /> Debe terminar la sesión "Entrar como" antes de entrar a cualquier otro espacio.';
...
$string['moduledisable'] = 'Este módulo ({$a}) ha sido deshabilitado para este espacio en particular';
...
$string['mustbeteacher'] = 'Sólo los facilitadores pueden ver esta página';
...
$string['needcoursecategroyid'] = 'O bien un ID de espacio o de una categoría debe de especificarse';
...
$string['nocontext'] = 'Lo sentimos, ese espacio no es un contexto válido';
...
$string['noinstances'] = 'En este espacio no aparece {$a}.';
...
$string['noparticipants'] = 'No se encontraron participantes en este espacio';
$string['noparticipatorycms'] = 'Lo sentimos, no dispone de módulos de participación en espacios sobre los que informar';
...
$string['nopermissiontoimportact'] = 'Usted no tiene los permisos necesarios para importar actividades a este espacio';
...
$string['nosite'] = 'No se puede encontrar un espacio de nivel superior!';
$string['nositeid'] = 'Sin ID de sitio';
$string['nostartdatenoenddate'] = 'Solamente se puede establecer una fecha de cierre del espacio si se ha establecido una fecha de inicio.';
...
$string['notmemberofgroup'] = 'Usted no es un miembro de este grupo en este espacio';
...
$string['onlyeditingteachers'] = 'Sólo los facilitadores editores pueden hacer eso';
...
$string['reportnotavailable'] = 'Este tipo de informe sólo está disponible para el espacio del sitio';
$string['requirecorrectaccess'] = 'Puerto o URL no válidos.';
$string['requireloginerror'] = 'Espacio o actividad no accesible.';
...
$string['shortnametaken'] = 'El nombre corto ({$a}) ya ha sido utilizado para otro espacio';
...
$string['statsnodata'] = 'No hay datos disponibles para esa combinación de espacio y período de tiempo';
...
$string['unknowncourse'] = 'No existe un espacio llamado "{$a}"';
$string['unknowncourseidnumber'] = 'ID del Espacio "{$a}" desconocido';
$string['unknowncourserequest'] = 'Petición de espacio desconocida';
$string['unknowncoursesection'] = 'Sección de espacio desconocida en el espacio "{$a}"';
...
$string['unspecifycourseid'] = 'Debe especificar Id de espacio, nombre corto o Número de Id';
$string['unsupportedevent'] = 'Tipo de evento no soportado';
$string['unsupportedstate'] = 'Estado de cierre no soportado';
...
$string['usernotincourse'] = '¡Éste usuario no está en este espacio!';
...
$string['wscouldnotcreateecoursenopermission'] = 'WS - No se pudo crear un espacio - No tiene permiso';
