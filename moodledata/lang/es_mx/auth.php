...
/**
 * Strings for component 'auth', language 'es_mx', version '3.11'.
 *
 * @package     auth
 * @category    string
...
$string['errorminpasswordnonalphanum'] = 'Las contraseñas deben tener al menos {$a} caracter(es) especiales no-alfanumérico(s) como  $, *, - o #.';
