...
/**
 * Strings for component 'repository', language 'es_mx', version '3.11'.
 *
 * @package     repository
 * @category    string
...
$string['aliaseschange'] = 'Hay {$a} enlaces hacia este archivo. Si Usted continúa entonces las localizaciones que actualmente enlazan al archivo serán automáticamente actualizadas para usar una copia del archivo en sustitución.';
...
$string['cannotunzipquotaexceeded'] = 'No se puede descomprimir este archivo porque será excedido el tamaño máximo permitido en esta área de borradores.';
...
$string['confirmdeletefilewithhref'] = '¿Está seguro de que desea eliminar este archivo? Hay {$a} enlaces hacia este archivo. Si Usted continua, entonces estas localizaciones que actualmente enlazan al archivo serán actualizadas automáticamente para usar una copia del archivo en sustitución.';
...
$string['confirmrenamefolder'] = '¿Está seguro que quiere mover/renombrar esta carpeta? Todas las localizaciones que actualmente enlacen a archivos dentro de esta carpeta serán actualizadas automáticamente para usar copias del archivo en sustitución.';
...
$string['createfolderfail'] = 'No se pudo crear este directorio';
...
$string['errordoublereference'] = 'No se puede sobrescribir un archivo con un enlace debido a que ya existen enlaces hacia este archivo.';
...
$string['errorwhiledownload'] = 'Ocurrió un error al descargar el archivo: {$a}';
