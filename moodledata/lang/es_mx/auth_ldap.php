...
/**
 * Strings for component 'auth_ldap', language 'es_mx', version '3.11'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['auth_ldap_memberattribute_isdn'] = 'Anular el manejo de valores de atributos de los miembros';
...
$string['auth_ldap_noextension'] = 'El módulo LDAP de PHP no parece estar presente. Por favor asegúrese que esté instalado y activado si desea emplear este plugin de autenticación.';
...
$string['auth_ldap_rolecontext_help'] = 'Contexto LDAP usado para seleccionar para mapeo  de i>{$a->localname}</i>. Usualmente algo parecido a  "cn={$a->shortname},ou=first-ou-with-role-groups,o=myorg; cn={$a->shortname},ou=second-ou-with-role-groups,o=myorg".';
