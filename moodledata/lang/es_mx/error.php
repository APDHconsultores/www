...
/**
 * Strings for component 'error', language 'es_mx', version '3.11'.
 *
 * @package     error
 * @category    string
...
$string['listcantmoveup'] = 'No se pudo subir el ítem, porque es el primero de sus iguales.';
...
$string['oauth2refreshtokenerror'] = 'No se pudo refrescar token  OAuth 2. Estado HTTP para puntofinal remoto: {$a}';
...
$string['oauth2upgradetokenerror'] = 'No se pudo actualizar token  OAuth 2.Estado HTTP para puntofinal remoto: {$a}';
