...
/**
 * Strings for component 'admin', language 'es_mx', version '3.11'.
 *
 * @package     admin
 * @category    string
...
$string['configdisplayloginfailures'] = 'Esto muestra información a los usuarios  sobre los anteriores intentos fallidos de ingreso al sistema .';
...
Puede cambiar esta opción si desea tener su propia documentación personalizada en línea. No obstante, si lo hace así, asegúrese de que las rutas de su documentación siguen el mismo formato que https://docs.moodle.org.';
$string['configdoctonewwindow'] = 'Si habilita esta opción, entonces los enlaces a Moodle Docs se mostrarán en una nueva ventana.';
...
$string['confignavshowcategories'] = 'Mostrar las categorías de curso en la barra de navegación y en los bloques de navegación. Esto no ocurre con cursos en los que el usuario está actualmente inscrito, de manera que todavía aparecerán bajo Mis cursos sin categorías.';
...
$string['confignotifyloginthreshold'] = 'Si las notificaciones de intentos fallidos de ingreso están activas, ¿cuántos intentos fallidos son necesarios para enviar una notificación al respecto a un usuario o a una dirección IP?';
...
$string['configsessiontimeoutwarning'] = 'Si las personas que ingresaron a este sitio están inactivas  por mucho tiempo (sin  cargar páginas) entonces son advertidas de que su sesión está a punto de terminar. Esta variable especifica que tan largo debería ser este tiempo.';
$string['configsessiontimeoutwarningcheck'] = 'Advertencia de tiempo agotado de sesión debería ser menor que el tiempo de sesión agotada';
...
$string['configusesitenameforsitepages'] = 'Si está habilitado se utilizará el nombre corto del sitio para el nodo de páginas del sitio en la navegación, en lugar de la cadena de texto \'Páginas del sitio\'.';
...
$string['devlibdirpresent'] = 'Los directorios con bibliotecas de desarrollo, especialmente <em>vendor</em> y <em>node_modules</em> no deberían de estar presentes en sitios públicos. Vea el <a href="{$a->moreinfourl}">reporte de vista general de seguridad</a> para más detalles.';
...
$string['displayloginfailures'] = 'Mostrar intentos fallidos de ingreso';
...
$string['encryptedpassword_edit'] = 'Ingresar nuevo valor';
...
$string['igbinary322buggyversion'] = 'La extensión php-igbinary instalada en el sitio podría causar problemas al ejecutarse PHP 7.2. Se le recomienda que, una de dos,  o actualice a php-igbinary 3.2.5 o más reciente, o alternativamente, que actualice a PHP 7.3 o más reciente.';
...
$string['iscustomadminwarnings'] = 'Se ha detectado que su curso está usando un directorio administrativo personalizado. Esta característica ya no es soportada y será removida después de Moodle 4.2.';
...
$string['lockoutthreshold_desc'] = 'Seleccione el número de intentos fallidos de entrar que resultarán en que se bloquee la cuenta. Esta característica puede ser abusada en los ataques por negación de servicio.';
...
$string['mbstringrecommended'] = 'La instalación de la biblioteca opcional MBSTRING es muy recomendable para mejorar el rendimiento del sitio, especialmente si su sitio está soportando idiomas no latinos.';
$string['mbstringrequired'] = 'Es necesario Instalar la biblioteca MBSTRINGpara mejorar el desempeño del sitio, particularmente si su sitio soporta idiomas no-latinos.';
...
$string['navshowmycoursecategories_help'] = 'Si se habilita, los cursos en la rama de Mis cursos del usuario serán mostrados en categorías en el bloque de Navegación (solamente temas basados en Classic).';
...
$string['opensslrecommended'] = 'Instalar la biblioteca opcional OpenSSL es altamente recomendado -- activa la funcionalidad de red de Moodle (\'Moodle Networking\').';
...
$string['pathtopdftoppm'] = 'Ruta hacia pdftoppm';
$string['pathtopdftoppm_help'] = '<a href="https://poppler.freedesktop.org/">Poppler</a> es una biblioteca para renderizado que incluye la herramienta pdftoppm para convertir las páginas PDF hacia PNG.
El desempeño es generalmente mejor que cuando se emplea Ghostscript, particularmente para archivos grandes. Si está disponible, \'pdftoppm\' será empleado en lugar de Ghostscript. En la mayoría de las instalaciones Linux, la ruta puede dejarse como \'/usr/bin/pdftoppm\'. En el caso contrario usted necesita instalar el paquete poppler o poppler-utils, dependiendo de su distribución Linux. En Windows esto es proporcionado por las instalaciones Cygwin.';
...
$string['profilevisible_help'] = '* No visible - Para datos privados solamente visibles por administradores
* Visible al usuario - Para datos privados solamente visibles por el usuario  y administradores
* Visible a usuarios, profesores y admins - Para datos privados solamente visibles por el usuario, administradores y profesores (en perfil del curso)
* Visible para todos';
...
$string['profilevisibleteachers'] = 'Visible a usuarios, profesores y administradores';
...
$string['questioncwqpfscheck'] = 'Una o más preguntas \'aleatorias\' de un examen están configuradas para seleccionar preguntas de una mezcla de categorías de pregunta compartidas y no compartidas. Puede ver el <a href="{$a->reporturl}">reporte de preguntas aleatorias/a> y la <a href="{$a->docsurl}">documentación</a>.';
...
$string['sessiontimeoutwarning'] = 'Advertencia de Tiempo Agotado';
...
$string['settingmaxinputvars'] = 'Se recomienda que la configuración PHP max_input_vars sea al menos 5000.';
$string['settingmaxinputvarsrequired'] = 'La configuración PHP max_input_vars debe ser al menos 5000.';
...
$string['showuseridentity_desc'] = 'Al seleccionar o buscar usuarios, y cuando se muestran las listas de usuarios, estos campos se mostrarán adicionalmente al nombre completo. Los campos sólo se muestran a los usuarios que tienen la capacidad moodle/site:viewuseridentity (de forma predeterminada solamente a profesores y mánagers). Esta opción tiene más sentido si selecciona uno o dos campos que sean obligatorios en su institución (por ejemplo: número_de_cuenta, RFC y CURP).

Los campos marcados con * son campos personalizados del perfil del usuario. Usted puede seleccionar estos campos, pero actualmente hay algunas pantallas en las cuales no aparecerán.
...
$string['taskbackupcleanup'] = 'Limpiar bitácoras, archivos y tablas de respaldo';
...
$string['tlswarning'] = 'No se ha detectado extensión PHP/cURL con soporte TLSv1.2. Algunos servicios puede que no funcionen. Es altamente recomendable que Usted actualice sus bibliotecas TLS.';
...
$string['useexternalyui'] = 'Usar bibliotecas YUI en línea';
$string['user'] = 'Usuario';
...
$string['ziprequired'] = 'Moodle requiere ahora la extensión Zip PHP. Ya no se usan ni las binarias info-ZIP ni la biblioteca PclZip.';
