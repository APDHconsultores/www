...
$string['blocksperrow'] = 'Bloques por fila';
$string['blocksperrowdesc'] = 'Número de bloques por fila al usar una región de bloque horizontal, como por ejemplo \'Mercadeo\'. Nota: Al editar todos los bloques serán del mismo tamaño para facilitar el uso.';
...
$string['cachedef_fontawesome5iconmapping'] = 'Cachea íconos de font Awesome 5';
...
$string['faiv'] = 'Calzas gratuitas v4 para FontAwesome 5';
$string['faivdesc'] = 'Cuando se use FontAwesome 5 Free para los íconos, añadir soporte para nombres de clase 4 de íconos.';
$string['fav'] = 'FontAwesome 5 Free';
$string['favdesc'] = 'Use FontAwesome 5 Free para íconos.  Nota: Por favor vea la licencia en la carpeta fonts del tema.';
...
$string['informationheadingdesc'] = 'Información acerca del tema Foundation.';
$string['informationheadingsub'] = 'Configuraciones de Información';
...
$string['themechangesdesc'] = 'Cambios al Tema ...';
