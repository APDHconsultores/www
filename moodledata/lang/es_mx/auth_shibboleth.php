...
/**
 * Strings for component 'auth_shibboleth', language 'es_mx', version '3.11'.
 *
...
$string['auth_shib_auth_logo'] = 'Logo del método de autenticación';
$string['auth_shib_auth_logo_description'] = 'Proporcionar un logo para el método de autenticación Sgibboleth que le sea familiar a los usuarios. Este podría ser el logo de su federación Shibboleth como por ejemplo <tt>SWITCHaai Login</tt> o <tt>InCommon Login</tt> o similar.';
...
$string['auth_shib_contact_administrator'] = 'En el caso de que Usted no esté asociado con las organizaciones dadas y que requiera accesar un curso en este servidor, por favor póngase en contacto con el (Administrador de este Moodle)  <a href="mailto:{$a}">Moodle Administrator</a>.';
$string['auth_shib_convert_data'] = 'API de modificación de datos';
$string['auth_shib_convert_data_description'] = 'Puede usar este API para modificar más adelante los datos proporcionados por Shibboleth. Lea <a href="{$a}">README</a> para ver instrucciones adicionales.';
$string['auth_shib_convert_data_filepath_warning'] = 'Usted no puede usar un archivo que esté localizado dentro del directorio de datos actual del sitio ($CFG->dataroot) como el API de modificación de datos.';
...
$string['auth_shibboleth_select_organization'] = 'Para autenticar vía Shibboleth, seleccione por favor su organización en el menú desplegable.';
$string['auth_shibbolethdescription'] = 'Usando este método los usuarios son creados y autenticados empleando Shibboleth. Para detalles de configuración, vea <a href="{$a}">Shibboleth README</a>..';
$string['pluginname'] = 'Shibboleth';
$string['privacy:metadata'] = 'El plugin de Autenticación Shibboleth no almacena ningún dato personal.';
...
$string['shib_not_all_attributes_error'] = 'Moodle necesita ciertos atributos Shibboleth que no están presentes en su caso. Los atributos son: {$a}<br />Por favor, póngase en contacto con el webmaster de este servidor o con su proveedor de identidad.';
$string['shib_not_set_up_error'] = 'La autenticación Shibboleth no parece ser correcta, debido a que en esta página no están presentes las variables contextuales Shibboleth. Por favor, consulte el archivo <a href="{$a}">README</a> si desea más instrucciones sobre cómo configurar la autenticación Shibboleth, o póngase en contacto con el webmaster de esta instalación de Moodle.';
