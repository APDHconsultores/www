...
/**
 * Strings for component 'tool_dataprivacy', language 'es_mx', version '3.11'.
 *
...
$string['confirmcontextdeletion'] = '¿Realmente desea confirmar la eliminación de los contextos seleccionados? Esto también eliminará todos los datos del usuario para sus sub-contextos respectivos .';
...
$string['dataprivacy:makedatarequestsforchildren'] = 'Hacer solicitudes de datos para menores';
...
$string['dporolemapping_desc'] = 'El Oficial de Privacidad puede gestionar solicitudes de datos. La capacidad tool/dataprivacy:managedatarequests debe estar permitida para que un rol sea enlistado como una opción para mapeo como Oficial de Privacidad.';
...
$string['exceptionnotificationbody'] = '<p>Ocurrió excepción al llamar a <b>{$a->fullmethodname}</b>.<br>Esto significa que el plugin <b>{$a->component}</b> no terminó de procesar los datos. La siguiente información de la excepción que puede ser pasada al desarrollador del plugin.</p><pre>{$a->message}<br>
...
$string['expandplugintype'] = 'Tipo del plugin para expandir y colapsar.';
...
$string['gdpr_art_9_2_c_description'] = 'El procesamiento es necesario para proteger los intereses vitales del interesado o de otra persona natural en donde el interesado está física o legalmente impedido para otorgar el consentimiento.';
$string['gdpr_art_9_2_c_name'] = 'Protección de intereses vitales (GDPR Art. 9.2(c))';
$string['gdpr_art_9_2_d_description'] = 'El procesamiento se lleva a cabo en el curso de sus actividades legítimas con las salvaguardias adecuadas por una fundación, asociación o cualquier otro organismo sin ánimo de lucro, con un objetivo político, filosófico, religioso o sindical y con la condición de que el procesamiento se relacione únicamente con el miembros o ex miembros del cuerpo o personas que tienen contacto regular con él en relación con sus propósitos y que los datos personales no se divulgan fuera de ese cuerpo sin el consentimiento de los interesados';
...
$string['gdpr_art_9_2_e_description'] = 'El procesamiento se relaciona a datos personales  que son hechos públicos de forma manifiesta por el interesado';
$string['gdpr_art_9_2_e_name'] = 'Datos hechos públicos por el interesado (GDPR Art. 9.2(e))';
$string['gdpr_art_9_2_f_description'] = 'El procesamiento es necesario para el establecimiento, ejercicio o defensa de querellas legales o cuando las cortes estén actuando en su capacidad judicial';
$string['gdpr_art_9_2_f_name'] = 'Requerimientos  legales y acciones de  la corte (GDPR Art. 9.2(f))';
$string['gdpr_art_9_2_g_description'] = 'El procesamiento es necesario por razones de interés público sustancial, sobre la base de la legislación de la Unión Europea o del Estado miembro, que será proporcional al objetivo perseguido, respetará la esencia del derecho a la protección de datos y establecerá medidas adecuadas y específicas para salvaguardar los derechos fundamentales y los intereses del interesado';
$string['gdpr_art_9_2_g_name'] = 'Interés público sustancial (GDPR Art. 9.2(g))';
$string['gdpr_art_9_2_h_description'] = 'El procesamiento es necesario para fines de medicina preventiva u ocupacional, para la evaluación de la capacidad laboral del empleado, el diagnóstico médico, la provisión de atención o tratamiento de salud o asistencia social o la gestión de los sistemas y servicios de salud o asistencia social sobre la base de La legislación del Estado miembro o de la Unión Europea o en virtud de un contrato con un profesional de la salud y sujeto a las condiciones y garantías a que se hace referencia en el párrafo 3 del Artículo 9 de la GDPR';
$string['gdpr_art_9_2_h_name'] = 'Propósitos médicos (GDPR Art. 9.2(h))';
$string['gdpr_art_9_2_i_description'] = 'El procesamiento es necesario por razones de interés público en el ámbito de la salud pública, como la protección contra amenazas transfronterizas graves para la salud o la garantía de altos niveles de calidad y seguridad de la asistencia sanitaria y de medicamentos o dispositivos médicos, sobre la base de la legislación de la Unión Europea o de los Estados miembros que establece medidas adecuadas y específicas para salvaguardar los derechos y libertades del interesado, en particular el secreto profesional';
...
$string['lawfulbases_help'] = 'Seleccione al menos una opción que servirá como la base legal para el procesamiento de datos personales. Para detalles acerca de estas bases legales, por favor vea <a href="https://gdpr-info.eu/art-6-gdpr/" target="_blank">GDPR Art. 6.1</a>';
...
$string['requestcomments_help'] = 'Esta caja le permite ingresar cualquier detalle adicional acerca de su solicitud de datos.';
...
$string['send'] = 'Enviar';
$string['sensitivedatareasons'] = 'Razones para procesamiento de datos personales sensibles (delicados)';
$string['sensitivedatareasons_help'] = 'Seleccione una o más razones aplicables que eximen de la prohibición de procesamiento de datos personales sensibles (delicados) ligados a este propósito. Para mayor información, por favor vea <a href="https://gdpr-info.eu/art-9-gdpr/" target="_blank">GDPR Art. 9.2</a>';
...
$string['user'] = 'Usuario';
$string['userlistexplanation'] = 'Este plugin tiene el proveedor base pero también debería de implementar el userlist provider (proveedor de lista_de_usuarios) para soporte completo de funcionalidad de privacidad.';
$string['userlistnoncompliant'] = 'Falta userlist provider (proveedor de lista_de_usuarios).';
