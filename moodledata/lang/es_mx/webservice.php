...
/**
 * Strings for component 'webservice', language 'es_mx', version '3.11'.
 *
 * @package     webservice
 * @category    string
...
$string['usernameorid'] = 'Nombre_de_usuario / ID de Usuario';
$string['usernameorid_help'] = 'Introduzca el nombre_de_usuario o la ID de usuario.';
$string['usernameoridnousererror'] = 'No se encontraron usuarios con este nombre_de_usuario / ID de usuario';
$string['usernameoridoccurenceerror'] = 'Se encontró a más de un usuario con este nombre_de_usuario . Por favor introduzca la ID del usuario';
...
$string['wrongusernamepassword'] = 'Nombre_de_usuario o contraseña erróneos';
$string['wsaccessuserdeleted'] = 'Se rechazó el acceso a servicio web para el nombre_de_usuario eliminado: {$a}';
$string['wsaccessuserexpired'] = 'Se rechazó el acceso a servicio web para el nombre_de_usuario con contraseña caduca: {$a}';
$string['wsaccessusernologin'] = 'Se rechazó el acceso a servicio web para el nombre_de_usuario con autenticación sin-ingreso (nologin): {$a}';
$string['wsaccessusersuspended'] = 'Se rechazó el acceso a servicio web para el nombre_de_usuario suspendido: {$a}';
$string['wsaccessuserunconfirmed'] = 'Se rechazó el acceso a servicio web para el nombre_de_usuario no-confirmado: {$a}';
...
$string['wsdocumentationlogin'] = 'o escriba su nombre_de_usuario y la contraseña de servicios web:';
$string['wspassword'] = 'Contraseña del Servicio Web';
$string['wsusername'] = 'Nombre_de_usuario del Servicio Web';
