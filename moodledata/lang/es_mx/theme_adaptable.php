...
/**
 * Strings for component 'theme_adaptable', language 'es_mx', version '3.11'.
 *
...
$string['cachedef_activitymodulecountcache'] = 'Cachea el número de estudiantes que pueden acceder a un módulo dado en un curso dado.';
$string['cachedef_activitystudentrolescache'] = 'Cachea los roles de estudiante.';
$string['cachedef_activitystudentscache'] = 'Cachea las IDs de los estudiantes en un curso dado.';
$string['cachedef_activityusercreatedcache'] = 'Cachea las IDs de los nuevos usuarios en un curso dado.';
$string['cannotgetactivitycacheslock'] = 'No se puede obtener bloqueo de cacheos de actividad para curso con id {$a}.';
...
$string['course'] = 'Curso';
$string['courseadditionalmoddatamaxstudents'] = 'Configurar el número máximo de estudiantes en un curso a los que aplicará el \'Mostrar información adicional\'';
$string['courseadditionalmoddatastudentsinfounlimited'] = 'Información adicional mostrará para las actividades habilitadas para {$a} estudiantes.';
