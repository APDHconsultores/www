...
/**
 * Strings for component 'auth_db', language 'es_mx', version '3.11'.
 *
 * @package     auth_db
 * @category    string
...
$string['auth_dbpasstype'] = '<p>Especifique el formato que está usando el campo de contraseña.</p> <p>Use "interno" si quiere que la base de datos externa gestione los nombres_de_usuarios y las direcciones de correo electrónico, pero que Moodle administre las contraseñas. Si utiliza "interno", Usted debe proporcionar un campo de dirección de correo electrónico poblado en la base de datos externa, y Usted debe habilitar el trabajo agendado  \\auth_db\\task\\sync_users . Moodle enviará un Email a usuarios nuevos con una contraseña temporal.</p>';
